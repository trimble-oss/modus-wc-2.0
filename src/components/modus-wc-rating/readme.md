...
| `getAriaLabelText` | --             | Function to provide aria-label text for a given rating-item index       | `((ratingValue: number) => string) \| undefined` | `(ratingValue) =>     `Rating item ${ratingValue}`` |
