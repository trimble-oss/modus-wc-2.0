...
| `format`          | `format`            | The date format for display and input.                                                                  | `"MMM DD, YYYY" \| "dd-mm-yyyy" \| "dd/mm/yyyy" \| "yyyy-mm-dd" \| "yyyy/mm/dd" \| undefined`           | `'dd-mm-yyyy'` |
...
| `showWeekNumbers` | `show-week-numbers` | Show week numbers in the calendar                                                                       | `boolean \| undefined`                                                                                  | `false`        |
