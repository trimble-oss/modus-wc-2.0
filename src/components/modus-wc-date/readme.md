...
| `hideOverflowDates` | `hide-overflow-dates` | Hides leading/trailing dates from adjacent months. Rows that mix current-month and overflow dates blank the overflow cells; rows made entirely of overflow dates are removed, shrinking the calendar height. | `boolean \| undefined`                                                                                                        | `false`     |
