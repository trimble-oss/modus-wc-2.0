...
export const ChevronDoubleLeft: FunctionalComponent = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
    fill="currentColor"
    class="mi-solid mi-chevron-double-left"
    viewBox="0 0 24 24"
  >
...
export const ChevronDoubleRight: FunctionalComponent = () => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
    fill="currentColor"
    class="mi-solid mi-chevron-double-right"
    viewBox="0 0 24 24"
  >
...
export const ChevronLeft: FunctionalComponent = () => (
  <svg
    ...
    height="24"
    fill="currentColor"
    class="mi-solid mi-chevron-left"
    viewBox="0 0 24 24"
  >
...
export const ChevronRight: FunctionalComponent = () => (
  <svg
    ...
    height="24"
    fill="currentColor"
    class="mi-solid mi-chevron-right"
    viewBox="0 0 24 24"
  >
