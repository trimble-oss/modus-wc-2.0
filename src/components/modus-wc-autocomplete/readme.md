...
| `noResults`     | --                | The content to display when no results are found.                                                       | `IAutocompleteNoResults`            | `{     label: 'No results found',     subLabel: 'Check spelling or try a different keyword',   }` |
