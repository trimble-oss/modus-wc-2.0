...
| ------------------------ | --------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------- | ----------- |
| `backgroundOverlay`      | `background-overlay`        | When true, dims the area behind the panel while it is expanded. If `targetElement` is set, the overlay is scoped to that element only; otherwise it covers the full viewport. | `boolean`                  | `false`     |
