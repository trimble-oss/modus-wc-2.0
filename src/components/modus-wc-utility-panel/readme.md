...
| ------------------- | -------------------- | -------------------------------------------------------------------------------------------------- | -------------------------- | ----------- |
| `backgroundOverlay` | `background-overlay` | When true, dims the page behind the panel while it is expanded using `--modus-wc-opacity-overlay`. | `boolean \| undefined`     | `false`     |
