...
| `variant`           | `variant`      | Icon set to use when both outlined and solid font sets are available. This does not load fonts; it only provides a CSS hook to switch font-family. The host app must load both font CSS and provide the appropriate font-family names through CSS variables. See docs for details. | `"outlined" \| "solid" \| undefined`        | `'outlined'` |
