...
| `cropPosition`     | `crop-position` | Sets the focal point when the image is cropped or letterboxed. Maps to CSS `object-position` (e.g. `center`, `top`, `bottom left`). | `string \| undefined`                                           | `'center'`  |
