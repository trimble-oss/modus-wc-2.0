...
| `showDelay`      | `show-delay`      | Delay in milliseconds before the tooltip shows on hover - the default of 0 shows immediately.  200ms is recommended if you're adding a delay. The delay is skipped if a tooltip closed within the last 300ms, on focus, and for touch input. | `number \| undefined`                                           | `0`         |
