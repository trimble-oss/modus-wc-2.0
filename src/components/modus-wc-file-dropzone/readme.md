...
| `feedback`                    | `feedback`                       | External feedback to display info, success, or error state with optional custom icon and message | `IFileDropzoneFeedback \| undefined` | `undefined` |
