...
| `feedback`                    | `feedback`                       | External feedback to display info, success, or error state with optional custom icon and message. When `icon` is omitted, the default icon for the feedback type is used (`cloud_upload`, `alert`, or `check_circle`). | `IFileDropzoneFeedback \| undefined` | `undefined` |
...
| `includeStateIcon`            | `include-state-icon`             | Include state icon for default, validation, upload, and feedback states                                                                                                                                                | `boolean \| undefined`               | `true`      |
