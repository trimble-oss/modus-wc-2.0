...
| `hidePasswordAriaLabel` | `hide-password-aria-label` | Aria label for the password visibility toggle when the password is visible.                             | `string \| undefined`                                                                                                                                 | `'Hide password'` |
...
| `showPasswordAriaLabel` | `show-password-aria-label` | Aria label for the password visibility toggle when the password is hidden.                              | `string \| undefined`                                                                                                                                 | `'Show password'` |
