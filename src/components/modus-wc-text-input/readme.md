...
| `showClearIcon`  | `show-clear-icon`  | Show the clear icon within the input field.                                                                                                                              | `boolean \| undefined`                                                                                                                                | `false`     |
| `showSearchIcon` | `show-search-icon` | Show the search icon within the input field.                                                                                                                             | `boolean \| undefined`                                                                                                                                | `false`     |
