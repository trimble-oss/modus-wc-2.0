...
| `pickerType`      | `picker-type`      | The type of custom picker to render. - `'picker'`: Renders a popper panel with side-by-side scrollable columns for hours, minutes, seconds, and AM/PM. - `'datalist'`: Renders a popper panel with a flat list sourced from `datalistOptions`.                               | `"datalist" \| "picker" \| undefined` | `'picker'`  |
