...
| ------------- | -------------- | --------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- | ------------- |
| `ariaCurrent` | `aria-current` | Reflects the aria-current state onto the inner button (e.g. "page" for the active dock item). | `string \| undefined`                                                                       | `undefined`   |
| `ariaLabel`   | `aria-label`   | Reflects aria-label onto the inner button when the label must update reactively.              | `string \| undefined`                                                                       | `undefined`   |
