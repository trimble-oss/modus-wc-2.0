...
| `userCard` _(required)_ | `user-card`               | <span style="color:red">**[DEPRECATED]**</span> The `user-card` prop will be replaced by `profile-props` prop of the `modus-wc-profile-menu` component in an upcoming release.<br/><br/>User information used to render the user card. | `INavbarUserCard`                   | `undefined`                                                                                                                                                        |
