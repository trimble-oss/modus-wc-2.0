...
| `logoName`              | `logo-name`               | The name of the logo to display. Can be set to any value supported by the `modus-wc-logo` component, but defaults to "trimble". | `LogoName \| undefined`             | `'trimble'`                                                                                                                                                        |
