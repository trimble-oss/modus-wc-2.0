...
| `list`                   | `list`             | Provide a list of pre-defined options to suggest to the user. The value must be the ID of a <datalist> element in the same document.                                                                                                                                         | `string \| undefined`                               | `DEFAULT_DATALIST_ID` |
...
| `timeOptions`            | --                 | The options to display in the time input dropdown.                                                                                                                                                                                                                           | `string[]`                                          | `[]`                  |
