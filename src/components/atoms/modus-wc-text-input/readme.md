...
| `inputMode`              | `input-mode`         | Hints at the type of data that might be entered by the user while editing the element or its contents. This allows a browser to display an appropriate virtual keyboard. | `"decimal" \| "email" \| "none" \| "numeric" \| "search" \| "tel" \| "text" \| "url" \| undefined` | `'text'`    |
...
| `name`                   | `name`               | Name of the form control. Submitted with the form as part of a name/value pai.                                                                                           | `string \| undefined`                                                                              | `''`        |
