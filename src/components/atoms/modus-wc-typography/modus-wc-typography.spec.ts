...
describe('modus-wc-typography', () => {
  it('renders with default props', async () => {
    ...
    expect(page.root).toEqualHtml(`
      <modus-wc-typography aria-label="Test typography">
        <p class="modus-wc-typography modus-wc-typography--body-1 modus-wc-typography--p modus-wc-typography--regular modus-wc-typography--sentence" aria-label="Test typography">
          Test content
        </p>
      </modus-wc-typography>
    `);
  ...
  it('renders with custom props', async () => {
    ...
    expect(page.root).toEqualHtml(`
      <modus-wc-typography variant="h1" body-size="2" weight="bold" text-case="uppercase" custom-class="custom-style" aria-label="Custom typography">
        <h1 class="modus-wc-typography modus-wc-typography--body-2 modus-wc-typography--h1 modus-wc-typography--bold modus-wc-typography--uppercase custom-style" aria-label="Custom typography">
          Custom content
        </h1>
      </modus-wc-typography>
    `);
  ...
  it('renders body variant with different sizes', async () => {
    const page = await newSpecPage({
      components: [ModusWCTypography],
