...
import { ModusWcBadge, ModusWcAlert } from '@trimble-oss/moduswebcomponents-react';
...
export default function Page() {
  return (
    <>
      ...
      <ModusWcAlert alertTitle="Hello" alertDescription="Server-rendered." type="success" />
      <InteractiveSection />
    </>
  );
}
...
export function InteractiveSection() {
  return (
    <ModusWcButton color="primary" variant="filled" onButtonClick={() => console.log('clicked')}>
      Click me
    </ModusWcButton>
  );
}
