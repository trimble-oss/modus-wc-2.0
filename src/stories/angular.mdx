...
Install both `modus-wc` and `modus-wc-ng` dependencies and ensure you specify the target version of Angular for the `modus-wc-ng` package (e.g., `ng18` for Angular 18):

```bash
npm install @trimble-cms/modus-wc @trimble-cms/modus-wc-ng@<latest-version>-ng<target-version>
```
