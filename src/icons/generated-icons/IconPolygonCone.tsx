...
export const IconPolygonCone: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-polygon-cone pressed' : 'icon-polygon-cone'}
