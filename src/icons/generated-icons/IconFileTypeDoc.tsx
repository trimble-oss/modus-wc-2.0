...
export const IconFileTypeDoc: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-file-type-doc pressed' : 'icon-file-type-doc'}
