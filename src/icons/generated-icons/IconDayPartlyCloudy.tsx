...
export const IconDayPartlyCloudy: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed
        ? 'icon-day-partly-cloudy pressed'
