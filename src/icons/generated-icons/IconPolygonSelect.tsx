...
export const IconPolygonSelect: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-polygon-select pressed' : 'icon-polygon-select'
    }
