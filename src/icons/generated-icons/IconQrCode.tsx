...
export const IconQrCode: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-qr-code pressed' : 'icon-qr-code'}
