...
export const IconFileTypeXls: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-file-type-xls pressed' : 'icon-file-type-xls'}
