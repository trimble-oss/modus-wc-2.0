...
export const IconPaperclip: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-paperclip pressed' : 'icon-paperclip'}
