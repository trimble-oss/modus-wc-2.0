...
export const IconFileCheckOut: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-file-check-out pressed' : 'icon-file-check-out'
    }
