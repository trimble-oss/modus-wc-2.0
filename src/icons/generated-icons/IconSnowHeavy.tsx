...
export const IconSnowHeavy: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-snow-heavy pressed' : 'icon-snow-heavy'}
