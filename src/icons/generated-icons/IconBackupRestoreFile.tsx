...
export const IconBackupRestoreFile: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed
        ? 'icon-backup-restore-file pressed'
        : 'icon-backup-restore-file'
    }
