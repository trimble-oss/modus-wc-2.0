...
export const IconFileTypeCur: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-file-type-cur pressed' : 'icon-file-type-cur'}
