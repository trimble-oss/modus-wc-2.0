...
export const IconCalendarLoadingUnloadingDate: FunctionalComponent<
  IconProps
> = (props: IconProps) => (
  <svg
    class={
      props.pressed
        ? 'icon-calendar-loading-unloading-date pressed'
        : 'icon-calendar-loading-unloading-date'
    }
