...
export const IconBatteryChargingVertical: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed
        ? 'icon-battery-charging-vertical pressed'
