...
export const IconSmileySomewhatSatisfiedOutlined: FunctionalComponent<
  IconProps
> = (props: IconProps) => (
  <svg
    class={
      props.pressed
        ? 'icon-smiley-somewhat-satisfied-outlined pressed'
        : 'icon-smiley-somewhat-satisfied-outlined'
    }
