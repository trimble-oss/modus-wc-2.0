...
export const IconFileTypeRfq: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-file-type-rfq pressed' : 'icon-file-type-rfq'}
