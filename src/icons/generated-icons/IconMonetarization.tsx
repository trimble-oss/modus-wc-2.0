...
export const IconMonetarization: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-monetarization pressed' : 'icon-monetarization'
    }
