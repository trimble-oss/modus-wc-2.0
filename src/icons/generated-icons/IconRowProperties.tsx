...
export const IconRowProperties: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-row-properties pressed' : 'icon-row-properties'
    }
