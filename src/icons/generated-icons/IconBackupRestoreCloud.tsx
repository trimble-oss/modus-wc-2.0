...
export const IconBackupRestoreCloud: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed
        ? 'icon-backup-restore-cloud pressed'
        : 'icon-backup-restore-cloud'
    }
