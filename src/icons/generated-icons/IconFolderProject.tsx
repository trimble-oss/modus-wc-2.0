...
export const IconFolderProject: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-folder-project pressed' : 'icon-folder-project'
    }
