...
export const IconClockQuestionMark: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed
        ? 'icon-clock-question-mark pressed'
        : 'icon-clock-question-mark'
    }
