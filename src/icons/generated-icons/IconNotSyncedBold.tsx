...
export const IconNotSyncedBold: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-not-synced-bold pressed' : 'icon-not-synced-bold'
    }
