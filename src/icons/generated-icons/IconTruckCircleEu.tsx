...
export const IconTruckCircleEu: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-truck-circle-eu pressed' : 'icon-truck-circle-eu'
    }
