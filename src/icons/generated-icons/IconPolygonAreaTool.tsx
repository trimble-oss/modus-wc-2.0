...
export const IconPolygonAreaTool: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed
        ? 'icon-polygon-area-tool pressed'
