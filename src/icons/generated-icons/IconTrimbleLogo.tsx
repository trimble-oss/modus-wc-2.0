...
export const IconTrimbleLogo: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-trimble-logo pressed' : 'icon-trimble-logo'}
