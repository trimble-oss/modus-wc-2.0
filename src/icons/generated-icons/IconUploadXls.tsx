...
export const IconUploadXls: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-upload-xls pressed' : 'icon-upload-xls'}
