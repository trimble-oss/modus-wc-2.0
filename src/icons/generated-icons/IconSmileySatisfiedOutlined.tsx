...
export const IconSmileySatisfiedOutlined: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed
        ? 'icon-smiley-satisfied-outlined pressed'
        : 'icon-smiley-satisfied-outlined'
    }
