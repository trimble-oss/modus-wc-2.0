...
export const IconManagePeople: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-manage-people pressed' : 'icon-manage-people'}
