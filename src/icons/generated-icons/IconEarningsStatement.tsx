...
export const IconEarningsStatement: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed
        ? 'icon-earnings-statement pressed'
        : 'icon-earnings-statement'
    }
