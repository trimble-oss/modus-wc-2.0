...
export const IconManageAccounts: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-manage-accounts pressed' : 'icon-manage-accounts'
    }
