...
export const IconTruckCircle: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-truck-circle pressed' : 'icon-truck-circle'}
