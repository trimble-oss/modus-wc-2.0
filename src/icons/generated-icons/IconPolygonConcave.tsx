...
export const IconPolygonConcave: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-polygon-concave pressed' : 'icon-polygon-concave'
    }
