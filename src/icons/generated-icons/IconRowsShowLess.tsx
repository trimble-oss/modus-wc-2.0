...
export const IconRowsShowLess: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-rows-show-less pressed' : 'icon-rows-show-less'
    }
