...
export const IconIconsShapes: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-icons-shapes pressed' : 'icon-icons-shapes'}
