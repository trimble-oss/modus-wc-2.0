...
export const IconBatteryChargingHorizontal: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed
        ? 'icon-battery-charging-horizontal pressed'
        : 'icon-battery-charging-horizontal'
    }
