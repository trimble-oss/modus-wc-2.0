...
export const IconGears: FunctionalComponent<IconProps> = (props: IconProps) => (
  <svg
    class={props.pressed ? 'icon-gears pressed' : 'icon-gears'}
