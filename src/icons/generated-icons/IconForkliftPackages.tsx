...
export const IconForkliftPackages: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed
        ? 'icon-forklift-packages pressed'
        : 'icon-forklift-packages'
    }
