...
export const IconArtificialIntelligence: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed
        ? 'icon-artificial-intelligence pressed'
