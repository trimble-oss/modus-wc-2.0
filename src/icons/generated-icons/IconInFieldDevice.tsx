...
export const IconInFieldDevice: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-in-field-device pressed' : 'icon-in-field-device'
    }
