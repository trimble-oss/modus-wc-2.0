...
export const IconFileTypeTmp: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-file-type-tmp pressed' : 'icon-file-type-tmp'}
