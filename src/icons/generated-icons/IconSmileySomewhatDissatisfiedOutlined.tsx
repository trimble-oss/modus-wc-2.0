...
export const IconSmileySomewhatDissatisfiedOutlined: FunctionalComponent<
  IconProps
> = (props: IconProps) => (
  <svg
    class={
      props.pressed
        ? 'icon-smiley-somewhat-dissatisfied-outlined pressed'
        : 'icon-smiley-somewhat-dissatisfied-outlined'
    }
