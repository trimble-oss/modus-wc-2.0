...
export const IconFileTypeLog: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-file-type-log pressed' : 'icon-file-type-log'}
