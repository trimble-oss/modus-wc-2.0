...
export const IconPackageDelivery: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-package-delivery pressed' : 'icon-package-delivery'
    }
