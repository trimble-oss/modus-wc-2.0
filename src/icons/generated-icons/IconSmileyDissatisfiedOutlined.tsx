...
export const IconSmileyDissatisfiedOutlined: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed
        ? 'icon-smiley-dissatisfied-outlined pressed'
        : 'icon-smiley-dissatisfied-outlined'
    }
