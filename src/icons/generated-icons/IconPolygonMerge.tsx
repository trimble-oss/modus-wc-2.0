...
export const IconPolygonMerge: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-polygon-merge pressed' : 'icon-polygon-merge'}
