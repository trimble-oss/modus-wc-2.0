...
export const IconUserPermissions: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-user-permissions pressed' : 'icon-user-permissions'
    }
