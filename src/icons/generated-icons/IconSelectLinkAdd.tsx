...
export const IconSelectLinkAdd: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={
      props.pressed ? 'icon-select-link-add pressed' : 'icon-select-link-add'
    }
