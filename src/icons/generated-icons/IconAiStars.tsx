...
export const IconAiStars: FunctionalComponent<IconProps> = (
  props: IconProps
) => (
  <svg
    class={props.pressed ? 'icon-ai-stars pressed' : 'icon-ai-stars'}
