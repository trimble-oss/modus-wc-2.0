...
To author a **product** theme without forking the library, use `npx modus-theme`
and `modus-theme.config.json`. See [offline theme authoring](https://github.com/trimble-oss/modus-wc-2.0/blob/main/docs/custom-themes.md).
