import{x as l}from"./lit-element-C8zulti1.js";import{o as n}from"./if-defined-yv6owfG8.js";const v={title:"Components/Toast",component:"modus-wc-toast",args:{position:"top-end"},argTypes:{position:{control:{type:"select"},options:["top-start","top-center","top-end","middle-start","middle-center","middle-end","bottom-start","bottom-center","bottom-end"]}},parameters:{layout:"padded",viewport:"responsive"}},p={render:o=>l`
