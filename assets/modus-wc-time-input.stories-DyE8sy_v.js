import{w as z}from"./decorator-D4YmxizW.js";import{x as a}from"./lit-element-C8zulti1.js";import{o as t}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var l=Object.freeze,q=Object.defineProperty,O=(e,F)=>l(q(e,"raw",{value:l(e.slice())})),m;const B={title:"Components/Forms/Time Input",component:"modus-wc-time-input",args:{disabled:!1,label:"Label",size:"md"},argTypes:{"auto-complete":{control:{type:"select"},options:["on","off"]},feedback:{description:"Feedback prop for input components",table:{type:{detail:`
...
| valueChange    | inputChange |                                                      |
  ...
  render: () => html\`<div></div>\`
}`,...(T=(S=d.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};const L=["Template","WithSeconds","WithDatalist","WithDatalistOptions","WithErrorFeedback","Migration"];export{d as Migration,n as Template,r as WithDatalist,o as WithDatalistOptions,s as WithErrorFeedback,i as WithSeconds,L as __namedExportsOrder,B as default};
