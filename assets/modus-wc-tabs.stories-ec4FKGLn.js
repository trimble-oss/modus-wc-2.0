import{w as C}from"./decorator-D4YmxizW.js";import{x as i}from"./lit-element-C8zulti1.js";import{o as n}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const A={title:"Components/Tabs",component:"modus-wc-tabs",args:{size:"md",tabs:[{label:"Tab 1"},{label:"Tab 2"},{label:"Tab 3",disabled:!0},{icon:"home"}],"tab-style":"bordered"},argTypes:{tabs:{description:"Array of tab objects defining the tabs to display",table:{type:{detail:`
            Interface: ITab
            Properties:
          ...
          `}}},"tab-style":{control:{type:"select"},options:["boxed","bordered","lifted","none"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[C],parameters:{actions:{handles:["tabChange"]}}},c={render:e=>i`
<modus-wc-tabs
...
}`,...(w=(T=o.parameters)==null?void 0:T.docs)==null?void 0:w.source}}};var y,I,x;r.parameters={...r.parameters,docs:{...(y=r.parameters)==null?void 0:y.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(x=(I=r.parameters)==null?void 0:I.docs)==null?void 0:x.source}}};const M=["Default","ActiveAndDisabled","Icons","TabsWithPanel","Migration"];export{t as ActiveAndDisabled,a as Default,s as Icons,r as Migration,o as TabsWithPanel,M as __namedExportsOrder,A as default};
