import{w as m}from"./decorator-D4YmxizW.js";import{x as c}from"./lit-element-C8zulti1.js";import{o as n}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const f={title:"Components/Forms/Checkbox",component:"modus-wc-checkbox",args:{"custom-class":"",disabled:!1,indeterminate:!1,label:"Label",name:"",required:!1,size:"md",value:!0},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[m],parameters:{actions:{handles:["inputBlur","inputChange","inputFocus"]}}},a={render:e=>c`
      <modus-wc-checkbox
        aria-label="Checkbox"
...
| checkboxClick | inputChange | Event now emits \\\`InputEvent\\\` instead of \\\`boolean\\\` |
  ...
  render: () => html\`<div></div>\`
}`,...(l=(d=i.parameters)==null?void 0:d.docs)==null?void 0:l.source}}};const g=["Default","Migration"];export{a as Default,i as Migration,g as __namedExportsOrder,f as default};
