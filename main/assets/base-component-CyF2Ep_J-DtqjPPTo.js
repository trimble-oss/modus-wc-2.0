...
modus-wc-button .modus-wc-btn-outline.modus-wc-btn-success[aria-pressed=true] {
  background-color: var(--modus-wc-color-success);
  border: 1px solid transparent;
...
modus-wc-button .modus-wc-btn-outline.modus-wc-btn-base-inverted[aria-pressed=true] {
...
modus-wc-button .modus-wc-btn-borderless.modus-wc-btn-success[aria-pressed=true] {
  background-color: var(--modus-wc-color-success);
  border: 1px solid transparent;
  color: var(--modus-wc-color-success-content);
}
...
modus-wc-button .modus-wc-btn-borderless.modus-wc-btn-base-inverted[aria-pressed=true] {
  background-color: var(--modus-wc-color-trimble-neutral);
  border: 1px solid transparent;
  color: var(--modus-wc-color-trimble-neutral-content);
}
