...
`}}},render:()=>v`
    ...
    `},y={render:e=>((!e.items||e.items.length===0)&&(e.items=[...f]),e.items=f.map(m=>m.value==="apple"||m.value==="banana"?{...m,selected:!0}:m),v(L||(L=A([`
<script>
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>v`<div></div>`};var D,F,H;g.parameters={...g.parameters,docs:{...(D=g.parameters)==null?void 0:D.docs,source:{originalSource:`{
  ...Template
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(ae=(se=E.parameters)==null?void 0:se.docs)==null?void 0:ae.source}}};const ve=["Default","WithTooltips","MultiSelect","WithSpinner","CustomMenuItems","CustomEventHandlers","WithProgrammaticControl","DynamicOptions","Migration"];export{C as CustomEventHandlers,x as CustomMenuItems,g as Default,S as DynamicOptions,E as Migration,y as MultiSelect,$ as WithProgrammaticControl,M as WithSpinner,I as WithTooltips,ve as __namedExportsOrder,re as default};
