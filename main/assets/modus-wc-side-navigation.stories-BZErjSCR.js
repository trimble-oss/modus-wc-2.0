import{w as S}from"./decorator-D4YmxizW.js";import{x as y}from"./lit-element-C8zulti1.js";import{o}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var m=Object.freeze,C=Object.defineProperty,x=(e,r)=>m(C(e,"raw",{value:m(e.slice())})),l,p;const A={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[S],parameters:{layout:"padded",actions:{handles:["expandedChange","itemSelect"]}}},c={render:e=>{const r=u=>{const n=u.target,a=n==null?void 0:n.closest(".layout-with-navbar");let t;a?t=a.querySelector("modus-wc-side-navigation"):t=document.querySelector("modus-wc-side-navigation"),t&&(t.expanded=u.detail)};return y(l||(l=x([`
      <style>
        .layout-with-navbar {
          display: flex;
    ...
    `])),r,{avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},{ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],o(e["custom-class"]),e.expanded,e["max-width"],o(e.mode),o(e["target-content"]))}},d={render:e=>{const r=n=>{const a=n.target,t=a==null?void 0:a.closest(".layout-with-navbar");let s;if(t&&(s=t.querySelector("modus-wc-side-navigation"),s)){const i=s;i.expanded=n.detail}},u=n=>{n.detail||n.target.querySelectorAll("modus-wc-menu-item").forEach(s=>{const i=s;i.hasSubmenu&&typeof i.collapseSubmenu=="function"&&i.collapseSubmenu()})};return y(p||(p=x([`
      ...
      <script>
        ...
        //
      <\/script>
    `])),r,{avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},{ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],o(e["custom-class"]),e.expanded,e["max-width"],o(e.mode),o(e["target-content"]),u,!0,!0,!0,!0)}};var v,h,w;c.parameters={...c.parameters,docs:{...(v=c.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: args => {
...
}`,...(w=(h=c.parameters)==null?void 0:h.docs)==null?void 0:w.source}}};var g,b,f;d.parameters={...d.parameters,docs:{...(g=d.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: args => {
    const handleMenuOpenChange = (e: CustomEvent) => {
      const eventSource = e.target as HTMLElement;
      const storyContainer = eventSource?.closest('.layout-with-navbar');
...
}`,...(f=(b=d.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};const O=["Default","WithSubmenu"];export{c as Default,d as WithSubmenu,O as __namedExportsOrder,A as default};
