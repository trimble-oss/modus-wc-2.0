import{w as D}from"./decorator-534da2b0.js";import{b as r}from"./lit-element-38260dd9.js";import{o as t}from"./if-defined-30b85b98.js";import{c as T}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";var u=Object.freeze,q=Object.defineProperty,B=(e,s)=>u(q(e,"raw",{value:u(s||e.slice())})),p;const O={title:"Components/Forms/Text Input",component:"modus-wc-text-input",args:{bordered:!0,disabled:!1,"include-clear":!1,"include-search":!1,inputmode:"text",label:"Label",size:"md",spellcheck:!1,type:"text",value:""},argTypes:{"auto-capitalize":{options:["off","none","on","sentences","words","characters"]},"auto-complete":{control:{type:"text"}},"auto-correct":{options:["on","off"]},enterkeyhint:{options:["enter","done","go","next","previous","search","send"]},feedback:{description:"Feedback prop for input components",table:{type:{detail:`
...
>
  ...
  `,args:{placeholder:"Enter text here..."}},c={render:e=>{if(!customElements.get("text-input-shadow-host")){const s=T({componentTag:"modus-wc-text-input",propsMapper:(n,S)=>{const a=S;a.autoCapitalize=n["auto-capitalize"]||"",a.autoComplete=n["auto-complete"]||"",a.autoCorrect=n["auto-correct"]||"",a.bordered=Boolean(n.bordered),a.clearAriaLabel=n["clear-aria-label"]||""||"Clear text",a.customClass=n["custom-class"]||"",a.disabled=Boolean(n.disabled),a.enterkeyhint=n.enterkeyhint||"",a.includeClear=Boolean(n["include-clear"]),a.includeSearch=Boolean(n["include-search"]),a.inputId=n["input-id"]||"",a.inputTabIndex=n["input-tab-index"]||0,a.label=n.label||"",a.maxLength=n["max-length"],a.minLength=n["min-length"],a.name=n.name||"",a.pattern=n.pattern||"",a.placeholder=n.placeholder||"",a.readOnly=Boolean(n["read-only"]),a.required=Boolean(n.required),a.size=n.size||"",a.type=n.type||"",a.value=n.value}});customElements.define("text-input-shadow-host",s)}return r`<text-input-shadow-host
      .props=${{...e}}
