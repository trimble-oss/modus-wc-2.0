...
*
* Styles for this loader component were adapted from tailwindcss: 
...
}`,l=c,w=function(){function e(t){i(this,t),this.color="primary",this.customClass="",this.size="md",this.variant="spinner"}return e.prototype.componentWillLoad=function(){this.el.ariaLabel||(console.warn("ModusWcLoader: aria-label is required for accessibility. Using fallback label."),this.el.ariaLabel="Loading")},e.prototype.getClasses=function(){var t=["modus-wc-loader"],o=s({color:this.color,size:this.size,variant:this.variant});return o&&t.push(o),this.customClass&&t.push(this.customClass),t.join(" ")},e.prototype.render=function(){return n(r,{key:"61661ac8470b865292b92ee0926e5a1aa3092f62"},n("span",{key:"89fa33a80919ed5e6fba88c23d3305a00e4286ec","aria-label":this.el.ariaLabel,class:this.getClasses(),role:"status",tabindex:-1}))},Object.defineProperty(e.prototype,"el",{get:function(){return a(this)},enumerable:!1,configurable:!0}),e}();w.style=l;export{w as modus_wc_loader};
