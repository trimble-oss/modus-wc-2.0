import{w as q}from"./decorator-D4YmxizW.js";import{x as e}from"./lit-element-CucEn6F2.js";import{o as O}from"./if-defined-BiZP-SBN.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var l=Object.freeze,U=Object.defineProperty,A=(t,u)=>l(U(t,"raw",{value:l(t.slice())})),m;const Q={title:"Components/Button",component:"modus-wc-button",args:{color:"primary",disabled:!1,"full-width":!1,pressed:!1,shape:"rectangle",size:"md",type:"button",variant:"filled"},argTypes:{color:{control:{type:"select"},options:["primary","secondary","tertiary","warning","danger"]},shape:{control:{type:"select"},options:["circle","ellipse","rectangle","square"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]},type:{control:{type:"select"},options:["button","submit","reset"]},variant:{control:{type:"select"},options:["borderless","filled","outlined"]}},decorators:[q],parameters:{actions:{handles:["buttonClick"]}}},j={render:t=>e`
<modus-wc-button
  color="${t.color}"
...
>
  Ellipse
    ...
    `},r={render:()=>{const t=()=>{const u=document.getElementById("btn-text"),R=document.getElementById("btn-text-input");u.textContent=R.value};return e(m||(m=A([`
<script>
...
}`,...(h=(g=o.parameters)==null?void 0:g.docs)==null?void 0:h.source}}};var x,y,f;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => {
...
}`,...(f=(y=r.parameters)==null?void 0:y.docs)==null?void 0:f.source}}};var B,T,C;s.parameters={...s.parameters,docs:{...(B=s.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: () => {
    // prettier-ignore
    return html\`
<modus-wc-button aria-label="Notification button">
...
}`,...(C=(T=s.parameters)==null?void 0:T.docs)==null?void 0:C.source}}};var E,I,k;a.parameters={...a.parameters,docs:{...(E=a.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => {
    // prettier-ignore
    return html\`
<modus-wc-button>
...
}`,...(k=(I=a.parameters)==null?void 0:I.docs)==null?void 0:k.source}}};var _,N,S;c.parameters={...c.parameters,docs:{...(_=c.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: () => {
    // prettier-ignore
    return html\`
<modus-wc-button>
...
}`,...(S=(N=c.parameters)==null?void 0:N.docs)==null?void 0:S.source}}};var z,P,$;i.parameters={...i.parameters,docs:{...(z=i.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: () => {
    // prettier-ignore
    return html\`
<modus-wc-button>
