...
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn,
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn {
...
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn:active, [data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn:hover:not(.modus-wc-chip--active):not(.modus-wc-chip--error), [data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn:focus,
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn:active,
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn:hover:not(.modus-wc-chip--active):not(.modus-wc-chip--error),
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn:focus {
  background-color: #eaeaef;
  color: #6a6976;
}
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn:active .modus-wc-chip-label, [data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn:hover:not(.modus-wc-chip--active):not(.modus-wc-chip--error) .modus-wc-chip-label, [data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn:focus .modus-wc-chip-label,
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn:active .modus-wc-chip-label,
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn:hover:not(.modus-wc-chip--active):not(.modus-wc-chip--error) .modus-wc-chip-label,
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn:focus .modus-wc-chip-label {
  color: #6a6976;
}
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn:has(.modus-wc-chip-remove-icon),
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn:has(.modus-wc-chip-remove-icon) {
  overflow: hidden;
  padding-inline-end: 0;
}
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn:has(.modus-wc-chip-remove-icon):not(.modus-wc-chip-multiline),
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn:has(.modus-wc-chip-remove-icon):not(.modus-wc-chip-multiline) {
  padding-block: 0;
}
...
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn modus-wc-icon:has(.modus-wc-chip-remove-icon--connect):hover,
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn modus-wc-icon:has(.modus-wc-chip-remove-icon--connect):hover {
...
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-chip-multiline.modus-wc-btn-sm modus-wc-icon:has(.modus-wc-chip-remove-icon--connect),
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-chip-multiline.modus-wc-btn-sm modus-wc-icon:has(.modus-wc-chip-remove-icon--connect) {
  height: var(--modus-wc-spacing-xl);
  min-width: var(--modus-wc-spacing-xl);
  width: var(--modus-wc-spacing-xl);
}
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-chip-multiline.modus-wc-btn-md modus-wc-icon:has(.modus-wc-chip-remove-icon--connect),
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-chip-multiline.modus-wc-btn-md modus-wc-icon:has(.modus-wc-chip-remove-icon--connect) {
  height: var(--modus-wc-spacing-2xl);
  min-width: var(--modus-wc-spacing-2xl);
  width: var(--modus-wc-spacing-2xl);
}
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-chip-multiline.modus-wc-btn-lg modus-wc-icon:has(.modus-wc-chip-remove-icon--connect),
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-chip-multiline.modus-wc-btn-lg modus-wc-icon:has(.modus-wc-chip-remove-icon--connect) {
  height: var(--modus-wc-spacing-3xl);
  min-width: var(--modus-wc-spacing-3xl);
  width: var(--modus-wc-spacing-3xl);
}
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-chip-multiline modus-wc-icon:has(.modus-wc-chip-remove-icon--connect),
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-chip-multiline modus-wc-icon:has(.modus-wc-chip-remove-icon--connect) {
  align-self: center;
}
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn .modus-wc-chip-remove-icon,
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn .modus-wc-chip-remove-icon {
  border-radius: 50%;
  color: #6a6976;
}
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-btn-sm .modus-wc-chip-remove-icon,
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-btn-sm .modus-wc-chip-remove-icon {
  font-size: var(--modus-wc-font-size-sm);
}
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-btn-md .modus-wc-chip-remove-icon,
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-btn-md .modus-wc-chip-remove-icon {
  font-size: var(--modus-wc-font-size-lg);
}
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-btn-lg .modus-wc-chip-remove-icon,
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn.modus-wc-btn-lg .modus-wc-chip-remove-icon {
  font-size: var(--modus-wc-font-size-3xl);
}
/**
* This component uses Tailwind CSS and DaisyUI.
