import{w as y}from"./decorator-D4YmxizW.js";import{x as v}from"./lit-element-CucEn6F2.js";import{o as r}from"./if-defined-BiZP-SBN.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const x={title:"Components/Forms/Date",component:"modus-wc-date",args:{bordered:!0,"custom-class":"",disabled:!1,label:"Label","read-only":!1,required:!1,"show-week-numbers":!1,size:"md",value:"","week-start-day":"sunday"},argTypes:{feedback:{description:"Feedback prop for input components",table:{type:{detail:`
      ...
      ></modus-wc-date>
    `},a={...b},f={level:"error",message:"Value is required."},o={...b,args:{feedback:f,required:!0},parameters:{docs:{source:{transform:e=>`${e}
<script>
