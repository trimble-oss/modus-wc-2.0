import{_ as Y,b as s}from"./chunk-4XZ63LWV-CnYBn8W6.js";import{x as l}from"./lit-element-C8zulti1.js";import"./v4-CtRu48qb.js";const{definePreview:re}=__STORYBOOK_MODULE_PREVIEW_API__,{global:S}=__STORYBOOK_MODULE_GLOBAL__;var F={};Y(F,{argsEnhancers:()=>Q,loaders:()=>ee});var q=(e,n)=>typeof n[e]>"u"&&!(e in n),G=e=>{let{initialArgs:n,argTypes:t,id:i,parameters:{actions:r}}=e;if(!r||r.disable||!r.argTypesRegex||!t)return{};let o=new RegExp(r.argTypesRegex);return Object.entries(t).filter(([a])=>!!o.test(a)).reduce((a,[m,c])=>(q(m,n)&&(a[m]=s(m,{implicit:!0,id:i})),a),{})},Z=e=>{let{initialArgs:n,argTypes:t,parameters:{actions:i}}=e;return i!=null&&i.disable||!t?{}:Object.entries(t).filter(([r,o])=>!!o.action).reduce((r,[o,a])=>(q(o,n)&&(r[o]=s(typeof a.action=="string"?a.action:o)),r),{})},Q=[Z,G],y=!1,X=e=>{let{parameters:{actions:n}}=e;if(!(n!=null&&n.disable)&&!y&&"__STORYBOOK_TEST_ON_MOCK_CALL__"in S&&typeof S.__STORYBOOK_TEST_ON_MOCK_CALL__=="function"){let t=S.__STORYBOOK_TEST_ON_MOCK_CALL__;t((i,r)=>{let o=i.getMockName();o!=="spy"&&(!/^next\/.*::/.test(o)||["next/router::useRouter()","next/navigation::useRouter()","next/navigation::redirect","next/cache::","next/headers::cookies().set","next/headers::cookies().delete","next/headers::headers().set","next/headers::headers().delete"].some(a=>o.startsWith(a)))&&s(o)(r)}),y=!0}},ee=[X],f=Object.freeze,ne=Object.defineProperty,d=(e,n)=>f(ne(e,"raw",{value:f(n||e.slice())})),$,D,I,z,x,R;const ie={title:"Components/Table",component:"modus-wc-table",argTypes:{columns:{control:"object",description:"An array of column definitions.",table:{type:{detail:`
    ...
    `],[`
      ...
      <modus-wc-table
        ...
        @cellEditCommit=`,`
      ></modus-wc-table>
    `])),n,t,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,e.caption,s("rowClick"),s("sortChange"),s("paginationChange"),s("rowSelectionChange"),s("cellEditStart"),s("cellEditCommit"))},args:{density:"comfortable",hover:!1,sortable:!0,paginated:!1,"show-page-size-selector":!0,"custom-class":"",selectable:"none",zebra:!1,"current-page":1,"page-size-options":[5,10,15],"selected-row-ids":[],editable:!1}},h={render:e=>{const n=e.columns||u(),t=e.data||p();return l(D||(D=d([`
      <script>
        // Helper functions
        const createDemoColumns = (): ITableColumn[] => [
          {
    ...
    `],[`
      ...
      <modus-wc-table
        ...
        @rowClick=`,`
      ></modus-wc-table>
    `])),n,t,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,s("rowClick"))},args:{density:"comfortable",hover:!0}},b={render:e=>{const n=e.columns||te(),t=e.data||p();return l(I||(I=d([`
      <script>
        // Helper functions
        const createDemoColumns = (): ITableColumn[] => [
          {
    ...
    `],[`
      ...
      <modus-wc-table
        ...
        @sortChange=`,`
      ></modus-wc-table>
    `])),n,t,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,s("sortChange"))},args:{density:"comfortable",sortable:!0}},w={render:e=>{const n=e.columns||u(),t=e.data||p(15);return l(z||(z=d([`
      <script>
            // Helper functions
            const createDemoColumns = (): ITableColumn[] => [
              {
    ...
    `],[`
      ...
      <modus-wc-table
        ...
        @paginationChange=`,`
      ></modus-wc-table>
    `])),n,t,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,s("paginationChange"))},args:{density:"comfortable",paginated:!0,"show-page-size-selector":!0}},C={render:e=>{const n=e.columns||u(),t=e.data||p();return l(x||(x=d([`
      <script>
            // Helper functions
            const createDemoColumns = (): ITableColumn[] => [
              {
    ...
    `],[`
      ...
      <modus-wc-table
        ...
        @rowSelectionChange=`,`
      ></modus-wc-table>
    `])),n,t,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,s("rowSelectionChange"))},args:{density:"comfortable",selectable:"multi"}},v={render:e=>{const n=[{id:"id",header:"ID",accessor:"id",width:"20px"},{id:"name",header:"Name",accessor:"name",editor:"text"},{id:"status",header:"Status",accessor:"status",editor:"custom",customEditorRenderer:(i,r)=>{const o=document.createElement("div");o.style.width="100%";const a=document.createElement("modus-wc-autocomplete");a.items=[{label:"Active",value:"Active",visibleInMenu:!0},{label:"Inactive",value:"Inactive",visibleInMenu:!0},{label:"Pending",value:"Pending",visibleInMenu:!0}],a.value=i,a.style.width="100%";const m=c=>{r(c.detail.value)};return a.addEventListener("itemSelect",m),o.appendChild(a),setTimeout(()=>{const c=a.querySelector("input");c==null||c.focus()},0),o},cellRenderer:i=>{const o={Active:"green",Inactive:"gray",Pending:"blue"}[i]||"black",a=document.createElement("span");return a.textContent=i,a.style.color=o,a.style.fontWeight="bold",a}}],t=[{id:"1",name:"John Doe",status:"Active"},{id:"2",name:"Jane Smith",status:"Inactive"},{id:"3",name:"Bob Johnson",status:"Pending"}];return l(R||(R=d([`
      <script>
                // Helper functions
                const createDemoColumns = (): ITableColumn[] => [
                  {
    ...
    `],[`
      ...
      <modus-wc-table
        ...
        @cellEditCommit=`,`
      ></modus-wc-table>
    `])),n,t,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],!0,s("cellEditStart"),s("cellEditCommit"))},args:{density:"comfortable",hover:!0,sortable:!0,paginated:!1,"show-page-size-selector":!0,"custom-class":"",selectable:"none",zebra:!1,"current-page":1,"page-size-options":[5,10,15],"selected-row-ids":[]}};var E,P,A;g.parameters={...g.parameters,docs:{...(E=g.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
...
}`,...(A=(P=g.parameters)==null?void 0:P.docs)==null?void 0:A.source}}};var T,_,O;h.parameters={...h.parameters,docs:{...(T=h.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
    const data = args.data || createDemoData();
    return html\`
...
}`,...(O=(_=h.parameters)==null?void 0:_.docs)==null?void 0:O.source}}};var U,N,M;b.parameters={...b.parameters,docs:{...(U=b.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: args => {
...
}`,...(M=(N=b.parameters)==null?void 0:N.docs)==null?void 0:M.source}}};var H,k,L;w.parameters={...w.parameters,docs:{...(H=w.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
    const data = args.data || createDemoData(15);
    return html\`
...
}`,...(L=(k=w.parameters)==null?void 0:k.docs)==null?void 0:L.source}}};var B,J,j;C.parameters={...C.parameters,docs:{...(B=C.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
    const data = args.data || createDemoData();
    return html\`
...
}`,...(j=(J=C.parameters)==null?void 0:J.docs)==null?void 0:j.source}}};var V,W,K;v.parameters={...v.parameters,docs:{...(V=v.parameters)==null?void 0:V.docs,source:{originalSource:`{
  render: args => {
    const columns: ITableColumn[] = [{
      id: 'id',
      header: 'ID',
...
}`,...(K=(W=v.parameters)==null?void 0:W.docs)==null?void 0:K.source}}};const ce=["Default","Hover","Sorting","Pagination","CheckBoxRowSelection","InlineEditing"];export{C as CheckBoxRowSelection,g as Default,h as Hover,v as InlineEditing,w as Pagination,b as Sorting,ce as __namedExportsOrder,ie as default};
