import{w as z}from"./decorator-Cv9na35H.js";import{b as i}from"./lit-element-DgBvYnzn.js";import{o}from"./if-defined-BnVFTJ4o.js";import{c as $}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-C_wAuwg_.js";import"./v4-C6aID195.js";var c=Object.freeze,O=Object.defineProperty,x=(e,d)=>c(O(e,"raw",{value:c(e.slice())})),p,u;const B=[{label:"Select an option",value:"",hidden:!0},{label:"Option 1",value:"1"},{label:"Option 2",value:"2"},{label:"Option 3",value:"3"}],M={title:"Components/Forms/Select",component:"modus-wc-select",args:{bordered:!0,disabled:!1,label:"Label",options:B,size:"md",value:""},argTypes:{feedback:{description:"Feedback prop for input components",table:{type:{detail:`
          ...
          `}}},size:{control:{type:"select"},options:["xs","sm","md","lg","xl"]}},decorators:[z],parameters:{actions:{handles:["inputBlur","inputChange","inputFocus"]}}},a={render:e=>i(p||(p=x([`
    <modus-wc-select
    ...
    <\/script>
  `])),e.bordered,o(e["custom-class"]),e.disabled,e.feedback,o(e["input-aria-invalid"]),o(e["input-id"]),o(e["input-tab-index"]),o(e.label),o(e.name),e.options,e.required,o(e.size),e.value)},C={level:"error",message:"Value is required."},s={render:e=>i(u||(u=x([`
    <modus-wc-select
      aria-label="Select input"
      .feedback=`,`
      id="error-select"
    ...
    <\/script>
  `])),C,o(e.label),[],!0,e.value)},r={render:e=>{if(!customElements.get("select-shadow-host")){const d=$({componentTag:"modus-wc-select",propsMapper:(n,y)=>{const t=y;t.bordered=!!n.bordered,t.customClass=n["custom-class"]||"",t.disabled=!!n.disabled,t.inputId=n["input-id"]||"",t.inputTabIndex=n["input-tab-index"]||0,t.label=n.label||"",t.name=n.name||"",t.options=n.options,t.required=!!n.required,t.size=n.size||"md",t.value=n.value}});customElements.define("select-shadow-host",d)}return i`<select-shadow-host
      .props=${{...e}}
