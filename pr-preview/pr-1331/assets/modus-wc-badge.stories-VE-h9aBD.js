import{b as d}from"./lit-element-DgBvYnzn.js";import{o as S}from"./if-defined-BnVFTJ4o.js";import{c as E}from"./shadow-host-helper-A4Nvcs5e.js";const P={title:"Components/Badge",component:"modus-wc-badge",args:{color:"default",size:"md",variant:"filled"},argTypes:{color:{control:{type:"select"},options:["default","primary","secondary","tertiary","high-contrast","success","warning","danger"]},size:{control:{type:"select"},options:["sm","md","lg"]},variant:{control:{type:"select"},options:["counter","filled","outlined","text"]}}},B={render:e=>d`
<modus-wc-badge
  color="${e.color}"
...
}`,...(w=(h=r.parameters)==null?void 0:h.docs)==null?void 0:w.source}}};var b,v,f;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:"{\n  parameters: {\n    docs: {\n      description: {\n        story: `\n#### Breaking Changes\n\n  - The \\`dark\\` color option is now \\`high-contrast\\`\n  - The \\`type\\` prop is now \\`variant\\` and \\`default\\` type is now \\`filled\\`\n  - Size values have changed from verbose names (\\`small\\`, \\`medium\\`, \\`large\\`) to abbreviations (\\`sm\\`, \\`md\\`, \\`lg\\`).\n\n#### Prop Mapping\n\n| 1.0 Prop   | 2.0 Prop   | Notes                                                       |\n|------------|------------|-------------------------------------------------------------|\n| aria-label | aria-label |                                                             |\n| color      | color      | \\`dark\\` is now \\`high-contrast\\`                           |\n| size       | size       | \\`small\\` → \\`sm\\`, \\`medium\\` → \\`md\\`, \\`large\\` → \\`lg\\` |\n| type       | variant    | \\`default\\` is now \\`filled\\`                               |\n        `\n      }\n    },\n    // To hide the actual story rendering and only show docs:\n    controls: {\n      disable: true\n    },\n    canvas: {\n      disable: true\n    }\n  },\n  // Simple render function or leave it empty\n  render: () => html`<div></div>`\n}",...(f=(v=t.parameters)==null?void 0:v.docs)==null?void 0:f.source}}};const x=["Default","WithIcon","ShadowDomParent","Migration"];export{n as Default,t as Migration,r as ShadowDomParent,s as WithIcon,x as __namedExportsOrder,P as default};
