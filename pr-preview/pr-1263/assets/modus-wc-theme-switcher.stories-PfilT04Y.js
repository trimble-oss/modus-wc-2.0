import{w as S}from"./decorator-D4YmxizW.js";import{b as i}from"./lit-element-DgBvYnzn.js";import{o as C}from"./if-defined-BnVFTJ4o.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const P={title:"Components/ThemeSwitcher",component:"modus-wc-theme-switcher",args:{"custom-class":void 0,"initial-theme":void 0},decorators:[S],parameters:{actions:{handles:["themeChange"]}}},a=()=>{const t=document.documentElement.getAttribute("data-theme")||"modus-modern-light",s=t.endsWith("-dark")?"dark":"light";return{theme:t.replace(`-${s}`,""),mode:s}},E={render:t=>{const s=a();return i`
