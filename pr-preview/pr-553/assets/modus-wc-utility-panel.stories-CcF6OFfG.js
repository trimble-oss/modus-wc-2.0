import{x as s}from"./lit-element-C8zulti1.js";import{o as b}from"./if-defined-yv6owfG8.js";const $={title:"Components/Utility Panel",component:"modus-wc-utility-panel",args:{expanded:!1,pushContent:!0,targetContent:"#main-content"},argTypes:{expanded:{control:{type:"boolean"}},pushContent:{control:{type:"boolean"}},targetContent:{control:{type:"text"}}},parameters:{actions:{handles:["panelOpened","panelClosed"]},docs:{description:{component:"A utility panel component that slides in from the right side of the screen. It can either push content or display as an overlay."}},layout:"fullscreen"}},o={render:n=>{const{expanded:e,pushContent:t,targetContent:l}=n;return s`
      <style>
        .demo-container {
          height: 100vh;
          display: flex;
    ...
    `}},a={render:n=>{const{expanded:e,pushContent:t}=n;return s`
      <style>
        .demo-container {
          height: 100vh;
          display: flex;
    ...
    `},args:{expanded:!0,pushContent:!0,targetContent:"#main-content-expanded"}},i={render:n=>{const{expanded:e,pushContent:t}=n;return s`
      <style>
        .demo-container {
          height: 100vh;
          display: flex;
    ...
    `},args:{expanded:!0,pushContent:!1,targetContent:"#main-content-overlay"}},d={render:n=>{const{expanded:e,pushContent:t,targetContent:l}=n;return s`
      <style>
        .demo-container {
          height: 100vh;
          position: relative;
    ...
    `},args:{expanded:!1,pushContent:!0,targetContent:"#main-content-2"}};var r,c,p;o.parameters={...o.parameters,docs:{...(r=o.parameters)==null?void 0:r.docs,source:{originalSource:`{
  render: args => {
    const {
      expanded,
      pushContent,
...
}`,...(p=(c=o.parameters)==null?void 0:c.docs)==null?void 0:p.source}}};var u,m,h;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  render: args => {
    const {
      expanded,
      pushContent
...
}`,...(h=(m=a.parameters)==null?void 0:m.docs)==null?void 0:h.source}}};var w,y,v;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: args => {
    const {
      expanded,
      pushContent
...
}`,...(v=(y=i.parameters)==null?void 0:y.docs)==null?void 0:v.source}}};var f,x,g;d.parameters={...d.parameters,docs:{...(f=d.parameters)==null?void 0:f.docs,source:{originalSource:`{
...
}`,...(g=(x=d.parameters)==null?void 0:x.docs)==null?void 0:g.source}}};const T=["Default","Expanded","OverlayMode","WithoutHeaderFooter"];export{o as Default,a as Expanded,i as OverlayMode,d as WithoutHeaderFooter,T as __namedExportsOrder,$ as default};
