...
`}}},render:()=>b`
    ...
    `},C={render:e=>(e.items||(e.items=[...w]),e.items=e.items.map(m=>m.value==="apple"||m.value==="banana"?{...m,selected:!0}:m),b(D||(D=v([`
      <style>
      ...
      <script>
        ...
        `,`
          ...
          // } 
        <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["max-chips"]??4,e["min-chars"],t(e["min-input-width"]),!0,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e.value,g))},S={render:e=>{let m;const f=h=>{var s;if(!((s=h.detail)!=null&&s.target))return;const c=h.target.closest("modus-wc-autocomplete");if(c){const n=h.detail.target.value.toLowerCase();m&&window.clearTimeout(m),c.showSpinner=!0,m=window.setTimeout(()=>{const i=w.filter(o=>o.label.toLowerCase().includes(n));c.items=i,c.showSpinner=!1},2e3)}};return b(F||(F=v([`
      <style>
...
>
  <div slot="menu-items">
    ...
    `}},A={render:e=>{const m=c=>{const s=document.getElementById("autocomplete-custom-event-handlers");if(!s)return;["ArrowDown","ArrowUp","Enter","Escape"].includes(c.key)&&c.preventDefault();const l=e.items.filter(n=>n.visibleInMenu&&!n.disabled);switch(c.key){case"Escape":e.items=e.items.map(n=>({...n,focused:!1})),s.items=[...e.items],s.closeMenu(),s.style.transform="scale(0.98)",setTimeout(()=>{s.style.transform=""},200);break;case"ArrowDown":{s.openMenu();const n=l.findIndex(a=>a.focused),i=n<0?0:Math.min(n+1,l.length-1),o=i+1<l.length?i+1:i;e.items=e.items.map(a=>{var u;return{...a,focused:((u=l[o])==null?void 0:u.value)===a.value}});break}case"ArrowUp":{const n=l.findIndex(a=>a.focused),i=n<0?l.length-1:Math.max(n-1,0),o=i-1>=0?i-1:i;e.items=e.items.map(a=>{var u;return{...a,focused:((u=l[o])==null?void 0:u.value)===a.value}});break}case"Enter":{const n=l.find(i=>i.focused);n&&(e.items=e.items.map(i=>({...i,selected:i.value===n.value,focused:!1})),s.value=n.label,s.closeMenu());break}default:return}s.items=[...e.items]},f=c=>{const s=document.getElementById("autocomplete-custom-event-handlers");if(!s)return;const l=c.toLowerCase().split("");if(c.length>0){const o=e.items.map(a=>{const u=a.label.toLowerCase();let p=0,d=!0;for(const r of l)if(u.includes(r)){const I=u.indexOf(r);I===0?p+=3:u[I-1]===" "?p+=2:p+=1}else{d=!1;break}return d&&u.includes(c.toLowerCase())&&(p+=10),{item:a,score:d?p:-1,visible:d}});o.sort((a,u)=>u.score-a.score),e.items=o.map(({item:a,visible:u})=>({...a,visibleInMenu:u,focused:!1,selected:a.selected&&u,label:a.label}))}else e.items=e.items.map(o=>({...o,visibleInMenu:!0,focused:!1}));s.items=[...e.items],s.value=c;const n=e.items.filter(o=>o.visibleInMenu).length;console.log(`Fuzzy search for "${c}": ${n} matches found`),e.items.some(o=>o.visibleInMenu)&&c.length>=e["min-chars"]?s.openMenu():s.closeMenu()},h=c=>{const s=document.getElementById("autocomplete-custom-event-handlers");s&&(e.items=e.items.map(l=>({...l,selected:l.value===c.value,focused:!1})),s.items=[...e.items],s.value=c.label,s.closeMenu())};return b(B||(B=v([`
      <style>
...
\`\`\`
      ...
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),m,t(e.label),e["leave-menu-open"],0,!1,t(e.name),e["no-results"],e["read-only"],e.required,!0,t(e.size),e.value,h,c)}},T={parameters:{docs:{description:{story:`
#### Breaking Changes
...
\`\`\`
  ...
  ...Template
}`,...(H=(W=y.parameters)==null?void 0:W.docs)==null?void 0:H.source}}};var R,j,K;x.parameters={...x.parameters,docs:{...(R=x.parameters)==null?void 0:R.docs,source:{originalSource:`{
  // prettier-ignore
  render: args => html\`
<style>
  div[id^='story--components-forms-autocomplete--with-custom-icon-slot'] {
...
}`,...(K=(j=x.parameters)==null?void 0:j.docs)==null?void 0:K.source}}};var J,U,V;M.parameters={...M.parameters,docs:{...(J=M.parameters)==null?void 0:J.docs,source:{originalSource:`{
  name: 'With Tooltips',
  parameters: {
    docs: {
      description: {
...
}`,...(V=(U=M.parameters)==null?void 0:U.docs)==null?void 0:V.source}}};var _,G,Q;C.parameters={...C.parameters,docs:{...(_=C.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: args => {
...
}`,...(Q=(G=C.parameters)==null?void 0:G.docs)==null?void 0:Q.source}}};var X,Y,Z;S.parameters={...S.parameters,docs:{...(X=S.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: args => {
...
}`,...(Z=(Y=S.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var ee,te,ne;$.parameters={...$.parameters,docs:{...(ee=$.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: args => {
...
}`,...(ne=(te=$.parameters)==null?void 0:te.docs)==null?void 0:ne.source}}};var oe,le,ae;A.parameters={...A.parameters,docs:{...(oe=A.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render: args => {
...
}`,...(ae=(le=A.parameters)==null?void 0:le.docs)==null?void 0:ae.source}}};var se,ie,ue;k.parameters={...k.parameters,docs:{...(se=k.parameters)==null?void 0:se.docs,source:{originalSource:`{
  args: {
    ...meta.args,
...
}`,...(ue=(ie=k.parameters)==null?void 0:ie.docs)==null?void 0:ue.source}}};var ce,re,me;E.parameters={...E.parameters,docs:{...(ce=E.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  render: args => {
    const defaultFruits = [{
      label: 'Apple',
      value: 'apple',
...
}`,...(me=(re=E.parameters)==null?void 0:re.docs)==null?void 0:me.source}}};var de,pe,he;T.parameters={...T.parameters,docs:{...(de=T.parameters)==null?void 0:de.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(he=(pe=T.parameters)==null?void 0:pe.docs)==null?void 0:he.source}}};const Ce=["Default","WithCustomIconSlot","WithTooltips","MultiSelect","WithSpinner","CustomMenuItems","CustomEventHandlers","WithProgrammaticControl","DynamicOptions","Migration"];export{A as CustomEventHandlers,$ as CustomMenuItems,y as Default,E as DynamicOptions,T as Migration,C as MultiSelect,x as WithCustomIconSlot,k as WithProgrammaticControl,S as WithSpinner,M as WithTooltips,Ce as __namedExportsOrder,ve as default};
