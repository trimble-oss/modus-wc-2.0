...
`}}},render:()=>b`
    ...
    `},C={render:e=>(e.items||(e.items=[...w]),e.items=e.items.map(m=>m.value==="apple"||m.value==="banana"?{...m,selected:!0}:m),b`
      <style>
    ...
    `)},S={render:e=>{let m;const f=h=>{var a;if(!((a=h.detail)!=null&&a.target))return;const r=h.target.closest("modus-wc-autocomplete");if(r){const n=h.detail.target.value.toLowerCase();m&&window.clearTimeout(m),r.showSpinner=!0,m=window.setTimeout(()=>{const i=w.filter(o=>o.label.toLowerCase().includes(n));r.items=i,r.showSpinner=!1},2e3)}};return b(z||(z=v([`
      <style>
...
>
  <div slot="menu-items">
    ...
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),t(e.label),e["leave-menu-open"],e["min-chars"],!1,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e["show-spinner"],e.value,h,r,!0,a,a,a,a)}},E={render:e=>{const m=r=>{const a=document.getElementById("autocomplete-custom-event-handlers");if(!a)return;["ArrowDown","ArrowUp","Enter","Escape"].includes(r.key)&&r.preventDefault();const l=e.items.filter(n=>n.visibleInMenu&&!n.disabled);switch(r.key){case"Escape":e.items=e.items.map(n=>({...n,focused:!1})),a.items=[...e.items],a.closeMenu(),a.style.transform="scale(0.98)",setTimeout(()=>{a.style.transform=""},200);break;case"ArrowDown":{a.openMenu();const n=l.findIndex(s=>s.focused),i=n<0?0:Math.min(n+1,l.length-1),o=i+1<l.length?i+1:i;e.items=e.items.map(s=>{var u;return{...s,focused:((u=l[o])==null?void 0:u.value)===s.value}});break}case"ArrowUp":{const n=l.findIndex(s=>s.focused),i=n<0?l.length-1:Math.max(n-1,0),o=i-1>=0?i-1:i;e.items=e.items.map(s=>{var u;return{...s,focused:((u=l[o])==null?void 0:u.value)===s.value}});break}case"Enter":{const n=l.find(i=>i.focused);n&&(e.items=e.items.map(i=>({...i,selected:i.value===n.value,focused:!1})),a.value=n.label,a.closeMenu());break}default:return}a.items=[...e.items]},f=r=>{const a=document.getElementById("autocomplete-custom-event-handlers");if(!a)return;const l=r.toLowerCase().split("");if(r.length>0){const o=e.items.map(s=>{const u=s.label.toLowerCase();let p=0,d=!0;for(const c of l)if(u.includes(c)){const g=u.indexOf(c);g===0?p+=3:u[g-1]===" "?p+=2:p+=1}else{d=!1;break}return d&&u.includes(r.toLowerCase())&&(p+=10),{item:s,score:d?p:-1,visible:d}});o.sort((s,u)=>u.score-s.score),e.items=o.map(({item:s,visible:u})=>({...s,visibleInMenu:u,focused:!1,selected:s.selected&&u,label:s.label}))}else e.items=e.items.map(o=>({...o,visibleInMenu:!0,focused:!1}));a.items=[...e.items],a.value=r;const n=e.items.filter(o=>o.visibleInMenu).length;console.log(`Fuzzy search for "${r}": ${n} matches found`),e.items.some(o=>o.visibleInMenu)&&r.length>=e["min-chars"]?a.openMenu():a.closeMenu()},h=r=>{const a=document.getElementById("autocomplete-custom-event-handlers");a&&(e.items=e.items.map(l=>({...l,selected:l.value===r.value,focused:!1})),a.items=[...e.items],a.value=r.label,a.closeMenu())};return b(F||(F=v([`
      <style>
...
\`\`\`
        ...
        `}}}},$={render:e=>{const m=[{label:"Apple",value:"apple",visibleInMenu:!0},{label:"Banana",value:"banana",visibleInMenu:!0},{label:"Orange",value:"orange",visibleInMenu:!0},{label:"Strawberry",value:"strawberry",visibleInMenu:!0}],f=[...m,{label:"Blackberry",value:"blackberry",visibleInMenu:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0},{label:"Cherry",value:"cherry",visibleInMenu:!0},{label:"Cranberry",value:"cranberry",visibleInMenu:!0},{label:"Fig",value:"fig",visibleInMenu:!0},{label:"Grape",value:"grape",visibleInMenu:!0},{label:"Kiwi",value:"kiwi",visibleInMenu:!0},{label:"Lemon",value:"lemon",visibleInMenu:!0},{label:"Lime",value:"lime",visibleInMenu:!0},{label:"Mango",value:"mango",visibleInMenu:!0},{label:"Melon",value:"melon",visibleInMenu:!0},{label:"Peach",value:"peach",visibleInMenu:!0},{label:"Pineapple",value:"pineapple",visibleInMenu:!0},{label:"Raspberry",value:"raspberry",visibleInMenu:!0},{label:"Watermelon",value:"watermelon",visibleInMenu:!0}],h=a=>{var n;if(!((n=a.detail)!=null&&n.target))return;const l=a.target.closest("modus-wc-autocomplete");if(l){const i=a.detail.target,o=i.value.toLowerCase();if(o===""){l.items=[...m],l.value=i.value;return}l.showSpinner=!0,setTimeout(()=>{const s=f.filter(u=>u.label.toLowerCase().includes(o));l.items=s,l.showSpinner=!1},1e3),l.value=i.value}},r=a=>{const l=a.target.closest("modus-wc-autocomplete");if(l){const n=a.detail.label;n&&(l.value=n)}};return b(O||(O=v([`
      <style>
      ...
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),m,t(e.label),e["leave-menu-open"],0,!1,t(e.name),e["no-results"],e["read-only"],e.required,!0,t(e.size),e.value,h,r)}},L={parameters:{docs:{description:{story:`
#### Breaking Changes
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>b`<div></div>`};var H,R,N;y.parameters={...y.parameters,docs:{...(H=y.parameters)==null?void 0:H.docs,source:{originalSource:`{
  ...Template
}`,...(N=(R=y.parameters)==null?void 0:R.docs)==null?void 0:N.source}}};var W,j,K;x.parameters={...x.parameters,docs:{...(W=x.parameters)==null?void 0:W.docs,source:{originalSource:`{
  // prettier-ignore
  render: args => html\`
<style>
  div[id^='story--components-forms-autocomplete--with-custom-icon-slot'] {
...
}`,...(K=(j=x.parameters)==null?void 0:j.docs)==null?void 0:K.source}}};var U,V,J;M.parameters={...M.parameters,docs:{...(U=M.parameters)==null?void 0:U.docs,source:{originalSource:`{
  name: 'With Tooltips',
  parameters: {
    docs: {
      description: {
...
}`,...(J=(V=M.parameters)==null?void 0:V.docs)==null?void 0:J.source}}};var _,G,Q;C.parameters={...C.parameters,docs:{...(_=C.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: args => {
...
}`,...(Z=(Y=S.parameters)==null?void 0:Y.docs)==null?void 0:Z.source}}};var ee,te,ne;A.parameters={...A.parameters,docs:{...(ee=A.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: args => {
    const originalNoResults = args['no-results'];
    if (args['leave-menu-open'] == true) {
      args['no-results'] = {
...
}`,...(ne=(te=A.parameters)==null?void 0:te.docs)==null?void 0:ne.source}}};var oe,le,se;E.parameters={...E.parameters,docs:{...(oe=E.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render: args => {
...
}`,...(ue=(ie=k.parameters)==null?void 0:ie.docs)==null?void 0:ue.source}}};var re,ce,me;$.parameters={...$.parameters,docs:{...(re=$.parameters)==null?void 0:re.docs,source:{originalSource:`{
  render: args => {
    const defaultFruits = [{
      label: 'Apple',
      value: 'apple',
...
}`,...(me=(ce=$.parameters)==null?void 0:ce.docs)==null?void 0:me.source}}};var de,pe,he;L.parameters={...L.parameters,docs:{...(de=L.parameters)==null?void 0:de.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(he=(pe=L.parameters)==null?void 0:pe.docs)==null?void 0:he.source}}};const Ce=["Default","WithCustomIconSlot","WithTooltips","MultiSelect","WithSpinner","CustomMenuItems","CustomEventHandlers","WithProgrammaticControl","DynamicOptions","Migration"];export{E as CustomEventHandlers,A as CustomMenuItems,y as Default,$ as DynamicOptions,L as Migration,C as MultiSelect,x as WithCustomIconSlot,k as WithProgrammaticControl,S as WithSpinner,M as WithTooltips,Ce as __namedExportsOrder,ve as default};
