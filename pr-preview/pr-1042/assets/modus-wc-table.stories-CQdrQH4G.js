import"./index-CK-iu89z.js";import{x as m}from"./lit-element-CucEn6F2.js";import{c as te}from"./shadow-host-helper-A4Nvcs5e.js";import{b as d}from"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var I=Object.freeze,ae=Object.defineProperty,p=(e,o)=>I(ae(e,"raw",{value:I(o||e.slice())})),k,T,x,R,A,q;const de={title:"Components/Table",component:"modus-wc-table",args:{density:"comfortable",hover:!1,sortable:!0,paginated:!1,"show-page-size-selector":!0,"custom-class":"",selectable:"none",zebra:!1,"current-page":1,"page-size-options":[5,10,15],"selected-row-ids":[],editable:!1},argTypes:{columns:{control:"object",description:"An array of column definitions.",table:{type:{detail:`
    ...
    `],[`
      ...
      <script>
        ...
        // table.hover = 'false';
      <\/script>
    `])),o,n,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,e.caption,d("rowClick"),d("sortChange"),d("paginationChange"),d("rowSelectionChange"),d("cellEditStart"),d("cellEditCommit"))},args:{density:"comfortable",hover:!1,sortable:!0,paginated:!1,"show-page-size-selector":!0,"custom-class":"",selectable:"none",zebra:!1,"current-page":1,"page-size-options":[5,10,15],"selected-row-ids":[],editable:!1}},w={render:e=>{const o=e.columns||h(),n=e.data||b();return m(T||(T=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        // table.data = createDemoData();
      <\/script>
    `])),o,n,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,d("rowClick"))},args:{density:"comfortable",hover:!0}},f={render:e=>{const o=e.columns||oe(),n=e.data||b();return m(x||(x=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        // table.data = createDemoData();
      <\/script>
    `])),o,n,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,d("sortChange"))},args:{density:"comfortable",sortable:!0}},v={render:e=>{const o=e.columns||h(),n=e.data||b(15);return m(R||(R=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        // table.paginated = true;
      <\/script>
    `])),o,n,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,d("paginationChange"))},args:{density:"comfortable",paginated:!0,"show-page-size-selector":!0}},y={render:e=>{const o=e.columns||h(),n=e.data||b();return m(A||(A=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        // table.selectable = 'multi';
      <\/script>
    `])),o,n,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,d("rowSelectionChange"))},args:{density:"comfortable",selectable:"multi"}},S={render:e=>{const o=[{id:"id",header:"ID",accessor:"id",width:"20px"},{id:"name",header:"Name",accessor:"name"},{id:"status",header:"Status",accessor:"status",editor:"custom",customEditorRenderer:(c,a)=>{const s=document.createElement("div");s.style.width="100%";const t=document.createElement("modus-wc-autocomplete");t.items=[{label:"Active",value:"Active",visibleInMenu:!0},{label:"Inactive",value:"Inactive",visibleInMenu:!0},{label:"Pending",value:"Pending",visibleInMenu:!0}],t.value=c,t.style.width="100%";const l=u=>{a(u.detail.value)};return t.addEventListener("itemSelect",l),s.appendChild(t),setTimeout(()=>{const u=t.querySelector("input");u==null||u.focus()},0),s},cellRenderer:c=>{const s={Active:"green",Inactive:"gray",Pending:"blue"}[c]||"black",t=document.createElement("span");return t.textContent=c,t.style.color=s,t.style.fontWeight="bold",t}},{id:"dueDate",header:"Due Date",accessor:"dueDate",editor:"custom",customEditorRenderer:(c,a)=>{const s=document.createElement("div");s.style.width="100%";const t=document.createElement("modus-wc-date");t.value=c,t.style.width="100%",t.bordered=!1;let l=!1;const u=r=>{if(r.key==="Enter"){r.preventDefault();const i=t.querySelector("input");i&&i.value&&!l&&(l=!0,a(i.value))}else if(r.key==="Escape")r.preventDefault(),l||(l=!0,a(c||""));else if(r.key==="Tab"){const i=t.querySelector("input");i&&i.value&&!l&&(l=!0,a(i.value))}},D=r=>{var z,P;const i=r.relatedTarget;if(i&&(s.contains(i)||(z=t.shadowRoot)!=null&&z.contains(i))||((P=t.shadowRoot)==null?void 0:P.querySelector('[class*="calendar"]')))return;const $=t.querySelector("input");$&&$.value&&!l&&(l=!0,setTimeout(()=>a($.value),50))};return s.addEventListener("keydown",u),s.addEventListener("focusout",D),s.appendChild(t),setTimeout(()=>{const r=t.querySelector("input");r==null||r.focus()},0),s},cellRenderer:c=>{if(!c)return"-";const a=c,s=a.split(/[-/]/);let t;if(s.length===3&&s[0].length<=2){const r=parseInt(s[0],10),i=parseInt(s[1],10)-1,E=parseInt(s[2],10);t=new Date(E,i,r)}else t=new Date(a);if(isNaN(t.getTime()))return a;const l=t.getDate().toString().padStart(2,"0"),u=(t.getMonth()+1).toString().padStart(2,"0"),D=t.getFullYear();return`${l}-${u}-${D}`}}],n=[{id:"1",name:"John Doe",status:"Active",dueDate:"15-10-2025"},{id:"2",name:"Jane Smith",status:"Inactive",dueDate:"20-11-2025"},{id:"3",name:"Bob Johnson",status:"Pending",dueDate:"05-12-2025"}];return m(q||(q=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        //   table.editable = true;
      <\/script>
    `])),o,n,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],!0,d("cellEditStart"),d("cellEditCommit"))},args:{density:"comfortable",hover:!1,sortable:!0,paginated:!1,"show-page-size-selector":!0,"custom-class":"",selectable:"none",zebra:!1,"current-page":1,"page-size-options":[5,10,15],"selected-row-ids":[]}},C={render:e=>{if(!customElements.get("table-shadow-host")){const o=te({componentTag:"modus-wc-table",propsMapper:(n,c)=>{const a=c;a.caption=n.caption??"",a.columns=n.columns??h(),a.currentPage=n["current-page"]??1,a.data=n.data??b(),a.customClass=n["custom-class"]||"",a.density=n.density??"comfortable",a.editable=!!n.editable,a.hover=!!n.hover,a.paginated=!!n.paginated,a.pageSizeOptions=n["page-size-options"]??[5,10,15],a.selectable=n.selectable??"none",a.selectedRowIds=n["selected-row-ids"]??[],a.showPageSizeSelector=n["show-page-size-selector"]!==!1,a.sortable=!!n.sortable,a.zebra=!!n.zebra}});customElements.define("table-shadow-host",o)}return m`<table-shadow-host .props=${{...e}}></table-shadow-host>`}};var M,U,N;g.parameters={...g.parameters,docs:{...(M=g.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: args => {
