...
<div style="height: 200px;">
  ...
  `},o={...f},e={render:t=>{if(!customElements.get("toast-shadow-host")){const y=b({componentTag:"modus-wc-toast",propsMapper:(n,a)=>{const r=a;r.customClass=n["custom-class"]||"",r.delay=n.delay??0,r.position=n.position??"top-end",a.hasChildNodes()||(a.innerHTML='<modus-wc-alert alert-title="Message sent!" variant="success"></modus-wc-alert>')}});customElements.define("toast-shadow-host",y)}return d`<toast-shadow-host .props=${{...t}}></toast-shadow-host>`}},s={parameters:{docs:{description:{story:`
#### Breaking Changes
    ...
    if (!customElements.get('toast-shadow-host')) {
      const ToastShadowHost = createShadowHostClass<ToastArgs>({
        ...
        propsMapper: (v: ToastArgs, el: HTMLElement) => {
          ...
          if (!el.hasChildNodes()) {
            el.innerHTML = '<modus-wc-alert alert-title="Message sent!" variant="success"></modus-wc-alert>';
          }
        }
      });
      customElements.define('toast-shadow-host', ToastShadowHost);
    }
    return html\`<toast-shadow-host .props=\${{
      ...args
    }}></toast-shadow-host>\`;
  }
}`,...(h=(u=e.parameters)==null?void 0:u.docs)==null?void 0:h.source}}};var v,w,g;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| dismissClick  |           | Not carried over |
  ...
  render: () => html\`<div></div>\`
}`,...(g=(w=s.parameters)==null?void 0:w.docs)==null?void 0:g.source}}};const C=["Default","ShadowDomParent","Migration"];export{o as Default,s as Migration,e as ShadowDomParent,C as __namedExportsOrder,M as default};
