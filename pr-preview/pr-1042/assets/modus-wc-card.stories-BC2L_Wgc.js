...
>
  ...
  `},p={render:o=>{if(!customElements.get("card-shadow-host")){const L=Y({componentTag:"modus-wc-card",propsMapper:(s,g)=>{const t=g;t.backgroundFigure=!!s["background-figure"],t.bordered=!!s.bordered,t.customClass=s["custom-class"]||"",t.layout=s.layout??"vertical",t.padding=s.padding??"compact",g.hasChildNodes()||(g.innerHTML='<span slot="title">Card Title</span><span slot="subtitle">Card Subtitle</span><p>This is a sample card content. You can place any content here.</p><div slot="actions" class="modus-wc-justify-end"><modus-wc-button aria-label="Click me">Click me</modus-wc-button></div>')}});customElements.define("card-shadow-host",L)}return a` <style>
        card-shadow-host {
          width: 400px;
          display: block;
        }
