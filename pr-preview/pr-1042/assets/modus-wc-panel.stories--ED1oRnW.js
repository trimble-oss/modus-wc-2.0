...
<modus-wc-panel custom-class="${m(e["custom-class"])}" width="${m(e.width)}" height="${m(e.height)}" ?floating="${e.floating}">
  ...
  <modus-wc-menu slot="footer">   
    ...
    `},u={args:{width:"250px",height:"500px",floating:!0},render:e=>l`
<style>
  .panel-section {
    padding: 12px;
  }
...
<modus-wc-panel custom-class="${m(e["custom-class"])}" width="${m(e.width)}" height="${m(e.height)}" ?floating="${e.floating}">
  <modus-wc-menu size="lg" slot="body">
    ...
    `},a={render:e=>{if(!customElements.get("panel-shadow-host")){const x=D({componentTag:"modus-wc-panel",propsMapper:(s,c)=>{const n=c;n.customClass=s["custom-class"]||"",n.width=s.width??"350px",n.height=s.height??"700px",n.floating=!!s.floating,c.hasChildNodes()||(c.innerHTML=`
<modus-wc-menu slot="header">
...
</modus-wc-menu>`)}});customElements.define("panel-shadow-host",x)}return l`<panel-shadow-host .props=${{...e}}></panel-shadow-host>`}};var d,i,w;o.parameters={...o.parameters,docs:{...(d=o.parameters)==null?void 0:d.docs,source:{originalSource:`{
  args: {
    width: '250px',
    height: '500px',
    floating: false
...
}`,...(w=(i=o.parameters)==null?void 0:i.docs)==null?void 0:w.source}}};var r,h,p;u.parameters={...u.parameters,docs:{...(r=u.parameters)==null?void 0:r.docs,source:{originalSource:`{
  args: {
    width: '250px',
    height: '500px',
    floating: true
...
}`,...(p=(h=u.parameters)==null?void 0:h.docs)==null?void 0:p.source}}};var g,b,v;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    width: '250px',
    height: 'auto'
  },
...
}`,...(v=(b=t.parameters)==null?void 0:b.docs)==null?void 0:v.source}}};var f,y,$;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: args => {
...
}`,...($=(y=a.parameters)==null?void 0:y.docs)==null?void 0:$.source}}};const P=["Default","Floating","BodyOnly","ShadowDomParent"];export{t as BodyOnly,o as Default,u as Floating,a as ShadowDomParent,P as __namedExportsOrder,H as default};
