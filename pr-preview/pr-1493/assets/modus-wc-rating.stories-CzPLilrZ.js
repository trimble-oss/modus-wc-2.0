import{w as S}from"./decorator-Cv9na35H.js";import{b as o}from"./lit-element-DgBvYnzn.js";import{o as e}from"./if-defined-BnVFTJ4o.js";import{c as D}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-C_wAuwg_.js";import"./v4-C6aID195.js";var m=Object.freeze,R=Object.defineProperty,P=(a,s)=>m(R(a,"raw",{value:m(a.slice())})),u;const N={title:"Components/Forms/Rating",component:"modus-wc-rating",args:{"allow-half":!1,count:5,"custom-class":"",disabled:!1,getAriaLabelText:a=>`${a} rating`,size:"md",value:0,variant:"smiley"},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]},variant:{control:{type:"select"},options:["heart","smiley","star","thumb"]}},decorators:[S],parameters:{actions:{handles:["ratingChange"]}}},r={render:a=>o`
    <modus-wc-rating
