...
<modus-wc-typography
  ...
  weight=${s(e.weight)}
  ></modus-wc-typography>
   `},t={...r},o={...r,args:{hierarchy:"h1",label:a}},n={...r,args:{hierarchy:"h2",label:a}},c={...r,args:{hierarchy:"h3",label:a}},i={...r,args:{hierarchy:"h4",label:a}},l={...r,args:{hierarchy:"h5",label:a}},h={...r,args:{hierarchy:"h6",label:a}},p={...r,args:{hierarchy:"p",label:a}},m={...r,args:{hierarchy:"p",label:"This text is set via the label prop"}},d={render:e=>K`
<modus-wc-typography
  custom-class=${s(e["custom-class"])}
  hierarchy=${e.hierarchy}
  size=${s(e.size)}
...
>
  ...
  `};var g,u,y;t.parameters={...t.parameters,docs:{...(g=t.parameters)==null?void 0:g.docs,source:{originalSource:`{
  ...Template
...
}`,...(F=(B=m.parameters)==null?void 0:B.docs)==null?void 0:F.source}}};var G,I,J;d.parameters={...d.parameters,docs:{...(G=d.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: args => {
    // prettier-ignore
    return html\`
<modus-wc-typography
...
}`,...(J=(I=d.parameters)==null?void 0:I.docs)==null?void 0:J.source}}};const R=["Default","Heading1","Heading2","Heading3","Heading4","Heading5","Heading6","Paragraph","WithLabel","WithSlot"];export{t as Default,o as Heading1,n as Heading2,c as Heading3,i as Heading4,l as Heading5,h as Heading6,p as Paragraph,m as WithLabel,d as WithSlot,R as __namedExportsOrder,Q as default};
