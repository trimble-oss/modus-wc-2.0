import{w as A}from"./decorator-534da2b0.js";import{b as m}from"./lit-element-38260dd9.js";import{o}from"./if-defined-30b85b98.js";import{n as D}from"./ref-0ba40d43.js";import{c as q}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";import"./directive-helpers-79ea5480.js";import"./directive-12249aa5.js";var d=Object.freeze,L=Object.defineProperty,j=(e,t)=>d(L(e,"raw",{value:d(t||e.slice())})),b;const J={title:"Components/Menu",component:"modus-wc-menu",args:{orientation:"vertical","selection-mode":"single",size:"md"},argTypes:{orientation:{control:{type:"select"},options:["horizontal","vertical"]},"selection-mode":{control:{type:"select"},options:["single","multiple"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[A],parameters:{actions:{handles:["menuFocusout","menuSelectionChange","itemSelect"]}}},i={render:e=>m`
<modus-wc-menu
  aria-label="Menu"
  ?bordered=${e.bordered}
...
>
  ...
  ></modus-wc-menu-item>
    ...
    `},a={args:{"selection-mode":"multiple"},render:e=>{let t;const s=u=>{if(!t)return;const{selectedItems:n}=u.detail;t.textContent=n.length>0?`Selected: ${n.map(E=>E.getAttribute("value")).join(", ")}`:"Selected: none"};return m`
<modus-wc-menu
  aria-label="Menu"
  ?bordered=${e.bordered}
  custom-class=${o(e["custom-class"])}
...
<p ${D(u=>{t=u})} style="font-size: 0.875rem; margin-top: 0.5rem; color: var(--modus-wc-color-gray-6);">Selected: none</p>
    `}},c={render:()=>m`
<style>
  .custom-menu-width {
    width: 400px;
...
>
  ...
  <li>
    ...
    `},r={render:()=>m(b||(b=j([`
      ...
      <script>
        ...
        // });
      <\/script>
    `])),!0,!0,!0,!0)},l={render:e=>{if(!customElements.get("menu-shadow-host")){const t=q({componentTag:"modus-wc-menu",propsMapper:(s,u)=>{const n=u;n.ariaLabel="Shadow DOM Menu",n.bordered=Boolean(s.bordered),n.customClass=s["custom-class"]||"",n.orientation=s.orientation||"vertical",n.size=s.size||"md",u.querySelector("modus-wc-menu-item")||(u.innerHTML=`
              <modus-wc-menu-item
    label="Small"
    value="1"
    size="sm"
  ...
  <modus-wc-menu-item
    ...
    disabled="true"
  ></modus-wc-menu-item>
          `)}});customElements.define("menu-shadow-host",t)}return m`<menu-shadow-host .props=${{...e}}></menu-shadow-host>`}};var w,v,h;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: args => {
    // prettier-ignore
    return html\`
<modus-wc-menu
