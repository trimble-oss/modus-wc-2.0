...
<modus-wc-menu>
  ...
  ></modus-wc-menu-item>
    ...
    `},d={render:e=>{if(!customElements.get("menu-item-shadow-host")){const D=L({componentTag:"modus-wc-menu",propsMapper:(t,l)=>{const S=l;S.ariaLabel="Shadow DOM Menu";let m=l.querySelector("modus-wc-menu-item");m||(m=document.createElement("modus-wc-menu-item"),l.innerHTML="",l.appendChild(m));const n=m;n.ariaLabel="Menu item in shadow DOM",n.bordered=Boolean(t.bordered),n.checkbox=Boolean(t.checkbox),n.customClass=t["custom-class"]||"",n.disabled=Boolean(t.disabled),n.focused=Boolean(t.focused),n.label=t.label,n.selected=Boolean(t.selected),n.size=t.size||"md",n.subLabel=t["sub-label"]||"",n.tooltipContent=t["tooltip-content"]||"",n.tooltipPosition=t["tooltip-position"]||"auto",n.value=t.value}});customElements.define("menu-item-shadow-host",D)}return s`<menu-item-shadow-host
      .props=${{...e}}
...
}`,...(g=(I=u.parameters)==null?void 0:I.docs)==null?void 0:g.source}}};var E,z,v;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
...
}`,...(v=(z=c.parameters)==null?void 0:z.docs)==null?void 0:v.source}}};var x,k,M;d.parameters={...d.parameters,docs:{...(x=d.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: args => {
