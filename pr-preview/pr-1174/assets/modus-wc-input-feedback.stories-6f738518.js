import{b as r}from"./lit-element-38260dd9.js";import{o as s}from"./if-defined-30b85b98.js";import{c as w}from"./shadow-host-helper-0b7f7548.js";const $={title:"Components/Forms/Input Feedback",component:"modus-wc-input-feedback",args:{level:"error",message:"Uh oh. You done messed up.",size:"md"},argTypes:{level:{control:{type:"select"},options:["error","info","success","warning"]},size:{control:{type:"select"},options:["sm","md","lg"]}}},v={render:e=>r`
