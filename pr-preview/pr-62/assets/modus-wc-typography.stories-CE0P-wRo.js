import{k as r}from"./lit-element-DVRzCIa_.js";import{t as e}from"./if-defined-1ipA9LQg.js";const O={title:"Components/Atoms/Typography",component:"modus-wc-typography",args:{"aria-label":"Example typography",content:"The quick brown fox jumps over the lazy dog",size:"md",weight:"normal"},argTypes:{content:{control:{type:"text"}},size:{control:{type:"radio"},options:["xs","sm","md","lg","xl"]},weight:{control:{type:"radio"},options:["light","normal","bold"]}}},s={render:a=>r`
      <modus-wc-typography
...
}`,...(q=(j=m.parameters)==null?void 0:j.docs)==null?void 0:q.source}}};const F=["Body","Heading1","Heading2","Heading3","Heading4","Heading5","Heading6","Paragraph"];export{s as Body,n as Heading1,t as Heading2,o as Heading3,c as Heading4,i as Heading5,l as Heading6,m as Paragraph,F as __namedExportsOrder,O as default};
