import{w as E}from"./decorator-534da2b0.js";import{b as d}from"./lit-element-38260dd9.js";import{o as y}from"./if-defined-30b85b98.js";import{c as I}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";var l=Object.freeze,T=Object.defineProperty,S=(e,s)=>l(T(e,"raw",{value:l(s||e.slice())})),p;const a=[{description:"Item one description",icon:"alert",iconAriaLabel:"Alert",title:"Item One"},{description:"Item two description",icon:"alert",iconAriaLabel:"Alert",title:"Item Two"},{description:"Item three description",icon:"alert",iconAriaLabel:"Alert",title:"Item Three"}],z={title:"Components/Accordion",component:"modus-wc-accordion",decorators:[E],parameters:{actions:{handles:["expandedChange"]},layout:{padded:!0}}},P={render:e=>d(p||(p=S([`
...
<script>
 ...
 // Adding this block to show how to set options via JS 
  ...
  // });
<\/script>
    `])),y(e["custom-class"]),a[0],a[1],a[2])},o={...P},n={render:()=>{if(!customElements.get("accordion-shadow-host")){const e=I({componentTag:"modus-wc-accordion",propsMapper:(s,c)=>{const f=c;f.customClass=s["custom-class"]||"",c.innerHTML="",a.forEach(A=>{const i=document.createElement("modus-wc-collapse");i.options=A;const r=document.createElement("div");r.setAttribute("slot","content"),r.textContent="Collapse content",i.appendChild(r),c.appendChild(i)})}});customElements.define("accordion-shadow-host",e)}return d`<accordion-shadow-host
...
| opened    | expandedChange |                  |
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>d`<div></div>`};var m,h,u;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  ...Template
