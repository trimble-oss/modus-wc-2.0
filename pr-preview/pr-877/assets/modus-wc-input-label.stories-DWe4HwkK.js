import{x as w}from"./lit-element-CucEn6F2.js";import{o as a}from"./if-defined-BiZP-SBN.js";import{c as g}from"./shadow-host-helper-A4Nvcs5e.js";const S={title:"Components/Forms/Input Label",component:"modus-wc-input-label",args:{"label-text":"Label",required:!1,size:"md"},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]}}},f={render:e=>w`
