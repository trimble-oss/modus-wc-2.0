import{w as u}from"./decorator-D4YmxizW.js";import{x as i}from"./lit-element-CucEn6F2.js";import{o as l}from"./if-defined-BiZP-SBN.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const x={title:"Components/ThemeSwitcher",component:"modus-wc-theme-switcher",args:{"custom-class":void 0,"initial-theme":void 0},decorators:[u],parameters:{actions:{handles:["themeChange"]}}},h=()=>{const e=document.documentElement.getAttribute("data-theme")||"modus-modern-light",t=e.endsWith("-dark")?"dark":"light";return{theme:e.replace(`-${t}`,""),mode:t}},p={render:e=>{const t=h();return i`
