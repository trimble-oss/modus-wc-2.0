import{w as z}from"./decorator-Dt3Huotz.js";import{k as a}from"./lit-element-DVRzCIa_.js";import{t}from"./if-defined-1ipA9LQg.js";import"./v4-CQkTLCs1.js";var l=Object.freeze,q=Object.defineProperty,O=(e,F)=>l(q(e,"raw",{value:l(e.slice())})),m;const W={title:"Components/Forms/Time Input",component:"modus-wc-time-input",args:{disabled:!1,label:"Label",size:"md"},argTypes:{"auto-complete":{control:{type:"select"},options:["on","off"]},feedback:{description:"Feedback prop for input components",table:{type:{detail:`
