import"./index-CK-iu89z.js";import{b as E}from"./lit-element-DgBvYnzn.js";import{o as p}from"./if-defined-BnVFTJ4o.js";import{c as V}from"./shadow-host-helper-A4Nvcs5e.js";import{b as c}from"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const _={profileImageUrl:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",headerName:"Enterprise ABC",userName:"Jane Doe",userEmail:"jane.doe@example.com",manageTrimbleId:{link:"#"}},W={title:"Components/Profile Menu",component:"modus-wc-profile-menu",args:{"profile-props":_},argTypes:{"profile-props":{description:"Profile menu properties containing user information",table:{type:{detail:`
...
<div style="min-height: 600px;">
  ...
  ></modus-wc-profile-menu>
    ...
    `},r={...d,parameters:{docs:{description:{story:"Basic profile menu with default menu items (My Profile, My Products, Support center, Admin settings) and no custom submenus."},source:{transform:(e,{args:n})=>s(n)}}}},a={...d,parameters:{docs:{description:{story:"Reorders built-in items, omits Admin settings, and inserts a custom Billing item between defaults."},source:{transform:(e,{args:n})=>s(n)}}},args:{"main-menu":{items:[{id:"my-products"},{label:"Billing",icon:"invoice",iconVariant:"solid",iconSize:"sm",value:"billing"},{id:"my-profile"},{id:"support-center"}]}}},m={...d,parameters:{docs:{description:{story:"Profile menu with one additional custom submenu section. Submenus can include a title and items with icons."},source:{transform:(e,{args:n})=>s(n)}}},args:{"menu-one":{title:"Recent Projects",items:[{label:"Project Alpha",icon:"bug",iconVariant:"solid"},{label:"Project Beta",icon:"triangle_down",iconVariant:"solid"},{label:"Project Gamma",icon:"service_rep",iconVariant:"solid"}]}}},l={...d,parameters:{docs:{description:{story:"Profile menu with two additional custom submenu sections. Each submenu can have its own title and menu items with icons."},source:{transform:(e,{args:n})=>s(n)}}},args:{"menu-one":{title:"Recent Projects",items:[{label:"Project Alpha",icon:"bug",iconVariant:"solid"},{label:"Project Beta",icon:"triangle_down",iconVariant:"solid"},{label:"Project Gamma",icon:"antenna",iconVariant:"solid"}]},"menu-two":{title:"Quick Actions",items:[{label:"Settings",icon:"settings",iconVariant:"solid"},{label:"Help Center",icon:"help",iconVariant:"solid"},{label:"Support",icon:"headset",iconVariant:"solid"}]}}},u={render:e=>{if(!customElements.get("profile-menu-shadow-host")){const n=V({componentTag:"modus-wc-profile-menu",propsMapper:(o,t)=>{const i=t;i.profileProps=o["profile-props"],i.mainMenu=o["main-menu"],i.menuOne=o["menu-one"],i.menuTwo=o["menu-two"],t.dataset.eventsWired||(t.addEventListener("signOutClick",c("signOutClick")),t.addEventListener("menuItemClick",c("menuItemClick")),t.dataset.eventsWired="true")}});customElements.define("profile-menu-shadow-host",n)}return E`<profile-menu-shadow-host
      .props=${{...e}}
...
}`,...(g=(h=r.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};var b,w,M;a.parameters={...a.parameters,docs:{...(b=a.parameters)==null?void 0:b.docs,source:{originalSource:`{
  ...Template,
  parameters: {
    docs: {
      description: {
        story: 'Reorders built-in items, omits Admin settings, and inserts a custom Billing item between defaults.'
      },
      source: {
        transform: (_src, {
          args
...
}`,...(M=(w=a.parameters)==null?void 0:w.docs)==null?void 0:M.source}}};var P,T,S;m.parameters={...m.parameters,docs:{...(P=m.parameters)==null?void 0:P.docs,source:{originalSource:`{
  ...Template,
  parameters: {
    docs: {
      description: {
...
}`,...(S=(T=m.parameters)==null?void 0:T.docs)==null?void 0:S.source}}};var y,v,I;l.parameters={...l.parameters,docs:{...(y=l.parameters)==null?void 0:y.docs,source:{originalSource:`{
  ...Template,
  parameters: {
    docs: {
      description: {
...
}`,...(I=(v=l.parameters)==null?void 0:v.docs)==null?void 0:I.source}}};var C,k,O;u.parameters={...u.parameters,docs:{...(C=u.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: args => {
...
}`,...(O=(k=u.parameters)==null?void 0:k.docs)==null?void 0:O.source}}};const L=["Default","WithCustomMainMenu","WithOneSubmenu","WithTwoSubmenus","ShadowDomParent"];export{r as Default,u as ShadowDomParent,a as WithCustomMainMenu,m as WithOneSubmenu,l as WithTwoSubmenus,L as __namedExportsOrder,W as default};
