...
<div style="min-height: 600px;">
  ...
  ></modus-wc-profile-menu>
    ...
    `},r={...p,parameters:{docs:{description:{story:"Basic profile menu with default menu items (My Profile, My Products, Support center, Admin settings) and no custom submenus."},source:{transform:(e,{args:n})=>s(n)}}}},a={...p,parameters:{docs:{description:{story:"Hides Admin settings via adminSettings: false and appends a custom Billing item after the remaining built-in items."},source:{transform:(e,{args:n})=>s(n)}}},args:{"main-menu":{adminSettings:!1,items:[{label:"Billing",icon:"invoice",iconVariant:"solid",value:"billing"}]}}},l={...p,parameters:{docs:{description:{story:"Profile menu with one additional custom submenu section. Submenus can include a title and items with icons."},source:{transform:(e,{args:n})=>s(n)}}},args:{"menu-one":{title:"Recent Projects",items:[{label:"Project Alpha",icon:"bug",iconVariant:"solid"},{label:"Project Beta",icon:"triangle_down",iconVariant:"solid"},{label:"Project Gamma",icon:"service_rep",iconVariant:"solid"}]}}},m={...p,parameters:{docs:{description:{story:"Profile menu with two additional custom submenu sections. Each submenu can have its own title and menu items with icons."},source:{transform:(e,{args:n})=>s(n)}}},args:{"menu-one":{title:"Recent Projects",items:[{label:"Project Alpha",icon:"bug",iconVariant:"solid"},{label:"Project Beta",icon:"triangle_down",iconVariant:"solid"},{label:"Project Gamma",icon:"antenna",iconVariant:"solid"}]},"menu-two":{title:"Quick Actions",items:[{label:"Settings",icon:"settings",iconVariant:"solid"},{label:"Help Center",icon:"help",iconVariant:"solid"},{label:"Support",icon:"headset",iconVariant:"solid"}]}}},u={render:e=>{if(!customElements.get("profile-menu-shadow-host")){const n=A({componentTag:"modus-wc-profile-menu",propsMapper:(t,o)=>{const i=o;i.profileProps=t["profile-props"],i.mainMenu=t["main-menu"],i.menuOne=t["menu-one"],i.menuTwo=t["menu-two"],i.showSignOut=t["show-sign-out"],o.dataset.eventsWired||(o.addEventListener("signOutClick",c("signOutClick")),o.addEventListener("menuItemClick",c("menuItemClick")),o.dataset.eventsWired="true")}});customElements.define("profile-menu-shadow-host",n)}return E`<profile-menu-shadow-host
      .props=${{...e}}
...
}`,...(P=(w=a.parameters)==null?void 0:w.docs)==null?void 0:P.source}}};var S,M,T;l.parameters={...l.parameters,docs:{...(S=l.parameters)==null?void 0:S.docs,source:{originalSource:`{
  ...Template,
  parameters: {
    docs: {
      description: {
...
}`,...(T=(M=l.parameters)==null?void 0:M.docs)==null?void 0:T.source}}};var y,v,C;m.parameters={...m.parameters,docs:{...(y=m.parameters)==null?void 0:y.docs,source:{originalSource:`{
  ...Template,
  parameters: {
    docs: {
      description: {
...
}`,...(C=(v=m.parameters)==null?void 0:v.docs)==null?void 0:C.source}}};var k,I,O;u.parameters={...u.parameters,docs:{...(k=u.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: args => {
...
}`,...(O=(I=u.parameters)==null?void 0:I.docs)==null?void 0:O.source}}};const H=["Default","WithCustomMainMenu","WithOneSubmenu","WithTwoSubmenus","ShadowDomParent"];export{r as Default,u as ShadowDomParent,a as WithCustomMainMenu,l as WithOneSubmenu,m as WithTwoSubmenus,H as __namedExportsOrder,x as default};
