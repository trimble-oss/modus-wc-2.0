...
<\/script>
  `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["min-chars"],t(e["min-input-width"]),!1,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],e["show-spinner"],t(e.size),e.value,g),args:{placeholder:"Search fruits..."}},M={render:e=>b`
    ...
    `,args:{feedback:{level:"error",message:"This field is required"}}},C={name:"With Tooltips",parameters:{docs:{description:{story:"This example demonstrates menu items with tooltips. Hover over the items to see the tooltips."},source:{code:`
        <script>
const tooltipItems = [
  {
    label: 'Apple',
...
`}}},render:()=>b`
    ...
    `},S={render:e=>(e.items||(e.items=[...w]),e.items=e.items.map(m=>m.value==="apple"||m.value==="banana"?{...m,selected:!0}:m),b(F||(F=v([`
      <style>
      ...
      <script>
        ...
        `,`
          ...
          // }
        <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["max-chips"]??4,e["min-chars"],t(e["min-input-width"]),!0,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e.value,g))},E={render:e=>{let m;const s=p=>{var u;if(!((u=p.detail)!=null&&u.target))return;const o=p.target.closest("modus-wc-autocomplete");if(o){const n=p.detail.target.value.toLowerCase();m&&window.clearTimeout(m),o.showSpinner=!0,m=window.setTimeout(()=>{const c=w.filter(l=>l.label.toLowerCase().includes(n));o.items=c,o.showSpinner=!1},2e3)}};return b(q||(q=v([`
      <style>
...
<script>
        ...
        // }
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),t(e.label),e["leave-menu-open"],e["min-chars"],!1,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e["show-spinner"],e.value,p,o,!0,u,u,u,u)}},k={render:e=>{const m=o=>{const u=document.getElementById("autocomplete-custom-event-handlers");if(!u)return;["ArrowDown","ArrowUp","Enter","Escape"].includes(o.key)&&o.preventDefault();const a=e.items.filter(n=>n.visibleInMenu&&!n.disabled);switch(o.key){case"Escape":e.items=e.items.map(n=>({...n,focused:!1})),u.items=[...e.items],u.closeMenu(),u.style.transform="scale(0.98)",setTimeout(()=>{u.style.transform=""},200);break;case"ArrowDown":{u.openMenu();const n=a.findIndex(i=>i.focused),c=n<0?0:Math.min(n+1,a.length-1),l=c+1<a.length?c+1:c;e.items=e.items.map(i=>{var r;return{...i,focused:((r=a[l])==null?void 0:r.value)===i.value}});break}case"ArrowUp":{const n=a.findIndex(i=>i.focused),c=n<0?a.length-1:Math.max(n-1,0),l=c-1>=0?c-1:c;e.items=e.items.map(i=>{var r;return{...i,focused:((r=a[l])==null?void 0:r.value)===i.value}});break}case"Enter":{const n=a.find(c=>c.focused);n&&(e.items=e.items.map(c=>({...c,selected:c.value===n.value,focused:!1})),u.value=n.label,u.closeMenu());break}default:return}u.items=[...e.items]},s=o=>{const u=document.getElementById("autocomplete-custom-event-handlers");if(!u)return;const a=o.toLowerCase().split("");if(o.length>0){const l=e.items.map(i=>{const r=i.label.toLowerCase();let f=0,h=!0;for(const d of a)if(r.includes(d)){const I=r.indexOf(d);I===0?f+=3:r[I-1]===" "?f+=2:f+=1}else{h=!1;break}return h&&r.includes(o.toLowerCase())&&(f+=10),{item:i,score:h?f:-1,visible:h}});l.sort((i,r)=>r.score-i.score),e.items=l.map(({item:i,visible:r})=>({...i,visibleInMenu:r,focused:!1,selected:i.selected&&r,label:i.label}))}else e.items=e.items.map(l=>({...l,visibleInMenu:!0,focused:!1}));u.items=[...e.items],u.value=o;const n=e.items.filter(l=>l.visibleInMenu).length;console.log(`Fuzzy search for "${o}": ${n} matches found`),e.items.some(l=>l.visibleInMenu)&&o.length>=e["min-chars"]?u.openMenu():u.closeMenu()},p=o=>{const u=document.getElementById("autocomplete-custom-event-handlers");u&&(e.items=e.items.map(a=>({...a,selected:a.value===o.value,focused:!1})),u.items=[...e.items],u.value=o.label,u.closeMenu())};return b(R||(R=v([`
      <style>
...
}`,...(ne=(te=S.parameters)==null?void 0:te.docs)==null?void 0:ne.source}}};var oe,le,se;E.parameters={...E.parameters,docs:{...(oe=E.parameters)==null?void 0:oe.docs,source:{originalSource:`{
  render: args => {
...
}`,...(se=(le=E.parameters)==null?void 0:le.docs)==null?void 0:se.source}}};var ae,ie,ue;A.parameters={...A.parameters,docs:{...(ae=A.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  render: args => {
...
}`,...(ue=(ie=A.parameters)==null?void 0:ie.docs)==null?void 0:ue.source}}};var ce,re,me;k.parameters={...k.parameters,docs:{...(ce=k.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  render: args => {
...
}`,...(me=(re=k.parameters)==null?void 0:re.docs)==null?void 0:me.source}}};var de,pe,he;$.parameters={...$.parameters,docs:{...(de=$.parameters)==null?void 0:de.docs,source:{originalSource:`{
  args: {
    ...meta.args,
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(Me=(xe=D.parameters)==null?void 0:xe.docs)==null?void 0:Me.source}}};const Pe=["Default","WithCustomIconSlot","WithFeedback","WithTooltips","MultiSelect","WithSpinner","CustomMenuItems","CustomEventHandlers","WithProgrammaticControl","DynamicOptions","ShadowDomParent","Migration"];export{k as CustomEventHandlers,A as CustomMenuItems,y as Default,L as DynamicOptions,D as Migration,S as MultiSelect,T as ShadowDomParent,x as WithCustomIconSlot,M as WithFeedback,$ as WithProgrammaticControl,E as WithSpinner,C as WithTooltips,Pe as __namedExportsOrder,Ae as default};
