import{w as H}from"./decorator-Cv9na35H.js";import{b as s}from"./lit-element-DgBvYnzn.js";import{o as a}from"./if-defined-BnVFTJ4o.js";import{c as A}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-C_wAuwg_.js";import"./v4-C6aID195.js";const G={title:"Components/Chip",component:"modus-wc-chip",args:{label:"Chip",multiline:!1,"show-remove":!0,shape:"rectangle",size:"md",variant:"filled"},argTypes:{shape:{control:{type:"select"},options:["rectangle","circle"]},size:{control:{type:"select"},options:["sm","md","lg"]},variant:{control:{type:"select"},options:["filled","outline"]}},decorators:[H],parameters:{actions:{handles:["chipClick","chipRemove"]}}},L={render:e=>s` <modus-wc-chip
