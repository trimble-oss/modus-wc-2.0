...
* Only add styles here that should not be applied by Tailwind, Daisy, or the theme.
*
* Disabled variant colors + light/dark opacity live in src/styles/tailwind.css
* (compiled to output.css). Classic theme styles in this file keep higher specificity.
*/
...
[data-theme]:not([data-theme^=connect]) modus-wc-button .modus-wc-btn.modus-wc-btn-filled.modus-wc-btn-neutral {
  background-color: var(--modus-wc-color-base-100);
  border-color: var(--modus-wc-color-base-100);
}
[data-theme]:not([data-theme^=connect]) modus-wc-button .modus-wc-btn.modus-wc-btn-filled.modus-wc-btn-neutral:hover, [data-theme]:not([data-theme^=connect]) modus-wc-button .modus-wc-btn.modus-wc-btn-filled.modus-wc-btn-neutral.modus-wc-btn-active, [data-theme]:not([data-theme^=connect]) modus-wc-button .modus-wc-btn.modus-wc-btn-filled.modus-wc-btn-neutral[aria-pressed=true] {
  background-color: var(--modus-wc-color-base-200);
  border-color: var(--modus-wc-color-base-200);
}
...
modus-wc-button .modus-wc-btn.modus-wc-btn-base-inverted.modus-wc-btn-filled {
  background-color: var(--modus-wc-color-trimble-neutral);
  border-color: var(--modus-wc-color-trimble-neutral);
  color: var(--modus-wc-color-base-page);
}
modus-wc-button .modus-wc-btn.modus-wc-btn-base-inverted.modus-wc-btn-filled:hover {
...
modus-wc-button .modus-wc-btn.modus-wc-btn-base-inverted.modus-wc-btn-filled:active, modus-wc-button .modus-wc-btn.modus-wc-btn-base-inverted.modus-wc-btn-filled[aria-pressed=true] {
...
modus-wc-button .modus-wc-btn.modus-wc-btn-base-inverted.modus-wc-btn-outline:not(:hover):not(:active):not([aria-pressed=true]) {
  background-color: transparent;
  border-color: var(--modus-wc-color-trimble-neutral);
  color: var(--modus-wc-color-trimble-neutral);
}
