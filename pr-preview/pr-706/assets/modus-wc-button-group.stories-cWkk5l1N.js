import{w as I}from"./decorator-D4YmxizW.js";import{x as t}from"./lit-element-C8zulti1.js";import{o}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var a=Object.freeze,L=Object.defineProperty,A=(e,k)=>a(L(e,"raw",{value:a(e.slice())})),r,m;const $={title:"Components/Button Group",component:"modus-wc-button-group",args:{"button-style":"outlined",color:"primary",disabled:!1,orientation:"horizontal","selection-type":"default"},argTypes:{"button-style":{control:{type:"select"},options:["borderless","fill","outlined"]},color:{control:{type:"select"},options:["primary","secondary","tertiary","warning","danger"]},disabled:{control:"boolean"},orientation:{control:{type:"select"},options:["horizontal","vertical"]},"selection-type":{control:{type:"select"},options:["default","single","multiple"]}},decorators:[I],parameters:{actions:{handles:["selectionChange","buttonGroupClick"]}}},G={render:e=>t`
...
>
 ...
 <modus-wc-button>Button 3</modus-wc-button>
    ...
    `},n={...G},s={...G,args:{"button-style":"outlined",orientation:"vertical"}},u={render:()=>t(r||(r=A([`
<script>
...
<div style="display: flex; flex-direction: column; gap: 16px;">
  ...
  ...Template
}`,...(w=(b=n.parameters)==null?void 0:b.docs)==null?void 0:w.source}}};var y,g,v;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  ...Template,
  args: {
    'button-style': 'outlined',
    orientation: 'vertical'
  }
}`,...(v=(g=s.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};var h,S,f;u.parameters={...u.parameters,docs:{...(h=u.parameters)==null?void 0:h.docs,source:{originalSource:`{
  render: () => {
    // prettier-ignore
    return html\`
<script>
...
}`,...(f=(S=u.parameters)==null?void 0:S.docs)==null?void 0:f.source}}};var x,E,C;i.parameters={...i.parameters,docs:{...(x=i.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: () => {
    // prettier-ignore
    return html\`
<div style="display: flex; flex-direction: column; gap: 16px;">
...
}`,...(D=(_=l.parameters)==null?void 0:_.docs)==null?void 0:D.source}}};var T,V,U;c.parameters={...c.parameters,docs:{...(T=c.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| selectionChange        | selectionChange        | Unchanged. Returns array of selected buttons               |
  ...
  render: () => html\`<div></div>\`
}`,...(U=(V=c.parameters)==null?void 0:V.docs)==null?void 0:U.source}}};const F=["Default","Vertical","SplitButton","SingleSelection","MultipleSelection","SelectionEvent","Migration"];export{n as Default,c as Migration,d as MultipleSelection,l as SelectionEvent,i as SingleSelection,u as SplitButton,s as Vertical,F as __namedExportsOrder,$ as default};
