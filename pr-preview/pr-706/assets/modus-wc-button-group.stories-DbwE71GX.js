import{w as I}from"./decorator-D4YmxizW.js";import{x as t}from"./lit-element-C8zulti1.js";import{o}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var a=Object.freeze,L=Object.defineProperty,A=(e,k)=>a(L(e,"raw",{value:a(e.slice())})),r,m;const $={title:"Components/Button Group",component:"modus-wc-button-group",args:{"button-style":"outlined",color:"primary",disabled:!1,orientation:"horizontal","selection-type":"default"},argTypes:{"button-style":{control:{type:"select"},options:["borderless","fill","outlined"]},color:{control:{type:"select"},options:["primary","secondary","tertiary","warning","danger"]},disabled:{control:"boolean"},orientation:{control:{type:"select"},options:["horizontal","vertical"]},"selection-type":{control:{type:"select"},options:["default","single","multiple"]}},decorators:[I],parameters:{actions:{handles:["buttonSelectionChange","buttonGroupClick"]}}},G={render:e=>t`
...
>
 ...
 <modus-wc-button>Button 3</modus-wc-button>
    ...
    `},n={...G},u={...G,args:{"button-style":"outlined",orientation:"vertical"}},s={render:()=>t(r||(r=A([`
<script>
...
| buttonSelectionChange  | buttonSelectionChange  | Unchanged. Returns array of selected buttons               |
  ...
  render: () => html\`<div></div>\`
}`,...(U=(V=c.parameters)==null?void 0:V.docs)==null?void 0:U.source}}};const F=["Default","Vertical","SplitButton","SingleSelection","MultipleSelection","SelectionEvent","Migration"];export{n as Default,c as Migration,d as MultipleSelection,l as SelectionEvent,i as SingleSelection,s as SplitButton,u as Vertical,F as __namedExportsOrder,$ as default};
