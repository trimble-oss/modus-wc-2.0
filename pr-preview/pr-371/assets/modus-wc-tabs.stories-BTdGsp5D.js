import{w as C}from"./decorator-DFROgT0E.js";import{x as i}from"./lit-element-C8zulti1.js";import{o as n}from"./if-defined-yv6owfG8.js";import"./v4-CtRu48qb.js";const D={title:"Components/Tabs",component:"modus-wc-tabs",args:{size:"md",tabs:[{label:"Tab 1"},{label:"Tab 2"},{label:"Tab 3",disabled:!0},{icon:"home"}],"tab-style":"bordered"},argTypes:{tabs:{description:"Array of tab objects defining the tabs to display",table:{type:{detail:`
            Interface: ITab
            Properties:
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(x=(I=r.parameters)==null?void 0:I.docs)==null?void 0:x.source}}};const A=["Default","ActiveAndDisabled","Icons","TabsWithPanel","Migration"];export{t as ActiveAndDisabled,a as Default,s as Icons,r as Migration,o as TabsWithPanel,A as __namedExportsOrder,D as default};
