import{w as f}from"./decorator-D4YmxizW.js";import{b as i}from"./lit-element-DgBvYnzn.js";import{o as c}from"./if-defined-BnVFTJ4o.js";import{c as C}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var l=Object.freeze,E=Object.defineProperty,x=(e,o)=>l(E(e,"raw",{value:l(e.slice())})),m;const $={title:"Components/Stepper",component:"modus-wc-stepper",args:{"active-step":void 0,interactive:!1,steps:[{label:"Scale",color:"primary"},{label:"Belong",color:"primary"},{label:"Grow",color:"warning"},{label:"Innovate",content:"🚀"}]},decorators:[f],argTypes:{"active-step":{control:"number"},"custom-class":{control:"text"},interactive:{control:"boolean"},orientation:{control:{type:"select"},options:["horizontal","vertical"]},steps:{description:"Array of step objects defining the steps to display",table:{type:{detail:`
          ...
          `}}}},parameters:{actions:{handles:["stepClick"]},layout:"padded"}},k={render:e=>i(m||(m=x([`
<modus-wc-stepper
  active-step="`,`"
  custom-class="`,`"
  orientation="`,`"
...
<\/script>
  ...
  `])),c(e["active-step"]),c(e["custom-class"]),c(e.orientation),e.interactive??!1,e.steps)},p={...k},a={parameters:{docs:{source:{code:`
<modus-wc-stepper
...
<\/script>
        `}}},render:()=>{const e=[{label:"Scale",color:"primary"},{label:"Belong",color:"primary"},{label:"Grow",color:"primary"},{label:"Innovate",content:"🚀",color:"primary"}],o=s=>e.map((t,I)=>({...t,color:I<=s?"primary":"neutral"})),r=s=>{const t=s.target;t.activeStep=s.detail,t.steps=o(s.detail)};return i`
      <modus-wc-stepper
        id="controlled-stepper"
        active-step="1"
        orientation="horizontal"
        ...
        @stepClick=${r}
      ></modus-wc-stepper>
    `}},n={render:e=>{if(!customElements.get("stepper-shadow-host")){const o=C({componentTag:"modus-wc-stepper",propsMapper:(r,s)=>{const t=s;t.activeStep=r["active-step"],t.customClass=r["custom-class"]||"",t.interactive=r.interactive??!1,t.orientation=r.orientation??"horizontal",t.steps=r.steps??[]}});customElements.define("stepper-shadow-host",o)}return i`<stepper-shadow-host
      .props=${{...e}}
    ></stepper-shadow-host>`}};var d,v,u;p.parameters={...p.parameters,docs:{...(d=p.parameters)==null?void 0:d.docs,source:{originalSource:`{
  ...Template
}`,...(u=(v=p.parameters)==null?void 0:v.docs)==null?void 0:u.source}}};var S,h,w;a.parameters={...a.parameters,docs:{...(S=a.parameters)==null?void 0:S.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        code: \`
...
}`,...(w=(h=a.parameters)==null?void 0:h.docs)==null?void 0:w.source}}};var y,b,g;n.parameters={...n.parameters,docs:{...(y=n.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: args => {
...
}`,...(g=(b=n.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};const A=["Default","Interactive","ShadowDomParent"];export{p as Default,a as Interactive,n as ShadowDomParent,A as __namedExportsOrder,$ as default};
