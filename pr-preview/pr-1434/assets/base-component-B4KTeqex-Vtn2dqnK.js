...
modus-wc-menu-item .modus-wc-menu-item button .modus-wc-menu-item-content:has([slot=start-icon]) .modus-wc-menu-item-labels, modus-wc-menu-item .modus-wc-menu-item button .modus-wc-menu-item-content:has(modus-wc-checkbox) .modus-wc-menu-item-labels {
  padding-inline-start: 0;
}
...
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-xs button {
  font-size: var(--modus-wc-font-size-sm);
  height: var(--modus-wc-size-xs);
  padding-block: var(--modus-wc-spacing-2xs);
  padding-inline: var(--modus-wc-spacing-sm);
}
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-xs button .modus-wc-menu-item-labels {
  line-height: 20px;
}
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-xs button [slot=start-icon] {
  height: var(--modus-wc-font-size-md);
  width: var(--modus-wc-font-size-md);
}
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-xs button [slot=start-icon] modus-wc-icon,
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-xs button [slot=start-icon] i {
  font-size: var(--modus-wc-font-size-md);
  height: var(--modus-wc-font-size-md);
  width: var(--modus-wc-font-size-md);
}
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-xs button .modus-wc-menu-submenu-chevron {
  height: var(--modus-wc-spacing-lg);
  width: var(--modus-wc-spacing-lg);
}
...
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-sm button [slot=start-icon] i {
  font-size: var(--modus-wc-spacing-lg);
}
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-sm button .modus-wc-menu-item-labels {
  line-height: var(--modus-wc-line-height-md);
}
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-sm button .modus-wc-menu-submenu-chevron {
  height: var(--modus-wc-spacing-lg);
  width: var(--modus-wc-spacing-lg);
}
...
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button [slot=start-icon] i {
  font-size: var(--modus-wc-font-size-xl);
}
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-labels {
  line-height: var(--modus-wc-line-height-md);
}
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-submenu-chevron {
  height: var(--modus-wc-font-size-xl);
  width: var(--modus-wc-font-size-xl);
}
...
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-lg button [slot=start-icon] i {
  font-size: var(--modus-wc-font-size-2xl);
}
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-lg button .modus-wc-menu-item-labels {
  line-height: var(--modus-wc-line-height-lg);
}
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-lg button .modus-wc-menu-submenu-chevron {
  height: var(--modus-wc-font-size-2xl);
  width: var(--modus-wc-font-size-2xl);
}
...
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-xl button {
  font-size: var(--modus-wc-font-size-2xl);
  height: var(--modus-wc-size-xl);
  padding-block: var(--modus-wc-spacing-md);
  padding-inline: var(--modus-wc-spacing-sm);
}
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-xl button .modus-wc-menu-item-labels {
  line-height: var(--modus-wc-line-height-lg);
}
modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-xl button .modus-wc-menu-submenu-chevron {
  height: var(--modus-wc-spacing-xl);
  width: var(--modus-wc-spacing-xl);
}
...
modus-wc-side-navigation modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-content [slot=start-icon] modus-wc-icon {
  align-items: center;
  display: inline-flex;
  flex-shrink: 0;
  justify-content: center;
...
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item .modus-wc-menu-item-interactive .modus-wc-menu-submenu-chevron {
  align-items: center;
  display: inline-flex;
  height: var(--modus-wc-font-size-2xl);
  justify-content: center;
...
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item .modus-wc-menu-item-interactive .modus-wc-menu-submenu-chevron i {
  display: block;
  font-size: var(--modus-wc-font-size-2xl);
  line-height: 1;
}
...
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item .modus-wc-menu-item-interactive .modus-wc-menu-item-content [slot=start] modus-wc-icon,
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item .modus-wc-menu-item-interactive .modus-wc-menu-item-content [slot=start] i {
  display: block;
  line-height: 1;
}
...
modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-xs .modus-wc-clear-icon-container {
...
modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-xl .modus-wc-clear-icon-container {
  min-width: var(--modus-wc-line-height-lg);
}
...
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xs .modus-wc-menu-item-interactive {
  font-size: var(--modus-wc-font-size-sm);
  height: var(--modus-wc-size-xs);
  padding-block: var(--modus-wc-spacing-2xs);
  padding-inline: var(--modus-wc-spacing-xs);
}
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xs .modus-wc-menu-item-interactive .modus-wc-menu-item-labels {
  line-height: 20px;
}
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xs .modus-wc-menu-item-interactive .modus-wc-menu-item-labels div {
  font-size: var(--modus-wc-font-size-sm);
  line-height: 20px;
}
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xs .modus-wc-menu-item-interactive .modus-wc-menu-submenu-chevron {
  height: var(--modus-wc-spacing-lg);
  width: var(--modus-wc-spacing-lg);
}
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xs .modus-wc-menu-item-interactive [slot=start],
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xs .modus-wc-menu-item-interactive [slot=start-icon] {
  height: var(--modus-wc-font-size-md);
  width: var(--modus-wc-font-size-md);
}
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xs .modus-wc-menu-item-interactive [slot=start] modus-wc-icon,
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xs .modus-wc-menu-item-interactive [slot=start-icon] modus-wc-icon {
  font-size: var(--modus-wc-font-size-md);
  height: var(--modus-wc-font-size-md);
  width: var(--modus-wc-font-size-md);
}
...
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-sm .modus-wc-menu-item-interactive .modus-wc-menu-item-labels {
  line-height: var(--modus-wc-line-height-md);
}
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-sm .modus-wc-menu-item-interactive .modus-wc-menu-item-sublabel {
  font-size: var(--modus-wc-font-size-xs);
}
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-sm .modus-wc-menu-item-interactive .modus-wc-menu-submenu-chevron {
  height: var(--modus-wc-spacing-lg);
  width: var(--modus-wc-spacing-lg);
}
...
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md .modus-wc-menu-item-interactive .modus-wc-menu-item-labels {
  line-height: var(--modus-wc-line-height-md);
}
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md .modus-wc-menu-item-interactive .modus-wc-menu-item-sublabel {
  font-size: var(--modus-wc-font-size-sm);
}
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md .modus-wc-menu-item-interactive .modus-wc-menu-submenu-chevron {
  height: var(--modus-wc-font-size-xl);
  width: var(--modus-wc-font-size-xl);
}
...
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-lg .modus-wc-menu-item-interactive .modus-wc-menu-item-labels {
  line-height: var(--modus-wc-line-height-lg);
}
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-lg .modus-wc-menu-item-interactive .modus-wc-menu-submenu-chevron {
  height: var(--modus-wc-font-size-2xl);
  width: var(--modus-wc-font-size-2xl);
}
...
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xl .modus-wc-menu-item-interactive {
  font-size: var(--modus-wc-font-size-2xl);
  height: var(--modus-wc-size-xl);
  padding-block: var(--modus-wc-spacing-md);
  padding-inline: var(--modus-wc-spacing-sm);
}
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xl .modus-wc-menu-item-interactive .modus-wc-menu-item-labels {
  line-height: var(--modus-wc-line-height-lg);
}
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xl .modus-wc-menu-item-interactive .modus-wc-menu-item-labels div {
  font-size: var(--modus-wc-font-size-2xl);
  line-height: var(--modus-wc-line-height-lg);
}
modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xl .modus-wc-menu-item-interactive .modus-wc-menu-submenu-chevron {
  height: var(--modus-wc-spacing-xl);
  width: var(--modus-wc-spacing-xl);
}
