...
<\/script>
`,Z={title:"Components/Tree Item",component:"modus-wc-tree-item",args:{label:"Tree Item",size:"md",value:"treeItem"},argTypes:{size:{control:{type:"select"},options:["xs","sm","md","lg","xl"]},"tooltip-position":{control:{type:"select"},options:["auto","top","right","bottom","left"]}},decorators:[P],parameters:{actions:{handles:["itemSelect"]}}},K={parameters:{docs:{source:{code:R}}},render:e=>n`
<modus-wc-tree-menu>
  <modus-wc-tree-item
    ?bordered=${e.bordered}
...
}`,...(f=($=l.parameters)==null?void 0:$.docs)==null?void 0:f.source}}};var x,z,C;u.parameters={...u.parameters,docs:{...(x=u.parameters)==null?void 0:x.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(C=(z=u.parameters)==null?void 0:z.docs)==null?void 0:C.source}}};var E,T,k;d.parameters={...d.parameters,docs:{...(E=d.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    checkbox: true
  },
  parameters: {
