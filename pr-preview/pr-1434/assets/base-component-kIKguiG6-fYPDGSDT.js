...
modus-wc-app-menu.modus-wc-app-menu .modus-wc-panel .modus-wc-app-menu-items modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button {
  font-size: var(--modus-wc-font-size-md);
  gap: 0;
  height: auto;
  min-height: unset;
  padding-block: var(--modus-wc-spacing-sm);
  padding-inline: var(--modus-wc-spacing-lg);
}
modus-wc-app-menu.modus-wc-app-menu .modus-wc-panel .modus-wc-app-menu-items modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-labels {
  line-height: var(--modus-wc-line-height-md);
}
modus-wc-app-menu.modus-wc-app-menu .modus-wc-panel .modus-wc-app-menu-items modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-sublabel {
  font-size: var(--modus-wc-font-size-sm);
  line-height: 20px;
}
modus-wc-app-menu.modus-wc-app-menu .modus-wc-panel .modus-wc-app-menu-items modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button:has(.modus-wc-menu-item-sublabel) {
  height: auto;
  min-height: unset;
}
...
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-sm > .modus-wc-menu-item-interactive,
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md > .modus-wc-menu-item-interactive,
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-lg > .modus-wc-menu-item-interactive {
  line-height: 1;
...
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-sm > .modus-wc-menu-item-interactive modus-wc-button .modus-wc-btn.modus-wc-btn-borderless:hover, modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-sm > .modus-wc-menu-item-interactive modus-wc-button .modus-wc-btn.modus-wc-btn-borderless:active, modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-sm > .modus-wc-menu-item-interactive modus-wc-button .modus-wc-btn.modus-wc-btn-borderless[aria-pressed=true],
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md > .modus-wc-menu-item-interactive modus-wc-button .modus-wc-btn.modus-wc-btn-borderless:hover,
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md > .modus-wc-menu-item-interactive modus-wc-button .modus-wc-btn.modus-wc-btn-borderless:active,
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md > .modus-wc-menu-item-interactive modus-wc-button .modus-wc-btn.modus-wc-btn-borderless[aria-pressed=true],
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-lg > .modus-wc-menu-item-interactive modus-wc-button .modus-wc-btn.modus-wc-btn-borderless:hover,
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-lg > .modus-wc-menu-item-interactive modus-wc-button .modus-wc-btn.modus-wc-btn-borderless:active,
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-lg > .modus-wc-menu-item-interactive modus-wc-button .modus-wc-btn.modus-wc-btn-borderless[aria-pressed=true] {
  background-color: transparent;
}
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item .modus-wc-menu-item-interactive .modus-wc-menu-item-content {
  gap: 0;
  /* Drag handle is also slot=start; keep it flush. Node-start owns
     the icon-to-label gap so content gap can stay 0 (label vs actions). */
}
...
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item .modus-wc-menu-item-interactive .modus-wc-menu-item-content .modus-wc-content-tree-node-start[slot=start] {
  padding-inline-end: var(--modus-wc-content-tree-row-gap);
}
...
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-sm > .modus-wc-menu-item-interactive .modus-wc-menu-item-labels {
  font-size: var(--modus-wc-font-size-sm);
  padding-block: 0;
}
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md > .modus-wc-menu-item-interactive .modus-wc-menu-item-labels {
  font-size: var(--modus-wc-font-size-md);
  padding-block: 0;
}
modus-wc-content-tree modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-lg > .modus-wc-menu-item-interactive .modus-wc-menu-item-labels {
  font-size: var(--modus-wc-font-size-lg);
  padding-block: 0;
}
...
modus-wc-content-tree .modus-wc-content-tree-node-start {
  /* Reset line-height for all direct children so glyphs render centred.
     tree-item.scss sets line-height:0 on [slot='start'] (this div) which
     propagates down and causes icons to shift upward. */
}
modus-wc-content-tree .modus-wc-content-tree-node-start > * {
  line-height: normal;
}
...
modus-wc-profile-menu [slot=body] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button {
  font-size: var(--modus-wc-font-size-md);
  gap: 0;
  height: auto;
  min-height: unset;
...
modus-wc-profile-menu [slot=body] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-labels {
  line-height: 1.25rem;
}
modus-wc-profile-menu [slot=body] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-sublabel {
  font-size: var(--modus-wc-font-size-sm);
  line-height: 20px;
}
modus-wc-profile-menu [slot=body] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button:has(.modus-wc-menu-item-sublabel) {
  height: auto;
  min-height: unset;
}
modus-wc-profile-menu [slot=body] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-content {
  gap: 0;
}
modus-wc-profile-menu [slot=body] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-content [slot=start-icon] {
  align-items: center;
...
modus-wc-profile-menu [slot=body] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-content [slot=start-icon] modus-wc-icon,
modus-wc-profile-menu [slot=body] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-content [slot=start-icon] i {
  font-size: var(--modus-wc-font-size-2xl);
  height: var(--modus-wc-font-size-2xl);
  width: var(--modus-wc-font-size-2xl);
}
modus-wc-profile-menu [slot=body] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-content .modus-wc-menu-item-labels {
  padding-inline-end: var(--modus-wc-spacing-xs);
  padding-inline-start: var(--modus-wc-spacing-md);
}
modus-wc-profile-menu [slot=body] modus-wc-menu .modus-wc-menu-item {
  color: var(--modus-wc-color-base-content);
  padding-block: var(--modus-wc-spacing-2xs);
  padding-inline: var(--modus-wc-spacing-xs);
}
...
modus-wc-side-navigation modus-wc-menu-item .modus-wc-menu-item .modus-wc-menu-submenu-chevron {
...
modus-wc-side-navigation modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-sm button [slot=start-icon] i,
modus-wc-side-navigation modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-lg button [slot=start-icon] i {
  font-size: var(--modus-wc-font-size-3xl);
}
modus-wc-side-navigation modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button {
  padding-inline-start: var(--modus-wc-spacing-xs);
}
modus-wc-side-navigation modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-content {
  gap: var(--modus-wc-spacing-sm);
}
modus-wc-side-navigation modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-content [slot=start-icon] {
  flex-shrink: 0;
  height: var(--modus-wc-font-size-2xl);
  width: var(--modus-wc-font-size-3xl);
}
modus-wc-side-navigation modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-content [slot=start-icon] i {
  font-size: var(--modus-wc-font-size-3xl);
}
modus-wc-side-navigation modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-item-content .modus-wc-menu-item-labels {
  font-size: var(--modus-wc-font-size-md);
  line-height: var(--modus-wc-font-size-2xl);
}
modus-wc-side-navigation .modus-wc-side-navigation-expanded modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-submenu-chevron {
  height: var(--modus-wc-font-size-3xl);
  width: var(--modus-wc-font-size-2xl);
}
modus-wc-side-navigation .modus-wc-side-navigation-expanded modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button .modus-wc-menu-submenu-chevron i {
  font-size: var(--modus-wc-font-size-3xl);
}
modus-wc-side-navigation .side-navigation-content > modus-wc-menu modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-sm button,
modus-wc-side-navigation .side-navigation-content > modus-wc-menu modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button {
  max-height: 32px;
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item .modus-wc-menu-item-interactive {
  padding-block: var(--modus-wc-spacing-xs);
  padding-inline: var(--modus-wc-spacing-sm);
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item .modus-wc-menu-item-interactive .modus-wc-menu-item-content {
  gap: 0;
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item .modus-wc-menu-item-interactive .modus-wc-menu-item-content [slot=start] {
  padding-inline-end: var(--modus-wc-spacing-sm);
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item .modus-wc-menu-item-interactive .modus-wc-menu-item-content .modus-wc-menu-item-labels {
  display: block;
...
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-sm .modus-wc-menu-item-interactive {
  font-size: var(--modus-wc-font-size-sm);
  height: auto;
  padding-block: var(--modus-wc-spacing-2xs);
  padding-inline: var(--modus-wc-spacing-sm);
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-sm .modus-wc-menu-item-interactive .modus-wc-menu-item-labels {
  line-height: inherit;
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-sm .modus-wc-menu-item-interactive .modus-wc-menu-item-labels div {
  font-size: inherit;
  line-height: inherit;
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-sm .modus-wc-menu-item-interactive .modus-wc-menu-item-sublabel {
  font-size: var(--modus-wc-font-size-xs);
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md .modus-wc-menu-item-interactive {
  font-size: var(--modus-wc-font-size-md);
  height: auto;
  padding: var(--modus-wc-spacing-sm);
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md .modus-wc-menu-item-interactive .modus-wc-menu-item-labels {
  line-height: inherit;
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md .modus-wc-menu-item-interactive .modus-wc-menu-item-labels div {
  font-size: inherit;
  line-height: inherit;
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md .modus-wc-menu-item-interactive .modus-wc-menu-item-sublabel {
  font-size: var(--modus-wc-font-size-sm);
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-lg .modus-wc-menu-item-interactive {
  font-size: var(--modus-wc-font-size-lg);
  height: auto;
  padding: var(--modus-wc-spacing-sm);
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-lg .modus-wc-menu-item-interactive .modus-wc-menu-item-labels {
  line-height: inherit;
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-lg .modus-wc-menu-item-interactive .modus-wc-menu-item-labels div {
  font-size: inherit;
  line-height: inherit;
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-lg .modus-wc-menu-item-interactive .modus-wc-menu-item-sublabel {
  font-size: var(--modus-wc-font-size-md);
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xs .modus-wc-menu-item-interactive {
  font-size: var(--modus-wc-font-size-sm);
  height: auto;
  padding-block: var(--modus-wc-spacing-2xs);
  padding-inline: var(--modus-wc-spacing-sm);
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xs .modus-wc-menu-item-interactive .modus-wc-menu-item-labels div {
  font-size: inherit;
  line-height: inherit;
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xl .modus-wc-menu-item-interactive {
  height: auto;
  padding-block: var(--modus-wc-spacing-md);
  padding-inline: var(--modus-wc-spacing-sm);
}
modus-wc-side-navigation modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-xl .modus-wc-menu-item-interactive .modus-wc-menu-item-labels div {
  font-size: inherit;
  line-height: inherit;
}
modus-wc-side-navigation modus-wc-tree-menu .modus-wc-menu.modus-wc-menu-lg modus-wc-tree-item .modus-wc-menu-item > .modus-wc-menu-item-interactive {
  line-height: 1.75rem;
  padding: var(--modus-wc-spacing-md) var(--modus-wc-spacing-xl);
}
