...
modus-wc-side-navigation modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-md button [slot=start-icon] i,
...
modus-wc-tree-item .modus-wc-menu-item .modus-wc-menu-item-interactive .modus-wc-menu-item-content:has([slot=start]) .modus-wc-menu-item-labels, modus-wc-tree-item .modus-wc-menu-item .modus-wc-menu-item-interactive .modus-wc-menu-item-content:has(modus-wc-checkbox) .modus-wc-menu-item-labels {
  padding-inline-start: 0;
}
