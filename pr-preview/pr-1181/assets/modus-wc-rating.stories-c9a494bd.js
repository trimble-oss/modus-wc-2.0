import{w as S}from"./decorator-534da2b0.js";import{b as s}from"./lit-element-38260dd9.js";import{o as e}from"./if-defined-30b85b98.js";import{c as D}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";var m=Object.freeze,R=Object.defineProperty,P=(a,o)=>m(R(a,"raw",{value:m(o||a.slice())})),u;const N={title:"Components/Forms/Rating",component:"modus-wc-rating",args:{"allow-half":!1,count:5,"custom-class":"",disabled:!1,getAriaLabelText:a=>`${a} rating`,size:"md",value:0,variant:"smiley"},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]},variant:{control:{type:"select"},options:["heart","smiley","star","thumb"]}},decorators:[S],parameters:{actions:{handles:["ratingChange"]}}},r={render:a=>s`
    <modus-wc-rating
    ...
    ></modus-wc-rating>
  `},i={render:a=>{const o=n=>`Custom label for rating item ${n}`;return s(u||(u=P([`
<script>
...
<modus-wc-rating
  ...
  .getAriaLabelText=`,`
></modus-wc-rating>
    `])),e(a["allow-half"]),a.count,e(a.disabled),e(a.size),e(a.value),a.variant,o)}},l={render:a=>s`
<style>
...
<modus-wc-rating
  ...
  variant="star"
></modus-wc-rating>
  `},c={render:a=>{if(!customElements.get("rating-shadow-host")){const o=D({componentTag:"modus-wc-rating",propsMapper:(n,A)=>{const t=A;t.allowHalf=Boolean(n["allow-half"]),t.count=n.count,t.customClass=n["custom-class"]||"",t.disabled=Boolean(n.disabled),n.getAriaLabelText&&(t.getAriaLabelText=n.getAriaLabelText),t.size=n.size||"md",t.value=n.value||0,t.variant=n.variant}});customElements.define("rating-shadow-host",o)}return s`<rating-shadow-host
      .props=${{...a}}
...
| sentimentSelection | ratingChange |                                               |
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>s`<div></div>`};var g,p,b;r.parameters={...r.parameters,docs:{...(g=r.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: args => html\`
    <modus-wc-rating
      aria-label="Rating scale component"
    ...
    ></modus-wc-rating>
  \`
}`,...(b=(p=r.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};var f,h,v;i.parameters={...i.parameters,docs:{...(f=i.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: args => {
...
}`,...(v=(h=i.parameters)==null?void 0:h.docs)==null?void 0:v.source}}};var w,$,y;l.parameters={...l.parameters,docs:{...(w=l.parameters)==null?void 0:w.docs,source:{originalSource:`{
  // prettier-ignore
  render: args => html\`
<style>
  .custom-color-rating-component {
