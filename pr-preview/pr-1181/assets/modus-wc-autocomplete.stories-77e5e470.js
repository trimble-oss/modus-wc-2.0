...
\`\`\`
      ...
      <script>
        ...
        // }
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),m,t(e.label),e["leave-menu-open"],0,!1,t(e.name),e["no-results"],e["read-only"],e.required,!0,t(e.size),e.value,p,o)}},T={render:e=>{if(!customElements.get("autocomplete-shadow-host")){const m=Se({componentTag:"modus-wc-autocomplete",propsMapper:(a,p)=>{const o=p;o.bordered=Boolean(a.bordered),o.customClass=a["custom-class"]||"",typeof a["debounce-ms"]=="number"&&(o.debounceMs=a["debounce-ms"]),o.disabled=Boolean(a.disabled),o.includeClear=Boolean(a["include-clear"]),o.includeSearch=Boolean(a["include-search"]),typeof a["input-id"]=="string"&&(o.inputId=a["input-id"]),typeof a["input-tab-index"]=="number"&&(o.inputTabIndex=a["input-tab-index"]),o.items=a.items,typeof a.label=="string"&&(o.label=a.label),typeof a["leave-menu-open"]=="boolean"&&(o.leaveMenuOpen=a["leave-menu-open"]),typeof a["max-chips"]=="number"&&(o.maxChips=a["max-chips"]),typeof a["min-chars"]=="number"&&(o.minChars=a["min-chars"]),typeof a["min-input-width"]=="number"&&(o.minInputWidth=a["min-input-width"]),o.multiSelect=Boolean(a["multi-select"]),typeof a.name=="string"&&(o.name=a.name),o.noResults=a["no-results"],typeof a.placeholder=="string"&&(o.placeholder=a.placeholder),o.readOnly=Boolean(a["read-only"]),o.required=Boolean(a.required),typeof a["show-menu-on-focus"]=="boolean"&&(o.showMenuOnFocus=a["show-menu-on-focus"]),o.showSpinner=Boolean(a["show-spinner"]),typeof a.size=="string"&&(o.size=a.size),o.value=a.value}});customElements.define("autocomplete-shadow-host",m)}return b`<autocomplete-shadow-host
      .props=${{...e}}
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(Me=(xe=D.parameters)==null?void 0:xe.docs)==null?void 0:Me.source}}};const ze=["Default","WithCustomIconSlot","WithFeedback","WithTooltips","MultiSelect","WithSpinner","CustomMenuItems","CustomEventHandlers","WithProgrammaticControl","DynamicOptions","ShadowDomParent","Migration"];export{A as CustomEventHandlers,k as CustomMenuItems,y as Default,L as DynamicOptions,D as Migration,S as MultiSelect,T as ShadowDomParent,x as WithCustomIconSlot,M as WithFeedback,$ as WithProgrammaticControl,E as WithSpinner,C as WithTooltips,ze as __namedExportsOrder,ke as default};
