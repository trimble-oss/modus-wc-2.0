import{b as w}from"./lit-element-38260dd9.js";import{o as a}from"./if-defined-30b85b98.js";import{c as g}from"./shadow-host-helper-0b7f7548.js";const S={title:"Components/Forms/Input Label",component:"modus-wc-input-label",args:{"label-text":"Label",required:!1,size:"md"},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]}}},f={render:e=>w`
    ...
    ></modus-wc-input-label>
  `},o={...f},n={...f,args:{required:!0}},l={render:e=>{if(!customElements.get("input-label-shadow-host")){const L=g({componentTag:"modus-wc-input-label",propsMapper:(t,x)=>{const s=x;s.forId=t["for-id"]??"",s.customClass=t["custom-class"]||"",s.labelText=t["label-text"]??"",s.required=Boolean(t.required),s.size=t.size??"md",s.subLabelText=t["sub-label-text"]??""}});customElements.define("input-label-shadow-host",L)}return w`<input-label-shadow-host
      .props=${{...e}}
