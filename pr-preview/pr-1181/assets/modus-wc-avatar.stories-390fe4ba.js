import{b as p}from"./lit-element-38260dd9.js";import{o as u}from"./if-defined-30b85b98.js";import{c as v}from"./shadow-host-helper-0b7f7548.js";const S={title:"Components/Avatar",component:"modus-wc-avatar",args:{alt:"Example avatar","img-src":"https://i.pinimg.com/474x/73/54/79/7354794bf3873c3ef2666f778da4bcac.jpg",shape:"circle",initials:"",size:"md"},argTypes:{shape:{control:{type:"select"},options:["circle","square"]},size:{control:{type:"select"},options:["xs","sm","md","lg","xl"]}}},g={render:a=>p`
      <modus-wc-avatar
        alt="${a.alt}"
