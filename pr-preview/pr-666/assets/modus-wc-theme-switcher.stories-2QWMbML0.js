import{w as i}from"./decorator-D4YmxizW.js";import{x as d}from"./lit-element-C8zulti1.js";import{o as p}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const b={title:"Components/ThemeSwitcher",component:"modus-wc-theme-switcher",args:{"custom-class":void 0,"initial-theme":void 0},decorators:[i],parameters:{actions:{handles:["themeChange"]}}},l={render:e=>d`
<modus-wc-theme-provider .initialTheme=${e["initial-theme"]}>
  <modus-wc-theme-switcher
    aria-label="Theme toggle"
    custom-class=${p(e["custom-class"])}
  ></modus-wc-theme-switcher>
</modus-wc-theme-provider>
  `},t={...l},h={args:{theme:"modus-modern",mode:"light"},argTypes:{theme:{control:{type:"select"},options:["modus-modern","modus-classic"],description:"The theme to apply"},mode:{control:{type:"select"},options:["light","dark"],description:"The theme mode (light or dark)"}},render:e=>d`
    <modus-wc-theme-provider
