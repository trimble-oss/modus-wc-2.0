import{w as x}from"./decorator-Dt3Huotz.js";import{k as i}from"./lit-element-DVRzCIa_.js";import{t as a}from"./if-defined-1ipA9LQg.js";import"./v4-CQkTLCs1.js";const E={title:"Components/Chip",component:"modus-wc-chip",args:{label:"Chip","show-remove":!0,size:"md",variant:"filled"},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]},variant:{control:{type:"select"},options:["filled","outline"]}},decorators:[x],parameters:{actions:{handles:["chipClick","chipRemove"]}}},k={render:e=>i` <modus-wc-chip
...
}`,...(f=($=o.parameters)==null?void 0:$.docs)==null?void 0:f.source}}};var z,C,g;c.parameters={...c.parameters,docs:{...(z=c.parameters)==null?void 0:z.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| closeClick | chipRemove |       |
  ...
  render: () => html\`<div></div>\`
}`,...(g=(C=c.parameters)==null?void 0:C.docs)==null?void 0:g.source}}};const M=["Default","AvatarChip","CheckIconChip","Composable","Migration"];export{s as AvatarChip,n as CheckIconChip,o as Composable,r as Default,c as Migration,M as __namedExportsOrder,E as default};
