import{_ as F,b as c}from"./chunk-4XZ63LWV-CnYBn8W6.js";import{x as d}from"./lit-element-C8zulti1.js";import"./v4-CtRu48qb.js";const{definePreview:ce}=__STORYBOOK_MODULE_PREVIEW_API__,{global:D}=__STORYBOOK_MODULE_GLOBAL__;var G={};F(G,{argsEnhancers:()=>X,loaders:()=>ne});var K=(e,n)=>typeof n[e]>"u"&&!(e in n),Z=e=>{let{initialArgs:n,argTypes:a,id:s,parameters:{actions:r}}=e;if(!r||r.disable||!r.argTypesRegex||!a)return{};let o=new RegExp(r.argTypesRegex);return Object.entries(a).filter(([t])=>!!o.test(t)).reduce((t,[l,i])=>(K(l,n)&&(t[l]=c(l,{implicit:!0,id:s})),t),{})},Q=e=>{let{initialArgs:n,argTypes:a,parameters:{actions:s}}=e;return s!=null&&s.disable||!a?{}:Object.entries(a).filter(([r,o])=>!!o.action).reduce((r,[o,t])=>(K(o,n)&&(r[o]=c(typeof t.action=="string"?t.action:o)),r),{})},X=[Q,Z],y=!1,ee=e=>{let{parameters:{actions:n}}=e;if(!(n!=null&&n.disable)&&!y&&"__STORYBOOK_TEST_ON_MOCK_CALL__"in D&&typeof D.__STORYBOOK_TEST_ON_MOCK_CALL__=="function"){let a=D.__STORYBOOK_TEST_ON_MOCK_CALL__;a((s,r)=>{let o=s.getMockName();o!=="spy"&&(!/^next\/.*::/.test(o)||["next/router::useRouter()","next/navigation::useRouter()","next/navigation::redirect","next/cache::","next/headers::cookies().set","next/headers::cookies().delete","next/headers::headers().set","next/headers::headers().delete"].some(t=>o.startsWith(t)))&&c(o)(r)}),y=!0}},ne=[ee],S=Object.freeze,te=Object.defineProperty,u=(e,n)=>S(te(e,"raw",{value:S(n||e.slice())})),f,$,I,E,R,z;const ie={title:"Components/Table",component:"modus-wc-table",argTypes:{columns:{control:"object",description:"An array of column definitions.",table:{type:{detail:`
    ...
    `],[`
      ...
      <modus-wc-table
        ...
        @rowClick=`,`
      ></modus-wc-table>
    `])),n,a,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,c("rowClick"))},args:{density:"comfortable",hover:!0}},b={render:e=>{const n=e.columns||ae(),a=e.data||p();return d(I||(I=u([`
      <script>
        // Helper functions
        const createDemoColumns = (): ITableColumn[] => [
          {
    ...
    `],[`
      ...
      <modus-wc-table
        ...
        @sortChange=`,`
      ></modus-wc-table>
    `])),n,a,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,c("sortChange"))},args:{density:"comfortable",sortable:!0}},w={render:e=>{const n=e.columns||m(),a=e.data||p(15);return d(E||(E=u([`
      <script>
            // Helper functions
            const createDemoColumns = (): ITableColumn[] => [
              {
    ...
    `],[`
      ...
      <modus-wc-table
        ...
        @paginationChange=`,`
      ></modus-wc-table>
    `])),n,a,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,c("paginationChange"))},args:{density:"comfortable",paginated:!0,"show-page-size-selector":!0}},v={render:e=>{const n=e.columns||m(),a=e.data||p();return d(R||(R=u([`
      <script>
            // Helper functions
            const createDemoColumns = (): ITableColumn[] => [
              {
    ...
    `],[`
      ...
      <modus-wc-table
        ...
        @rowSelectionChange=`,`
      ></modus-wc-table>
    `])),n,a,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,c("rowSelectionChange"))},args:{density:"comfortable",selectable:"multi"}},C={render:e=>{const n=[{id:"id",header:"ID",accessor:"id",width:"20px"},{id:"name",header:"Name",accessor:"name",editor:"text"},{id:"status",header:"Status",accessor:"status",editor:"custom",customEditorRenderer:(s,r)=>{const o=document.createElement("div");o.style.width="100%";const t=document.createElement("modus-wc-autocomplete");t.items=[{label:"Active",value:"Active",visibleInMenu:!0},{label:"Inactive",value:"Inactive",visibleInMenu:!0},{label:"Pending",value:"Pending",visibleInMenu:!0}],t.value=s,t.style.width="100%";const l=i=>{r(i.detail.value)};return t.addEventListener("itemSelect",l),o.appendChild(t),setTimeout(()=>{const i=t.querySelector("input");i==null||i.focus()},0),o},cellRenderer:s=>{const o={Active:"green",Inactive:"gray",Pending:"blue"}[s]||"black",t=document.createElement("span");return t.textContent=s,t.style.color=o,t.style.fontWeight="bold",t}},{id:"dueDate",header:"Due Date",accessor:"dueDate",editor:"custom",customEditorRenderer:(s,r)=>{const o=document.createElement("div");o.style.width="100%";const t=document.createElement("modus-wc-date");t.value=s,t.style.width="100%",t.bordered=!1;const l=i=>{const Y=i.target;r(Y.value)};return t.addEventListener("change",l),o.appendChild(t),setTimeout(()=>{const i=t.querySelector("input");i==null||i.focus()},0),o},cellRenderer:s=>s?new Date(s).toLocaleDateString():"-"}],a=[{id:"1",name:"John Doe",status:"Active",dueDate:"2025-10-15"},{id:"2",name:"Jane Smith",status:"Inactive",dueDate:"2025-11-20"},{id:"3",name:"Bob Johnson",status:"Pending",dueDate:"2025-12-05"}];return d(z||(z=u([`
      <script>
                // Helper functions
                const createDemoColumns = (): ITableColumn[] => [
                  {
...
}`,...(T=(P=g.parameters)==null?void 0:P.docs)==null?void 0:T.source}}};var A,_,k;h.parameters={...h.parameters,docs:{...(A=h.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
    const data = args.data || createDemoData();
    return html\`
...
}`,...(k=(_=h.parameters)==null?void 0:_.docs)==null?void 0:k.source}}};var O,U,L;b.parameters={...b.parameters,docs:{...(O=b.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: args => {
...
}`,...(L=(U=b.parameters)==null?void 0:U.docs)==null?void 0:L.source}}};var M,N,H;w.parameters={...w.parameters,docs:{...(M=w.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
    const data = args.data || createDemoData(15);
    return html\`
...
}`,...(H=(N=w.parameters)==null?void 0:N.docs)==null?void 0:H.source}}};var B,J,j;v.parameters={...v.parameters,docs:{...(B=v.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
    const data = args.data || createDemoData();
    return html\`
...
}`,...(j=(J=v.parameters)==null?void 0:J.docs)==null?void 0:j.source}}};var q,V,W;C.parameters={...C.parameters,docs:{...(q=C.parameters)==null?void 0:q.docs,source:{originalSource:`{
  render: args => {
    const columns: ITableColumn[] = [{
      id: 'id',
      header: 'ID',
...
}`,...(W=(V=C.parameters)==null?void 0:V.docs)==null?void 0:W.source}}};const le=["Default","Hover","Sorting","Pagination","CheckBoxRowSelection","InlineEditing"];export{v as CheckBoxRowSelection,g as Default,h as Hover,C as InlineEditing,w as Pagination,b as Sorting,le as __namedExportsOrder,ie as default};
