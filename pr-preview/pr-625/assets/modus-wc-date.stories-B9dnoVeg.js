...
| valueError          |             | Not carried over |
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>o`<div></div>`};var d,i,s;r.parameters={...r.parameters,docs:{...(d=r.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: args => {
    return html\`
      <style>
        div[id^='story--components-forms-date--default--primary'] {
...
| valueError          |             | Not carried over |
  ...
  render: () => html\`<div></div>\`
}`,...(f=(p=t.parameters)==null?void 0:p.docs)==null?void 0:f.source}}};const x=["Default","WithErrorFeedback","Migration"];export{r as Default,t as Migration,n as WithErrorFeedback,x as __namedExportsOrder,w as default};
