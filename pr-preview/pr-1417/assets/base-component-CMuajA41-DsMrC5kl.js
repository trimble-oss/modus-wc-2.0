...
[data-theme=modus-modern-light] modus-wc-select:has(.modus-wc-select-xs) .modus-wc-input-label .modus-wc-input-label,
[data-theme=modus-modern-dark] modus-wc-select:has(.modus-wc-select-xs) .modus-wc-input-label .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-sm);
  line-height: 1.25rem;
}
...
[data-theme=modus-modern-light] modus-wc-select:has(.modus-wc-select-xl) .modus-wc-input-label .modus-wc-input-label,
[data-theme=modus-modern-dark] modus-wc-select:has(.modus-wc-select-xl) .modus-wc-input-label .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-xl);
  line-height: var(--modus-wc-line-height-lg);
}
...
[data-theme=modus-modern-light] modus-wc-text-input:has(.modus-wc-input-xs) .modus-wc-input-label .modus-wc-input-label,
[data-theme=modus-modern-dark] modus-wc-text-input:has(.modus-wc-input-xs) .modus-wc-input-label .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-sm);
  line-height: 1.25rem;
}
...
[data-theme=modus-modern-light] modus-wc-text-input:has(.modus-wc-input-xl) .modus-wc-input-label .modus-wc-input-label,
[data-theme=modus-modern-dark] modus-wc-text-input:has(.modus-wc-input-xl) .modus-wc-input-label .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-xl);
  line-height: var(--modus-wc-line-height-lg);
}
