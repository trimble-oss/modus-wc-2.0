import{w as M}from"./decorator-D4YmxizW.js";import{x as n}from"./lit-element-C8zulti1.js";import{o as t}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var u=Object.freeze,_=Object.defineProperty,k=(e,l)=>u(_(e,"raw",{value:u(e.slice())})),g;const J={title:"Components/Tabs",component:"modus-wc-tabs",args:{size:"md",tabs:[{label:"Tab 1"},{label:"Tab 2"},{label:"Tab 3",disabled:!0},{icon:"home"}],"tab-style":"bordered"},argTypes:{tabs:{description:"Array of tab objects defining the tabs to display",table:{type:{detail:`
            Interface: ITab
            Properties:
          ...
          `}}},"tab-style":{control:{type:"select"},options:["boxed","bordered","lifted","none"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[M],parameters:{actions:{handles:["tabChange"]}}},d=e=>n(g||(g=k([`
  <script>
    //   // This is to show how to set tabs via script
    //  const tabElement = document.querySelector('modus-wc-tabs');
    //  tabElement.tabs = `,`;
  <\/script>
`])),JSON.stringify(e)),b={render:e=>n`
<modus-wc-tabs
...
${d(e.tabs)}
    `},a={...b},s={args:{tabs:[{icon:"home",iconPosition:"left",label:"Home",slotName:"home-tab-content"},{icon:"clipboard",iconPosition:"right",label:"Tasks"},{slotName:"actions-tab-content"},{slotName:"notifications-tab-content"}]},parameters:{docs:{description:{story:"Tabs now include slots, offering a flexible approach for users to add relevant components within the tab for more complex use cases."}}},render:e=>{var l,m,p;return n`
    <style>
      .red-icon {
        color: red;
      }
    ...
    >
      ...
      >
        <modus-wc-badge
          ...
          size="${t(e.size)}"
          variant="filled"
          disabled="${((l=e.tabs[0])==null?void 0:l.disabled)===!0}"
        >
    ...
    ${d(e.tabs)}
  `}},o={...b,args:{activeTabIndex:1,tabs:[{label:"Normal"},{label:"Active"},{label:"Disabled",disabled:!0}]}},i={...b,args:{tabs:[{icon:"home"},{icon:"settings",iconPosition:"left",label:"Settings"},{icon:"alert",iconPosition:"right",label:"Alerts"}]}},r={render:e=>n`
<modus-wc-tabs
  active-tab-index="${t(e.activeTabIndex)}"
  aria-label="Tab group"
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>n`<div></div>`};var f,h,w;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  ...Template
}`,...(w=(h=a.parameters)==null?void 0:h.docs)==null?void 0:w.source}}};var v,y,T;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    tabs: [{
      icon: 'home',
      iconPosition: 'left',
...
}`,...(T=(y=s.parameters)==null?void 0:y.docs)==null?void 0:T.source}}};var x,$,z;o.parameters={...o.parameters,docs:{...(x=o.parameters)==null?void 0:x.docs,source:{originalSource:`{
  ...Template,
  args: {
    activeTabIndex: 1,
    tabs: [{
...
}`,...(z=($=o.parameters)==null?void 0:$.docs)==null?void 0:z.source}}};var I,S,C;i.parameters={...i.parameters,docs:{...(I=i.parameters)==null?void 0:I.docs,source:{originalSource:`{
  ...Template,
  args: {
    tabs: [{
      icon: 'home'
...
}`,...(C=(S=i.parameters)==null?void 0:S.docs)==null?void 0:C.source}}};var P,N,D;r.parameters={...r.parameters,docs:{...(P=r.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: args => {
    // prettier-ignore
    return html\`
<modus-wc-tabs
...
}`,...(D=(N=r.parameters)==null?void 0:N.docs)==null?void 0:D.source}}};var A,j,E;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(E=(j=c.parameters)==null?void 0:j.docs)==null?void 0:E.source}}};const F=["Default","CustomContent","ActiveAndDisabled","Icons","TabsWithPanel","Migration"];export{o as ActiveAndDisabled,s as CustomContent,a as Default,i as Icons,c as Migration,r as TabsWithPanel,F as __namedExportsOrder,J as default};
