import{w as E}from"./decorator-D4YmxizW.js";import{x as n}from"./lit-element-C8zulti1.js";import{o as t}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const W={title:"Components/Tabs",component:"modus-wc-tabs",args:{size:"md",tabs:[{label:"Tab 1"},{label:"Tab 2"},{label:"Tab 3",disabled:!0},{icon:"home"}],"tab-style":"bordered"},argTypes:{tabs:{description:"Array of tab objects defining the tabs to display",table:{type:{detail:`
            Interface: ITab
            Properties:
          ...
          `}}},"tab-style":{control:{type:"select"},options:["boxed","bordered","lifted","none"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[E],parameters:{actions:{handles:["tabChange"]}}},l=e=>n`
  <script>
   
    // // This is to show how to set tabs via script
    // const tabElement = document.querySelector('modus-wc-tabs');
    // tabElement.tabs = ${JSON.stringify(e)};
...
${l(e.tabs)}
    `},a={...d},s={args:{tabs:[{icon:"home",iconPosition:"left",label:"Home",slotName:"home-tab-content"},{icon:"clipboard",iconPosition:"right",label:"Tasks"},{slotName:"actions-tab-content"},{slotName:"notifications-tab-content"}]},parameters:{docs:{description:{story:"Tabs now include slots, offering a flexible approach for users to add relevant components within the tab for more complex use cases."}}},render:e=>{var b,m,p;return n`
    <style>
      .red-icon {
        color: red;
      }
    ...
    >
      ...
      >
        <modus-wc-badge
          ...
          size="${t(e.size)}"
          variant="filled"
          disabled="${((b=e.tabs[0])==null?void 0:b.disabled)===!0}"
        >
    ...
    ${l(e.tabs)}
  `}},o={...d,args:{activeTabIndex:1,tabs:[{label:"Normal"},{label:"Active"},{label:"Disabled",disabled:!0}]}},i={...d,args:{tabs:[{icon:"home"},{icon:"settings",iconPosition:"left",label:"Settings"},{icon:"alert",iconPosition:"right",label:"Alerts"}]}},r={render:e=>n`
<modus-wc-tabs
  active-tab-index="${t(e.activeTabIndex)}"
  aria-label="Tab group"
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>n`<div></div>`};var u,g,f;a.parameters={...a.parameters,docs:{...(u=a.parameters)==null?void 0:u.docs,source:{originalSource:`{
  ...Template
}`,...(f=(g=a.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var h,w,v;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    tabs: [{
      icon: 'home',
      iconPosition: 'left',
...
}`,...(v=(w=s.parameters)==null?void 0:w.docs)==null?void 0:v.source}}};var y,T,$;o.parameters={...o.parameters,docs:{...(y=o.parameters)==null?void 0:y.docs,source:{originalSource:`{
  ...Template,
  args: {
    activeTabIndex: 1,
    tabs: [{
...
}`,...($=(T=o.parameters)==null?void 0:T.docs)==null?void 0:$.source}}};var x,z,I;i.parameters={...i.parameters,docs:{...(x=i.parameters)==null?void 0:x.docs,source:{originalSource:`{
  ...Template,
  args: {
    tabs: [{
      icon: 'home'
...
}`,...(I=(z=i.parameters)==null?void 0:z.docs)==null?void 0:I.source}}};var S,C,N;r.parameters={...r.parameters,docs:{...(S=r.parameters)==null?void 0:S.docs,source:{originalSource:`{
  render: args => {
    // prettier-ignore
    return html\`
<modus-wc-tabs
...
}`,...(N=(C=r.parameters)==null?void 0:C.docs)==null?void 0:N.source}}};var P,D,A;c.parameters={...c.parameters,docs:{...(P=c.parameters)==null?void 0:P.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(A=(D=c.parameters)==null?void 0:D.docs)==null?void 0:A.source}}};const B=["Default","CustomContent","ActiveAndDisabled","Icons","TabsWithPanel","Migration"];export{o as ActiveAndDisabled,s as CustomContent,a as Default,i as Icons,c as Migration,r as TabsWithPanel,B as __namedExportsOrder,W as default};
