import{w as q}from"./decorator-534da2b0.js";import{b as i}from"./lit-element-38260dd9.js";import{o as t}from"./if-defined-30b85b98.js";import{c as N}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";const D={title:"Components/Forms/Number Input",component:"modus-wc-number-input",args:{bordered:!0,disabled:!1,inputmode:"numeric",label:"Label",size:"md",type:"number",value:""},argTypes:{"auto-complete":{control:{type:"select"},options:["on","off"]},feedback:{description:"Feedback prop for input components",table:{type:{detail:`
...
<\/script>`}}}},l={render:e=>{if(!customElements.get("number-input-shadow-host")){const S=N({componentTag:"modus-wc-number-input",propsMapper:(n,C)=>{const r=C;r.autoComplete=n["auto-complete"]??"",r.bordered=Boolean(n.bordered),r.currencySymbol=n["currency-symbol"]??"",r.customClass=n["custom-class"]||"",r.disabled=Boolean(n.disabled),r.inputId=n["input-id"]??"",r.inputTabIndex=n["input-tab-index"]??0,r.label=n.label??"",r.max=n.max??0,r.min=n.min??0,r.name=n.name??"",r.placeholder=n.placeholder??"",r.readOnly=Boolean(n["read-only"]),r.required=Boolean(n.required),r.size=n.size??"",r.step=n.step??1,r.type=n.type??"",r.value=n.value}});customElements.define("number-input-shadow-host",S)}return i`<number-input-shadow-host
