...
<\/script>
    ...
    `])),e["apps-menu-open"],e.condensed,e["condensed-menu-open"],n(e["custom-class"]),e["main-menu-open"],e["notifications-menu-open"],n(e["search-debounce-ms"]),e["search-input-open"],n(e["text-overrides"]),e["user-card"],e["user-menu-open"],e.visibility,e["logo-name"])},s={...A},t={render:e=>{function r(C){var c;const i=(c=C.currentTarget.parentElement)==null?void 0:c.querySelector("#custom-user-menu");i==null||i.classList.toggle("hidden")}return a(m||(m=y([`
  ...
  ...Template
}`,...(v=(p=s.parameters)==null?void 0:p.docs)==null?void 0:v.source}}};var b,f,g;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: args => {
