...
<div class="value">
  ...
  <span id="selected-value"></span>
    ...
    `])),n(e["button-aria-label"]),n(e["button-color"]),n(e["button-shape"]),n(e["button-size"]),n(e["button-variant"]),n(e["custom-class"]),e.disabled,e["menu-bordered"],n(e["menu-offset"]),n(e["menu-placement"]),n(e["menu-size"]),n(e["menu-strategy"]),e["menu-visible"],t,t,t)}},u={...L},m={render:()=>p`
<style>
  /* Storybook styling */
...
}`,...(B=(A=c.parameters)==null?void 0:A.docs)==null?void 0:B.source}}};const F=["Default","IconOnlyDropdownMenu","WithTreeView","ShadowDomParent"];export{u as Default,m as IconOnlyDropdownMenu,c as ShadowDomParent,i as WithTreeView,F as __namedExportsOrder,U as default};
