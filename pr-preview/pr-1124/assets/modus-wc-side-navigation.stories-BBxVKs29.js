import{w as fe}from"./decorator-D4YmxizW.js";import{b as y,A as ye}from"./lit-element-DgBvYnzn.js";import{o as b}from"./if-defined-BnVFTJ4o.js";import{n as H}from"./ref-Bw8asrgi.js";import{c as Se}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";import"./directive-helpers-BZ4DLK7w.js";import"./directive-C_Rw-dL6.js";const Ce="1.15.0",se=`https://resources.connect.trimble.com/${Ce}/fonts/icon-font.min.css`,c=(e,t="",n="")=>["icon-font",e,n,t].filter(Boolean).join(" "),r={allProjects:"tc-icon-arrow-line-back",data:"tc-icon-layers",explorer:"tc-icon-explorer",folder:"tc-icon-folder",chevronRight:"tc-icon-chevron-right",views:"tc-icon-views",releases:"tc-icon-release",activity:"tc-icon-activity",bcfTopics:"tc-icon-bcf",fieldData:"tc-icon-fixed-point"},g="modus-wc-tree-item-end-action",q="modus-wc-tree-item-end-action-dropdown",F="modus-wc-tree-item-end-action-icon",E="data-flyout-dropdown",ie=new Set(["connect-light","connect-dark"]),xe=()=>{if(typeof document>"u")return null;const e=document.documentElement.getAttribute("data-theme");if(e&&ie.has(e))return e;const t=document.querySelector('[data-theme="connect-light"], [data-theme="connect-dark"]');return(t==null?void 0:t.getAttribute("data-theme"))??null},v=e=>{const t=xe();return t!==null&&ie.has(t)},ce="15rem",Ee=`
...
`),De=220,ve=e=>{e.flyoutOpenTimer&&(clearTimeout(e.flyoutOpenTimer),e.flyoutOpenTimer=null),e.collapseFlyoutTimer&&(clearTimeout(e.collapseFlyoutTimer),e.collapseFlyoutTimer=null)},L=e=>{ve(e),e.dataIconDropdown&&(e.dataIconDropdown.menuVisible=!1)},T=(e,t)=>{e.dataIconDropdown&&(e.dataIconDropdown.disabled=t)},Oe=e=>{if(!e.dataIconDropdown)return;const t=e.dataIconDropdown.closest("modus-wc-side-navigation"),n=t==null?void 0:t.querySelector(".modus-wc-side-navigation"),o=e.dataIconDropdown.querySelector("modus-wc-button");if(!n||!o)return;const s=n.getBoundingClientRect(),u=o.getBoundingClientRect(),d=e.dataIconDropdown.getBoundingClientRect(),m=Math.max(u.right,d.right),f=Math.round(s.right-m+Te);e.dataIconDropdown.menuOffset=f},V=(e,t=!1)=>{if(!v())return;ve(e);const n=()=>{e.flyoutOpenTimer=null,e.dataIconDropdown&&(Oe(e),e.dataIconDropdown.menuVisible=!0)};t?e.flyoutOpenTimer=setTimeout(n,0):n()},Ae=e=>{const t=e.querySelector(".modus-wc-menu-dropdown"),n=e.querySelector(":scope > li");if(!t||!n)return;t.classList.remove("modus-wc-menu-dropdown-show"),n.classList.remove("modus-wc-menu-item-expanded"),n.classList.remove("modus-wc-menu-dropdown-show");const o=e;o&&"isExpanded"in o&&(o.isExpanded=!1)},Me=e=>{const t=e.querySelector(".modus-wc-menu-dropdown"),n=e.querySelector(":scope > li");if(!t||!n||t.classList.contains("modus-wc-menu-dropdown-show"))return;t.classList.add("modus-wc-menu-dropdown-show"),n.classList.add("modus-wc-menu-item-expanded"),n.classList.add("modus-wc-menu-dropdown-show");const o=e;o&&"isExpanded"in o&&(o.isExpanded=!0)},be=e=>{const t=Array.from(e.querySelectorAll("modus-wc-tree-item"));for(const n of t)if(n.selected)return n;return null},$e=e=>{const t=be(e);return t?t.getAttribute("value")==="data"?!0:!!t.closest('modus-wc-tree-item[value="data"] modus-wc-tree-view'):!1},_e=e=>{var t;return((t=be(e))==null?void 0:t.getAttribute("value"))==="data"},ke=e=>{e.querySelectorAll("modus-wc-tree-item").forEach(t=>{const n=t;n.hasSubmenu&&typeof n.collapseSubmenu=="function"&&n.collapseSubmenu()})},Fe=(e,t,n)=>{e.detail||(n.set(!0),ke(t))},Le=(e,t,n,o)=>{L(n);const s=t.querySelectorAll("modus-wc-tree-item");if(e.detail){if(T(n,!0),s.forEach(u=>{const d=u;d.hasSubmenu&&(d.blockExpand=!1)}),$e(t)){const u=t.querySelector('modus-wc-tree-item[value="data"]');u&&setTimeout(()=>Me(u),0)}}else o.set(!0),T(n,!1),s.forEach(u=>{const d=u;d.hasSubmenu&&(d.blockExpand=!0,Ae(u),typeof d.collapseSubmenu=="function"&&d.collapseSubmenu())}),_e(t)&&(n.collapseFlyoutTimer=setTimeout(()=>{n.collapseFlyoutTimer=null,V(n)},De))},Ve=(e,t)=>{if(t.get()&&e.detail){t.set(!1);return}t.set(!1);const n=e.target,o=n==null?void 0:n.closest(".layout-with-navbar"),s=o?o.querySelector("modus-wc-side-navigation"):document.querySelector("modus-wc-side-navigation");s&&(s.expanded=e.detail)},qe=e=>{L(e),T(e,!0),document.querySelectorAll("modus-wc-side-navigation.side-navigation modus-wc-tree-item").forEach(t=>{const n=t;n.hasSubmenu&&(n.blockExpand=!1)})},Re=()=>`
...
<\/script>
`;var W=Object.freeze,ze=Object.defineProperty,ge=(e,t)=>W(ze(e,"raw",{value:W(e.slice())})),P,j;const Ke={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[fe],parameters:{layout:"padded",actions:{handles:["expandedChange","itemSelect"]}}},M={render:e=>{const t=n=>{const o=n.target,s=o==null?void 0:o.closest(".layout-with-navbar");let u;s?u=s.querySelector("modus-wc-side-navigation"):u=document.querySelector("modus-wc-side-navigation"),u&&(u.expanded=n.detail)};return y(P||(P=ge([`
      <style>
        .layout-with-navbar {
          display: flex;
      ...
      <\/script>
    `])),t,{avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},{ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],b(e["custom-class"]),e.expanded,e["max-width"],b(e.mode),b(e["target-content"]))}},$={render:e=>{const t=o=>{const s=o.target,u=s==null?void 0:s.closest(".layout-with-navbar");let d;if(u&&(d=u.querySelector("modus-wc-side-navigation"),d)){const m=d;m.expanded=o.detail}},n=o=>{o.detail||o.target.querySelectorAll("modus-wc-menu-item").forEach(d=>{const m=d;m.hasSubmenu&&typeof m.collapseSubmenu=="function"&&m.collapseSubmenu()})};return y(j||(j=ge([`
      <style>
        .layout-with-navbar {
...
}`,...(ae=(oe=k.parameters)==null?void 0:oe.docs)==null?void 0:ae.source}}};const Qe=["Default","WithSubmenu","WithTreeView","ShadowDomParent"];export{M as Default,k as ShadowDomParent,$ as WithSubmenu,_ as WithTreeView,Qe as __namedExportsOrder,Ke as default};
