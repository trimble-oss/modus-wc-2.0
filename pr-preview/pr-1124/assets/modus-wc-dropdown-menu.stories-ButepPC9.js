import{w as V}from"./decorator-D4YmxizW.js";import{b as v}from"./lit-element-DgBvYnzn.js";import{o as l}from"./if-defined-BnVFTJ4o.js";import{c as T}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var f=Object.freeze,O=Object.defineProperty,_=(e,d)=>f(O(e,"raw",{value:f(e.slice())})),S;const N={title:"Components/Dropdown Menu",component:"modus-wc-dropdown-menu",args:{"button-aria-label":"Dropdown menu button","button-color":"primary","button-shape":"rectangle","button-size":"md","button-variant":"filled",disabled:!1,"menu-bordered":!0,"menu-offset":14,"menu-placement":"bottom-start","menu-size":"md","menu-strategy":"absolute","menu-visible":!1},argTypes:{"button-color":{control:{type:"select"},options:["primary","secondary","tertiary","warning","danger"]},"button-size":{control:{type:"select"},options:["xs","sm","md","lg","xl"]},"button-shape":{control:{type:"select"},options:["circle","ellipse","rectangle","square"]},"button-variant":{control:{type:"select"},options:["borderless","filled","outlined"]},"menu-placement":{control:{type:"select"},options:["top","top-start","top-end","bottom","bottom-start","bottom-end","left","left-start","left-end","right","right-start","right-end"]},"menu-size":{control:{type:"select"},options:["sm","md","lg"]},"menu-strategy":{control:{type:"select"},options:["absolute","fixed"]}},decorators:[V],parameters:{actions:{handles:["menuVisibilityChange"]}}},B={render:e=>{let d="";const n=o=>{d=o.detail.value;const t=document.querySelector("#selected-value");t&&(t.textContent=d);const a=o.target.closest("modus-wc-dropdown-menu");a&&(a.menuVisible=!1)};return v(S||(S=_([`
<style>
  /* Storybook styling */
...
<div class="value">
  ...
  <span id="selected-value"></span>
    ...
    `])),l(e["button-aria-label"]),l(e["button-color"]),l(e["button-shape"]),l(e["button-size"]),l(e["button-variant"]),l(e["custom-class"]),e.disabled,e["menu-bordered"],l(e["menu-offset"]),l(e["menu-placement"]),l(e["menu-size"]),l(e["menu-strategy"]),e["menu-visible"],n,n,n)}},r={...B},m={render:()=>v`
<style>
  /* Storybook styling */
