import{w as A}from"./decorator-D4YmxizW.js";import{b as m}from"./lit-element-DgBvYnzn.js";import{o}from"./if-defined-BnVFTJ4o.js";import{n as D}from"./ref-DbcCaYnB.js";import{c as q}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";import"./directive-helpers-BZ4DLK7w.js";import"./directive-C_Rw-dL6.js";var d=Object.freeze,L=Object.defineProperty,j=(e,u)=>d(L(e,"raw",{value:d(e.slice())})),b;const J={title:"Components/Menu",component:"modus-wc-menu",args:{orientation:"vertical","selection-mode":"single",size:"md"},argTypes:{orientation:{control:{type:"select"},options:["horizontal","vertical"]},"selection-mode":{control:{type:"select"},options:["single","multiple"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[A],parameters:{actions:{handles:["menuFocusout","menuSelectionChange","itemSelect"]}}},i={render:e=>m`
<modus-wc-menu
  aria-label="Menu"
  ?bordered=${e.bordered}
