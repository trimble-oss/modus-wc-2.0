import{w as te}from"./decorator-D4YmxizW.js";import{b as $}from"./lit-element-DgBvYnzn.js";import{o as g}from"./if-defined-BnVFTJ4o.js";import{n as L}from"./ref-DbcCaYnB.js";import{c as ne}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";import"./directive-helpers-BZ4DLK7w.js";import"./directive-C_Rw-dL6.js";const oe="1.15.0",ae=`https://resources.connect.trimble.com/${oe}/fonts/icon-font.min.css`,m=(e,a="",i="")=>["icon-font",e,i,a].filter(Boolean).join(" "),p={allProjects:"tc-icon-arrow-line-back",data:"tc-icon-layers",explorer:"tc-icon-explorer",folder:"tc-icon-folder",chevronRight:"tc-icon-chevron-right",views:"tc-icon-views",releases:"tc-icon-release",activity:"tc-icon-activity",bcfTopics:"tc-icon-bcf",fieldData:"tc-icon-fixed-point"},b="modus-wc-tree-item-end-action",Z="modus-wc-tree-item-end-action-dropdown",R="modus-wc-tree-item-end-action-icon",ie=`
...
`;var H=Object.freeze,se=Object.defineProperty,ee=(e,a)=>H(se(e,"raw",{value:H(e.slice())})),z,j;const ve={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[te],parameters:{layout:"padded",actions:{handles:["expandedChange","itemSelect"]}}},T={render:e=>{const a=i=>{const n=i.target,c=n==null?void 0:n.closest(".layout-with-navbar");let d;c?d=c.querySelector("modus-wc-side-navigation"):d=document.querySelector("modus-wc-side-navigation"),d&&(d.expanded=i.detail)};return $(z||(z=ee([`
      <style>
        .layout-with-navbar {
          display: flex;
      ...
      <\/script>
    `])),a,{avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},{ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],g(e["custom-class"]),e.expanded,e["max-width"],g(e.mode),g(e["target-content"]))}},k={render:e=>{const a=n=>{const c=n.target,d=c==null?void 0:c.closest(".layout-with-navbar");let w;if(d&&(w=d.querySelector("modus-wc-side-navigation"),w)){const l=w;l.expanded=n.detail}},i=n=>{n.detail||n.target.querySelectorAll("modus-wc-menu-item").forEach(w=>{const l=w;l.hasSubmenu&&typeof l.collapseSubmenu=="function"&&l.collapseSubmenu()})};return $(j||(j=ee([`
      <style>
        .layout-with-navbar {
      ...
      <script>
        ...
        //
      <\/script>
    `])),a,{avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},{ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],g(e["custom-class"]),e.expanded,e["max-width"],g(e.mode),g(e["target-content"]),i,!0,!0,!0,!0)}},M={args:{expanded:!0},render:e=>{let a=null,i=null,n=null,c=null;const d=()=>{a&&(a.style.display="none")},w=o=>{const t=o.target,s=t==null?void 0:t.closest(".layout-with-navbar"),u=s?s.querySelector("modus-wc-side-navigation"):document.querySelector("modus-wc-side-navigation");u&&(u.expanded=o.detail)},l=o=>{d(),o.target.querySelectorAll("modus-wc-tree-item").forEach(u=>{const r=u;r.hasSubmenu&&(r.blockExpand=!o.detail,!o.detail&&typeof r.collapseSubmenu=="function"&&r.collapseSubmenu())})},S=o=>{if(!a||!i)return;const t=o.querySelector("modus-wc-tree-view");if(!t)return;const s=t.querySelector("ul");if(!s)return;n=o,i.innerHTML="",Array.from(s.querySelectorAll(":scope > modus-wc-tree-item")).forEach(h=>{const C=h.querySelector(":scope > li");if(!C)return;const I=C.cloneNode(!0),q=h.getAttribute("value");q&&I.setAttribute("data-value",q),I.querySelectorAll('[slot="end"]').forEach(v=>v.remove()),Array.from(I.querySelectorAll("modus-wc-icon, modus-wc-button, modus-wc-checkbox")).reverse().forEach(v=>{const D=v.parentNode,A=document.createElement("span");A.className=v.className,v.hasAttribute("slot")&&A.setAttribute("slot",v.getAttribute("slot")),Array.from(v.childNodes).filter(_=>_.nodeType!==Node.COMMENT_NODE).forEach(_=>A.appendChild(_)),D.insertBefore(A,v),D.removeChild(v)}),i.appendChild(I)});const r=(o.querySelector(".modus-wc-menu-item-interactive")||o).getBoundingClientRect();a.style.top=`${r.top+window.scrollY}px`,a.style.left=`${r.right+window.scrollX+4}px`,a.style.display="block"},f=o=>{const t=o.target.closest("modus-wc-tree-item");if(!t)return;const s=t.closest("modus-wc-side-navigation");!s||s.expanded||!t.querySelector("modus-wc-tree-view")||S(t)},N=o=>{console.log("Action:",o.detail.value);const t=o.target.closest("modus-wc-dropdown-menu");t&&(t.menuVisible=!1)};let E=!1;const y=o=>{!o||E||(E=!0,requestAnimationFrame(()=>{const t=o.querySelector(".modus-wc-menu-item-interactive");t==null||t.click()}))},x=o=>{o&&(a=o,i=a.querySelector("ul"),i==null||i.addEventListener("click",t=>{const s=t.target.closest("[data-value]");if(!s||!n)return;const u=s.getAttribute("data-value");if(!u)return;const r=n.closest("modus-wc-side-navigation"),h=r==null?void 0:r.querySelector(`modus-wc-tree-item[value="${u}"]`);if(h){const C=h.querySelector(".modus-wc-menu-item-interactive");C==null||C.click()}d()}),c||(c=t=>{const s=t.target;if((a==null?void 0:a.style.display)!=="block"||a.contains(s))return;const u=s instanceof Element?s.closest("modus-wc-tree-item"):null;u&&u===n||d()},document.addEventListener("click",c)))};return $`
                      ...
                      >
                        ...
                        >
                          <modus-wc-icon
                            ...
                            name=""
                            size="sm"
                            custom-class=${m(p.folder,R,"i16")}
                          ></modus-wc-icon>
                          <modus-wc-icon
                            aria-label="Open submenu icon"
                            name=""
                            size="sm"
                            custom-class=${m(p.chevronRight,R,"i16")}
                          ></modus-wc-icon>
                        </div>
                        <modus-wc-menu-item
                          slot="menu"
    ...
    `}},O={render:e=>{if(!customElements.get("side-navigation-shadow-host")){const a=ne({componentTag:"modus-wc-side-navigation",propsMapper:(i,n)=>{const c=n;if(c.customClass=i["custom-class"]||"",c.expanded=!!i.expanded,c.maxWidth=i["max-width"]||"256px",c.collapseOnClickOutside=!!i["collapse-on-click-outside"],c.mode=i.mode||"overlay",c.targetContent=i["target-content"]||"",!n.hasAttribute("data-layout-built")){n.setAttribute("data-layout-built","");const d=n.getRootNode(),w=n.parentElement;n.className="side-navigation",n.style.cssText="height: 500px; align-self: flex-start; position: relative;";const l=document.createElement("modus-wc-navbar");l.setAttribute("style","z-index: 2;"),l.className="navbar",l.userCard={avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},l.visibility={ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0};const S=document.createElement("modus-wc-menu");S.setAttribute("size","lg"),[{label:"home",icon:"home",selected:!0},{label:"profile",icon:"person",selected:!1},{label:"settings",icon:"gears",selected:!1}].forEach(({label:t,icon:s,selected:u})=>{const r=document.createElement("modus-wc-menu-item");r.setAttribute("label",t),u&&r.setAttribute("selected","");const h=document.createElement("modus-wc-icon");h.setAttribute("slot","start-icon"),h.setAttribute("name",s),r.appendChild(h),S.appendChild(r)}),n.appendChild(S),l.addEventListener("mainMenuOpenChange",t=>{const s=t;n.expanded=s.detail});const f=document.createElement("div");f.className="panel-content";const N=document.createElement("p");N.textContent="The side navigation of an application provides context through accessible menu options and positions a consistent component to connect to various pages in the application.";const E=document.createElement("p");E.textContent=`The side navigation is a collapsible side content of the site's pages. It is located alongside the page's primary content. The component is designed to add side content to a fullscreen application. It is activated through the "hamburger" menu in the Navbar.`,f.appendChild(N),f.appendChild(E);const y=document.createElement("div");y.className="main-content-row",y.appendChild(n),y.appendChild(f);const x=document.createElement("div");x.className="layout-with-navbar",x.appendChild(l),x.appendChild(y),w.appendChild(x);const o=document.createElement("style");o.textContent=`
                .layout-with-navbar {
                  display: flex;
                  flex-direction: column;
                  height: 100%;
              ...
              `,d.appendChild(o)}}});customElements.define("side-navigation-shadow-host",a)}return $`<side-navigation-shadow-host
      .props=${{...e}}
    ></side-navigation-shadow-host>`}};var F,V,U;T.parameters={...T.parameters,docs:{...(F=T.parameters)==null?void 0:F.docs,source:{originalSource:`{
  render: args => {
...
}`,...(U=(V=T.parameters)==null?void 0:V.docs)==null?void 0:U.source}}};var P,B,W;k.parameters={...k.parameters,docs:{...(P=k.parameters)==null?void 0:P.docs,source:{originalSource:`{
  render: args => {
    const handleMenuOpenChange = (e: CustomEvent) => {
      const eventSource = e.target as HTMLElement;
      const storyContainer = eventSource?.closest('.layout-with-navbar');
...
}`,...(W=(B=k.parameters)==null?void 0:B.docs)==null?void 0:W.source}}};var X,J,Y;M.parameters={...M.parameters,docs:{...(X=M.parameters)==null?void 0:X.docs,source:{originalSource:`{
  args: {
    expanded: true
  },
  render: args => {
...
}`,...(Y=(J=M.parameters)==null?void 0:J.docs)==null?void 0:Y.source}}};var K,G,Q;O.parameters={...O.parameters,docs:{...(K=O.parameters)==null?void 0:K.docs,source:{originalSource:`{
  render: args => {
...
}`,...(Q=(G=O.parameters)==null?void 0:G.docs)==null?void 0:Q.source}}};const ge=["Default","WithSubmenu","WithTreeView","ShadowDomParent"];export{T as Default,O as ShadowDomParent,k as WithSubmenu,M as WithTreeView,ge as __namedExportsOrder,ve as default};
