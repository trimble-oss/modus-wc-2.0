import{w as ye}from"./decorator-D4YmxizW.js";import{b as y,A as Se}from"./lit-element-DgBvYnzn.js";import{o as b}from"./if-defined-BnVFTJ4o.js";import{n as H}from"./ref-Bw8asrgi.js";import{c as Ce}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";import"./directive-helpers-BZ4DLK7w.js";import"./directive-C_Rw-dL6.js";const xe="1.15.0",se=`https://resources.connect.trimble.com/${xe}/fonts/icon-font.min.css`,c=(e,t="",n="")=>["icon-font",e,n,t].filter(Boolean).join(" "),r={allProjects:"tc-icon-arrow-line-back",data:"tc-icon-layers",explorer:"tc-icon-explorer",folder:"tc-icon-folder",chevronRight:"tc-icon-chevron-right",views:"tc-icon-views",releases:"tc-icon-release",activity:"tc-icon-activity",bcfTopics:"tc-icon-bcf",fieldData:"tc-icon-fixed-point"},g="modus-wc-tree-item-end-action",R="modus-wc-tree-item-end-action-dropdown",k="modus-wc-tree-item-end-action-icon",E="data-flyout-dropdown",ie=new Set(["connect-light","connect-dark"]),Ee=()=>{if(typeof document>"u")return null;const e=document.documentElement.getAttribute("data-theme");if(e&&ie.has(e))return e;const t=document.querySelector('[data-theme="connect-light"], [data-theme="connect-dark"]');return(t==null?void 0:t.getAttribute("data-theme"))??null},v=e=>{const t=Ee();return t!==null&&ie.has(t)},Te="15rem",ce=0,re=4,Ne=`
...
`),ve=220,be=e=>{e.flyoutOpenTimer&&(clearTimeout(e.flyoutOpenTimer),e.flyoutOpenTimer=null),e.collapseFlyoutTimer&&(clearTimeout(e.collapseFlyoutTimer),e.collapseFlyoutTimer=null)},L=e=>{be(e),e.dataIconDropdown&&(e.dataIconDropdown.menuVisible=!1)},T=(e,t)=>{e.dataIconDropdown&&(e.dataIconDropdown.disabled=t)},De=e=>{if(!e.dataIconDropdown)return;const t=e.dataIconDropdown.closest("modus-wc-side-navigation"),n=t==null?void 0:t.querySelector(".modus-wc-side-navigation"),o=e.dataIconDropdown.querySelector("modus-wc-button");if(!n||!o)return;const s=n.getBoundingClientRect(),u=o.getBoundingClientRect(),d=e.dataIconDropdown.getBoundingClientRect(),m=Math.max(u.right,d.right),f=Math.round(s.right-m+ce);e.dataIconDropdown.menuOffset=f},V=(e,t=!1)=>{if(!v())return;be(e);const n=()=>{e.flyoutOpenTimer=null,e.dataIconDropdown&&(De(e),e.dataIconDropdown.menuVisible=!0)};t?e.flyoutOpenTimer=setTimeout(n,0):n()},Oe=e=>{const t=e.querySelector(".modus-wc-menu-dropdown"),n=e.querySelector(":scope > li");if(!t||!n)return;t.classList.remove("modus-wc-menu-dropdown-show"),n.classList.remove("modus-wc-menu-item-expanded"),n.classList.remove("modus-wc-menu-dropdown-show");const o=e;o&&"isExpanded"in o&&(o.isExpanded=!1)},Ae=e=>{const t=e.querySelector(".modus-wc-menu-dropdown"),n=e.querySelector(":scope > li");if(!t||!n||t.classList.contains("modus-wc-menu-dropdown-show"))return;t.classList.add("modus-wc-menu-dropdown-show"),n.classList.add("modus-wc-menu-item-expanded"),n.classList.add("modus-wc-menu-dropdown-show");const o=e;o&&"isExpanded"in o&&(o.isExpanded=!0)},ge=e=>{const t=Array.from(e.querySelectorAll("modus-wc-tree-item"));for(const n of t)if(n.selected)return n;return null},Me=e=>{const t=ge(e);return t?t.getAttribute("value")==="data"?!0:!!t.closest('modus-wc-tree-item[value="data"] modus-wc-tree-view'):!1},$e=e=>{var t;return((t=ge(e))==null?void 0:t.getAttribute("value"))==="data"},_e=e=>{e.querySelectorAll("modus-wc-tree-item").forEach(t=>{const n=t;n.hasSubmenu&&typeof n.collapseSubmenu=="function"&&n.collapseSubmenu()})},Fe=(e,t,n)=>{e.detail||(n.set(!0),_e(t))},ke=(e,t,n,o)=>{L(n);const s=t.querySelectorAll("modus-wc-tree-item");if(e.detail){if(T(n,!0),s.forEach(u=>{const d=u;d.hasSubmenu&&(d.blockExpand=!1)}),Me(t)){const u=t.querySelector('modus-wc-tree-item[value="data"]');u&&setTimeout(()=>Ae(u),0)}}else o.set(!0),T(n,!1),s.forEach(u=>{const d=u;d.hasSubmenu&&(d.blockExpand=!0,Oe(u),typeof d.collapseSubmenu=="function"&&d.collapseSubmenu())}),$e(t)&&(n.collapseFlyoutTimer=setTimeout(()=>{n.collapseFlyoutTimer=null,V(n)},ve))},Le=(e,t)=>{if(t.get()&&e.detail){t.set(!1);return}t.set(!1);const n=e.target,o=n==null?void 0:n.closest(".layout-with-navbar"),s=o?o.querySelector("modus-wc-side-navigation"):document.querySelector("modus-wc-side-navigation");s&&(s.expanded=e.detail)},Ve=e=>{L(e),T(e,!0),document.querySelectorAll("modus-wc-side-navigation.side-navigation modus-wc-tree-item").forEach(t=>{const n=t;n.hasSubmenu&&(n.blockExpand=!1)})},Re=()=>`
...
<\/script>
`;var P=Object.freeze,qe=Object.defineProperty,fe=(e,t)=>P(qe(e,"raw",{value:P(e.slice())})),W,j;const Je={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[ye],parameters:{layout:"padded",actions:{handles:["expandedChange","itemSelect"]}}},M={render:e=>{const t=n=>{const o=n.target,s=o==null?void 0:o.closest(".layout-with-navbar");let u;s?u=s.querySelector("modus-wc-side-navigation"):u=document.querySelector("modus-wc-side-navigation"),u&&(u.expanded=n.detail)};return y(W||(W=fe([`
      <style>
        .layout-with-navbar {
          display: flex;
      ...
      <\/script>
    `])),t,{avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},{ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],b(e["custom-class"]),e.expanded,e["max-width"],b(e.mode),b(e["target-content"]))}},$={render:e=>{const t=o=>{const s=o.target,u=s==null?void 0:s.closest(".layout-with-navbar");let d;if(u&&(d=u.querySelector("modus-wc-side-navigation"),d)){const m=d;m.expanded=o.detail}},n=o=>{o.detail||o.target.querySelectorAll("modus-wc-menu-item").forEach(d=>{const m=d;m.hasSubmenu&&typeof m.collapseSubmenu=="function"&&m.collapseSubmenu()})};return y(j||(j=fe([`
      <style>
        .layout-with-navbar {
      ...
      <script>
        ...
        //
      <\/script>
    `])),t,{avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},{ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],b(e["custom-class"]),e.expanded,e["max-width"],b(e.mode),b(e["target-content"]),n,!0,!0,!0,!0)}};let B=!1;const w={dataIconDropdown:null,flyoutOpenTimer:null,collapseFlyoutTimer:null};let U=!1;const _={args:{expanded:!0},parameters:{docs:{description:{story:"This story is theme-specific: markup and styles differ between Connect and Modern/Classic. After changing the theme in the Storybook toolbar, re-render the story so it re-renders with the correct layout."},source:{code:Re()}}},render:(e,t)=>{var I;let n=!1;const o={get:()=>n,set:a=>{n=a}},s=(I=t.globals)==null?void 0:I.theme,u=s?s==="connect-light"||s==="connect-dark":v();!U&&typeof document<"u"&&(U=!0,new MutationObserver(()=>{v()||Ve(w)}).observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]}));const d=(a,i)=>{i.selected=!0,a.querySelectorAll("modus-wc-tree-item").forEach(l=>{l!==i&&(l.selected=!1)})},m=a=>{Le(a,o)},f=a=>{const i=a.target;if(!B){B=!0,v()&&T(w,!!a.detail);return}v()?ke(a,i,w,o):Fe(a,i,o)},S=a=>{const i=a.target.closest("modus-wc-tree-item");if(!i)return;const l=i.closest("modus-wc-side-navigation");if(!l)return;const p=i.getAttribute("value"),h=l.expanded;if(p==="data"){const D=l.querySelector('modus-wc-tree-item[value="data"]');D&&h&&d(l,D)}v()&&!h&&i.querySelector("modus-wc-tree-view")&&V(w,!0)},O=a=>{var h,D,q,z;if(!v())return;const i=(h=a.detail)==null?void 0:h.value;if(!i||!w.dataIconDropdown)return;L(w);const l=w.dataIconDropdown.closest("modus-wc-side-navigation"),p=l==null?void 0:l.querySelector(`modus-wc-tree-item[value="${i}"]`);p&&((D=p.querySelector(":scope > li > .modus-wc-menu-item-interactive"))==null||D.click()),(z=(q=w.dataIconDropdown)==null?void 0:q.querySelector("modus-wc-button .modus-wc-btn"))==null||z.blur(),setTimeout(()=>L(w),0)},A=a=>{console.log("Action:",a.detail.value);const i=a.target.closest("modus-wc-dropdown-menu");i&&(i.menuVisible=!1)},C=a=>{a&&(a.hasAttribute("data-flyout-wired")||(a.setAttribute("data-flyout-wired",""),a.addEventListener("itemSelect",i=>{if(i.target!==a)return;const l=a.closest("modus-wc-side-navigation");if(l){if(l.expanded){d(l,a);return}v()&&V(w,!0)}})))},x=a=>{if(!a){w.dataIconDropdown=null;return}if(w.dataIconDropdown=a,!v()){T(w,!0);return}const i=w.dataIconDropdown.closest("modus-wc-side-navigation"),l=i==null?void 0:i.expanded;T(w,!!l)};return y`
      <link rel="stylesheet" href=${se} />
      <style>
        .layout-with-navbar {
          display: flex;
    ...
    `}},F={render:e=>{if(!customElements.get("side-navigation-shadow-host")){const t=Ce({componentTag:"modus-wc-side-navigation",propsMapper:(n,o)=>{const s=o;if(s.customClass=n["custom-class"]||"",s.expanded=!!n.expanded,s.maxWidth=n["max-width"]||"256px",s.collapseOnClickOutside=!!n["collapse-on-click-outside"],s.mode=n.mode||"overlay",s.targetContent=n["target-content"]||"",!o.hasAttribute("data-layout-built")){o.setAttribute("data-layout-built","");const u=o.getRootNode(),d=o.parentElement;o.className="side-navigation",o.style.cssText="height: 500px; align-self: flex-start; position: relative;";const m=document.createElement("modus-wc-navbar");m.setAttribute("style","z-index: 2;"),m.className="navbar",m.userCard={avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},m.visibility={ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0};const f=document.createElement("modus-wc-menu");f.setAttribute("size","lg"),[{label:"home",icon:"home",selected:!0},{label:"profile",icon:"person",selected:!1},{label:"settings",icon:"gears",selected:!1}].forEach(({label:a,icon:i,selected:l})=>{const p=document.createElement("modus-wc-menu-item");p.setAttribute("label",a),l&&p.setAttribute("selected","");const h=document.createElement("modus-wc-icon");h.setAttribute("slot","start-icon"),h.setAttribute("name",i),p.appendChild(h),f.appendChild(p)}),o.appendChild(f),m.addEventListener("mainMenuOpenChange",a=>{const i=a;o.expanded=i.detail});const S=document.createElement("div");S.className="panel-content";const O=document.createElement("p");O.textContent="The side navigation of an application provides context through accessible menu options and positions a consistent component to connect to various pages in the application.";const A=document.createElement("p");A.textContent=`The side navigation is a collapsible side content of the site's pages. It is located alongside the page's primary content. The component is designed to add side content to a fullscreen application. It is activated through the "hamburger" menu in the Navbar.`,S.appendChild(O),S.appendChild(A);const C=document.createElement("div");C.className="main-content-row",C.appendChild(o),C.appendChild(S);const x=document.createElement("div");x.className="layout-with-navbar",x.appendChild(m),x.appendChild(C),d.appendChild(x);const I=document.createElement("style");I.textContent=`
      ...
      .props=${{...e}}
    ></side-navigation-shadow-host>`}};var Y,G,J;M.parameters={...M.parameters,docs:{...(Y=M.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: args => {
...
}`,...(J=(G=M.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};var K,Q,X;$.parameters={...$.parameters,docs:{...(K=$.parameters)==null?void 0:K.docs,source:{originalSource:`{
  render: args => {
    const handleMenuOpenChange = (e: CustomEvent) => {
      const eventSource = e.target as HTMLElement;
      const storyContainer = eventSource?.closest('.layout-with-navbar');
...
}`,...(ae=(oe=F.parameters)==null?void 0:oe.docs)==null?void 0:ae.source}}};const Ke=["Default","WithSubmenu","WithTreeView","ShadowDomParent"];export{M as Default,F as ShadowDomParent,$ as WithSubmenu,_ as WithTreeView,Ke as __namedExportsOrder,Je as default};
