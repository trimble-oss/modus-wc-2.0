import{w as ge}from"./decorator-D4YmxizW.js";import{b as y,A as fe}from"./lit-element-DgBvYnzn.js";import{o as g}from"./if-defined-BnVFTJ4o.js";import{n as H}from"./ref-Bw8asrgi.js";import{c as ye}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";import"./directive-helpers-BZ4DLK7w.js";import"./directive-C_Rw-dL6.js";const Se="1.15.0",se=`https://resources.connect.trimble.com/${Se}/fonts/icon-font.min.css`,c=(e,t="",n="")=>["icon-font",e,n,t].filter(Boolean).join(" "),r={allProjects:"tc-icon-arrow-line-back",data:"tc-icon-layers",explorer:"tc-icon-explorer",folder:"tc-icon-folder",chevronRight:"tc-icon-chevron-right",views:"tc-icon-views",releases:"tc-icon-release",activity:"tc-icon-activity",bcfTopics:"tc-icon-bcf",fieldData:"tc-icon-fixed-point"},p="modus-wc-tree-item-end-action",q="modus-wc-tree-item-end-action-dropdown",F="modus-wc-tree-item-end-action-icon",E="data-flyout-dropdown",ie=new Set(["connect-light","connect-dark"]),Ce=()=>{if(typeof document>"u")return null;const e=document.documentElement.getAttribute("data-theme");if(e&&ie.has(e))return e;const t=document.querySelector('[data-theme="connect-light"], [data-theme="connect-dark"]');return(t==null?void 0:t.getAttribute("data-theme"))??null},b=e=>{const t=Ce();return t!==null&&ie.has(t)},ce="15rem",xe=`
...
`,ue=N(`
  .${p} .modus-wc-menu-item-interactive {
    align-items: stretch;
    height: 52px;
    padding-block: 0;
  ...
  .${p} [slot='end'] modus-wc-dropdown-menu {
    align-self: stretch;
    height: 100%;
  }

  .${p} [slot='end'] modus-wc-dropdown-menu .modus-wc-btn {
    height: 100%;
  }
...
`),le=N(`
  ...
  modus-wc-tree-item > li.modus-wc-menu-item.${p}:has(
      [slot='end'] :active
    ) {
    background-color: transparent;
  }
  ...
  modus-wc-tree-item
    > li.modus-wc-menu-item.${p}:has([slot='end'] :active)
    > .modus-wc-menu-item-interactive {
    background-color: transparent !important;
    color: inherit;
  }
...
`;var W=Object.freeze,qe=Object.defineProperty,be=(e,t)=>W(qe(e,"raw",{value:W(e.slice())})),P,j;const Je={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[ge],parameters:{layout:"padded",actions:{handles:["expandedChange","itemSelect"]}}},M={render:e=>{const t=n=>{const o=n.target,s=o==null?void 0:o.closest(".layout-with-navbar");let u;s?u=s.querySelector("modus-wc-side-navigation"):u=document.querySelector("modus-wc-side-navigation"),u&&(u.expanded=n.detail)};return y(P||(P=be([`
      ...
      <\/script>
    `])),t,{avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},{ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],g(e["custom-class"]),e.expanded,e["max-width"],g(e.mode),g(e["target-content"]))}},$={render:e=>{const t=o=>{const s=o.target,u=s==null?void 0:s.closest(".layout-with-navbar");let d;if(u&&(d=u.querySelector("modus-wc-side-navigation"),d)){const m=d;m.expanded=o.detail}},n=o=>{o.detail||o.target.querySelectorAll("modus-wc-menu-item").forEach(d=>{const m=d;m.hasSubmenu&&typeof m.collapseSubmenu=="function"&&m.collapseSubmenu()})};return y(j||(j=be([`
      <style>
        .layout-with-navbar {
      ...
      <script>
        ...
        //
      <\/script>
    `])),t,{avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},{ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],g(e["custom-class"]),e.expanded,e["max-width"],g(e.mode),g(e["target-content"]),n,!0,!0,!0,!0)}};let B=!1;const w={dataIconDropdown:null,flyoutOpenTimer:null,collapseFlyoutTimer:null};let U=!1;const _={args:{expanded:!0},parameters:{docs:{description:{story:"This story is theme-specific: markup and styles differ between Connect and Modern/Classic. After changing the theme in the Storybook toolbar, re-render the story so it re-renders with the correct layout."},source:{code:Ve()}}},render:(e,t)=>{var I;let n=!1;const o={get:()=>n,set:a=>{n=a}},s=(I=t.globals)==null?void 0:I.theme,u=s?s==="connect-light"||s==="connect-dark":b();!U&&typeof document<"u"&&(U=!0,new MutationObserver(()=>{b()||Le(w)}).observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]}));const d=(a,i)=>{i.selected=!0,a.querySelectorAll("modus-wc-tree-item").forEach(l=>{l!==i&&(l.selected=!1)})},m=a=>{Fe(a,o)},f=a=>{const i=a.target;if(!B){B=!0,b()&&T(w,!!a.detail);return}b()?ke(a,i,w,o):_e(a,i,o)},S=a=>{const i=a.target.closest("modus-wc-tree-item");if(!i)return;const l=i.closest("modus-wc-side-navigation");if(!l)return;const h=i.getAttribute("value"),v=l.expanded;if(h==="data"){const D=l.querySelector('modus-wc-tree-item[value="data"]');D&&v&&d(l,D)}b()&&!v&&i.querySelector("modus-wc-tree-view")&&V(w,!0)},O=a=>{var v,D,R,z;if(!b())return;const i=(v=a.detail)==null?void 0:v.value;if(!i||!w.dataIconDropdown)return;L(w);const l=w.dataIconDropdown.closest("modus-wc-side-navigation"),h=l==null?void 0:l.querySelector(`modus-wc-tree-item[value="${i}"]`);h&&((D=h.querySelector(":scope > li > .modus-wc-menu-item-interactive"))==null||D.click()),(z=(R=w.dataIconDropdown)==null?void 0:R.querySelector("modus-wc-button .modus-wc-btn"))==null||z.blur(),setTimeout(()=>L(w),0)},A=a=>{console.log("Action:",a.detail.value);const i=a.target.closest("modus-wc-dropdown-menu");i&&(i.menuVisible=!1)},C=a=>{a&&(a.hasAttribute("data-flyout-wired")||(a.setAttribute("data-flyout-wired",""),a.addEventListener("itemSelect",i=>{if(i.target!==a)return;const l=a.closest("modus-wc-side-navigation");if(l){if(l.expanded){d(l,a);return}b()&&V(w,!0)}})))},x=a=>{if(!a){w.dataIconDropdown=null;return}if(w.dataIconDropdown=a,!b()){T(w,!0);return}const i=w.dataIconDropdown.closest("modus-wc-side-navigation"),l=i==null?void 0:i.expanded;T(w,!!l)};return y`
      <link rel="stylesheet" href=${se} />
      <style>
        .layout-with-navbar {
          display: flex;
