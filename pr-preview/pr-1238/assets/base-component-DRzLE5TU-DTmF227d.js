...
[data-theme=connect-light] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-active,
[data-theme=connect-dark] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-active {
  background-color: transparent;
}
[data-theme=connect-light] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-active > button,
[data-theme=connect-dark] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-active > button {
  background-color: #e5f0f8;
  color: var(--modus-wc-color-primary);
  font-weight: var(--modus-wc-font-weight-semibold);
}
[data-theme=connect-light] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-active > button:hover, [data-theme=connect-light] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-active > button:focus,
[data-theme=connect-dark] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-active > button:hover,
[data-theme=connect-dark] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-active > button:focus {
  background-color: #e5f0f8;
  color: var(--modus-wc-color-primary);
}
[data-theme=connect-light] modus-wc-menu-item .modus-wc-menu-item:not(.modus-wc-menu-item-active):not(.modus-wc-menu-item-disabled):not(.modus-wc-menu-item-focused):not(:has(.modus-wc-menu-dropdown)):hover,
[data-theme=connect-dark] modus-wc-menu-item .modus-wc-menu-item:not(.modus-wc-menu-item-active):not(.modus-wc-menu-item-disabled):not(.modus-wc-menu-item-focused):not(:has(.modus-wc-menu-dropdown)):hover {
  background-color: transparent;
  outline: none;
}
[data-theme=connect-light] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-focused:not(.modus-wc-menu-item-disabled):not(.modus-wc-menu-item-active):not(:has(.modus-wc-menu-dropdown)):hover,
[data-theme=connect-dark] modus-wc-menu-item .modus-wc-menu-item.modus-wc-menu-item-focused:not(.modus-wc-menu-item-disabled):not(.modus-wc-menu-item-active):not(:has(.modus-wc-menu-dropdown)):hover {
  background-color: transparent;
}
[data-theme=connect-light] modus-wc-menu-item .modus-wc-menu-item:not(.modus-wc-menu-item-active):not(.modus-wc-menu-item-disabled) > button:hover,
[data-theme=connect-light] modus-wc-menu-item .modus-wc-menu-item:not(.modus-wc-menu-item-active):not(.modus-wc-menu-item-disabled) > button:focus,
[data-theme=connect-dark] modus-wc-menu-item .modus-wc-menu-item:not(.modus-wc-menu-item-active):not(.modus-wc-menu-item-disabled) > button:hover,
[data-theme=connect-dark] modus-wc-menu-item .modus-wc-menu-item:not(.modus-wc-menu-item-active):not(.modus-wc-menu-item-disabled) > button:focus {
  background-color: var(--modus-wc-color-base-100);
}
[data-theme=connect-light] modus-wc-menu-item .modus-wc-menu-item:not(.modus-wc-menu-item-active):not(.modus-wc-menu-item-disabled):focus:not(:focus-visible), [data-theme=connect-light] modus-wc-menu-item .modus-wc-menu-item:not(.modus-wc-menu-item-active):not(.modus-wc-menu-item-disabled).modus-wc-arrow-focused,
[data-theme=connect-dark] modus-wc-menu-item .modus-wc-menu-item:not(.modus-wc-menu-item-active):not(.modus-wc-menu-item-disabled):focus:not(:focus-visible),
[data-theme=connect-dark] modus-wc-menu-item .modus-wc-menu-item:not(.modus-wc-menu-item-active):not(.modus-wc-menu-item-disabled).modus-wc-arrow-focused {
  background-color: var(--modus-wc-color-base-100);
  outline: none;
}
