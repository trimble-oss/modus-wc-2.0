import{w as m}from"./decorator-Dt3Huotz.js";import{k as u}from"./lit-element-DVRzCIa_.js";import{t as a}from"./if-defined-1ipA9LQg.js";import"./v4-CQkTLCs1.js";const w={title:"Components/Forms/Radio",component:"modus-wc-radio",args:{"aria-label":"Radio","custom-class":"",disabled:!1,name:"",required:!1,size:"md",value:!0},argTypes:{"input-dir":{control:{type:"inline-radio"},options:["ltr","rtl","auto"]},size:{control:{type:"inline-radio"},options:["xs","sm","md","lg","xl"]}},decorators:[m],parameters:{actions:{handles:["inputBlur","inputChange","inputFocus"]}}},i={render:e=>u`
      <modus-wc-radio
...
}`,...(s=(l=n.parameters)==null?void 0:l.docs)==null?void 0:s.source}}};const x=["Template","RadioWithLabel"];export{n as RadioWithLabel,i as Template,x as __namedExportsOrder,w as default};
