import{w as k}from"./decorator-Dt3Huotz.js";import{k as v}from"./lit-element-DVRzCIa_.js";import{t as o}from"./if-defined-1ipA9LQg.js";import"./v4-CQkTLCs1.js";var b=Object.freeze,z=Object.defineProperty,$=(e,r)=>b(z(e,"raw",{value:b(e.slice())})),g,I;const s=[{label:"Apple",value:"apple",visibleInMenu:!0},{label:"Banana",value:"banana",visibleInMenu:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0},{label:"Cherry",value:"cherry",visibleInMenu:!0},{label:"Grape",value:"grape",visibleInMenu:!0},{label:"Lemon",value:"lemon",visibleInMenu:!0},{label:"Orange",value:"orange",visibleInMenu:!0},{label:"Peach",value:"peach",visibleInMenu:!0},{label:"Pear",value:"pear",visibleInMenu:!0},{label:"Strawberry",value:"strawberry",visibleInMenu:!0}],P={title:"Components/Forms/Autocomplete",component:"modus-wc-autocomplete",args:{bordered:!0,"debounce-ms":300,disabled:!1,items:s,label:"Label","min-chars":0,"multi-select":!1,"no-results":{label:"No results found",subLabel:"Check spelling or try a different keyword"},size:"md",value:""},argTypes:{items:{description:"Array of items for the autocomplete component",table:{type:{detail:`
          ...
          `}}},size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[k],parameters:{actions:{handles:["chipRemove","inputBlur","inputChange","inputFocus","itemSelect"]}}},R={render:e=>{const r=i=>{var n;if(!((n=i.detail)!=null&&n.target))return;const t=i.target.closest("modus-wc-autocomplete");if(t){const l=i.detail.target,a=l.value.toLowerCase(),f=s.map(u=>({...u,selected:a?u.selected:!1,visibleInMenu:u.label.toLowerCase().includes(a)}));t.items=[...f],t.value=l.value}},p=i=>{const t=i.target.closest("modus-wc-autocomplete");if(t){const n=i.detail.label;n&&(t.value=n),s.forEach(a=>a.selected=!1);const l=s.find(a=>a.value===i.detail.value);l&&(l.selected=!0,t.items=[...s])}};return v(g||(g=$([`
<style>
  /* Only for Storybook */
...
<modus-wc-autocomplete
  ...
  @itemSelect=`,`
></modus-wc-autocomplete>
    `])),e.bordered,o(e["custom-class"]),o(e["debounce-ms"]),e.disabled,o(e["input-id"]),o(e["input-tab-index"]),e.items,o(e.label),e["min-chars"],!1,e["no-results"],o(e.name),o(e.placeholder),e["read-only"],e.required,o(e.size),e.value,r,p)}},c={...R},m={render:e=>{const r=t=>{const n=t.target.closest("modus-wc-autocomplete");if(n){const l=s.find(a=>a.value===t.detail.value);l&&(l.selected=!1,n.items=[...s])}},p=t=>{var l;if(!((l=t.detail)!=null&&l.target))return;const n=t.target.closest("modus-wc-autocomplete");if(n){const a=t.detail.target,f=a.value.toLowerCase(),u=s.map(h=>({...h,visibleInMenu:h.label.toLowerCase().includes(f)}));n.items=[...u],n.value=a.value}},i=t=>{const n=t.target.closest("modus-wc-autocomplete");if(n){n.value="",n.items=s.map(a=>({...a,visibleInMenu:!0}));const l=s.find(a=>a.value===t.detail.value);l&&(l.selected=!0)}};return v(I||(I=$([`
<style>
  /* Only for Storybook */
...
<modus-wc-autocomplete
  ...
  @itemSelect=`,`
></modus-wc-autocomplete>
    `])),e.bordered,o(e["custom-class"]),o(e["debounce-ms"]),e.disabled,o(e["input-id"]),o(e["input-tab-index"]),e.items,o(e.label),e["min-chars"],!0,o(e.name),e["no-results"],o(e.placeholder),e["read-only"],e.required,o(e.size),e.value,r,p,i)}},d={parameters:{docs:{description:{story:`
#### Breaking Changes
