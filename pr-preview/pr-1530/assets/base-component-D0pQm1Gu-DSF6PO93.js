...
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host {
  position: relative;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host::before,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host::before {
  background-color: transparent;
  border-radius: var(--modus-wc-border-radius-rounded);
  content: "";
  height: 2.5rem;
...
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host:has(.modus-wc-checkbox-sm)::before,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host:has(.modus-wc-checkbox-sm)::before {
  left: -0.875rem;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host:has(.modus-wc-checkbox-lg)::before,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host:has(.modus-wc-checkbox-lg)::before {
  left: -0.625rem;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host:has(.modus-wc-checkbox:hover:not(:disabled))::before,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host:has(.modus-wc-checkbox:hover:not(:disabled))::before {
  background-color: #cfe1ee;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox {
  --check-bg: #005f9e;
  --fallback-bc: #aeaeb6;
  --check-content: var(--modus-wc-color-white);
  --tw-border-opacity: 1;
...
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox.modus-wc-checkbox-sm,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox.modus-wc-checkbox-sm {
  height: 0.75rem;
  width: 0.75rem;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox.modus-wc-checkbox-md,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox.modus-wc-checkbox-md {
  height: 1rem;
  width: 1rem;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox.modus-wc-checkbox-lg,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox.modus-wc-checkbox-lg {
  height: 1.25rem;
  width: 1.25rem;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:checked,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:checked {
  --fallback-bc: #005f9e;
  border-color: #005f9e;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:checked:hover,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:checked:hover {
  --check-bg: #005f9e;
  --fallback-bc: #005f9e;
  border-color: #005f9e;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:indeterminate,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:indeterminate {
  --fallback-bc: #005f9e;
  border-color: #005f9e;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:disabled,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:disabled {
  opacity: 0.3;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:disabled:not(:checked),
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:disabled:not(:checked) {
  background-color: unset;
  border: var(--modus-wc-border-width-sm) solid #aeaeb6;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus, [data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus-visible,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus-visible {
  box-shadow: none;
  outline: none;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:not(:hover):not(:checked):not(:active):not(:indeterminate), [data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus-visible:not(:hover):not(:checked):not(:active):not(:indeterminate),
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:not(:hover):not(:checked):not(:active):not(:indeterminate),
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus-visible:not(:hover):not(:checked):not(:active):not(:indeterminate) {
  --fallback-bc: #aeaeb6;
  --tw-border-opacity: 1;
  border-color: #aeaeb6;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:checked, [data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus-visible:checked, [data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:indeterminate, [data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus-visible:indeterminate,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:checked,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus-visible:checked,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:indeterminate,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus-visible:indeterminate {
  --fallback-bc: #005f9e;
  border-color: #005f9e;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:hover:not(:disabled):not(:checked):not(:indeterminate),
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:hover:not(:disabled):not(:checked):not(:indeterminate) {
  --fallback-bc: #005f9e;
  border-color: #005f9e;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:active:not(:disabled):not(:checked),
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:active:not(:disabled):not(:checked) {
  --fallback-bc: #005f9e;
  border-color: #005f9e;
}
/**
...
`,a=new WeakSet;let t=null;const r=new WeakSet;let d=null;async function b(o,s=!1){if(o instanceof ShadowRoot)if(s){if(r.has(o))return;const n=m+`
`+u+`
`+i+`
`+w;if(!n.trim()){console.warn("No CSS content available for shadow DOM injection");return}if("adoptedStyleSheets"in Document.prototype&&"CSSStyleSheet"in window)try{d||(d=new CSSStyleSheet,await d.replace(n));const e=o;e.adoptedStyleSheets=[...e.adoptedStyleSheets||[],d]}catch(e){console.warn("adoptedStyleSheets failed, falling back to <style> element:",e);const c=document.createElement("style");c.textContent=n,o.appendChild(c)}else{const e=document.createElement("style");e.textContent=n,o.appendChild(e)}r.add(o),a.add(o)}else{if(r.has(o)||a.has(o))return;const n=m+`
`+u+`
`+i;if(!n.trim()){console.warn("No CSS content available for shadow DOM injection");return}if("adoptedStyleSheets"in Document.prototype&&"CSSStyleSheet"in window)try{t||(t=new CSSStyleSheet,await t.replace(n));const e=o;e.adoptedStyleSheets=[...e.adoptedStyleSheets||[],t]}catch(e){console.warn("adoptedStyleSheets failed, falling back to <style> element:",e);const c=document.createElement("style");c.textContent=n,o.appendChild(c)}else{const e=document.createElement("style");e.textContent=n,o.appendChild(e)}a.add(o)}}function h(o,s=!1){const n=o.getRootNode();n instanceof ShadowRoot&&b(n,s)}export{h};
