...
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host {
  --connect-checkbox-size: 1rem;
  position: relative;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host:has(.modus-wc-checkbox-sm),
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host:has(.modus-wc-checkbox-sm) {
  --connect-checkbox-size: 0.75rem;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host:has(.modus-wc-checkbox-lg),
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host:has(.modus-wc-checkbox-lg) {
  --connect-checkbox-size: 1.25rem;
}
...
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host::before {
  ...
  border-radius: var(--modus-wc-border-radius-rounded);
  content: "";
  height: calc(var(--connect-checkbox-size) + 2 * var(--modus-wc-spacing-sm));
  inset-inline-start: calc(-1 * var(--modus-wc-spacing-sm));
  pointer-events: none;
  position: absolute;
  top: 50%;
  transform: translateY(-50%);
  width: calc(var(--connect-checkbox-size) + 2 * var(--modus-wc-spacing-sm));
  z-index: 0;
}
...
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:not(:focus-visible),
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:not(:focus-visible) {
  box-shadow: none;
  outline: none;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:not(:focus-visible):not(:hover):not(:checked):not(:active):not(:indeterminate),
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:not(:focus-visible):not(:hover):not(:checked):not(:active):not(:indeterminate) {
  --fallback-bc: #aeaeb6;
  border-color: #aeaeb6;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:not(:focus-visible):checked, [data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:not(:focus-visible):indeterminate,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:not(:focus-visible):checked,
[data-theme=connect-dark] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus:not(:focus-visible):indeterminate {
  --fallback-bc: #005f9e;
  border-color: #005f9e;
}
[data-theme=connect-light] modus-wc-checkbox.modus-wc-checkbox-host [type=checkbox].modus-wc-checkbox:focus-visible,
