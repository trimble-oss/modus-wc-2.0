...
<\/script>`}}},render:e=>d`
  ...
  `},r={args:{multiple:!0,"accept-file-types":"image/*"},render:e=>d`
    ...
    ></modus-wc-file-dropzone>
  `},u={type:"success",message:"Files uploaded successfully!"},T={type:"error",message:"Upload failed. Please try again."},H={type:"info",message:"Release to upload your files"},a={args:{"accept-file-types":".pdf, .doc, .docx",feedback:u},parameters:{docs:{source:{code:`<div style="display: flex; flex-direction: column; gap: 1rem;">
  <modus-wc-file-dropzone
...
<\/script>\`
  ...
  \`
}`,...(D=($=a.parameters)==null?void 0:$.docs)==null?void 0:D.source}}};var I,B,S;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: args => {
...
}`,...(S=(B=p.parameters)==null?void 0:B.docs)==null?void 0:S.source}}};const j=["Default","customContent","fileValidations","multipleFiles","withFeedback","ShadowDomParent"];export{i as Default,p as ShadowDomParent,j as __namedExportsOrder,c as customContent,N as default,l as fileValidations,r as multipleFiles,a as withFeedback};
