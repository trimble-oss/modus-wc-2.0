import{w as M}from"./decorator-D4YmxizW.js";import{b as d}from"./lit-element-DgBvYnzn.js";import{o as t}from"./if-defined-BnVFTJ4o.js";import{c as L}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const N={title:"Components/File Dropzone",component:"modus-wc-file-dropzone",args:{"accept-file-types":".doc, .docx, .pdf",disabled:!1,"include-state-icon":!0,instructions:"Drag files here or browse to upload"},argTypes:{"accept-file-types":{control:"text",description:"Accepted file types (e.g. '.jpg,.png' or 'image/*')"},"custom-class":{control:"text",description:"Custom CSS class to apply to the file dropzone element"},disabled:{control:"boolean",description:"Disable the file input",table:{defaultValue:{summary:"false"}}},feedback:{control:"object",description:"External feedback to display dragging, success, or error state with an optional custom message",table:{type:{summary:"IFileDropzoneFeedback",detail:`{
...
<\/script>`}}},render:e=>d`
  ...
  `},r={args:{multiple:!0,"max-file-name-length":20,"max-file-count":3,"max-total-file-size-bytes":10485760,"invalid-file-type-message":"Invalid file format. Please upload correct file type."},render:e=>d`
    <modus-wc-file-dropzone
      accept-file-types=${t(e["accept-file-types"])}
      invalid-file-type-message=${t(e["invalid-file-type-message"])}
      max-file-name-length=${t(e["max-file-name-length"])}
    ...
    ></modus-wc-file-dropzone>
  `},l={args:{multiple:!0,"accept-file-types":"image/*"},render:e=>d`
    <modus-wc-file-dropzone
      accept-file-types=${t(e["accept-file-types"])}
      multiple=${e.multiple}
      instructions="Select multiple image files"
    ></modus-wc-file-dropzone>
  `},u={type:"success",message:"Files uploaded successfully!"},T={type:"error",message:"Upload failed. Please try again."},H={type:"dragging",message:"Release to upload your files"},a={args:{"accept-file-types":".pdf, .doc, .docx",feedback:u},parameters:{docs:{source:{code:`<div style="display: flex; flex-direction: column; gap: 1rem;">
  <modus-wc-file-dropzone
...
<\/script>`}}},render:e=>d`
    <div style="display: flex; flex-direction: column; gap: 1rem;">
      ...
      <div style="display: flex; gap: 0.5rem;">
        <modus-wc-button
          @buttonClick=${()=>{const o=document.getElementById("feedback-dropzone");o&&(o.feedback=u)}}
        >
          Show Success
        </modus-wc-button>
        <modus-wc-button
  ...
  render: args => html\`
    ...
    ></modus-wc-file-dropzone>
  \`
}`,...(g=(f=i.parameters)==null?void 0:f.docs)==null?void 0:g.source}}};var b,y,z;c.parameters={...c.parameters,docs:{...(b=c.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    'accept-file-types': '.pdf, .doc, .docx',
    'success-message': 'Files uploaded successfully!'
  },
...
<\/script>\`
  ...
  \`
}`,...(z=(y=c.parameters)==null?void 0:y.docs)==null?void 0:z.source}}};var w,k,x;r.parameters={...r.parameters,docs:{...(w=r.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    multiple: true,
  ...
  render: args => html\`
    ...
    ></modus-wc-file-dropzone>
  \`
}`,...(x=(k=r.parameters)==null?void 0:k.docs)==null?void 0:x.source}}};var h,v,F;l.parameters={...l.parameters,docs:{...(h=l.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    multiple: true,
  ...
  render: args => html\`
    ...
    ></modus-wc-file-dropzone>
  \`
}`,...(F=(v=l.parameters)==null?void 0:v.docs)==null?void 0:F.source}}};var E,$,D;a.parameters={...a.parameters,docs:{...(E=a.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
    'accept-file-types': '.pdf, .doc, .docx',
...
<\/script>\`
  ...
  \`
}`,...(D=($=a.parameters)==null?void 0:$.docs)==null?void 0:D.source}}};var B,S,I;p.parameters={...p.parameters,docs:{...(B=p.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: args => {
...
}`,...(I=(S=p.parameters)==null?void 0:S.docs)==null?void 0:I.source}}};const j=["Default","customContent","fileValidations","multipleFiles","withFeedback","ShadowDomParent"];export{i as Default,p as ShadowDomParent,j as __namedExportsOrder,c as customContent,N as default,r as fileValidations,l as multipleFiles,a as withFeedback};
