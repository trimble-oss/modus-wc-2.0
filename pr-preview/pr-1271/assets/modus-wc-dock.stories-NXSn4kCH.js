import{w as C}from"./decorator-D4YmxizW.js";import{b as c}from"./lit-element-DgBvYnzn.js";import{o as h}from"./if-defined-BnVFTJ4o.js";import{c as P}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const a=[{label:"Home",icon:"home"},{label:"Inbox",icon:"email"},{label:"Settings",icon:"settings"}],M=c`
  <style>
    .dock-demo-frame {
...
`),b=`<modus-wc-dock
    ...
    position="${o}"${i}
    size="${t}"
  ></modus-wc-dock>`,k='<div class="dock-demo-frame__content" aria-hidden="true"></div>',A=o==="top"||o==="left"?`${b}
  ${k}`:`${k}
  ${b}`;return`<style>
  .dock-demo-frame {
    border: 1px dashed var(--modus-wc-color-base-content-low-contrast);
...
<\/script>`},q=(e,s)=>c`
  <modus-wc-dock
    aria-label="Dock navigation"
    active-item-index=${h(e["active-item-index"])}
...
<div class="dock-demo-frame dock-demo-frame--${s}">
  ...
  `},p=e=>({docs:{description:{story:e==null?void 0:e.storyDescription},source:{code:H({activeItemIndex:(e==null?void 0:e.activeItemIndex)??2,items:(e==null?void 0:e.items)??a,position:(e==null?void 0:e.position)??"bottom",showLabels:(e==null?void 0:e.showLabels)??!0,size:(e==null?void 0:e.size)??"md"})}}}),K={title:"Components/Dock",component:"modus-wc-dock",args:{items:a,position:"bottom","show-labels":!0,size:"md","active-item-index":2},argTypes:{items:{table:{type:{detail:`
            Interface: IDockItem
            Properties:
          ...
          `}}},position:{control:{type:"select"},options:["top","bottom","left","right"]},"show-labels":{control:"boolean"},size:{control:{type:"select"},options:["sm","md","lg"]},"active-item-index":{control:{type:"number",min:0,max:2,step:1}}},decorators:[C,(e,s)=>{const o=e();return queueMicrotask(()=>{const n=document.querySelector(".dock-demo-frame"),t=(n==null?void 0:n.querySelector("modus-wc-dock"))??null;if(!t)return;const i=s.args.items??a;t.items=i,s.args["active-item-index"]!==void 0&&(t.activeItemIndex=s.args["active-item-index"])}),o}],parameters:{actions:{handles:["itemSelect"]},layout:"padded",docs:{description:{component:"Dock navigation bar for navigating between primary screens. Position the host at an app edge in your layout; the stories below use a demo frame to pin the dock to each corner."},source:{code:H({})}}}},u={render:e=>B(e)},d={...u,parameters:p({storyDescription:"Bottom dock with labels. The demo frame positions the dock flush to the bottom edge of the content area."})},m={...u,args:{items:a,"show-labels":!1},parameters:p({showLabels:!1,storyDescription:"Icon-only dock. Labels are hidden visually but remain available to assistive technologies via `aria-label` on each item button."})},r={...u,name:"Active and disabled",args:{items:[{label:"Home",icon:"home"},{label:"Inbox",icon:"email",disabled:!0},{label:"Settings",icon:"settings"}],"active-item-index":0},parameters:p({activeItemIndex:0,items:[{label:"Home",icon:"home"},{label:"Inbox",icon:"email",disabled:!0},{label:"Settings",icon:"settings"}],storyDescription:"Dock with an active item and a disabled item that cannot be selected."})},l={parameters:{docs:{source:{code:`<dock-shadow-host></dock-shadow-host>
...
}`,...(y=(g=d.parameters)==null?void 0:g.docs)==null?void 0:y.source}}};var I,x,D;m.parameters={...m.parameters,docs:{...(I=m.parameters)==null?void 0:I.docs,source:{originalSource:`{
  ...Template,
  args: {
    items: defaultItems,
    'show-labels': false
...
}`,...(D=(x=m.parameters)==null?void 0:x.docs)==null?void 0:D.source}}};var v,S,$;r.parameters={...r.parameters,docs:{...(v=r.parameters)==null?void 0:v.docs,source:{originalSource:`{
  ...Template,
...
}`,...($=(S=r.parameters)==null?void 0:S.docs)==null?void 0:$.source}}};var E,z,L;l.parameters={...l.parameters,docs:{...(E=l.parameters)==null?void 0:E.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
...
}`,...(L=(z=l.parameters)==null?void 0:z.docs)==null?void 0:L.source}}};const Q=["Default","IconsOnly","ActiveAndDisabled","ShadowDomParent"];export{r as ActiveAndDisabled,d as Default,m as IconsOnly,l as ShadowDomParent,Q as __namedExportsOrder,K as default};
