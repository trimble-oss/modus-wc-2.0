import{w as p}from"./decorator-D4YmxizW.js";import{x as b}from"./lit-element-CucEn6F2.js";import{o as t}from"./if-defined-BiZP-SBN.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var a=Object.freeze,w=Object.defineProperty,f=(e,o)=>a(w(e,"raw",{value:a(e.slice())})),r;const g={title:"Components/Dropdown Menu",component:"modus-wc-dropdown-menu",args:{"button-aria-label":"Dropdown menu button","button-color":"primary","button-size":"md","button-variant":"filled",disabled:!1,"menu-bordered":!0,"menu-offset":14,"menu-placement":"bottom-start","menu-size":"md","menu-visible":!1},argTypes:{"button-color":{control:{type:"select"},options:["primary","secondary","tertiary","warning","danger"]},"button-size":{control:{type:"select"},options:["xs","sm","md","lg"]},"button-variant":{control:{type:"select"},options:["borderless","filled","outlined"]},"menu-placement":{control:{type:"select"},options:["top","top-start","top-end","bottom","bottom-start","bottom-end","left","left-start","left-end","right","right-start","right-end"]},"menu-size":{control:{type:"select"},options:["sm","md","lg"]}},decorators:[p],parameters:{actions:{handles:["menuVisibilityChange"]}}},v={render:e=>{let o="";const l=s=>{o=s.detail.value;const m=document.querySelector("#selected-value");m&&(m.textContent=o);const d=s.target.closest("modus-wc-dropdown-menu");d&&(d.menuVisible=!1)};return b(r||(r=f([`
<style>
  /* Storybook styling */
