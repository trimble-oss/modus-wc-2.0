import{w as c}from"./decorator-DFROgT0E.js";import{x as m}from"./lit-element-C8zulti1.js";import{o as n}from"./if-defined-yv6owfG8.js";import"./v4-CtRu48qb.js";const h={title:"Components/Forms/Switch",component:"modus-wc-switch",args:{"custom-class":"",disabled:!1,indeterminate:!1,label:"Label",name:"",required:!1,size:"md",value:!0},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[c],parameters:{actions:{handles:["inputBlur","inputChange","inputFocus"]}}},a={render:e=>m`
      <modus-wc-switch
        aria-label="Toggle"
...
| switchClick    | inputChange    |                                                       |
  ...
  render: () => html\`<div></div>\`
}`,...(l=(d=s.parameters)==null?void 0:d.docs)==null?void 0:l.source}}};const g=["Default","Migration"];export{a as Default,s as Migration,g as __namedExportsOrder,h as default};
