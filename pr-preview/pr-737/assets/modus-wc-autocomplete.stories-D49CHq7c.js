...
// autocomplete.items = autocompleteItems;
<\/script>
  `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["min-chars"],t(e["min-input-width"]),!1,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],e["show-spinner"],t(e.size),e.value,I),args:{placeholder:"Search fruits..."}},M={name:"With Tooltips",parameters:{docs:{description:{story:"This example demonstrates menu items with tooltips. Hover over the items to see the tooltips."},source:{code:`
        <script>
const tooltipItems = [
  {
    label: 'Apple',
...
`}}},render:()=>b`
    ...
    `},C={render:e=>(e.items||(e.items=[...w]),e.items=e.items.map(m=>m.value==="apple"||m.value==="banana"?{...m,selected:!0}:m),b(P||(P=v([`
      <style>
      ...
      <script>
        ...
        `,`
          ...
          // } 
        <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["max-chips"]??4,e["min-chars"],t(e["min-input-width"]),!0,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e.value,I))},S={render:e=>{let m;const f=h=>{var s;if(!((s=h.detail)!=null&&s.target))return;const c=h.target.closest("modus-wc-autocomplete");if(c){const n=h.detail.target.value.toLowerCase();m&&window.clearTimeout(m),c.showSpinner=!0,m=window.setTimeout(()=>{const i=w.filter(o=>o.label.toLowerCase().includes(n));c.items=i,c.showSpinner=!1},2e3)}};return b(F||(F=v([`
      <style>
      ...
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["min-chars"],!1,t(e.name),t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],e["show-spinner"],t(e.size),e.value,f,I)}},E={render:e=>{const m=e["no-results"];e["leave-menu-open"]==!0&&(e["no-results"]={ariaLabel:"",label:"",subLabel:""});const f=l=>{const n=l.querySelectorAll("modus-wc-menu-item:not([disabled])");return Array.from(n).filter(i=>window.getComputedStyle(i).display!=="none"&&!i.classList.contains("hidden"))},h=l=>{var p,d;const n=l.target.closest("modus-wc-autocomplete");if(!n||n.disabled||n.readOnly)return;const o=f(n).map(r=>r.querySelector("button")).filter(Boolean),a=document.activeElement,u=o.indexOf(a);switch(l.key){case"ArrowDown":{l.preventDefault(),n.openMenu();let r=u+1;if(r>=o.length)return;r<0&&(r=0),(p=o[r])==null||p.focus();break}case"ArrowUp":{l.preventDefault(),n.openMenu();let r=u-1;if(r<0)return;(d=o[r])==null||d.focus();break}case"Enter":{l.preventDefault(),o.includes(a)&&a.click();const r=n.querySelector("input");r==null||r.focus();break}case"Escape":{l.preventDefault(),n.closeMenu();const r=n.querySelector("input");r==null||r.focus();break}}},c=l=>{var i;if(!((i=l.detail)!=null&&i.target))return;const n=l.target.closest("modus-wc-autocomplete");if(n){const o=l.detail.target.value.toLowerCase(),a=n==null?void 0:n.querySelectorAll("modus-wc-menu-item");o===""&&(a==null||a.forEach(d=>{d.removeAttribute("selected")}));let u=0;Array.from(a??[]).forEach(d=>{var g;(((g=d.getAttribute("label"))==null?void 0:g.toLowerCase())||"").includes(o)?d.classList.remove("hidden"):(d.classList.add("hidden"),u++)}),n.noResults=u===(a==null?void 0:a.length)?m:{ariaLabel:"",label:"",subLabel:""};const p=n.querySelector(".no-results-item");p&&(u===(a==null?void 0:a.length)?p.classList.add("visible"):p.classList.remove("visible"))}},s=l=>{const n=l.target.closest("modus-wc-autocomplete");if(n){const i=l.detail.value;n.value=i,n.querySelectorAll("modus-wc-menu-item").forEach(a=>{a.getAttribute("value")===i?a.setAttribute("selected","true"):a.removeAttribute("selected")}),e["leave-menu-open"]||n.closeMenu()}};return b(B||(B=v([`
<style>
...
<script>
        ...
        // }
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),t(e.label),e["leave-menu-open"],e["min-chars"],!1,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e["show-spinner"],e.value,h,c,!0,s,s,s,s)}},A={render:e=>{const m=c=>{const s=document.getElementById("autocomplete-custom-event-handlers");if(!s)return;["ArrowDown","ArrowUp","Enter","Escape"].includes(c.key)&&c.preventDefault();const l=e.items.filter(n=>n.visibleInMenu&&!n.disabled);switch(c.key){case"Escape":e.items=e.items.map(n=>({...n,focused:!1})),s.items=[...e.items],s.closeMenu(),s.style.transform="scale(0.98)",setTimeout(()=>{s.style.transform=""},200);break;case"ArrowDown":{s.openMenu();const n=l.findIndex(a=>a.focused),i=n<0?0:Math.min(n+1,l.length-1),o=i+1<l.length?i+1:i;e.items=e.items.map(a=>{var u;return{...a,focused:((u=l[o])==null?void 0:u.value)===a.value}});break}case"ArrowUp":{const n=l.findIndex(a=>a.focused),i=n<0?l.length-1:Math.max(n-1,0),o=i-1>=0?i-1:i;e.items=e.items.map(a=>{var u;return{...a,focused:((u=l[o])==null?void 0:u.value)===a.value}});break}case"Enter":{const n=l.find(i=>i.focused);n&&(e.items=e.items.map(i=>({...i,selected:i.value===n.value,focused:!1})),s.value=n.label,s.closeMenu());break}default:return}s.items=[...e.items]},f=c=>{const s=document.getElementById("autocomplete-custom-event-handlers");if(!s)return;const l=c.toLowerCase().split("");if(c.length>0){const o=e.items.map(a=>{const u=a.label.toLowerCase();let p=0,d=!0;for(const r of l)if(u.includes(r)){const g=u.indexOf(r);g===0?p+=3:u[g-1]===" "?p+=2:p+=1}else{d=!1;break}return d&&u.includes(c.toLowerCase())&&(p+=10),{item:a,score:d?p:-1,visible:d}});o.sort((a,u)=>u.score-a.score),e.items=o.map(({item:a,visible:u})=>({...a,visibleInMenu:u,focused:!1,selected:a.selected&&u,label:a.label}))}else e.items=e.items.map(o=>({...o,visibleInMenu:!0,focused:!1}));s.items=[...e.items],s.value=c;const n=e.items.filter(o=>o.visibleInMenu).length;console.log(`Fuzzy search for "${c}": ${n} matches found`),e.items.some(o=>o.visibleInMenu)&&c.length>=e["min-chars"]?s.openMenu():s.closeMenu()},h=c=>{const s=document.getElementById("autocomplete-custom-event-handlers");s&&(e.items=e.items.map(l=>({...l,selected:l.value===c.value,focused:!1})),s.items=[...e.items],s.value=c.label,s.closeMenu())};return b(q||(q=v([`
      <style>
...
Items are automatically sorted by relevance with exact substring matches appearing first.`}}}},k={args:{...we.args,items:w},render:e=>{const m=async()=>{const o=document.getElementById("programmatic-autocomplete");if(o){const a=w.find(u=>u.value==="apple")||null;await o.selectItem(a)}},f=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.selectItem(null)},h=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.openMenu()},c=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.closeMenu()},s=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.toggleMenu()},l=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.focusInput()},n=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.clearInput()},i=window;return i.handleSelectApple=m,i.handleSelectNull=f,i.handleOpenMenu=h,i.handleCloseMenu=c,i.handleToggleMenu=s,i.handleFocusInput=l,i.handleClearInput=n,b(O||(O=v([`
      <style>
      ...
      <script type="module">
        ...
        // autocomplete.items = autocompleteItems;
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,e["leave-menu-open"],e["max-chips"]??4,e["min-chars"],t(e["min-input-width"]),e["multi-select"],t(e.name),e["no-results"],e["read-only"],e.required,e["show-menu-on-focus"],e["show-spinner"],t(e.size),e.value,I)},parameters:{docs:{description:{story:`
## Public Methods
...
\`\`\`
        ...
        `}}}},$={render:e=>{const m=[{label:"Apple",value:"apple",visibleInMenu:!0},{label:"Banana",value:"banana",visibleInMenu:!0},{label:"Orange",value:"orange",visibleInMenu:!0},{label:"Strawberry",value:"strawberry",visibleInMenu:!0}],f=[...m,{label:"Blackberry",value:"blackberry",visibleInMenu:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0},{label:"Cherry",value:"cherry",visibleInMenu:!0},{label:"Cranberry",value:"cranberry",visibleInMenu:!0},{label:"Fig",value:"fig",visibleInMenu:!0},{label:"Grape",value:"grape",visibleInMenu:!0},{label:"Kiwi",value:"kiwi",visibleInMenu:!0},{label:"Lemon",value:"lemon",visibleInMenu:!0},{label:"Lime",value:"lime",visibleInMenu:!0},{label:"Mango",value:"mango",visibleInMenu:!0},{label:"Melon",value:"melon",visibleInMenu:!0},{label:"Peach",value:"peach",visibleInMenu:!0},{label:"Pineapple",value:"pineapple",visibleInMenu:!0},{label:"Raspberry",value:"raspberry",visibleInMenu:!0},{label:"Watermelon",value:"watermelon",visibleInMenu:!0}],h=s=>{var n;if(!((n=s.detail)!=null&&n.target))return;const l=s.target.closest("modus-wc-autocomplete");if(l){const i=s.detail.target,o=i.value.toLowerCase();if(o===""){l.items=[...m],l.value=i.value;return}l.showSpinner=!0,setTimeout(()=>{const a=f.filter(u=>u.label.toLowerCase().includes(o));l.items=a,l.showSpinner=!1},1e3),l.value=i.value}},c=s=>{const l=s.target.closest("modus-wc-autocomplete");if(l){const n=s.detail.label;n&&(l.value=n)}};return b(R||(R=v([`
      <style>
      ...
      <script>
        ...
        // }
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),m,t(e.label),e["leave-menu-open"],0,!1,t(e.name),e["no-results"],e["read-only"],e.required,!0,t(e.size),e.value,h,c)}},L={parameters:{docs:{description:{story:`
#### Breaking Changes
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>b`<div></div>`};var N,W,H;y.parameters={...y.parameters,docs:{...(N=y.parameters)==null?void 0:N.docs,source:{originalSource:`{
  ...Template
}`,...(H=(W=y.parameters)==null?void 0:W.docs)==null?void 0:H.source}}};var j,K,V;x.parameters={...x.parameters,docs:{...(j=x.parameters)==null?void 0:j.docs,source:{originalSource:`{
  // prettier-ignore
  render: args => html\`
<style>
  div[id^='story--components-forms-autocomplete--with-custom-icon-slot'] {
...
}`,...(V=(K=x.parameters)==null?void 0:K.docs)==null?void 0:V.source}}};var J,U,_;M.parameters={...M.parameters,docs:{...(J=M.parameters)==null?void 0:J.docs,source:{originalSource:`{
  name: 'With Tooltips',
  parameters: {
    docs: {
      description: {
...
}`,...(_=(U=M.parameters)==null?void 0:U.docs)==null?void 0:_.source}}};var G,Q,X;C.parameters={...C.parameters,docs:{...(G=C.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: args => {
...
}`,...(X=(Q=C.parameters)==null?void 0:Q.docs)==null?void 0:X.source}}};var Y,Z,ee;S.parameters={...S.parameters,docs:{...(Y=S.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: args => {
...
}`,...(ee=(Z=S.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var te,ne,oe;E.parameters={...E.parameters,docs:{...(te=E.parameters)==null?void 0:te.docs,source:{originalSource:`{
  render: args => {
...
}`,...(oe=(ne=E.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};var le,ae,se;A.parameters={...A.parameters,docs:{...(le=A.parameters)==null?void 0:le.docs,source:{originalSource:`{
  render: args => {
...
}`,...(se=(ae=A.parameters)==null?void 0:ae.docs)==null?void 0:se.source}}};var ie,ue,ce;k.parameters={...k.parameters,docs:{...(ie=k.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  args: {
    ...meta.args,
...
}`,...(ce=(ue=k.parameters)==null?void 0:ue.docs)==null?void 0:ce.source}}};var re,me,de;$.parameters={...$.parameters,docs:{...(re=$.parameters)==null?void 0:re.docs,source:{originalSource:`{
  render: args => {
    const defaultFruits = [{
      label: 'Apple',
      value: 'apple',
...
}`,...(de=(me=$.parameters)==null?void 0:me.docs)==null?void 0:de.source}}};var pe,he,be;L.parameters={...L.parameters,docs:{...(pe=L.parameters)==null?void 0:pe.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(be=(he=L.parameters)==null?void 0:he.docs)==null?void 0:be.source}}};const Se=["Default","WithCustomIconSlot","WithTooltips","MultiSelect","WithSpinner","CustomMenuItems","CustomEventHandlers","WithProgrammaticControl","DynamicOptions","Migration"];export{A as CustomEventHandlers,E as CustomMenuItems,y as Default,$ as DynamicOptions,L as Migration,C as MultiSelect,x as WithCustomIconSlot,k as WithProgrammaticControl,S as WithSpinner,M as WithTooltips,Se as __namedExportsOrder,we as default};
