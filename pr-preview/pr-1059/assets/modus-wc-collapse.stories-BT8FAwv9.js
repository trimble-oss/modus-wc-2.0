import{w as T}from"./decorator-D4YmxizW.js";import{x as d}from"./lit-element-CucEn6F2.js";import{o as r}from"./if-defined-BiZP-SBN.js";import{c as A}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var p=Object.freeze,z=Object.defineProperty,S=(e,t)=>p(z(e,"raw",{value:p(e.slice())})),u,m;const M={title:"Collapse Title",description:"Collapse description",icon:"alert",iconAriaLabel:"Alert"},D={title:"Components/Collapse",component:"modus-wc-collapse",args:{bordered:!1,expanded:!1,options:M},argTypes:{options:{description:"Configuration options for the collapse component",table:{type:{detail:`
          ...
          `}}}},decorators:[T],parameters:{actions:{handles:["expandedChange"]},layout:"padded"}},H={render:e=>d(u||(u=S([`
<modus-wc-collapse
  ?bordered=`,`
  custom-class=`,`
  ?expanded=`,`
...
<\/script>
    `])),e.bordered,r(e["custom-class"]),e.expanded,r(e.id),e.options)},s={...H},a={render:e=>{const t=()=>{window.alert("Button was clicked!")};return d(m||(m=S([`
<style>
  .clickable-div {
    position: relative;
    width: fit-content;
...
<\/script>
    `])),e.bordered,r(e["custom-class"]),e.expanded,t,t)}},l={render:e=>{if(!customElements.get("collapse-shadow-host")){const t=A({componentTag:"modus-wc-collapse",propsMapper:(o,c)=>{const n=c;c.querySelector('[slot="content"]')||(c.innerHTML='<div slot="content">Collapse content</div>'),n.bordered=!!o.bordered,n.customClass=o["custom-class"]||"",n.expanded=!!o.expanded,n.id=o.id??"",o.options&&(n.options=o.options)}});customElements.define("collapse-shadow-host",t)}return d`<collapse-shadow-host
      .props=${{...e}}
...
| opened    | expandedChange |                  |
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>d`<div></div>`};var h,b,v;s.parameters={...s.parameters,docs:{...(h=s.parameters)==null?void 0:h.docs,source:{originalSource:`{
  ...Template
...
}`,...(g=(C=a.parameters)==null?void 0:C.docs)==null?void 0:g.source}}};var f,k,x;l.parameters={...l.parameters,docs:{...(f=l.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: args => {
...
}`,...(x=(k=l.parameters)==null?void 0:k.docs)==null?void 0:x.source}}};var E,B,y;i.parameters={...i.parameters,docs:{...(E=i.parameters)==null?void 0:E.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| opened    | expandedChange |                  |
  ...
  render: () => html\`<div></div>\`
}`,...(y=(B=i.parameters)==null?void 0:B.docs)==null?void 0:y.source}}};const O=["Default","WithCustomClickableHeader","ShadowDomParent","Migration"];export{s as Default,i as Migration,l as ShadowDomParent,a as WithCustomClickableHeader,O as __namedExportsOrder,D as default};
