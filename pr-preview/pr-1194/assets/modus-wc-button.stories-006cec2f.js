import{w as j}from"./decorator-534da2b0.js";import{b as o}from"./lit-element-38260dd9.js";import{o as F}from"./if-defined-30b85b98.js";import{c as G}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";var b=Object.freeze,J=Object.defineProperty,K=(t,s)=>b(J(t,"raw",{value:b(s||t.slice())})),w;const nt={title:"Components/Button",component:"modus-wc-button",args:{color:"primary",disabled:!1,"full-width":!1,pressed:!1,shape:"rectangle",size:"md",type:"button",variant:"filled"},argTypes:{color:{control:{type:"select"},options:["primary","secondary","tertiary","warning","danger"]},shape:{control:{type:"select"},options:["circle","ellipse","rectangle","square"]},size:{control:{type:"select"},options:["xs","sm","md","lg","xl"]},type:{control:{type:"select"},options:["button","submit","reset"]},variant:{control:{type:"select"},options:["borderless","filled","outlined"]}},decorators:[j],parameters:{actions:{handles:["buttonClick"]}}},Q={render:t=>o`
<modus-wc-button
  color="${t.color}"
