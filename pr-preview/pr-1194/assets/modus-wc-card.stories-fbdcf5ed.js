...
>
  ...
  `},p={render:o=>{if(!customElements.get("card-shadow-host")){const L=Y({componentTag:"modus-wc-card",propsMapper:(s,g)=>{const t=g;t.backgroundFigure=Boolean(s["background-figure"]),t.bordered=Boolean(s.bordered),t.customClass=s["custom-class"]||"",t.layout=s.layout??"vertical",t.padding=s.padding??"compact",g.hasChildNodes()||(g.innerHTML='<span slot="title">Card Title</span><span slot="subtitle">Card Subtitle</span><p>This is a sample card content. You can place any content here.</p><div slot="actions" class="modus-wc-justify-end"><modus-wc-button aria-label="Click me">Click me</modus-wc-button></div>')}});customElements.define("card-shadow-host",L)}return a` <style>
        card-shadow-host {
          width: 400px;
          display: block;
        }
    ...
    if (!customElements.get('card-shadow-host')) {
      const CardShadowHost = createShadowHostClass<CardArgs>({
        ...
        propsMapper: (v: CardArgs, el: HTMLElement) => {
          ...
          if (!el.hasChildNodes()) {
            el.innerHTML = '<span slot="title">Card Title</span><span slot="subtitle">Card Subtitle</span><p>This is a sample card content. You can place any content here.</p><div slot="actions" class="modus-wc-justify-end"><modus-wc-button aria-label="Click me">Click me</modus-wc-button></div>';
          }
        }
      });
...
| width                |                     | Not carried over, use CSS instead    |
  ...
  render: () => html\`<div></div>\`
}`,...(j=(P=m.parameters)==null?void 0:P.docs)==null?void 0:j.source}}};const q=["Default","SimpleCard","SlotsLayout","ComplexCard","HorizontalImage","BackgroundFigureImage","ShadowDomParent","Migration"];export{u as BackgroundFigureImage,i as ComplexCard,d as Default,l as HorizontalImage,m as Migration,p as ShadowDomParent,n as SimpleCard,c as SlotsLayout,q as __namedExportsOrder,O as default};
