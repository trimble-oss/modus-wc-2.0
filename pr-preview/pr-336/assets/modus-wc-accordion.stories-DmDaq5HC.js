import{w as l}from"./decorator-DFROgT0E.js";import{x as d}from"./lit-element-C8zulti1.js";import{o as m}from"./if-defined-yv6owfG8.js";import"./v4-CtRu48qb.js";const n=[{description:"Item one description",icon:"alert",iconAriaLabel:"Alert",title:"Item One"},{description:"Item two description",icon:"alert",iconAriaLabel:"Alert",title:"Item Two"},{description:"Item three description",icon:"alert",iconAriaLabel:"Alert",title:"Item Three"}],x={title:"Components/Accordion",component:"modus-wc-accordion",decorators:[l],parameters:{actions:{handles:["expandedChange"]},layout:{padded:!0}}},u={render:p=>d`
...
| opened    | expandedChange |                  |
  ...
  ...Template
}`,...(i=(t=e.parameters)==null?void 0:t.docs)==null?void 0:i.source}}};var r,c,s;o.parameters={...o.parameters,docs:{...(r=o.parameters)==null?void 0:r.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| opened    | expandedChange |                  |
  ...
  render: () => html\`<div></div>\`
}`,...(s=(c=o.parameters)==null?void 0:c.docs)==null?void 0:s.source}}};const w=["Default","Migration"];export{e as Default,o as Migration,w as __namedExportsOrder,x as default};
