import{w as m}from"./decorator-DFROgT0E.js";import{x as l}from"./lit-element-C8zulti1.js";import{o as n}from"./if-defined-yv6owfG8.js";import"./v4-CtRu48qb.js";const c={firstPage:"First page",lastPage:"Last page",nextPage:"Next page",page:"Page {0}",previousPage:"Previous page"},h={title:"Components/Pagination",component:"modus-wc-pagination",args:{"aria-label-values":c,count:5,"custom-class":"",page:1,size:"md"},argTypes:{"aria-label-values":{description:"Custom aria label values for pagination buttons",table:{type:{detail:`
...
\`\`\`
  ...
  render: args => html\`
    ...
    ></modus-wc-pagination>
  \`
}`,...(i=(s=a.parameters)==null?void 0:s.docs)==null?void 0:i.source}}};var r,p,g;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| pageChange  | pageChange  | Now emits an object with \\\`newPage\\\` and \\\`prevPage\\\`   |
  ...
  render: () => html\`<div></div>\`
}`,...(g=(p=t.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};const f=["Default","Migration"];export{a as Default,t as Migration,f as __namedExportsOrder,h as default};
