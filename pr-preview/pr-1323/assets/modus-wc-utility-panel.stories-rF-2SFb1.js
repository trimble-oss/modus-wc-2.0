import{w as V}from"./decorator-Cv9na35H.js";import{b as d}from"./lit-element-DgBvYnzn.js";import{o as C}from"./if-defined-BnVFTJ4o.js";import{c as X}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-C_wAuwg_.js";import"./v4-C6aID195.js";const ie={title:"Components/Utility Panel",component:"modus-wc-utility-panel",args:{expanded:!1,"push-content":!0},argTypes:{"custom-class":{control:{type:"text"}},expanded:{control:{type:"boolean"}},"push-content":{control:{type:"boolean"}}},decorators:[V,e=>(requestAnimationFrame(()=>{document.querySelectorAll("modus-wc-utility-panel").forEach(a=>{const t=a.closest(".demo-container");if(t){const c=t.querySelector(".main-content");c&&a&&(a.targetElement=c)}})}),e())],parameters:{actions:{handles:["panelOpened","panelClosed"]},docs:{description:{component:"A utility panel component that slides in from the right side of the screen. It can either push content or display as an overlay.\n\nThe component supports `<slot>` called 'header' for panel title content, 'body' for main content area, and 'footer' for action buttons or additional controls."}},layout:"fullscreen"}},o=`
  .demo-container {
    height: 100vh;
    display: flex;
