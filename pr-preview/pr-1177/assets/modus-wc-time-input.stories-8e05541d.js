import{w as _}from"./decorator-534da2b0.js";import{b as o}from"./lit-element-38260dd9.js";import{o as a}from"./if-defined-30b85b98.js";import{c as W}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";var b=Object.freeze,H=Object.defineProperty,L=(e,u)=>b(H(e,"raw",{value:b(u||e.slice())})),h;const Q={title:"Components/Forms/Time Input",component:"modus-wc-time-input",args:{disabled:!1,label:"Label",size:"md"},argTypes:{"auto-complete":{control:{type:"select"},options:["on","off"]},feedback:{description:"Feedback prop for input components",table:{type:{detail:`
            Interface: IInputFeedbackProp
            Properties:
            - level ('error' | 'info' | 'success' | 'warning'): The feedback level
            - message (string, optional): The feedback message
          `}}},size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[_],parameters:{actions:{handles:["inputBlur","inputChange","inputFocus"]}}},c={render:e=>o`
    <modus-wc-time-input
      ...
      .value=${e.value}
    ></modus-wc-time-input>
  `},i={...c},r={...c,args:{"show-seconds":!0}},s={render:()=>o`
<modus-wc-time-input
...
></modus-wc-time-input>
    `])))},U={level:"error",message:"Value is required."},l={...c,args:{feedback:U,required:!0},parameters:{docs:{source:{transform:e=>`${e}
<script>
...
<\/script>`}}}},m={render:e=>{if(!customElements.get("time-input-shadow-host")){const u=W({componentTag:"modus-wc-time-input",propsMapper:(t,D)=>{const n=D;n.autoComplete=t["auto-complete"]??"",n.bordered=t.bordered??!0,n.customClass=t["custom-class"]||"",n.datalistId=t["datalist-id"]??"",t["datalist-options"]&&(n.datalistOptions=t["datalist-options"]),n.disabled=Boolean(t.disabled),n.inputId=t["input-id"]??"",n.inputTabIndex=t["input-tab-index"]??0,n.label=t.label??"",n.max=t.max??"",n.min=t.min??"",n.name=t.name??"",n.readOnly=Boolean(t["read-only"]),n.required=Boolean(t.required),n.showSeconds=Boolean(t["show-seconds"]),n.size=t.size??"md",t.step!==void 0&&(n.step=t.step),n.value=t.value??""}});customElements.define("time-input-shadow-host",u)}return o`<time-input-shadow-host
      .props=${{...e}}
...
}`,...(O=(C=l.parameters)==null?void 0:C.docs)==null?void 0:O.source}}};var z,N,B;m.parameters={...m.parameters,docs:{...(z=m.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: args => {
...
}`,...(B=(N=m.parameters)==null?void 0:N.docs)==null?void 0:B.source}}};var P,F,M;p.parameters={...p.parameters,docs:{...(P=p.parameters)==null?void 0:P.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
