import{w as $}from"./decorator-D4YmxizW.js";import{x as c}from"./lit-element-C8zulti1.js";import{o as t}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const M={title:"Components/Tabs",component:"modus-wc-tabs",args:{size:"md",tabs:[{label:"Tab 1"},{label:"Tab 2"},{label:"Tab 3",disabled:!0},{icon:"home"}],"tab-style":"bordered"},argTypes:{tabs:{description:"Array of tab objects defining the tabs to display",table:{type:{detail:`
            Interface: ITab
            Properties:
...
>
    ...
    `},a={...l},n={...l};n.args={activeTabIndex:1,tabs:[{label:"Normal"},{label:"Active"},{label:"Disabled",disabled:!0}]};const s={render:e=>(e.tabs=[{icon:"home",iconPosition:"left",label:"Home",customContent:`<span style="display: inline-flex; align-items: center; gap: 8px;">
  ...
  .warning-icon {
    color: red;
  }</style></span>`},{customContent:'<span style="display: inline-flex; align-items: center; gap: 8px;">Notifications<modus-wc-badge color="primary" size="md" variant="counter">5</modus-wc-badge></span>'}],c`
<modus-wc-tabs
  .tabs="${e.tabs}"
  size="${t(e.size)}"
  tab-style="${t(e["tab-style"])}"
...
>
    ...
    `)},o={...l,args:{tabs:[{icon:"home"},{icon:"settings",iconPosition:"left",label:"Settings"},{icon:"alert",iconPosition:"right",label:"Alerts"}]}},i={render:e=>c`
<modus-wc-tabs
  active-tab-index="${t(e.activeTabIndex)}"
  aria-label="Tab group"
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>c`<div></div>`};var d,b,m;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  ...Template
}`,...(m=(b=a.parameters)==null?void 0:b.docs)==null?void 0:m.source}}};var p,u,g;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:`{
  ...Template
...
}`,...(w=(h=s.parameters)==null?void 0:h.docs)==null?void 0:w.source}}};var v,y,T;o.parameters={...o.parameters,docs:{...(v=o.parameters)==null?void 0:v.docs,source:{originalSource:`{
  ...Template,
  args: {
    tabs: [{
      icon: 'home'
...
}`,...(T=(y=o.parameters)==null?void 0:y.docs)==null?void 0:T.source}}};var x,C,I;i.parameters={...i.parameters,docs:{...(x=i.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: args => {
    // prettier-ignore
    return html\`
<modus-wc-tabs
...
}`,...(I=(C=i.parameters)==null?void 0:C.docs)==null?void 0:I.source}}};var z,P,S;r.parameters={...r.parameters,docs:{...(z=r.parameters)==null?void 0:z.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(S=(P=r.parameters)==null?void 0:P.docs)==null?void 0:S.source}}};const G=["Default","ActiveAndDisabled","CustomContent","Icons","TabsWithPanel","Migration"];export{n as ActiveAndDisabled,s as CustomContent,a as Default,o as Icons,r as Migration,i as TabsWithPanel,G as __namedExportsOrder,M as default};
