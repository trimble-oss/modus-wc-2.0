...
>
    ...
    >
      ...
      >
        <modus-wc-badge
          color="primary"
          ?disabled="${!!((d=e.tabs[0])!=null&&d.disabled)}"
          size="${t(e.size)}"
          variant="outlined"
        >
      ...
      >
        ...
        <modus-wc-icon
          name="warning"
          variant="solid"
          ?disabled="${!!((b=e.tabs[2])!=null&&b.disabled)}"
          size="${t(e.size)}"
      ...
      >
        ...
        <modus-wc-badge
          color="primary"
          disabled="${!!((m=e.tabs[3])!=null&&m.disabled)}"
          size="${t(e.size)}"
          variant="counter"
          >5</modus-wc-badge
        >
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>c`<div></div>`};var p,u,g;s.parameters={...s.parameters,docs:{...(p=s.parameters)==null?void 0:p.docs,source:{originalSource:`{
  ...Template
}`,...(g=(u=s.parameters)==null?void 0:u.docs)==null?void 0:g.source}}};var f,h,w;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  ...Template
}`,...(w=(h=a.parameters)==null?void 0:h.docs)==null?void 0:w.source}}};var v,y,T;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    tabs: [{
      icon: 'home',
      iconPosition: 'left',
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(N=(D=r.parameters)==null?void 0:D.docs)==null?void 0:N.source}}};const O=["Default","ActiveAndDisabled","CustomContent","Icons","TabsWithPanel","Migration"];export{a as ActiveAndDisabled,n as CustomContent,s as Default,o as Icons,r as Migration,i as TabsWithPanel,O as __namedExportsOrder,H as default};
