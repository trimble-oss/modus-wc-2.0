import{w as A}from"./decorator-D4YmxizW.js";import{x as c}from"./lit-element-C8zulti1.js";import{o as t}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const O={title:"Components/Tabs",component:"modus-wc-tabs",args:{size:"md",tabs:[{label:"Tab 1"},{label:"Tab 2"},{label:"Tab 3",disabled:!0},{icon:"home"}],"tab-style":"bordered"},argTypes:{tabs:{description:"Array of tab objects defining the tabs to display",table:{type:{detail:`
            Interface: ITab
            Properties:
...
>
    ...
    `},a={args:{tabs:[{icon:"home",iconPosition:"left",label:"Home",slotName:"home-tab-content"},{icon:"clipboard",iconPosition:"right",label:"Tasks"},{slotName:"actions-tab-content"},{slotName:"notifications-tab-content"}]},parameters:{docs:{description:{story:"Tabs now include slots, offering a flexible approach for users to add relevant components within the tab for more complex use cases."}}},render:e=>{var d,b,m;return c`
    <style>
      .red-icon {
        color: red;
      }
  ...
  `}},s={...l},n={...l};n.args={activeTabIndex:1,tabs:[{label:"Normal"},{label:"Active"},{label:"Disabled",disabled:!0}]};const o={...l,args:{tabs:[{icon:"home"},{icon:"settings",iconPosition:"left",label:"Settings"},{icon:"alert",iconPosition:"right",label:"Alerts"}]}},i={render:e=>c`
<modus-wc-tabs
  active-tab-index="${t(e.activeTabIndex)}"
  aria-label="Tab group"
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>c`<div></div>`};var p,u,g;a.parameters={...a.parameters,docs:{...(p=a.parameters)==null?void 0:p.docs,source:{originalSource:`{
  args: {
    tabs: [{
      icon: 'home',
      iconPosition: 'left',
  ...
  \`
}`,...(g=(u=a.parameters)==null?void 0:u.docs)==null?void 0:g.source}}};var f,h,w;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`{
  ...Template
}`,...(w=(h=s.parameters)==null?void 0:h.docs)==null?void 0:w.source}}};var v,y,T;n.parameters={...n.parameters,docs:{...(v=n.parameters)==null?void 0:v.docs,source:{originalSource:`{
  ...Template
}`,...(T=(y=n.parameters)==null?void 0:y.docs)==null?void 0:T.source}}};var x,$,z;o.parameters={...o.parameters,docs:{...(x=o.parameters)==null?void 0:x.docs,source:{originalSource:`{
  ...Template,
  args: {
    tabs: [{
      icon: 'home'
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(N=(D=r.parameters)==null?void 0:D.docs)==null?void 0:N.source}}};const W=["CustomContent","Default","ActiveAndDisabled","Icons","TabsWithPanel","Migration"];export{n as ActiveAndDisabled,a as CustomContent,s as Default,o as Icons,r as Migration,i as TabsWithPanel,W as __namedExportsOrder,O as default};
