...
<modus-wc-button aria-label="${o["aria-label"]}" label="Checkout">
  ...
  <modus-wc-icon slot="right" name="shopping_cart"></modus-wc-icon>
    ...
    `};var c,u,i;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`{
  ...Template
}`,...(i=(u=a.parameters)==null?void 0:u.docs)==null?void 0:i.source}}};var d,m,b;t.parameters={...t.parameters,docs:{...(d=t.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: args => {
    return html\`
<modus-wc-button
...
}`,...(b=(m=t.parameters)==null?void 0:m.docs)==null?void 0:b.source}}};var p,w,h;r.parameters={...r.parameters,docs:{...(p=r.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: args => {
    return html\`
...
}`,...(h=(w=r.parameters)==null?void 0:w.docs)==null?void 0:h.source}}};var g,$,f;n.parameters={...n.parameters,docs:{...(g=n.parameters)==null?void 0:g.docs,source:{originalSource:`{
  render: args => {
    return html\`
...
}`,...(f=($=n.parameters)==null?void 0:$.docs)==null?void 0:f.source}}};var y,B,S;s.parameters={...s.parameters,docs:{...(y=s.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: args => {
    return html\`
...
}`,...(S=(B=s.parameters)==null?void 0:B.docs)==null?void 0:S.source}}};var C,I,k;l.parameters={...l.parameters,docs:{...(C=l.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: args => {
    return html\`
...
}`,...(k=(I=l.parameters)==null?void 0:I.docs)==null?void 0:k.source}}};const A=["Default","ButtonShapes","IconOnlyButton","IconLeftButton","IconRightButton","IconLeftAndRightButton"];export{t as ButtonShapes,a as Default,l as IconLeftAndRightButton,n as IconLeftButton,r as IconOnlyButton,s as IconRightButton,A as __namedExportsOrder,x as default};
