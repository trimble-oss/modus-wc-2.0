import{w as p}from"./decorator-D4YmxizW.js";import{x as v}from"./lit-element-C8zulti1.js";import{o}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var c=Object.freeze,g=Object.defineProperty,h=(e,i)=>c(g(e,"raw",{value:c(e.slice())})),r;const C={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[p],parameters:{layout:"padded",actions:{handles:["expandedChange"]}}},n={render:e=>{const i=s=>{const a=s.target,d=a==null?void 0:a.closest(".layout-with-navbar");let t;d?t=d.querySelector("modus-wc-side-navigation"):t=document.querySelector("modus-wc-side-navigation"),t&&(t.expanded=s.detail)};return v(r||(r=h([`
    ...
    `])),i,{apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],o(e["custom-class"]),e.expanded,e["max-width"],o(e.mode),o(e["target-content"]))}};var l,m,u;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: args => {
