...
<\/script>
  ...
  `])),d(e["custom-class"]),d(e.orientation),e.interactive??!1,e.steps)},p={...A},a={args:{interactive:!0},parameters:{docs:{source:{code:`
<modus-wc-stepper
...
<\/script>
        `}}},render:e=>{const t=[{label:"Scale"},{label:"Belong"},{label:"Grow"},{label:"Innovate",content:"🚀"}],r=n=>t.map((o,y)=>y<=n?{...o,color:"primary"}:{...o}),s=n=>{const o=n.target;o.steps=r(n.detail.index)};return l`
      <modus-wc-stepper
        id="interactive-stepper"
        orientation="horizontal"
        ...
        @stepClick=${s}
      ></modus-wc-stepper>
    `}},i={render:e=>{if(!customElements.get("stepper-shadow-host")){const c=E({componentTag:"modus-wc-stepper",propsMapper:(t,r)=>{const s=r;s.customClass=t["custom-class"]||"",s.interactive=t.interactive??!1,s.orientation=t.orientation??"horizontal",s.steps=t.steps??[]}});customElements.define("stepper-shadow-host",c)}return l`<stepper-shadow-host
      .props=${{...e}}
    ></stepper-shadow-host>`}};var u,h,S;p.parameters={...p.parameters,docs:{...(u=p.parameters)==null?void 0:u.docs,source:{originalSource:`{
  ...Template
}`,...(S=(h=p.parameters)==null?void 0:h.docs)==null?void 0:S.source}}};var g,w,I;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
    interactive: true
  },
  parameters: {
...
}`,...(I=(w=a.parameters)==null?void 0:w.docs)==null?void 0:I.source}}};var b,x,f;i.parameters={...i.parameters,docs:{...(b=i.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: args => {
...
}`,...(f=(x=i.parameters)==null?void 0:x.docs)==null?void 0:f.source}}};const D=["Default","Interactive","ShadowDomParent"];export{p as Default,a as Interactive,i as ShadowDomParent,D as __namedExportsOrder,P as default};
