...
<modus-wc-autocomplete
  ...
  @itemSelect=`,`
></modus-wc-autocomplete>
    `])),e.bordered,a(e["custom-class"]),a(e["debounce-ms"]),e.disabled,a(e["input-id"]),a(e["input-tab-index"]),e.items,a(e.label),e["leave-menu-open"],e["min-chars"],!0,a(e.name),a(e.placeholder),e["read-only"],e.required,a(e.size),e.value,r,p,i)}},d={parameters:{docs:{description:{story:`
#### Breaking Changes
