import{w as _}from"./decorator-Cv9na35H.js";import{b as a}from"./lit-element-DgBvYnzn.js";import{o}from"./if-defined-BnVFTJ4o.js";import{c as W}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-C_wAuwg_.js";import"./v4-C6aID195.js";var b=Object.freeze,H=Object.defineProperty,L=(e,c)=>b(H(e,"raw",{value:b(e.slice())})),h;const Q={title:"Components/Forms/Time Input",component:"modus-wc-time-input",args:{disabled:!1,label:"Label",size:"md"},argTypes:{"auto-complete":{control:{type:"select"},options:["on","off"]},feedback:{description:"Feedback prop for input components",table:{type:{detail:`
    ...
    <modus-wc-time-input
      ...
      ?required=${e.required}
      show-seconds=${o(e["show-seconds"])}
      size=${o(e.size)}
      step=${o(e.step)}
      .datalistOptions=${e["datalist-options"]}
      .value=${e.value}
    ></modus-wc-time-input>
  `},i={...u},r={...u,args:{"show-seconds":!0}},s={render:()=>a`
<modus-wc-time-input
...
<\/script>`}}}},m={render:e=>{if(!customElements.get("time-input-shadow-host")){const c=W({componentTag:"modus-wc-time-input",propsMapper:(t,D)=>{const n=D;n.autoComplete=t["auto-complete"]??"",n.bordered=t.bordered??!0,n.customClass=t["custom-class"]||"",n.datalistId=t["datalist-id"]??"",t["datalist-options"]&&(n.datalistOptions=t["datalist-options"]),n.disabled=!!t.disabled,n.inputId=t["input-id"]??"",n.inputTabIndex=t["input-tab-index"]??0,n.label=t.label??"",n.max=t.max??"",n.min=t.min??"",n.name=t.name??"",n.readOnly=!!t["read-only"],n.required=!!t.required,n.showSeconds=!!t["show-seconds"],n.size=t.size??"md",t.step!==void 0&&(n.step=t.step),n.value=t.value??""}});customElements.define("time-input-shadow-host",c)}return a`<time-input-shadow-host
      .props=${{...e}}
...
| valueChange    | inputChange |                                                      |
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>a`<div></div>`};var v,f,g;i.parameters={...i.parameters,docs:{...(v=i.parameters)==null?void 0:v.docs,source:{originalSource:`{
  ...Template
