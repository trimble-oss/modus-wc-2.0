...
[data-theme=modus-modern-light] modus-wc-date .calendar-container,
[data-theme=modus-modern-dark] modus-wc-date .calendar-container,
[data-theme=modus-classic-light] modus-wc-date .calendar-container,
[data-theme=modus-classic-dark] modus-wc-date .calendar-container {
  border-radius: var(--modus-wc-border-radius-box);
  box-shadow: 0 2px 4px -2px rgba(0, 0, 0, 0.1), 0 4px 6px -1px rgba(0, 0, 0, 0.1);
}
[data-theme=modus-modern-light] modus-wc-date .calendar-container .calendar-header,
[data-theme=modus-modern-dark] modus-wc-date .calendar-container .calendar-header,
[data-theme=modus-classic-light] modus-wc-date .calendar-container .calendar-header,
[data-theme=modus-classic-dark] modus-wc-date .calendar-container .calendar-header {
  min-height: 55px;
}
[data-theme=modus-modern-light] modus-wc-date .calendar-container .calendar-header .nav-btn,
[data-theme=modus-modern-dark] modus-wc-date .calendar-container .calendar-header .nav-btn,
[data-theme=modus-classic-light] modus-wc-date .calendar-container .calendar-header .nav-btn,
[data-theme=modus-classic-dark] modus-wc-date .calendar-container .calendar-header .nav-btn {
  align-self: center;
  display: inline-flex;
  flex-shrink: 0;
}
[data-theme=modus-modern-light] modus-wc-date .calendar-container .calendar-header .calendar-selects modus-wc-select,
[data-theme=modus-modern-dark] modus-wc-date .calendar-container .calendar-header .calendar-selects modus-wc-select,
[data-theme=modus-classic-light] modus-wc-date .calendar-container .calendar-header .calendar-selects modus-wc-select,
[data-theme=modus-classic-dark] modus-wc-date .calendar-container .calendar-header .calendar-selects modus-wc-select {
  align-self: center;
  display: inline-flex;
}
[data-theme=modus-modern-light] modus-wc-date .calendar-container .calendar-header .calendar-selects modus-wc-select select.modus-wc-select,
...
[data-theme=modus-classic-light] modus-wc-date .calendar-container .calendar-header .calendar-selects modus-wc-select select.modus-wc-select,
[data-theme=modus-classic-dark] modus-wc-date .calendar-container .calendar-header .calendar-selects modus-wc-select select.modus-wc-select {
  background-color: var(--modus-wc-color-white);
  border-radius: var(--modus-wc-border-radius-input);
  box-shadow: 0 1px 2px 0 rgba(0, 0, 0, 0.05);
  color: var(--modus-wc-color-gray-10);
