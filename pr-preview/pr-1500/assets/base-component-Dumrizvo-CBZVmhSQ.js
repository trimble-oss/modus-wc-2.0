...
modus-wc-date .calendar-container .calendar-header .nav-btn {
  align-self: center;
  display: inline-flex;
  flex-shrink: 0;
}
...
modus-wc-date .calendar-container .calendar-header .calendar-selects modus-wc-select {
  align-self: center;
  display: inline-flex;
}
modus-wc-date .calendar-container .calendar-header .calendar-selects modus-wc-select select.modus-wc-select {
  background-color: var(--modus-wc-color-white);
