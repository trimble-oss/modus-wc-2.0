...
[data-theme=modus-modern-dark] modus-wc-date .calendar-container .calendar-header {
  gap: var(--modus-wc-spacing-xs);
  padding: var(--modus-wc-spacing-xs) var(--modus-wc-spacing-xl);
}
...
[data-theme=modus-modern-dark] modus-wc-date .calendar-container .calendar-header .calendar-selects modus-wc-select select.modus-wc-select:hover, [data-theme=modus-modern-dark] modus-wc-date .calendar-container .calendar-header .calendar-selects modus-wc-select select.modus-wc-select:focus, [data-theme=modus-modern-dark] modus-wc-date .calendar-container .calendar-header .calendar-selects modus-wc-select select.modus-wc-select:active, [data-theme=modus-modern-dark] modus-wc-date .calendar-container .calendar-header .calendar-selects modus-wc-select select.modus-wc-select:focus-visible {
  background-color: transparent;
  color: var(--modus-wc-color-base-content);
}
