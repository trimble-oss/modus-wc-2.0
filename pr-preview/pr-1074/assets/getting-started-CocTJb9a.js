import{j as e,M as r}from"./index-CqBxgeWe.js";import{useMDXComponents as t}from"./index-v6A4WH50.js";import"./iframe-CaphtZd7.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-aQYXhgXp.js";import"./index-DrFu-skq.js";function o(s){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...t(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Documentation/Getting Started"}),`
...
`,e.jsx(n.p,{children:"Modus Web Components supports server-side rendering via Stencil's hydrate app."}),`
`,e.jsx(n.h3,{id:"installation-1",children:"Installation"}),`
`,e.jsxs(n.p,{children:["The ",e.jsx(n.code,{children:"hydrate"})," subpath is included in the package — no additional install needed."]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-bash",children:`npm install @trimble-oss/moduswebcomponents
`})}),`
`,e.jsx(n.h3,{id:"nextjs-app-router-setup",children:"Next.js (App Router) Setup"}),`
`,e.jsx(n.p,{children:e.jsxs(n.strong,{children:["1. Create a reusable ",e.jsx(n.code,{children:"ModusSSR"})," helper (one-time setup)"]})}),`
...
`})}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"2. Use it in any Server Component"})}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`// app/page.tsx
...
`})}),`
`,e.jsx(n.p,{children:e.jsx(n.strong,{children:"3. Register custom elements for client-side interactivity"})}),`
`,e.jsx(n.p,{children:"SSR renders the initial HTML, but event handlers require the Stencil runtime on the client."}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`// app/providers.tsx
'use client';
...
`})}),`
`,e.jsx(n.p,{children:"Wrap your layout with this provider:"}),`
...
`,e.jsxs(n.p,{children:["The Modus CSS references font files via relative paths, so it needs to be served statically rather than bundled. Add a ",e.jsx(n.code,{children:"postinstall"})," script to your ",e.jsx(n.code,{children:"package.json"})," to automate this:"]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-json",children:`{
  "scripts": {
    "postinstall": "npm run setup:modus",
    "setup:modus": "cp node_modules/@trimble-oss/moduswebcomponents/modus-wc-styles.css public/ && cp node_modules/@trimble-oss/moduswebcomponents/modus-icons.css public/ && cp -r node_modules/@trimble-oss/moduswebcomponents/assets public/"
  }
}
`})}),`
`,e.jsx(n.p,{children:"Or run it once manually:"}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-bash",children:`cp node_modules/@trimble-oss/moduswebcomponents/modus-wc-styles.css public/
cp node_modules/@trimble-oss/moduswebcomponents/modus-icons.css public/
cp -r node_modules/@trimble-oss/moduswebcomponents/assets public/
`})}),`
`,e.jsx(n.h3,{id:"notes",children:"Notes"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.code,{children:"renderToString"})," runs on the server only — no browser APIs involved."]}),`
`,e.jsxs(n.li,{children:["The ",e.jsx(n.code,{children:"inputHtml"})," passed to ",e.jsx(n.code,{children:"ModusSSR"})," must be trusted markup, not user-supplied content."]}),`
`,e.jsx(n.li,{children:"The function is framework-agnostic — works with Next.js, Remix, Express, or any Node.js server."}),`
`]}),`
`,e.jsx(n.hr,{}),`
...
or `,e.jsx(n.a,{href:"https://github.com/trimble-oss/modus-wc-2.0/issues",rel:"nofollow",children:"raise an issue"}),"."]})]})}function u(s={}){const{wrapper:n}={...t(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(o,{...s})}):o(s)}export{u as default};
