...
<div style="display: flex; flex-direction: column; gap: 16px;">
  ...
  <div style="display: flex; gap: 8px;">
    ...
    `])))},c={render:t=>{if(!customElements.get("button-group-shadow-host")){const p=R({componentTag:"modus-wc-button-group",propsMapper:(o,b)=>{const n=b;n.variant=o.variant,n.color=o.color,n.disabled=Boolean(o.disabled),n.orientation=o.orientation,n.selectionType=o["selection-type"],b.hasChildNodes()||(b.innerHTML="<modus-wc-button>Button 1</modus-wc-button><modus-wc-button>Button 2</modus-wc-button><modus-wc-button>Button 3</modus-wc-button>")}});customElements.define("button-group-shadow-host",p)}return e`<button-group-shadow-host
      .props=${{...t}}
