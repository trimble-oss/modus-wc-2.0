import{w as v}from"./decorator-534da2b0.js";import{b as d}from"./lit-element-38260dd9.js";import{o}from"./if-defined-30b85b98.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";const f={showBackButton:!0,title:"Title",subtitle:"Subtitle",showCloseButton:!0},S={title:"Components/Bottom Sheet",component:"modus-wc-bottom-sheet",args:{"custom-class":"",visible:!0,"display-mode":"default","drag-step-threshold":.4,header:f},argTypes:{visible:{control:"boolean",table:{defaultValue:{summary:"false"}}},"display-mode":{control:"select",options:["default","expanded","minimized"],table:{defaultValue:{summary:"default"}}},"drag-step-threshold":{control:{type:"number",min:0,max:1,step:.05},table:{defaultValue:{summary:"0.4"}}},header:{description:"Configuration for the built-in header layout. Do not set if you use the header slot.",table:{type:{detail:`
...
}`,...(g=(y=a.parameters)==null?void 0:y.docs)==null?void 0:g.source}}};const E=["Default","TriggeredByButton","ContentOnly"];export{a as ContentOnly,i as Default,n as TriggeredByButton,E as __namedExportsOrder,S as default};
