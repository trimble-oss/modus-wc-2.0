import{w as x}from"./decorator-534da2b0.js";import{b as i}from"./lit-element-38260dd9.js";import{o}from"./if-defined-30b85b98.js";import{c as $}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";var c=Object.freeze,O=Object.defineProperty,y=(e,d)=>c(O(e,"raw",{value:c(d||e.slice())})),p,u;const B=[{label:"Option 1",value:"1"},{label:"Option 2",value:"2"},{label:"Option 3",value:"3"}],M={title:"Components/Forms/Select",component:"modus-wc-select",args:{bordered:!0,disabled:!1,label:"Label",options:B,size:"md",value:""},argTypes:{feedback:{description:"Feedback prop for input components",table:{type:{detail:`
  ...
  `])),e.bordered,o(e["custom-class"]),e.disabled,e.feedback,o(e["input-aria-invalid"]),o(e["input-id"]),o(e["input-tab-index"]),o(e.label),o(e.name),e.options,e.required,o(e.size),e.value)},C={level:"error",message:"Value is required."},s={render:e=>i(u||(u=y([`
    ...
    <\/script>
  `])),C,o(e.label),[],!0,e.value)},r={render:e=>{if(!customElements.get("select-shadow-host")){const d=$({componentTag:"modus-wc-select",propsMapper:(n,z)=>{const t=z;t.bordered=Boolean(n.bordered),t.customClass=n["custom-class"]||"",t.disabled=Boolean(n.disabled),t.inputId=n["input-id"]||"",t.inputTabIndex=n["input-tab-index"]||0,t.label=n.label||"",t.name=n.name||"",t.options=n.options,t.required=Boolean(n.required),t.size=n.size||"md",t.value=n.value}});customElements.define("select-shadow-host",d)}return i`<select-shadow-host
      .props=${{...e}}
