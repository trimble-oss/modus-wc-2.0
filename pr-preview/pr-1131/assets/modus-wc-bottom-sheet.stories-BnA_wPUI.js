import{w as f}from"./decorator-D4YmxizW.js";import{b as d}from"./lit-element-DgBvYnzn.js";import{o as a}from"./if-defined-BnVFTJ4o.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const y={showBackButton:!0,title:"Title",subtitle:"Subtitle",showCloseButton:!0},S={title:"Components/Bottom Sheet",component:"modus-wc-bottom-sheet",args:{"custom-class":"",open:!0,expanded:!1,minimized:!1,"step-down-threshold":.4,header:y},argTypes:{open:{control:"boolean",table:{defaultValue:{summary:"false"}}},expanded:{control:"boolean",table:{defaultValue:{summary:"false"}}},minimized:{control:"boolean",table:{defaultValue:{summary:"false"}}},"step-down-threshold":{control:{type:"number",min:0,max:1,step:.05},table:{defaultValue:{summary:"0.4"}}},header:{description:"Configuration for the built-in header layout. Do not set if you use the header slot.",table:{type:{detail:`
          ...
          `}},control:{type:"object"}}},decorators:[f],parameters:{layout:"padded",actions:{handles:["headerBackClick","headerCloseClick","expandedChange","minimizedChange","openChange"]}}},s={render:e=>d`
      <style>
    ...
    `},n={args:{header:{showBackButton:!1,title:"Bottom Sheet Title",subtitle:"Drag the handle down to minimize or up to expand.",showCloseButton:!1}},render:e=>{const o="demo-triggered-bottom-sheet",r=()=>{const t=document.getElementById(o);t&&(t.open=!1)};return d`
      <style>
        /* Demo-only frame: the component is position: fixed, which would escape
           to the page (and overlap other stories) on the docs canvas. 'contain'
           makes this frame a containing block for the sheet's position: fixed
...
}`,...(h=(c=s.parameters)==null?void 0:c.docs)==null?void 0:h.source}}};var l,u,p;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
    header: {
...
}`,...(p=(u=n.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};var w,b,g;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
    header: undefined
  },
  render: args => {
...
}`,...(g=(b=i.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};const T=["Default","TriggeredByButton","ContentOnly"];export{i as ContentOnly,s as Default,n as TriggeredByButton,T as __namedExportsOrder,S as default};
