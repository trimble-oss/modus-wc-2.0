import{w as v}from"./decorator-534da2b0.js";import{b as d}from"./lit-element-38260dd9.js";import{o}from"./if-defined-30b85b98.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";const f={showBackButton:!0,title:"Title",subtitle:"Subtitle",showCloseButton:!0},M={title:"Components/Bottom Sheet",component:"modus-wc-bottom-sheet",args:{"custom-class":"",visible:!0,"display-mode":"default","drag-step-threshold":.4,header:f},argTypes:{visible:{control:"boolean",table:{defaultValue:{summary:"false"}}},"display-mode":{control:"select",options:["default","expanded","minimized"],table:{defaultValue:{summary:"default"}}},"drag-step-threshold":{control:{type:"number",min:0,max:1,step:.05},table:{defaultValue:{summary:"0.4"}}},header:{description:"Configuration for the built-in header layout. Do not set if you use the header slot.",table:{type:{detail:`
          ...
          `}},control:{type:"object"}}},decorators:[v],parameters:{layout:"padded",actions:{handles:["headerBackClick","headerCloseClick","displayModeChange","sheetVisibilityChange"]},docs:{description:{component:["A bottom sheet that slides up from the bottom of the viewport.","","**Usage in your app**","- Render `<modus-wc-bottom-sheet>` as a **direct child of `<body>`** (or another top-level element) so its `position: fixed` anchors it to the window. When nested inside a positioned/`contain`ed container it falls back to `position: absolute` and is bounded by that container instead.","- Keep the **trigger button and its click handler in your own page**. Open the sheet by setting the `visible` property to `true` and close it with `visible = false`; set `displayMode` to control the resting size.","- Listen to `sheetVisibilityChange` and `displayModeChange` to react to state changes.","","The dashed frame in these stories is **demo-only**: it bounds the sheet so it does not overlap the rest of the Storybook canvas."].join(`
`)}}}},n={parameters:{docs:{description:{story:"Default sheet with the built-in header, content, and footer slots. Toggle the `visible` control to open and close it. In a real app, attach the sheet to `<body>` and drive `visible` from a button in your page (see **Triggered By Button**)."}}},render:e=>d`
      <style>
...
<\/script>`}}},render:e=>{const s="demo-triggered-bottom-sheet",r=()=>{const t=document.getElementById(s);t&&(t.visible=!1)};return d`
    ...
    `};var h,c,m;n.parameters={...n.parameters,docs:{...(h=n.parameters)==null?void 0:h.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(m=(c=n.parameters)==null?void 0:c.docs)==null?void 0:m.source}}};var u,p,b;i.parameters={...i.parameters,docs:{...(u=i.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
    header: {
...
}`,...(b=(p=i.parameters)==null?void 0:p.docs)==null?void 0:b.source}}};var y,g,w;a.parameters={...a.parameters,docs:{...(y=a.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    header: undefined
  },
  parameters: {
...
}`,...(w=(g=a.parameters)==null?void 0:g.docs)==null?void 0:w.source}}};const I=["Default","TriggeredByButton","ContentOnly"];export{a as ContentOnly,n as Default,i as TriggeredByButton,I as __namedExportsOrder,M as default};
