...
[data-theme=connect-dark] modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md .modus-wc-menu-item-interactive .modus-wc-menu-item-labels {
  font-size: var(--modus-wc-font-size-connect-md);
  font-weight: var(--modus-wc-font-weight-normal);
  line-height: var(--modus-wc-line-height-connect-md);
}
[data-theme=connect-light] modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md.modus-wc-menu-item-active .modus-wc-menu-item-interactive .modus-wc-menu-item-labels,
[data-theme=connect-dark] modus-wc-tree-item .modus-wc-menu-item.modus-wc-menu-item-md.modus-wc-menu-item-active .modus-wc-menu-item-interactive .modus-wc-menu-item-labels {
  font-weight: var(--modus-wc-font-weight-semibold);
}
