import{x as i}from"./lit-element-C8zulti1.js";import{o as t}from"./if-defined-yv6owfG8.js";const C={title:"Components/Alert",component:"modus-wc-alert",args:{"alert-description":"You have 3 new messages.","alert-title":"New message!",dismissible:!1,role:"status",variant:"info"},argTypes:{role:{control:{type:"select"},options:["","alert","log","marquee","status","timer"]},variant:{control:{type:"select"},options:["","error","info","success","warning"]}},parameters:{layout:"padded"}},w={render:e=>i`
<modus-wc-alert
...
}`,...(v=(b=o.parameters)==null?void 0:b.docs)==null?void 0:v.source}}};var $,f,g;r.parameters={...r.parameters,docs:{...($=r.parameters)==null?void 0:$.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| dismissClick | dismissClick |                                       |
  ...
  render: () => html\`<div></div>\`
}`,...(g=(f=r.parameters)==null?void 0:f.docs)==null?void 0:g.source}}};const D=["Default","CustomButton","WithCustomContent","Migration"];export{s as CustomButton,n as Default,r as Migration,o as WithCustomContent,D as __namedExportsOrder,C as default};
