import{w as S}from"./decorator-D4YmxizW.js";import{x as i}from"./lit-element-CucEn6F2.js";import{o as s}from"./if-defined-BiZP-SBN.js";import{g as k}from"./logo-constants-B1DTGvvy.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var d=Object.freeze,M=Object.defineProperty,y=(e,r)=>d(M(e,"raw",{value:d(e.slice())})),u,l;const I={apps:"Apps",help:"Help",notifications:"Notifications",search:"Search"},A={avatarAlt:"Sonic",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"sonic@trimble.com",name:"Sonic the Hedgehog"},T={ai:!0,apps:!0,help:!0,logo:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!0,user:!0},U={title:"Components/Navbar",component:"modus-wc-navbar",args:{condensed:!1,"search-debounce-ms":300,"text-overrides":I,"user-card":A,visibility:T,"logo-name":"trimble"},argTypes:{"text-overrides":{description:"Text replacements for navbar menu items",table:{type:{detail:`
...
<\/script>
    ...
    `])),e["apps-menu-open"],e.condensed,e["condensed-menu-open"],s(e["custom-class"]),e["main-menu-open"],e["notifications-menu-open"],s(e["search-debounce-ms"]),e["search-input-open"],s(e["text-overrides"]),e["user-card"],e["user-menu-open"],e.visibility,e["logo-name"])},n={...z},t={render:e=>{function r(C){var c;const a=(c=C.currentTarget.parentElement)==null?void 0:c.querySelector("#custom-user-menu");a==null||a.classList.toggle("hidden")}return i(l||(l=y([`
  ...
  ...Template
}`,...(v=(p=n.parameters)==null?void 0:p.docs)==null?void 0:v.source}}};var b,g,f;t.parameters={...t.parameters,docs:{...(b=t.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: args => {
