...
<\/script>
    `])),o.bordered,e(o["chevron-position"]),e(o["custom-class"]),o.expanded,e(o.id),o.options)},a={...D},l={render:o=>i(b||(b=u([`
<modus-wc-collapse
  ?bordered=`,`
  chevron-position=`,`
  custom-class=`,`
...
//   collapse.options = options;
<\/script>
    `])),o.bordered,e(o["chevron-position"]),e(o["custom-class"]),o.expanded,e(o.id),o.options),args:{bordered:!1,"chevron-position":"left",expanded:!1,options:H}},r={render:o=>{const s=()=>{window.alert("Button was clicked!")};return i(v||(v=u([`
<style>
  .clickable-div {
    position: relative;
    width: fit-content;
...
| opened    | expandedChange |                  |
  ...
  ...Template
}`,...(C=(g=a.parameters)==null?void 0:g.docs)==null?void 0:C.source}}};var f,x,k;l.parameters={...l.parameters,docs:{...(f=l.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: args => {
    // prettier-ignore
    return html\`
<modus-wc-collapse
...
}`,...(k=(x=l.parameters)==null?void 0:x.docs)==null?void 0:k.source}}};var A,S,E;r.parameters={...r.parameters,docs:{...(A=r.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: args => {
...
}`,...(E=(S=r.parameters)==null?void 0:S.docs)==null?void 0:E.source}}};var I,y,T;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: args => {
...
| opened    | expandedChange |                  |
  ...
  render: () => html\`<div></div>\`
}`,...(M=(L=d.parameters)==null?void 0:L.docs)==null?void 0:M.source}}};const G=["Default","WithStartAndEndIcons","WithCustomClickableHeader","ShadowDomParent","Migration"];export{a as Default,d as Migration,c as ShadowDomParent,r as WithCustomClickableHeader,l as WithStartAndEndIcons,G as __namedExportsOrder,F as default};
