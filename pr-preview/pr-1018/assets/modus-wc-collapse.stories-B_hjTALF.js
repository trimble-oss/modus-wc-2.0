...
<\/script>
    `])),o.bordered,e(o["chevron-position"]),e(o["custom-class"]),o.expanded,s,s)}},c={render:o=>{if(!customElements.get("collapse-shadow-host")){const s=_({componentTag:"modus-wc-collapse",propsMapper:(t,p)=>{const n=p;p.querySelector('[slot="content"]')||(p.innerHTML='<div slot="content">Collapse content</div>'),n.bordered=!!t.bordered,n.chevronPosition=t["chevron-position"]??"right",n.customClass=t["custom-class"]||"",n.expanded=!!t.expanded,n.id=t.id??"",t.options&&(n.options=t.options)}});customElements.define("collapse-shadow-host",s)}return i`<collapse-shadow-host
      .props=${{...o}}
...
| opened    | expandedChange |                  |
  ...
  render: () => html\`<div></div>\`
}`,...(M=(L=d.parameters)==null?void 0:L.docs)==null?void 0:M.source}}};const G=["Default","WithStartIcon","WithCustomClickableHeader","ShadowDomParent","Migration"];export{a as Default,d as Migration,c as ShadowDomParent,r as WithCustomClickableHeader,l as WithStartIcon,G as __namedExportsOrder,F as default};
