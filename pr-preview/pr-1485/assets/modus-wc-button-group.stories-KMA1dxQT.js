import{w as j}from"./decorator-Cv9na35H.js";import{b as e}from"./lit-element-DgBvYnzn.js";import{o as s}from"./if-defined-BnVFTJ4o.js";import{c as R}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-C_wAuwg_.js";import"./v4-C6aID195.js";var w=Object.freeze,F=Object.defineProperty,H=(t,b)=>w(F(t,"raw",{value:w(t.slice())})),g,v;const Z={title:"Components/Button Group",component:"modus-wc-button-group",args:{variant:"outlined",color:"primary",disabled:!1,orientation:"horizontal","selection-type":"default"},argTypes:{variant:{control:{type:"select"},options:["borderless","filled","outlined"]},color:{control:{type:"select"},options:["primary","secondary","tertiary","warning","danger","neutral","success"]},disabled:{control:"boolean"},orientation:{control:{type:"select"},options:["horizontal","vertical"]},"selection-type":{control:{type:"select"},options:["default","single","multiple"]}},decorators:[j],parameters:{actions:{handles:["buttonSelectionChange","buttonGroupClick"]}}},$={render:t=>e`
