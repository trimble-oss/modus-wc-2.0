import{x as s}from"./lit-element-C8zulti1.js";import{o as z}from"./if-defined-yv6owfG8.js";const y={title:"Components/Icon",component:"modus-wc-icon",args:{"custom-class":"",decorative:!1,name:"alert",size:"md"},argTypes:{size:{control:{type:"select"},options:["xs","sm","md","lg"]},variant:{control:{type:"select"},options:["outlined","solid"]}}},C={render:e=>s`
<modus-wc-icon
...
}`,...(l=(m=n.parameters)==null?void 0:m.docs)==null?void 0:l.source}}};var u,p,h;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`{
  args: {
...
| iconClick |           | Not carried over, use \\\`click\\\` event on host element instead |
  ...
  render: () => html\`<div></div>\`
}`,...(f=(v=r.parameters)==null?void 0:v.docs)==null?void 0:f.source}}};const $=["Default","CustomColor","CustomIcons","Migration"];export{n as CustomColor,t as CustomIcons,o as Default,r as Migration,$ as __namedExportsOrder,y as default};
