import{w as E}from"./decorator-D4YmxizW.js";import{x as i}from"./lit-element-C8zulti1.js";import{o as I}from"./if-defined-yv6owfG8.js";import{c as T}from"./shadow-host-helper-B2BwyiIi.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var l=Object.freeze,S=Object.defineProperty,P=(e,d)=>l(S(e,"raw",{value:l(e.slice())})),p;const a=[{description:"Item one description",icon:"alert",iconAriaLabel:"Alert",title:"Item One"},{description:"Item two description",icon:"alert",iconAriaLabel:"Alert",title:"Item Two"},{description:"Item three description",icon:"alert",iconAriaLabel:"Alert",title:"Item Three"}],z={title:"Components/Accordion",component:"modus-wc-accordion",decorators:[E],parameters:{actions:{handles:["expandedChange"]},layout:{padded:!0}}},y={render:e=>i(p||(p=P([`
...
<script>
 ...
 // Adding this block to show how to set options via JS 
  ...
  // });
<\/script>
    `])),I(e["custom-class"]),a[0],a[1],a[2])},o={...y},n={render:()=>{if(!customElements.get("accordion-shadow-host")){const e=T({componentTag:"modus-wc-accordion",propsMapper:(d,s)=>{const f=s;f.customClass=d["custom-class"]||"",s.innerHTML="",a.forEach(A=>{const c=document.createElement("modus-wc-collapse");c.options=A;const r=document.createElement("div");r.setAttribute("slot","content"),r.textContent="Collapse content",c.appendChild(r),s.appendChild(c)})}});customElements.define("accordion-shadow-host",e)}return i`<accordion-shadow-host .props=${{}}></accordion-shadow-host>`}},t={parameters:{docs:{description:{story:`
#### Breaking Changes
...
| opened    | expandedChange |                  |
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>i`<div></div>`};var m,h,u;o.parameters={...o.parameters,docs:{...(m=o.parameters)==null?void 0:m.docs,source:{originalSource:`{
  ...Template
