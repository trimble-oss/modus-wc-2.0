import{w as q}from"./decorator-D4YmxizW.js";import{x as i}from"./lit-element-C8zulti1.js";import{o as t}from"./if-defined-yv6owfG8.js";import{c as N}from"./shadow-host-helper-B2BwyiIi.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const D={title:"Components/Forms/Number Input",component:"modus-wc-number-input",args:{bordered:!0,disabled:!1,inputmode:"numeric",label:"Label",size:"md",type:"number",value:""},argTypes:{"auto-complete":{control:{type:"select"},options:["on","off"]},feedback:{description:"Feedback prop for input components",table:{type:{detail:`
            Interface: IInputFeedbackProp
            Properties:
            - level ('error' | 'info' | 'success' | 'warning'): The feedback level
            - message (string, optional): The feedback message
          `}}},"input-aria-invalid":{control:{type:"select"},options:["true","false"]},inputmode:{control:{type:"select"},options:["decimal","none","numeric"]},size:{control:{type:"select"},options:["sm","md","lg"]},type:{control:{type:"select"},options:["number","range"]}},decorators:[q],parameters:{actions:{handles:["inputBlur","inputChange","inputFocus"]}}},m={render:e=>i`
    <modus-wc-number-input
      ...
      .value=${e.value}
    ></modus-wc-number-input>
  `},o={...m},z={level:"error",message:"Value is required."},a={...m,args:{"currency-symbol":"$"}},s={...m,args:{feedback:z,required:!0},parameters:{docs:{source:{transform:e=>`${e}
<script>
...
| valueChange  | inputChange  |       |
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>i`<div></div>`};var d,p,c;o.parameters={...o.parameters,docs:{...(d=o.parameters)==null?void 0:d.docs,source:{originalSource:`{
  ...Template
...
}`,...(f=(g=s.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var I,w,E;u.parameters={...u.parameters,docs:{...(I=u.parameters)==null?void 0:I.docs,source:{originalSource:`{
  render: args => {
...
}`,...(E=(w=u.parameters)==null?void 0:w.docs)==null?void 0:E.source}}};var x,k,$;l.parameters={...l.parameters,docs:{...(x=l.parameters)==null?void 0:x.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| valueChange  | inputChange  |       |
  ...
  render: () => html\`<div></div>\`
}`,...($=(k=l.parameters)==null?void 0:k.docs)==null?void 0:$.source}}};const O=["Default","Currency","WithErrorFeedback","ShadowDomParent","Migration"];export{a as Currency,o as Default,l as Migration,u as ShadowDomParent,s as WithErrorFeedback,O as __namedExportsOrder,D as default};
