...
// autocomplete.items = autocompleteItems;
<\/script>
  `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["min-chars"],t(e["min-input-width"]),!1,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],e["show-spinner"],t(e.size),e.value,g),args:{placeholder:"Search fruits..."}},M={name:"With Tooltips",parameters:{docs:{description:{story:"This example demonstrates menu items with tooltips. Hover over the items to see the tooltips."},source:{code:`
        <script>
const tooltipItems = [
  {
    label: 'Apple',
...
`}}},render:()=>f`
    ...
    `},C={render:e=>(e.items||(e.items=[...w]),e.items=e.items.map(m=>m.value==="apple"||m.value==="banana"?{...m,selected:!0}:m),f(P||(P=v([`
      <style>
      ...
      <script>
        ...
        `,`
          ...
          // }
        <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["max-chips"]??4,e["min-chars"],t(e["min-input-width"]),!0,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e.value,g))},S={render:e=>{let m;const s=p=>{var u;if(!((u=p.detail)!=null&&u.target))return;const o=p.target.closest("modus-wc-autocomplete");if(o){const n=p.detail.target.value.toLowerCase();m&&window.clearTimeout(m),o.showSpinner=!0,m=window.setTimeout(()=>{const c=w.filter(l=>l.label.toLowerCase().includes(n));o.items=c,o.showSpinner=!1},2e3)}};return f(F||(F=v([`
      <style>
      ...
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["min-chars"],!1,t(e.name),t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],e["show-spinner"],t(e.size),e.value,s,g)}},E={render:e=>{const m=e["no-results"];e["leave-menu-open"]==!0&&(e["no-results"]={ariaLabel:"",label:"",subLabel:""});const s=a=>{const n=a.querySelectorAll("modus-wc-menu-item:not([disabled])");return Array.from(n).filter(c=>window.getComputedStyle(c).display!=="none"&&!c.classList.contains("hidden"))},p=a=>{var b,h;const n=a.target.closest("modus-wc-autocomplete");if(!n||n.disabled||n.readOnly)return;const l=s(n).map(d=>d.querySelector("button")).filter(Boolean),i=document.activeElement,r=l.indexOf(i);switch(a.key){case"ArrowDown":{a.preventDefault(),n.openMenu();let d=r+1;if(d>=l.length)return;d<0&&(d=0),(b=l[d])==null||b.focus();break}case"ArrowUp":{a.preventDefault(),n.openMenu();let d=r-1;if(d<0)return;(h=l[d])==null||h.focus();break}case"Enter":{a.preventDefault(),l.includes(i)&&i.click();const d=n.querySelector("input");d==null||d.focus();break}case"Escape":{a.preventDefault(),n.closeMenu();const d=n.querySelector("input");d==null||d.focus();break}}},o=a=>{var c;if(!((c=a.detail)!=null&&c.target))return;const n=a.target.closest("modus-wc-autocomplete");if(n){const l=a.detail.target.value.toLowerCase(),i=n==null?void 0:n.querySelectorAll("modus-wc-menu-item");l===""&&(i==null||i.forEach(h=>{h.removeAttribute("selected")}));let r=0;Array.from(i??[]).forEach(h=>{var I;(((I=h.getAttribute("label"))==null?void 0:I.toLowerCase())||"").includes(l)?h.classList.remove("hidden"):(h.classList.add("hidden"),r++)}),n.noResults=r===(i==null?void 0:i.length)?m:{ariaLabel:"",label:"",subLabel:""};const b=n.querySelector(".no-results-item");b&&(r===(i==null?void 0:i.length)?b.classList.add("visible"):b.classList.remove("visible"))}},u=a=>{const n=a.target.closest("modus-wc-autocomplete");if(n){const c=a.detail.value;n.value=c,n.querySelectorAll("modus-wc-menu-item").forEach(i=>{i.getAttribute("value")===c?i.setAttribute("selected","true"):i.removeAttribute("selected")}),e["leave-menu-open"]||n.closeMenu()}};return f(q||(q=v([`
<style>
...
<script>
        ...
        // }
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),t(e.label),e["leave-menu-open"],e["min-chars"],!1,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e["show-spinner"],e.value,p,o,!0,u,u,u,u)}},A={render:e=>{const m=o=>{const u=document.getElementById("autocomplete-custom-event-handlers");if(!u)return;["ArrowDown","ArrowUp","Enter","Escape"].includes(o.key)&&o.preventDefault();const a=e.items.filter(n=>n.visibleInMenu&&!n.disabled);switch(o.key){case"Escape":e.items=e.items.map(n=>({...n,focused:!1})),u.items=[...e.items],u.closeMenu(),u.style.transform="scale(0.98)",setTimeout(()=>{u.style.transform=""},200);break;case"ArrowDown":{u.openMenu();const n=a.findIndex(i=>i.focused),c=n<0?0:Math.min(n+1,a.length-1),l=c+1<a.length?c+1:c;e.items=e.items.map(i=>{var r;return{...i,focused:((r=a[l])==null?void 0:r.value)===i.value}});break}case"ArrowUp":{const n=a.findIndex(i=>i.focused),c=n<0?a.length-1:Math.max(n-1,0),l=c-1>=0?c-1:c;e.items=e.items.map(i=>{var r;return{...i,focused:((r=a[l])==null?void 0:r.value)===i.value}});break}case"Enter":{const n=a.find(c=>c.focused);n&&(e.items=e.items.map(c=>({...c,selected:c.value===n.value,focused:!1})),u.value=n.label,u.closeMenu());break}default:return}u.items=[...e.items]},s=o=>{const u=document.getElementById("autocomplete-custom-event-handlers");if(!u)return;const a=o.toLowerCase().split("");if(o.length>0){const l=e.items.map(i=>{const r=i.label.toLowerCase();let b=0,h=!0;for(const d of a)if(r.includes(d)){const I=r.indexOf(d);I===0?b+=3:r[I-1]===" "?b+=2:b+=1}else{h=!1;break}return h&&r.includes(o.toLowerCase())&&(b+=10),{item:i,score:h?b:-1,visible:h}});l.sort((i,r)=>r.score-i.score),e.items=l.map(({item:i,visible:r})=>({...i,visibleInMenu:r,focused:!1,selected:i.selected&&r,label:i.label}))}else e.items=e.items.map(l=>({...l,visibleInMenu:!0,focused:!1}));u.items=[...e.items],u.value=o;const n=e.items.filter(l=>l.visibleInMenu).length;console.log(`Fuzzy search for "${o}": ${n} matches found`),e.items.some(l=>l.visibleInMenu)&&o.length>=e["min-chars"]?u.openMenu():u.closeMenu()},p=o=>{const u=document.getElementById("autocomplete-custom-event-handlers");u&&(e.items=e.items.map(a=>({...a,selected:a.value===o.value,focused:!1})),u.items=[...e.items],u.value=o.label,u.closeMenu())};return f(O||(O=v([`
      <style>
...
\`\`\`
        ...
        `}}}},$={render:e=>{const m=[{label:"Apple",value:"apple",visibleInMenu:!0},{label:"Banana",value:"banana",visibleInMenu:!0},{label:"Orange",value:"orange",visibleInMenu:!0},{label:"Strawberry",value:"strawberry",visibleInMenu:!0}],s=[...m,{label:"Blackberry",value:"blackberry",visibleInMenu:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0},{label:"Cherry",value:"cherry",visibleInMenu:!0},{label:"Cranberry",value:"cranberry",visibleInMenu:!0},{label:"Fig",value:"fig",visibleInMenu:!0},{label:"Grape",value:"grape",visibleInMenu:!0},{label:"Kiwi",value:"kiwi",visibleInMenu:!0},{label:"Lemon",value:"lemon",visibleInMenu:!0},{label:"Lime",value:"lime",visibleInMenu:!0},{label:"Mango",value:"mango",visibleInMenu:!0},{label:"Melon",value:"melon",visibleInMenu:!0},{label:"Peach",value:"peach",visibleInMenu:!0},{label:"Pineapple",value:"pineapple",visibleInMenu:!0},{label:"Raspberry",value:"raspberry",visibleInMenu:!0},{label:"Watermelon",value:"watermelon",visibleInMenu:!0}],p=u=>{var n;if(!((n=u.detail)!=null&&n.target))return;const a=u.target.closest("modus-wc-autocomplete");if(a){const c=u.detail.target,l=c.value.toLowerCase();if(l===""){a.items=[...m],a.value=c.value;return}a.showSpinner=!0,setTimeout(()=>{const i=s.filter(r=>r.label.toLowerCase().includes(l));a.items=i,a.showSpinner=!1},1e3),a.value=c.value}},o=u=>{const a=u.target.closest("modus-wc-autocomplete");if(a){const n=u.detail.label;n&&(a.value=n)}};return f(H||(H=v([`
      <style>
      ...
      <script>
        ...
        // }
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),m,t(e.label),e["leave-menu-open"],0,!1,t(e.name),e["no-results"],e["read-only"],e.required,!0,t(e.size),e.value,p,o)}},L={render:e=>{if(!customElements.get("autocomplete-shadow-host")){const m=ye({componentTag:"modus-wc-autocomplete",propsMapper:(s,p)=>{const o=p;o.bordered=!!s.bordered,o.customClass=s["custom-class"]||"",typeof s["debounce-ms"]=="number"&&(o.debounceMs=s["debounce-ms"]),o.disabled=!!s.disabled,o.includeClear=!!s["include-clear"],o.includeSearch=!!s["include-search"],typeof s["input-id"]=="string"&&(o.inputId=s["input-id"]),typeof s["input-tab-index"]=="number"&&(o.inputTabIndex=s["input-tab-index"]),o.items=s.items,typeof s.label=="string"&&(o.label=s.label),typeof s["leave-menu-open"]=="boolean"&&(o.leaveMenuOpen=s["leave-menu-open"]),typeof s["max-chips"]=="number"&&(o.maxChips=s["max-chips"]),typeof s["min-chars"]=="number"&&(o.minChars=s["min-chars"]),typeof s["min-input-width"]=="number"&&(o.minInputWidth=s["min-input-width"]),o.multiSelect=!!s["multi-select"],typeof s.name=="string"&&(o.name=s.name),o.noResults=s["no-results"],typeof s.placeholder=="string"&&(o.placeholder=s.placeholder),o.readOnly=!!s["read-only"],o.required=!!s.required,typeof s["show-menu-on-focus"]=="boolean"&&(o.showMenuOnFocus=s["show-menu-on-focus"]),o.showSpinner=!!s["show-spinner"],typeof s.size=="string"&&(o.size=s.size),o.value=s.value}});customElements.define("autocomplete-shadow-host",m)}return f`<autocomplete-shadow-host
      .props=${{...e}}
    ></autocomplete-shadow-host>`}},T={parameters:{docs:{description:{story:`
#### Breaking Changes
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>f`<div></div>`};var W,N,j;y.parameters={...y.parameters,docs:{...(W=y.parameters)==null?void 0:W.docs,source:{originalSource:`{
  ...Template
}`,...(j=(N=y.parameters)==null?void 0:N.docs)==null?void 0:j.source}}};var K,V,J;x.parameters={...x.parameters,docs:{...(K=x.parameters)==null?void 0:K.docs,source:{originalSource:`{
  // prettier-ignore
  render: args => html\`
<style>
  div[id^='story--components-forms-autocomplete--with-custom-icon-slot'] {
...
}`,...(J=(V=x.parameters)==null?void 0:V.docs)==null?void 0:J.source}}};var U,_,G;M.parameters={...M.parameters,docs:{...(U=M.parameters)==null?void 0:U.docs,source:{originalSource:`{
  name: 'With Tooltips',
  parameters: {
    docs: {
      description: {
...
}`,...(G=(_=M.parameters)==null?void 0:_.docs)==null?void 0:G.source}}};var Q,X,Y;C.parameters={...C.parameters,docs:{...(Q=C.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  render: args => {
...
}`,...(Y=(X=C.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};var Z,ee,te;S.parameters={...S.parameters,docs:{...(Z=S.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  render: args => {
...
}`,...(te=(ee=S.parameters)==null?void 0:ee.docs)==null?void 0:te.source}}};var ne,oe,le;E.parameters={...E.parameters,docs:{...(ne=E.parameters)==null?void 0:ne.docs,source:{originalSource:`{
  render: args => {
...
}`,...(le=(oe=E.parameters)==null?void 0:oe.docs)==null?void 0:le.source}}};var se,ae,ie;A.parameters={...A.parameters,docs:{...(se=A.parameters)==null?void 0:se.docs,source:{originalSource:`{
  render: args => {
...
}`,...(ie=(ae=A.parameters)==null?void 0:ae.docs)==null?void 0:ie.source}}};var ue,ce,re;k.parameters={...k.parameters,docs:{...(ue=k.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  args: {
    ...meta.args,
...
}`,...(re=(ce=k.parameters)==null?void 0:ce.docs)==null?void 0:re.source}}};var me,de,pe;$.parameters={...$.parameters,docs:{...(me=$.parameters)==null?void 0:me.docs,source:{originalSource:`{
  render: args => {
    const defaultFruits = [{
      label: 'Apple',
      value: 'apple',
...
}`,...(pe=(de=$.parameters)==null?void 0:de.docs)==null?void 0:pe.source}}};var he,be,fe;L.parameters={...L.parameters,docs:{...(he=L.parameters)==null?void 0:he.docs,source:{originalSource:`{
  render: args => {
...
}`,...(fe=(be=L.parameters)==null?void 0:be.docs)==null?void 0:fe.source}}};var ve,we,ge;T.parameters={...T.parameters,docs:{...(ve=T.parameters)==null?void 0:ve.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(ge=(we=T.parameters)==null?void 0:we.docs)==null?void 0:ge.source}}};const Te=["Default","WithCustomIconSlot","WithTooltips","MultiSelect","WithSpinner","CustomMenuItems","CustomEventHandlers","WithProgrammaticControl","DynamicOptions","ShadowDomParent","Migration"];export{A as CustomEventHandlers,E as CustomMenuItems,y as Default,$ as DynamicOptions,T as Migration,C as MultiSelect,L as ShadowDomParent,x as WithCustomIconSlot,k as WithProgrammaticControl,S as WithSpinner,M as WithTooltips,Te as __namedExportsOrder,Me as default};
