import{w as x}from"./decorator-D4YmxizW.js";import{x as i}from"./lit-element-C8zulti1.js";import{o as c}from"./if-defined-yv6owfG8.js";import{c as C}from"./shadow-host-helper-B2BwyiIi.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var l=Object.freeze,A=Object.defineProperty,q=(e,r)=>l(A(e,"raw",{value:l(e.slice())})),d;const I={title:"Components/Menu",component:"modus-wc-menu",args:{orientation:"vertical",size:"md"},argTypes:{orientation:{control:{type:"select"},options:["horizontal","vertical"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[x],parameters:{actions:{handles:["menuFocusout"]}}},o={render:e=>i`
<modus-wc-menu
  aria-label="Menu"
  ?bordered=${e.bordered}
