import{w as S}from"./decorator-D4YmxizW.js";import{x as o}from"./lit-element-C8zulti1.js";import{o as e}from"./if-defined-yv6owfG8.js";import{c as D}from"./shadow-host-helper-B2BwyiIi.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var m=Object.freeze,R=Object.defineProperty,P=(a,s)=>m(R(a,"raw",{value:m(a.slice())})),u;const N={title:"Components/Forms/Rating",component:"modus-wc-rating",args:{"allow-half":!1,count:5,"custom-class":"",disabled:!1,getAriaLabelText:a=>`${a} rating`,size:"md",value:0,variant:"smiley"},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]},variant:{control:{type:"select"},options:["heart","smiley","star","thumb"]}},decorators:[S],parameters:{actions:{handles:["ratingChange"]}}},r={render:a=>o`
    <modus-wc-rating
