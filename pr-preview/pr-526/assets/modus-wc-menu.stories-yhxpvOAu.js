import{w as x}from"./decorator-D4YmxizW.js";import{x as i}from"./lit-element-C8zulti1.js";import{o as a}from"./if-defined-yv6owfG8.js";import{c as C}from"./shadow-host-helper-B2BwyiIi.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var l=Object.freeze,A=Object.defineProperty,E=(e,c)=>l(A(e,"raw",{value:l(e.slice())})),d;const I={title:"Components/Menu",component:"modus-wc-menu",args:{orientation:"vertical",size:"md"},argTypes:{orientation:{control:{type:"select"},options:["horizontal","vertical"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[x],parameters:{actions:{handles:["menuFocusout"]}}},o={render:e=>i`
<modus-wc-menu
  aria-label="Menu"
  ?bordered=${e.bordered}
...
>
  ...
  <li>
    ...
    `},t={render:()=>i(d||(d=E([`
      ...
      <script>
        ...
        // });
      <\/script>
    `])),!0,!0,!0,!0)},m={render:e=>{if(!customElements.get("menu-shadow-host")){const c=C({componentTag:"modus-wc-menu",propsMapper:(s,r)=>{const n=r;n.ariaLabel="Shadow DOM Menu",n.bordered=!!s.bordered,n.customClass=s["custom-class"]||"",n.orientation=s.orientation||"vertical",n.size=s.size||"md",r.innerHTML=`
              <modus-wc-menu-item
    label="Small"
    value="1"
    size="sm"
  ...
  <modus-wc-menu-item
    ...
    disabled="true"
  ></modus-wc-menu-item>
          `}});customElements.define("menu-shadow-host",c)}return i`<menu-shadow-host .props=${{...e}}></menu-shadow-host>`}};var b,w,v;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: args => {
    // prettier-ignore
    return html\`
<modus-wc-menu
...
}`,...(_=(z=m.parameters)==null?void 0:z.docs)==null?void 0:_.source}}};const B=["Default","CustomMenu","CollapsibleMenu","ShadowDomParent"];export{t as CollapsibleMenu,u as CustomMenu,o as Default,m as ShadowDomParent,B as __namedExportsOrder,I as default};
