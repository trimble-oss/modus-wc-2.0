import{x as o}from"./lit-element-C8zulti1.js";import{o as d}from"./if-defined-yv6owfG8.js";import{c as k}from"./shadow-host-helper-B2BwyiIi.js";const H={title:"Components/Icon",component:"modus-wc-icon",args:{"custom-class":"",decorative:!1,name:"alert",size:"md"},argTypes:{size:{control:{type:"select"},options:["xs","sm","md","lg"]},variant:{control:{type:"select"},options:["outlined","solid"]}}},M={render:e=>o`
<modus-wc-icon
