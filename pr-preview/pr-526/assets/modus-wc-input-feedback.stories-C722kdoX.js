import{x as r}from"./lit-element-C8zulti1.js";import{o as s}from"./if-defined-yv6owfG8.js";import{c as w}from"./shadow-host-helper-B2BwyiIi.js";const $={title:"Components/Forms/Input Feedback",component:"modus-wc-input-feedback",args:{level:"error",message:"Uh oh. You done messed up.",size:"md"},argTypes:{level:{control:{type:"select"},options:["error","info","success","warning"]},size:{control:{type:"select"},options:["sm","md","lg"]}}},v={render:e=>r`
