import{w as b}from"./decorator-D4YmxizW.js";import{x as h}from"./lit-element-C8zulti1.js";import{o as n}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var c=Object.freeze,g=Object.defineProperty,x=(e,i)=>c(g(e,"raw",{value:c(e.slice())})),r;const w={apps:"Apps",help:"Help",notifications:"Notifications",search:"Search"},y={avatarAlt:"Sonic",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"sonic@trimble.com",name:"Sonic the Hedgehog"},C={ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!0,user:!0},_={title:"Components/Navbar",component:"modus-wc-navbar",args:{condensed:!1,"search-debounce-ms":300,"text-overrides":w,"user-card":y,visibility:C},argTypes:{"text-overrides":{description:"Text replacements for navbar menu items",table:{type:{detail:`
...
>
  ...
  <div slot="apps">App drawer contents</div>
    ...
    `},s={...$},t={render:e=>{function i(f){var a;const o=(a=f.currentTarget.parentElement)==null?void 0:a.querySelector("#custom-user-menu");o==null||o.classList.toggle("hidden")}return h(r||(r=x([`
