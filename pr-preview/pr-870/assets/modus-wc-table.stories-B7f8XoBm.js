import{_ as ne,b as c}from"./chunk-4XZ63LWV-CnYBn8W6.js";import{x as m}from"./lit-element-CucEn6F2.js";import"./v4-CtRu48qb.js";const{definePreview:pe}=__STORYBOOK_MODULE_PREVIEW_API__,{global:$}=__STORYBOOK_MODULE_GLOBAL__;var te={};ne(te,{argsEnhancers:()=>re,loaders:()=>ie});var ee=(e,a)=>typeof a[e]>"u"&&!(e in a),ae=e=>{let{initialArgs:a,argTypes:o,id:s,parameters:{actions:r}}=e;if(!r||r.disable||!r.argTypesRegex||!o)return{};let t=new RegExp(r.argTypesRegex);return Object.entries(o).filter(([n])=>!!t.test(n)).reduce((n,[i,u])=>(ee(i,a)&&(n[i]=c(i,{implicit:!0,id:s})),n),{})},oe=e=>{let{initialArgs:a,argTypes:o,parameters:{actions:s}}=e;return s!=null&&s.disable||!o?{}:Object.entries(o).filter(([r,t])=>!!t.action).reduce((r,[t,n])=>(ee(t,a)&&(r[t]=c(typeof n.action=="string"?n.action:t)),r),{})},re=[oe,ae],z=!1,se=e=>{let{parameters:{actions:a}}=e;if(!(a!=null&&a.disable)&&!z&&"__STORYBOOK_TEST_ON_MOCK_CALL__"in $&&typeof $.__STORYBOOK_TEST_ON_MOCK_CALL__=="function"){let o=$.__STORYBOOK_TEST_ON_MOCK_CALL__;o((s,r)=>{let t=s.getMockName();t!=="spy"&&(!/^next\/.*::/.test(t)||["next/router::useRouter()","next/navigation::useRouter()","next/navigation::redirect","next/cache::","next/headers::cookies().set","next/headers::cookies().delete","next/headers::headers().set","next/headers::headers().delete"].some(n=>t.startsWith(n)))&&c(t)(r)}),z=!0}},ie=[se],k=Object.freeze,ce=Object.defineProperty,p=(e,a)=>k(ce(e,"raw",{value:k(a||e.slice())})),x,T,R,A,_,q;const he={title:"Components/Table",component:"modus-wc-table",argTypes:{columns:{control:"object",description:"An array of column definitions.",table:{type:{detail:`
    ...
    `],[`
      ...
      <script>
        ...
        // table.data = createDemoData();
      <\/script>
    `])),a,o,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,c("rowClick"))},args:{density:"comfortable",hover:!0}},w={render:e=>{const a=e.columns||le(),o=e.data||g();return m(R||(R=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        // table.data = createDemoData();
      <\/script>
    `])),a,o,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,c("sortChange"))},args:{density:"comfortable",sortable:!0}},v={render:e=>{const a=e.columns||h(),o=e.data||g(15);return m(A||(A=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
...
}`,...(U=(M=b.parameters)==null?void 0:M.docs)==null?void 0:U.source}}};var N,L,B;f.parameters={...f.parameters,docs:{...(N=f.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
    const data = args.data || createDemoData();
    return html\`
...
}`,...(B=(L=f.parameters)==null?void 0:L.docs)==null?void 0:B.source}}};var K,Y,F;w.parameters={...w.parameters,docs:{...(K=w.parameters)==null?void 0:K.docs,source:{originalSource:`{
  render: args => {
