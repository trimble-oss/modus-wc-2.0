import{k as u}from"./lit-element-DVRzCIa_.js";import{t as s}from"./if-defined-1ipA9LQg.js";const f={title:"Components/Forms/Input Feedback",component:"modus-wc-input-feedback",args:{level:"error",message:"Uh oh. You done messed up.",size:"md"},argTypes:{level:{control:{type:"select"},options:["error","info","success","warning"]},size:{control:{type:"select"},options:["sm","md","lg"]}}},i={render:e=>u`
