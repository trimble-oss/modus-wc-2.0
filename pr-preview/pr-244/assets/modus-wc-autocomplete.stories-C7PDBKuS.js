import{w as S}from"./decorator-Dt3Huotz.js";import{k as h}from"./lit-element-DVRzCIa_.js";import{t as r}from"./if-defined-1ipA9LQg.js";import"./v4-CQkTLCs1.js";const g=[{label:"Apple",value:"apple",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Banana",value:"banana",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0,focused:!1},{label:"Cherry",value:"cherry",visibleInMenu:!0,focused:!1},{label:"Grape",value:"grape",visibleInMenu:!0,focused:!1},{label:"Lemon",value:"lemon",visibleInMenu:!0,focused:!1},{label:"Orange",value:"orange",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Peach",value:"peach",visibleInMenu:!0,focused:!1},{label:"Pear",value:"pear",visibleInMenu:!0,focused:!1},{label:"Strawberry",value:"strawberry",visibleInMenu:!0,focused:!1,disabled:!0}],L={title:"Components/Forms/Autocomplete",component:"modus-wc-autocomplete",args:{bordered:!0,"debounce-ms":300,disabled:!1,items:g,label:"Label","leave-menu-open":!1,"min-chars":0,"multi-select":!1,size:"md",value:""},argTypes:{items:{description:"Array of items for the autocomplete component",table:{type:{detail:`
      ...
      <modus-wc-autocomplete
        ...
        @keydown=${p}
      ></modus-wc-autocomplete>
    `}},c={...A},d={render:e=>{(!e.items||e.items.length===0)&&(e.items=[...g]);const p=i=>{const n=i.target.closest("modus-wc-autocomplete");n&&(e.items=e.items.map(a=>a.value===i.detail.value?{...a,selected:!1}:a),n.items=[...e.items])},f=i=>{var a;if(!((a=i.detail)!=null&&a.target))return;const n=i.target.closest("modus-wc-autocomplete");if(n){const t=i.detail.target,l=t.value.toLowerCase(),o=e.items.map(u=>({...u,visibleInMenu:u.label.toLowerCase().includes(l),focused:!1}));e.items=o,n.items=[...e.items],n.value=t.value}},v=()=>{e.initialNavigation=!0,e.items=e.items.map(i=>({...i,focused:!1})),console.log("blur",e.items,e.initialNavigation)},b=i=>{const n=i.target.closest("modus-wc-autocomplete");n&&(e.items=e.items.map(a=>a.value===i.detail.value?{...a,selected:!0}:a),n.items=[...e.items],n.value="")},s=i=>{const n=i.target.closest("modus-wc-autocomplete");if(!n)return;e.initialNavigation===void 0&&(e.initialNavigation=!0),["ArrowDown","ArrowUp","Enter","Backspace"].includes(i.key)&&i.preventDefault();const a=e.items.filter(t=>t.visibleInMenu&&!t.disabled);switch(i.target.value!==n.value&&(e.initialNavigation=!0),i.key){case"ArrowDown":if(e.initialNavigation){e.initialNavigation=!1;return}else{const t=a.findIndex(o=>o.focused),l=t<0?0:Math.min(t+1,a.length-1);e.items=e.items.map(o=>{var u;return{...o,focused:((u=a[l])==null?void 0:u.value)===o.value}})}break;case"ArrowUp":if(e.initialNavigation){e.initialNavigation=!1;return}else{const t=a.findIndex(o=>o.focused),l=t<0?a.length-1:Math.max(t-1,0);e.items=e.items.map(o=>{var u;return{...o,focused:((u=a[l])==null?void 0:u.value)===o.value}})}break;case"Enter":{const t=a.find(l=>l.focused);t&&(e.items=e.items.map(l=>({...l,selected:l.value===t.value?!l.selected:l.selected,focused:!1})),n.value="",e.initialNavigation=!0);break}case"Backspace":if(i.target.value===""){const t=e.items.filter(l=>l.selected);if(t.length>0){const l=t[t.length-1];e.items=e.items.map(o=>({...o,selected:o.value===l.value?!1:o.selected}))}}break;default:return}n.items=[...e.items]};return h`
      <style>
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>h`<div></div>`};var I,w,y;c.parameters={...c.parameters,docs:{...(I=c.parameters)==null?void 0:I.docs,source:{originalSource:`{
  ...Template
}`,...(y=(w=c.parameters)==null?void 0:w.docs)==null?void 0:y.source}}};var $,x,k;d.parameters={...d.parameters,docs:{...($=d.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: args => {
...
}`,...(k=(x=d.parameters)==null?void 0:x.docs)==null?void 0:k.source}}};var M,N,C;m.parameters={...m.parameters,docs:{...(M=m.parameters)==null?void 0:M.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(C=(N=m.parameters)==null?void 0:N.docs)==null?void 0:C.source}}};const B=["Default","MultiSelect","Migration"];export{c as Default,m as Migration,d as MultiSelect,B as __namedExportsOrder,L as default};
