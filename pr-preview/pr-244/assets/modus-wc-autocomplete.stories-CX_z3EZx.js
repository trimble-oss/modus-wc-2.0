import{w as N}from"./decorator-Dt3Huotz.js";import{k as w}from"./lit-element-DVRzCIa_.js";import{t as a}from"./if-defined-1ipA9LQg.js";import"./v4-CQkTLCs1.js";const g=[{label:"Apple",value:"apple",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Banana",value:"banana",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0,focused:!1},{label:"Cherry",value:"cherry",visibleInMenu:!0,focused:!1},{label:"Grape",value:"grape",visibleInMenu:!0,focused:!1},{label:"Lemon",value:"lemon",visibleInMenu:!0,focused:!1},{label:"Orange",value:"orange",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Peach",value:"peach",visibleInMenu:!0,focused:!1},{label:"Pear",value:"pear",visibleInMenu:!0,focused:!1},{label:"Strawberry",value:"strawberry",visibleInMenu:!0,focused:!1,disabled:!0}],q={title:"Components/Forms/Autocomplete",component:"modus-wc-autocomplete",args:{bordered:!0,"debounce-ms":300,disabled:!1,items:g,label:"Label","min-chars":0,"multi-select":!1,size:"md",value:""},argTypes:{items:{description:"Array of items for the autocomplete component",table:{type:{detail:`
      ...
      <modus-wc-autocomplete
        ...
        @keydown=${d}
      ></modus-wc-autocomplete>
    `}},f={...T},b={render:e=>{let d=[...g];const v=l=>{const t=l.target.closest("modus-wc-autocomplete");if(t){const u=e.items.find(i=>i.value===l.detail.value);if(u){u.selected=!1;const i=e.items.filter(n=>n.selected);d.forEach(n=>{n.selected=i.some(c=>c.value===n.value)}),t.items=[...d]}}},I=l=>{var u;if(!((u=l.detail)!=null&&u.target))return;const t=l.target.closest("modus-wc-autocomplete");if(t){const i=l.detail.target,n=i.value.toLowerCase(),c=d.map(m=>({...m,visibleInMenu:!!(!n||m.label&&m.label.toLowerCase().includes(n)||m.selected),focused:!1}));e.items=c.filter(m=>m.visibleInMenu),t.items=[...e.items],t.value=i.value}};let p=!1;const o=()=>{e.initialNavigation=!0,e.items.forEach(l=>{l.focused=!1}),e.items=[...d],p=!0},r=l=>{const t=l.target.closest("modus-wc-autocomplete");if(t){t.value="",t.items=d.map(i=>({...i,visibleInMenu:!0,focused:!1}));const u=d.find(i=>i.value===l.detail.value);u&&(u.selected=!0)}},s=l=>{["ArrowDown","ArrowUp","Enter"].includes(l.key)&&l.preventDefault();const t=l.target.closest("modus-wc-autocomplete");if(!t)return;const u=l.target;if(e.initialNavigation===void 0&&(e.initialNavigation=!0),l.key==="Backspace"&&!u.value){const n=d.reduce((c,m,D)=>m.selected?D:c,-1);n!==-1&&(d[n].selected=!1,t.items=[...d]);return}let i=e.items.findIndex(n=>n.focused);if(p&&(i=-1,p=!1),e.items=e.items.map(n=>({...n,focused:!1})),i===-1&&(l.key==="ArrowDown"||l.key==="ArrowUp")){if(l.key==="ArrowDown"){for(let n=0;n<e.items.length;n++)if(!e.items[n].disabled){i=n;break}}else for(let n=e.items.length-1;n>=0;n--)if(!e.items[n].disabled){i=n;break}}else if(l.key==="ArrowDown"&&i<e.items.length-1){let n=i+1;for(;n<e.items.length&&e.items[n].disabled;)n++;n<e.items.length&&(i=n)}else if(l.key==="ArrowUp"&&i>0){let n=i-1;for(;n>=0&&e.items[n].disabled;)n--;n>=0&&(i=n)}else if(l.key==="Enter"){if(i!==-1){e.items[i].selected=!e.items[i].selected;const n=e.items.filter(c=>c.selected);d.forEach(c=>{c.selected=n.some(m=>m.value===c.value)}),t.items=[...d],t.value=""}return}if(e.initialNavigation){e.initialNavigation=!1;return}e.items[i].focused=!0,t.items=[...e.items]};return w`
      <style>
        /* Only for Storybook */
