import{w as E}from"./decorator-Dt3Huotz.js";import{k as v}from"./lit-element-DVRzCIa_.js";import{t as a}from"./if-defined-1ipA9LQg.js";import"./v4-CQkTLCs1.js";const M=[{label:"Apple",value:"apple",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Banana",value:"banana",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0,focused:!1},{label:"Cherry",value:"cherry",visibleInMenu:!0,focused:!1},{label:"Grape",value:"grape",visibleInMenu:!0,focused:!1},{label:"Lemon",value:"lemon",visibleInMenu:!0,focused:!1},{label:"Orange",value:"orange",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Peach",value:"peach",visibleInMenu:!0,focused:!1},{label:"Pear",value:"pear",visibleInMenu:!0,focused:!1},{label:"Strawberry",value:"strawberry",visibleInMenu:!0,focused:!1,disabled:!0}],R={title:"Components/Forms/Autocomplete",component:"modus-wc-autocomplete",args:{bordered:!0,"debounce-ms":300,disabled:!1,initialNavigation:!0,items:M,label:"Label","min-chars":0,"multi-select":!1,size:"md",value:""},argTypes:{items:{description:"Array of items for the autocomplete component",table:{type:{detail:`
      ...
      <modus-wc-autocomplete
        ...
        @keydown=${p}
      ></modus-wc-autocomplete>
    `}},d={...D},c={render:e=>{const p=n=>{const i=n.target.closest("modus-wc-autocomplete");if(i){const l=e.items.find(t=>t.value===n.detail.value);l&&(l.selected=!1,i.items=[...e.items])}},f=n=>{var l;if(!((l=n.detail)!=null&&l.target))return;const i=n.target.closest("modus-wc-autocomplete");if(i){const t=n.detail.target,o=t.value.toLowerCase(),r=e.items.map(u=>({...u,visibleInMenu:(o?u.label?u.label.toLowerCase().includes(o):!1:!0)||u.selected===!0,focused:!1}));e.items=r.filter(u=>u.visibleInMenu),i.items=[...e.items],i.value=t.value}},b=()=>{e.initialNavigation=!0,e.items.forEach(n=>{n.focused=!1})},h=n=>{const i=n.target.closest("modus-wc-autocomplete");if(i){i.value="",i.items=e.items.map(t=>({...t,visibleInMenu:!0,focused:!1}));const l=e.items.find(t=>t.value===n.detail.value);l&&(l.selected=!0)}},s=n=>{["ArrowDown","ArrowUp","Enter"].includes(n.key)&&n.preventDefault();const i=n.target.closest("modus-wc-autocomplete");if(!i)return;const l=n.target;if(n.key==="Backspace"&&!l.value){const o=e.items.reduce((r,u,A)=>u.selected?A:r,-1);if(o!==-1){const r=new CustomEvent("chipRemove",{detail:e.items[o],bubbles:!0,composed:!0});n.target.dispatchEvent(r),i.items=[...e.items]}return}let t=e.items.findIndex(o=>o.focused);if(t===-1&&(t=e.items.findIndex(o=>o.selected)),e.items=e.items.map(o=>({...o,focused:!1})),t===-1&&(n.key==="ArrowDown"||n.key==="ArrowUp")){if(n.key==="ArrowDown"){for(let o=0;o<e.items.length;o++)if(!e.items[o].disabled){t=o;break}}else for(let o=e.items.length-1;o>=0;o--)if(!e.items[o].disabled){t=o;break}}else if(n.key==="ArrowDown"&&t<e.items.length-1){let o=t+1;for(;o<e.items.length&&e.items[o].disabled;)o++;o<e.items.length&&(t=o)}else if(n.key==="ArrowUp"&&t>0){let o=t-1;for(;o>=0&&e.items[o].disabled;)o--;o>=0&&(t=o)}else if(n.key==="Enter"){t!==-1&&(e.items[t].selected=!e.items[t].selected,i.items=[...e.items]);return}if(e.initialNavigation){e.initialNavigation=!1;return}e.items[t].focused=!0,i.items=[...e.items]};return v`
      <style>
        /* Only for Storybook */
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>v`<div></div>`};var w,I,g;d.parameters={...d.parameters,docs:{...(w=d.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...Template
}`,...(g=(I=d.parameters)==null?void 0:I.docs)==null?void 0:g.source}}};var y,x,$;c.parameters={...c.parameters,docs:{...(y=c.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: args => {
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(S=(C=m.parameters)==null?void 0:C.docs)==null?void 0:S.source}}};const z=["Default","MultiSelect","Migration"];export{d as Default,m as Migration,c as MultiSelect,z as __namedExportsOrder,R as default};
