import{w as D}from"./decorator-Dt3Huotz.js";import{k as b}from"./lit-element-DVRzCIa_.js";import{t as r}from"./if-defined-1ipA9LQg.js";import"./v4-CQkTLCs1.js";var h=Object.freeze,F=Object.defineProperty,S=(e,c)=>h(F(e,"raw",{value:h(e.slice())})),w,x;const m=[{label:"Apple",value:"apple",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Banana",value:"banana",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0,focused:!1},{label:"Cherry",value:"cherry",visibleInMenu:!0,focused:!1},{label:"Grape",value:"grape",visibleInMenu:!0,focused:!1},{label:"Lemon",value:"lemon",visibleInMenu:!0,focused:!1},{label:"Orange",value:"orange",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Peach",value:"peach",visibleInMenu:!0,focused:!1},{label:"Pear",value:"pear",visibleInMenu:!0,focused:!1},{label:"Strawberry",value:"strawberry",visibleInMenu:!0,focused:!1,disabled:!0}],B={title:"Components/Forms/Autocomplete",component:"modus-wc-autocomplete",args:{bordered:!0,"debounce-ms":300,disabled:!1,items:m,label:"Label","leave-menu-open":!1,"min-chars":0,"multi-select":!1,"no-results":{ariaLabel:"No results found",label:"No results found",subLabel:"Check spelling or try a different keyword"},size:"md",value:""},argTypes:{items:{description:"Array of items for the autocomplete component",table:{type:{detail:`
      ...
      <modus-wc-autocomplete
        ...
        @keydown=`,`
      ></modus-wc-autocomplete>
    `])),e.bordered,r(e["custom-class"]),r(e["debounce-ms"]),e.disabled,r(e["input-id"]),r(e["input-tab-index"]),e.items,r(e.label),e["leave-menu-open"],e["min-chars"],!1,r(e.name),r(e.placeholder),e["read-only"],e.required,r(e.size),e.value,v,I,g,c)}},d={...z},p={render:e=>{(!e.items||e.items.length===0)&&(e.items=[...m]);const c=a=>{const i=a.target.closest("modus-wc-autocomplete");i&&(e.items=e.items.map(t=>t.value===a.detail.value?{...t,selected:!1}:t),i.items=[...e.items])},v=a=>{var t;if(!((t=a.detail)!=null&&t.target))return;const i=a.target.closest("modus-wc-autocomplete");if(i){const n=a.detail.target,s=n.value.toLowerCase(),o=e.items.map(u=>({...u,visibleInMenu:u.label.toLowerCase().includes(s),focused:!1}));e.items=o,i.items=[...e.items],i.value=n.value,i.value&&(e.initialNavigation=!1)}},g=()=>{e.initialNavigation=!0,e.items=e.items.map(a=>({...a,focused:!1,visibleInMenu:!0}))},I=a=>{const i=a.target.closest("modus-wc-autocomplete");i&&(e.items=e.items.map(t=>t.value===a.detail.value?{...t,selected:!0}:t),i.items=[...e.items],i.value="")},l=a=>{const i=a.target.closest("modus-wc-autocomplete");if(!i)return;e.initialNavigation===void 0&&(e.initialNavigation=!0),["ArrowDown","ArrowUp","Enter"].includes(a.key)&&a.preventDefault();const t=e.items.filter(n=>n.visibleInMenu&&!n.disabled);switch(a.target.value!==i.value&&(e.initialNavigation=!0),a.key){case"Escape":e.items=e.items.map(n=>({...n,focused:!1})),e.initialNavigation=!0,i.items=[...e.items];return;case"ArrowDown":if(e.initialNavigation){e.initialNavigation=!1;return}else{const n=t.findIndex(o=>o.focused),s=n<0?0:Math.min(n+1,t.length-1);e.items=e.items.map(o=>{var u;return{...o,focused:((u=t[s])==null?void 0:u.value)===o.value}})}break;case"ArrowUp":if(e.initialNavigation){e.initialNavigation=!1;return}else{const n=t.findIndex(o=>o.focused),s=n<0?t.length-1:Math.max(n-1,0);e.items=e.items.map(o=>{var u;return{...o,focused:((u=t[s])==null?void 0:u.value)===o.value}})}break;case"Enter":{const n=t.find(s=>s.focused);n&&(e.items=e.items.map(s=>({...s,selected:s.value===n.value?!s.selected:s.selected,focused:!1})),i.value="",e.initialNavigation=!0);break}default:return}i.items=[...e.items]};return b(x||(x=S([`
      <style>
      ...
      <modus-wc-autocomplete
        ...
        @keydown=`,`
      ></modus-wc-autocomplete>
    `])),e.bordered,r(e["custom-class"]),r(e["debounce-ms"]),e.disabled,r(e["input-id"]),r(e["input-tab-index"]),e.items,r(e.label),e["leave-menu-open"],e["min-chars"],!0,r(e.name),e["no-results"],r(e.placeholder),e["read-only"],e.required,r(e.size),e.value,c,v,I,g,l)}},f={parameters:{docs:{description:{story:`
#### Breaking Changes
...
}`,...(C=(k=p.parameters)==null?void 0:k.docs)==null?void 0:C.source}}};var T,A,L;f.parameters={...f.parameters,docs:{...(T=f.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
