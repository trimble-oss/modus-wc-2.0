import{w as M}from"./decorator-534da2b0.js";import{b as r}from"./lit-element-38260dd9.js";import{o as c}from"./if-defined-30b85b98.js";import{c as U}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";var l=Object.freeze,x=Object.defineProperty,T=(e,i)=>l(x(e,"raw",{value:l(i||e.slice())})),u,b;const R=[{label:"Root",url:"#"},{label:"Subpage",url:"#"},{label:"Current Page",url:"#"}],$=[{label:"Unsafe URL fallback",url:"javascript:alert(1)"},{label:"Safe subpage",url:"#"},{label:"Current Page",url:"#"}],J={title:"Components/Breadcrumbs",component:"modus-wc-breadcrumbs",args:{items:R,size:"md"},argTypes:{items:{description:"Array of items for the breadcrumbs component",table:{type:{detail:`
...
<modus-wc-breadcrumbs
  ...
  size=${c(e.size)}
></modus-wc-breadcrumbs>
    `},t={render:e=>{if(!customElements.get("breadcrumbs-shadow-host")){const i=U({componentTag:"modus-wc-breadcrumbs",propsMapper:(m,_)=>{const d=_;d.customClass=m["custom-class"]||"",d.items=m.items,d.size=m.size??"md"}});customElements.define("breadcrumbs-shadow-host",i)}return r`<breadcrumbs-shadow-host
      .props=${{...e}}
