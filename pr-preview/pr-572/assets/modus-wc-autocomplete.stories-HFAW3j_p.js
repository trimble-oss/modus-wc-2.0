...
`}}},render:()=>f`
    ...
    `},y={render:e=>(e.items||(e.items=[...v]),e.items=e.items.map(m=>m.value==="apple"||m.value==="banana"?{...m,selected:!0}:m),f(L||(L=A([`
<script>
