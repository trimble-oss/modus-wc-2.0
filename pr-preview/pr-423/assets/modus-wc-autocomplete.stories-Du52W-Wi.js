import{w as _}from"./decorator-D4YmxizW.js";import{x as v}from"./lit-element-C8zulti1.js";import{o as a}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var C=Object.freeze,K=Object.defineProperty,y=(e,d)=>C(K(e,"raw",{value:C(e.slice())})),E,M,T,S;const f=[{label:"Apple",value:"apple",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Banana",value:"banana",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0,focused:!1},{label:"Cherry",value:"cherry",visibleInMenu:!0,focused:!1},{label:"Grape",value:"grape",visibleInMenu:!0,focused:!1},{label:"Lemon",value:"lemon",visibleInMenu:!0,focused:!1},{label:"Orange",value:"orange",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Peach",value:"peach",visibleInMenu:!0,focused:!1},{label:"Pear",value:"pear",visibleInMenu:!0,focused:!1},{label:"Strawberry",value:"strawberry",visibleInMenu:!0,focused:!1,disabled:!0}],Y={title:"Components/Forms/Autocomplete",component:"modus-wc-autocomplete",args:{bordered:!0,"debounce-ms":300,disabled:!1,"include-clear":!1,"include-search":!1,items:f,label:"Label","leave-menu-open":!1,"min-chars":0,"multi-select":!1,"show-menu-on-focus":!1,"show-spinner":!1,"no-results":{ariaLabel:"No results found",label:"No results found",subLabel:"Check spelling or try a different keyword"},size:"md",value:""},argTypes:{items:{description:"Array of items for the autocomplete component",table:{type:{detail:`
          ...
          `}}},size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[_],parameters:{actions:{handles:["chipRemove","inputBlur","inputChange","inputFocus","itemSelect"]}}},W={render:e=>{const d=l=>{const o=l.target.closest("modus-wc-autocomplete");if(!o)return;["ArrowDown","ArrowUp","Enter","Escape"].includes(l.key)&&l.preventDefault();const t=e.items.filter(n=>n.visibleInMenu&&!n.disabled);switch(l.key){case"Escape":e.items=e.items.map(n=>({...n,focused:!1})),o.items=[...e.items];break;case"ArrowDown":{const n=t.findIndex(s=>s.focused),i=n<0?0:Math.min(n+1,t.length-1);e.items=e.items.map(s=>{var c;return{...s,focused:((c=t[i])==null?void 0:c.value)===s.value}});break}case"ArrowUp":{const n=t.findIndex(s=>s.focused),i=n<0?t.length-1:Math.max(n-1,0);e.items=e.items.map(s=>{var c;return{...s,focused:((c=t[i])==null?void 0:c.value)===s.value}});break}case"Enter":{const n=t.find(i=>i.focused);n&&(e.items=e.items.map(i=>({...i,selected:i.value===n.value,focused:!1})),o.value=n.label);break}default:return}o.items=[...e.items]},p=l=>{var t;if(!((t=l.detail)!=null&&t.target))return;const o=l.target.closest("modus-wc-autocomplete");if(o){const n=l.detail.target,i=n.value.toLowerCase();e.items=e.items.map(s=>({...s,visibleInMenu:s.label.toLowerCase().includes(i),focused:!1,selected:i?s.selected:!1})),o.items=[...e.items],o.value=n.value}},m=l=>{const o=l.target.closest("modus-wc-autocomplete");if(o){const t=l.detail.label;t&&(o.value=t),e.items.forEach(i=>i.selected=!1);const n=e.items.find(i=>i.value===l.detail.value);n&&(n.selected=!0,o.items=[...e.items])}};return v(E||(E=y([`
      <style>
      ...
      <modus-wc-autocomplete
        ...
        @keydown=`,`
      ></modus-wc-autocomplete>
    `])),e.bordered,a(e["custom-class"]),a(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],a(e["input-id"]),a(e["input-tab-index"]),e.items,a(e.label),e["leave-menu-open"],e["min-chars"],!1,a(e.name),e["no-results"],a(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],e["show-spinner"],a(e.size),e.value,p,m,d)}},h={...W},b={render:e=>{(!e.items||e.items.length===0)&&(e.items=[...f]);const d=t=>{const n=t.target.closest("modus-wc-autocomplete");n&&(e.items=e.items.map(i=>i.value===t.detail.value?{...i,selected:!1}:i),n.items=[...e.items])},p=t=>{var i;if(!((i=t.detail)!=null&&i.target))return;const n=t.target.closest("modus-wc-autocomplete");if(n){const s=t.detail.target,c=s.value.toLowerCase(),u=e.items.map(r=>({...r,visibleInMenu:r.label.toLowerCase().includes(c),focused:!1}));e.items=u,n.items=[...e.items],n.value=s.value,n.value&&(e.initialNavigation=!1)}},m=()=>{e.initialNavigation=!0,e.items=e.items.map(t=>({...t,focused:!1,visibleInMenu:!0}))},l=t=>{const n=t.target.closest("modus-wc-autocomplete");n&&(e.items=e.items.map(i=>i.value===t.detail.value?{...i,selected:!0}:i),n.items=[...e.items],n.value="")},o=t=>{const n=t.target.closest("modus-wc-autocomplete");if(!n)return;e.initialNavigation===void 0&&(e.initialNavigation=!0),["ArrowDown","ArrowUp","Enter"].includes(t.key)&&t.preventDefault();const i=e.items.filter(s=>s.visibleInMenu&&!s.disabled);switch(t.target.value!==n.value&&(e.initialNavigation=!0),t.key){case"Escape":e.items=e.items.map(s=>({...s,focused:!1})),e.initialNavigation=!0,n.items=[...e.items];return;case"ArrowDown":if(e.initialNavigation){e.initialNavigation=!1;return}else{const s=i.findIndex(u=>u.focused),c=s<0?0:Math.min(s+1,i.length-1);e.items=e.items.map(u=>{var r;return{...u,focused:((r=i[c])==null?void 0:r.value)===u.value}})}break;case"ArrowUp":if(e.initialNavigation){e.initialNavigation=!1;return}else{const s=i.findIndex(u=>u.focused),c=s<0?i.length-1:Math.max(s-1,0);e.items=e.items.map(u=>{var r;return{...u,focused:((r=i[c])==null?void 0:r.value)===u.value}})}break;case"Enter":{const s=i.find(c=>c.focused);s&&(e.items=e.items.map(c=>({...c,selected:c.value===s.value?!c.selected:c.selected,focused:!1})),n.value="",e.initialNavigation=!0);break}default:return}n.items=[...e.items]};return v(M||(M=y([`
      <style>
      ...
      <modus-wc-autocomplete
        ...
        @keydown=`,`
      ></modus-wc-autocomplete>
    `])),e.bordered,a(e["custom-class"]),a(e["debounce-ms"]),e.disabled,a(e["input-id"]),a(e["input-tab-index"]),e.items,a(e.label),e["leave-menu-open"],e["min-chars"],!0,a(e.name),e["no-results"],a(e.placeholder),e["read-only"],e.required,a(e.size),e.value,d,p,l,m,o)}},g={render:e=>{const d=m=>{var o;if(!((o=m.detail)!=null&&o.target))return;const l=m.target.closest("modus-wc-autocomplete");if(l){const t=m.detail.target,n=t.value.toLowerCase();setTimeout(()=>{l.showSpinner=!1},2e3),l.showSpinner=!0;const i=f.map(s=>({...s,selected:n?s.selected:!1,visibleInMenu:s.label.toLowerCase().includes(n)}));l.items=[...i],l.value=t.value}},p=m=>{const l=m.target.closest("modus-wc-autocomplete");if(l){const o=m.detail.label;o&&(l.value=o),f.forEach(n=>n.selected=!1);const t=f.find(n=>n.value===m.detail.value);t&&(t.selected=!0,l.items=[...f])}};return v(T||(T=y([`
<style>
  /* Only for Storybook */
  div[id^="story--components-forms-autocomplete--default"] {
    height: 400px;
...
<modus-wc-autocomplete
  ...
  @itemSelect=`,`
></modus-wc-autocomplete>
    `])),e.bordered,a(e["custom-class"]),a(e["debounce-ms"]),e.disabled,a(e["input-id"]),a(e["input-tab-index"]),e.items,a(e.label),e["leave-menu-open"],e["min-chars"],!1,a(e.name),a(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],e["show-spinner"],a(e.size),e.value,d,p)}},I={render:e=>{const d=e["no-results"];e["leave-menu-open"]==!0&&(e["no-results"]={ariaLabel:"",label:"",subLabel:""});const p=o=>{var n;if(!((n=o.detail)!=null&&n.target))return;const t=o.target.closest("modus-wc-autocomplete");if(t){const i=o.detail.target.value,s=t==null?void 0:t.querySelectorAll("li");i===""&&(s==null||s.forEach(u=>u.classList.remove("selected")));let c=0;Array.from(s??[]).forEach(u=>{var x,L;(((L=(x=u.querySelector(".title"))==null?void 0:x.textContent)==null?void 0:L.toLowerCase())||"").includes(i.toLowerCase())?(u.classList.remove("hidden"),t.noResults={ariaLabel:"",label:"",subLabel:""}):(u.classList.add("hidden"),c++,c===(s==null?void 0:s.length)&&(t.noResults=d))})}},m=o=>{const t=o.target.closest("modus-wc-autocomplete");t&&(t.noResults={ariaLabel:"",label:"",subLabel:""})},l=o=>{var n;const t=o.target.closest("modus-wc-autocomplete");if(t){const i=(n=o.detail.target)==null?void 0:n.value;t.value=i;const s=t==null?void 0:t.querySelectorAll("li");s==null||s.forEach(c=>c.classList.remove("selected")),s==null||s.forEach(c=>{var u;c.contains(o.target)&&(c.classList.add("selected"),t.value=(u=c.querySelector(".title"))==null?void 0:u.textContent)})}};return v(S||(S=y([`
<style>
  /* Only for Storybook */
...
`])),e.bordered,a(e["custom-class"]),a(e["debounce-ms"]),e.disabled,a(e["input-id"]),a(e["input-tab-index"]),a(e.label),e["leave-menu-open"],e["min-chars"],!1,a(e.name),e["no-results"],a(e.placeholder),e["read-only"],e.required,a(e.size),e.value,m,p,l,!0,a(e.size),l,!0,a(e.size),l,!0,a(e.size),l,!0,a(e.size),l,!0,a(e.size))}},w={parameters:{docs:{description:{story:`
#### Breaking Changes
