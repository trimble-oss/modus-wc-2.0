...
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn modus-wc-icon:has(.modus-wc-chip-remove-icon):hover .modus-wc-chip-remove-icon,
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn modus-wc-icon:has(.modus-wc-chip-remove-icon):hover .modus-wc-chip-remove-icon {
  color: #d0d0d7;
}
[data-theme=connect-light] modus-wc-chip .modus-wc-chip.modus-wc-btn-sm .modus-wc-chip-remove-icon,
[data-theme=connect-dark] modus-wc-chip .modus-wc-chip.modus-wc-btn-sm .modus-wc-chip-remove-icon {
  font-size: var(--modus-wc-font-size-sm);
}
/**
* This component uses Tailwind CSS and DaisyUI.
