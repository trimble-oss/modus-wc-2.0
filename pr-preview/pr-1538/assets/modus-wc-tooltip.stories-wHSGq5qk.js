import{b as s}from"./lit-element-DgBvYnzn.js";import{o as n}from"./if-defined-BnVFTJ4o.js";const M={title:"Components/Tooltip",component:"modus-wc-tooltip",args:{content:"Tooltip content",position:"auto"},argTypes:{position:{control:{type:"select"},options:["auto","top","right","bottom","left"]},"show-delay":{control:{type:"number"},description:"Delay in ms before the tooltip shows on hover; 0 (default) shows immediately, 200ms is recommended so a passing cursor does not open it. Skipped if a tooltip closed within the last 300ms, on keyboard focus, and for touch"}},parameters:{docs:{description:{component:`
...
| text | content | |
  ...
  ...Template
}`,...(u=(m=r.parameters)==null?void 0:m.docs)==null?void 0:u.source}}};var h,b,f;l.parameters={...l.parameters,docs:{...(h=l.parameters)==null?void 0:h.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
}`,...(f=(b=l.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};var g,v,w;a.parameters={...a.parameters,docs:{...(g=a.parameters)==null?void 0:g.docs,source:{originalSource:`{
  args: {
...
}`,...(w=(v=a.parameters)==null?void 0:v.docs)==null?void 0:w.source}}};var y,E,T;p.parameters={...p.parameters,docs:{...(y=p.parameters)==null?void 0:y.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| text | content | |
  ...
  render: () => html\`<div></div>\`
}`,...(T=(E=p.parameters)==null?void 0:E.docs)==null?void 0:T.source}}};const _=["Default","ContentElement","ShadowDomParent","Migration"];export{l as ContentElement,r as Default,p as Migration,a as ShadowDomParent,_ as __namedExportsOrder,M as default};
