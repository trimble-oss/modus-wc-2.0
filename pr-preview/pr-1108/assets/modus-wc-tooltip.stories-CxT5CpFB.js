import{b as r}from"./lit-element-DgBvYnzn.js";import{o as n}from"./if-defined-BnVFTJ4o.js";const x={title:"Components/Tooltip",component:"modus-wc-tooltip",args:{content:"Tooltip content",position:"auto"},argTypes:{position:{control:{type:"select"},options:["auto","top","right","left","bottom"]}},parameters:{docs:{description:{component:`
...
- The tooltip will automatically re-enable on mouse enter
        `}}}},T={parameters:{actions:{handles:["dismissEscape"]}},render:t=>r`
      <modus-wc-tooltip
        content=${n(t.content)}
    ...
    `},s={...T},i={parameters:{actions:{handles:["dismissEscape"]},docs:{description:{story:"Use the `content` slot for rich HTML tooltip content such as multiline text. Slotted content stays in sync when updated after mount. For plain dynamic text, use the `content` prop instead."}}},render:t=>r`
    <modus-wc-tooltip
      custom-class="${n(t["custom-class"])}"
      ?disabled=${t.disabled}
      ?force-open=${t["force-open"]}
...
| text        | content     |                                          |
  ...
  ...Template
}`,...(c=(d=s.parameters)==null?void 0:d.docs)==null?void 0:c.source}}};var m,u,h;i.parameters={...i.parameters,docs:{...(m=i.parameters)==null?void 0:m.docs,source:{originalSource:`{
  parameters: {
    actions: {
    ...
    docs: {
      description: {
        story: 'Use the \`content\` slot for rich HTML tooltip content such as multiline text. Slotted content stays in sync when updated after mount. For plain dynamic text, use the \`content\` prop instead.'
      }
    }
  },
  render: args => html\`
  ...
  \`
}`,...(h=(u=i.parameters)==null?void 0:u.docs)==null?void 0:h.source}}};var f,b,g;p.parameters={...p.parameters,docs:{...(f=p.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: args => {
...
}`,...(g=(b=p.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};var v,w,y;a.parameters={...a.parameters,docs:{...(v=a.parameters)==null?void 0:v.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| text        | content     |                                          |
  ...
  render: () => html\`<div></div>\`
}`,...(y=(w=a.parameters)==null?void 0:w.docs)==null?void 0:y.source}}};const $=["Default","ContentSlot","ShadowDomParent","Migration"];export{i as ContentSlot,s as Default,a as Migration,p as ShadowDomParent,$ as __namedExportsOrder,x as default};
