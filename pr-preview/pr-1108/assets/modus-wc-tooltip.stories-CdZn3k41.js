import{b as r}from"./lit-element-DgBvYnzn.js";import{o as s}from"./if-defined-BnVFTJ4o.js";const $={title:"Components/Tooltip",component:"modus-wc-tooltip",args:{content:"Tooltip content",position:"auto"},argTypes:{position:{control:{type:"select"},options:["auto","top","right","left","bottom"]}},parameters:{docs:{description:{component:`
...
- The tooltip will automatically re-enable on mouse enter
      ...
      <modus-wc-tooltip
        ...
        tooltip-id="${s(t["tooltip-id"])}"
        position=${s(t.position)}
      >
        <modus-wc-badge>Hover</modus-wc-badge>
      </modus-wc-tooltip>
    `},n={...C},i={parameters:{actions:{handles:["dismissEscape"]},docs:{description:{story:"Use the `content` slot for static rich tooltip content such as multiline text."}}},render:t=>r`
    <modus-wc-tooltip
      custom-class="${s(t["custom-class"])}"
      ?disabled="${t.disabled}"
      ?force-open="${t["force-open"]}"
...
| text        | content     |                                          |
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>r`<div></div>`};var l,d,c;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  ...Template
