...
- The tooltip will automatically re-enable on mouse enter
    ...
    `},d="<strong>Tooltip</strong><p>Rich HTML content</p>",r={parameters:{docs:{description:{story:"Use `contentElement` to pass a rich HTML element as the tooltip body. `contentElement` takes precedence over the `content` string prop, and the provided element is moved into the tooltip (not cloned)."},source:{transform:(t,{args:s})=>`<modus-wc-tooltip
...
<\/script>`}}},args:{position:"auto"},render:t=>{const s=document.createElement("div");return s.innerHTML=d,l`
      <modus-wc-tooltip
        .contentElement=${s}
        content=${e(t.content)}
        custom-class="${e(t["custom-class"])}"
...
| text        | content     |                                          |
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>l`<div></div>`};var c,m,u;i.parameters={...i.parameters,docs:{...(c=i.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: args =>
  // prettier-ignore
  html\`
      <modus-wc-tooltip
  ...
  parameters: {
    docs: {
      description: {
        story: 'Use \`contentElement\` to pass a rich HTML element as the tooltip body. \`contentElement\` takes precedence over the \`content\` string prop, and the provided element is moved into the tooltip (not cloned).'
      },
      source: {
        transform: (_src, {
          args
