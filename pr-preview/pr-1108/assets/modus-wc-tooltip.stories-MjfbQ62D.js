...
- The tooltip will automatically re-enable on mouse enter
        `}}}},T={parameters:{actions:{handles:["dismissEscape"]}},render:t=>a`
      <modus-wc-tooltip
        content=${n(t.content)}
...
<\/script>`}}},args:{position:"top","custom-class":"tooltip-rich-html-demo"},render:t=>{const e=$(C);return a`
      <modus-wc-tooltip
        .contentElement=${e}
        content=${n(t.content)}
        custom-class="${n(t["custom-class"])}"
...
| text | content | |
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>a`<div></div>`};var c,d,m;i.parameters={...i.parameters,docs:{...(c=i.parameters)==null?void 0:c.docs,source:{originalSource:`{
  ...Template
...
}`,...(v=(f=l.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};var w,E,y;p.parameters={...p.parameters,docs:{...(w=p.parameters)==null?void 0:w.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| text | content | |
  ...
  render: () => html\`<div></div>\`
}`,...(y=(E=p.parameters)==null?void 0:E.docs)==null?void 0:y.source}}};const M=["Default","ContentElement","ShadowDomParent","Migration"];export{r as ContentElement,i as Default,p as Migration,l as ShadowDomParent,M as __namedExportsOrder,P as default};
