import{b as p}from"./lit-element-DgBvYnzn.js";import{o as n}from"./if-defined-BnVFTJ4o.js";const P={title:"Components/Tooltip",component:"modus-wc-tooltip",args:{content:"Tooltip content",position:"auto"},argTypes:{position:{control:{type:"select"},options:["auto","top","right","bottom","left"]}},parameters:{docs:{description:{component:`
...
}`,...(g=(h=r.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};var b,f,v;l.parameters={...l.parameters,docs:{...(b=l.parameters)==null?void 0:b.docs,source:{originalSource:`{
  render: args => {
...
}`,...(v=(f=l.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};var w,E,y;a.parameters={...a.parameters,docs:{...(w=a.parameters)==null?void 0:w.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| text | content | |
  ...
  render: () => html\`<div></div>\`
}`,...(y=(E=a.parameters)==null?void 0:E.docs)==null?void 0:y.source}}};const M=["Default","ContentElement","ShadowDomParent","Migration"];export{r as ContentElement,i as Default,a as Migration,l as ShadowDomParent,M as __namedExportsOrder,P as default};
