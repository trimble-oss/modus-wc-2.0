...
- The tooltip will automatically re-enable on mouse enter
    ...
    `},s={...T},i={parameters:{actions:{handles:["dismissEscape"]},docs:{description:{story:"Use the `content` slot for static rich tooltip content such as multiline text."}}},render:t=>r`
    <modus-wc-tooltip
      custom-class="${n(t["custom-class"])}"
      ?disabled=${t.disabled}
      ?force-open=${t["force-open"]}
