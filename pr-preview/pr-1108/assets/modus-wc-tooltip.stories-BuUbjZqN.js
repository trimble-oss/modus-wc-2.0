import{b as p}from"./lit-element-DgBvYnzn.js";import{o as n}from"./if-defined-BnVFTJ4o.js";const S={title:"Components/Tooltip",component:"modus-wc-tooltip",args:{content:"Tooltip content",position:"auto"},argTypes:{position:{control:{type:"select"},options:["auto","top","right","left","bottom"]}},parameters:{docs:{description:{component:`
...
<\/script>`}}},args:{position:"top","custom-class":"tooltip-rich-html-demo"},render:t=>{const e=$(H);return p`
      <modus-wc-tooltip
        .contentElement=${e}
        content=${n(t.content)}
        custom-class="${n(t["custom-class"])}"
...
}`,...(g=(b=c.parameters)==null?void 0:b.docs)==null?void 0:g.source}}};var f,w,v;a.parameters={...a.parameters,docs:{...(f=a.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: args => {
...
}`,...(v=(w=a.parameters)==null?void 0:w.docs)==null?void 0:v.source}}};var E,T,y;l.parameters={...l.parameters,docs:{...(E=l.parameters)==null?void 0:E.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| text        | content     |                                          |
  ...
  render: () => html\`<div></div>\`
}`,...(y=(T=l.parameters)==null?void 0:T.docs)==null?void 0:y.source}}};const A=["Default","ContentElement","ShadowDomParent","Migration"];export{c as ContentElement,r as Default,l as Migration,a as ShadowDomParent,A as __namedExportsOrder,S as default};
