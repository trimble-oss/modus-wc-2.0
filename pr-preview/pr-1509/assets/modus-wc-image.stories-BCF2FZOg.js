import{w as q}from"./decorator-Cv9na35H.js";import{b as R}from"./lit-element-DgBvYnzn.js";import{o as s}from"./if-defined-BnVFTJ4o.js";import"./chunk-4XZ63LWV-C_wAuwg_.js";import"./v4-C6aID195.js";const N=["center","top","bottom","left","right","top left","top right","bottom left","bottom right"],m="https://images.pexels.com/photos/5146774/pexels-photo-5146774.jpeg",K={title:"Components/Image",component:"modus-wc-image",args:{src:m,alt:"A zebra drinks from a pond",fit:"default",shape:"square",size:"md","crop-position":"center"},argTypes:{"crop-position":{control:{type:"select"},options:N},fit:{control:{type:"select"},options:["default","contain","scale-down","none"]},shape:{control:{type:"select"},options:["square","rounded"]},size:{control:{type:"select"},options:["sm","md","lg","xl"]}},decorators:[q],parameters:{actions:{handles:["imageLoad","imageError"]},docs:{description:{component:"\nA resilient atomic image component wrapping the native `<img>` tag with consistent sizing tokens,\naspect-ratio control, an accessible error fallback, and WCAG 2.2 compliance."}}}},e={render:t=>R`
    <modus-wc-image
      src=${t.src}
      alt=${s(t.alt)}
      size=${s(t.size)}
    ...
    ></modus-wc-image>
  `},i={...e,parameters:{docs:{description:{story:'Default rendering with `fit="default"` and `size="md"` (288×192 px). The image fills the fixed box completely — non-matching aspect ratios are **cropped** equally from the center edges with no distortion.'}}}},o={...e,args:{fit:"contain"},parameters:{docs:{description:{story:'`fit="contain"` — the image scales down to fit **entirely** inside the hard-locked box while preserving its original aspect ratio. Areas not covered by the image show the background (letterbox/pillarbox effect).'}}}},a={...e,args:{fit:"scale-down"},parameters:{docs:{description:{story:'`fit="scale-down"` — the container uses `max-width / max-height` from the `size` token instead of hard-locked dimensions. If the image is larger than the target it is scaled down proportionally; if smaller it renders at its intrinsic size. The box shrinks to fit the image.'}}}},n={...e,args:{fit:"none"},parameters:{docs:{description:{story:'`fit="none"` — the image renders at its **intrinsic pixel size** with no scaling applied. The container is still hard-locked to the `size` token dimensions, so any part of the image that exceeds the box is clipped by `overflow: hidden`.'}}}},r={...e,args:{shape:"rounded"},parameters:{docs:{description:{story:'Applies a `16 px` border-radius to the image container via `shape="rounded"`. All size variants use the same radius value.'}}}},c={render:()=>R`
    <div
...
}`,...(f=(g=i.parameters)==null?void 0:g.docs)==null?void 0:f.source}}};var u,x,w;o.parameters={...o.parameters,docs:{...(u=o.parameters)==null?void 0:u.docs,source:{originalSource:`{
  ...Template,
  args: {
    fit: 'contain'
  },
...
}`,...(w=(x=o.parameters)==null?void 0:x.docs)==null?void 0:w.source}}};var y,b,v;a.parameters={...a.parameters,docs:{...(y=a.parameters)==null?void 0:y.docs,source:{originalSource:`{
  ...Template,
  args: {
    fit: 'scale-down'
  },
...
}`,...($=(T=r.parameters)==null?void 0:T.docs)==null?void 0:$.source}}};var E,I,D;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => html\`
    <div
      style="display: flex; flex-wrap: wrap; gap: 24px; align-items: flex-end;"
    >
...
}`,...(D=(I=c.parameters)==null?void 0:I.docs)==null?void 0:D.source}}};var F,M,_;p.parameters={...p.parameters,docs:{...(F=p.parameters)==null?void 0:F.docs,source:{originalSource:`{
  ...Template,
  args: {
    alt: ''
  },
...
}`,...(G=(O=l.parameters)==null?void 0:O.docs)==null?void 0:G.source}}};const Q=["Default","FitContain","FitScaleDown","FitNone","Rounded","AllSizes","DecorativeImage","CropPosition","ErrorFallback"];export{c as AllSizes,d as CropPosition,p as DecorativeImage,i as Default,l as ErrorFallback,o as FitContain,n as FitNone,a as FitScaleDown,r as Rounded,Q as __namedExportsOrder,K as default};
