import{w as p}from"./decorator-D4YmxizW.js";import{x as v}from"./lit-element-C8zulti1.js";import{o as i}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var r=Object.freeze,g=Object.defineProperty,h=(e,o)=>r(g(e,"raw",{value:r(e.slice())})),c;const C={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[p],parameters:{layout:"padded",actions:{handles:["expandedChange"]}}},n={render:e=>{const o=s=>{const a=s.target,d=a==null?void 0:a.closest(".layout-with-navbar");let t;d?t=d.querySelector("modus-wc-side-navigation"):t=document.querySelector("modus-wc-side-navigation"),t&&(t.expanded=s.detail)};return v(c||(c=h([`
      <style>
        .layout-with-navbar {
