import{w as r}from"./decorator-D4YmxizW.js";import{x as c}from"./lit-element-C8zulti1.js";import{o as n}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var a=Object.freeze,m=Object.defineProperty,l=(e,p)=>a(m(e,"raw",{value:a(e.slice())})),i;const x={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[r],parameters:{layout:"padded",actions:{handles:["expandedChange"]}}},t={render:e=>c(i||(i=l([`
    <style>
      .layout-with-navbar {
