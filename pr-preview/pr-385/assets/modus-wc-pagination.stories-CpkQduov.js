import{w as u}from"./decorator-DFROgT0E.js";import{x as l}from"./lit-element-C8zulti1.js";import{o as t}from"./if-defined-yv6owfG8.js";import"./v4-CtRu48qb.js";const m={firstPage:"First page",lastPage:"Last page",nextPage:"Next page",page:"Page {0}",previousPage:"Previous page"},h={title:"Components/Pagination",component:"modus-wc-pagination",args:{"aria-label-values":m,count:5,"custom-class":"",page:1,size:"md","prev-button-text":"","next-button-text":""},argTypes:{"aria-label-values":{description:"Custom aria label values for pagination buttons",table:{type:{detail:`
...
| pageChange  | pageChange  | Now emits an object with \\\`newPage\\\` and \\\`prevPage\\\`   |
  ...
  render: () => html\`<div></div>\`
}`,...(g=(p=n.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};const f=["Default","Migration"];export{a as Default,n as Migration,f as __namedExportsOrder,h as default};
