import{w as S}from"./decorator-D4YmxizW.js";import{x as s}from"./lit-element-C8zulti1.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const E={title:"Components/Utility Panel",component:"modus-wc-utility-panel",args:{expanded:!1,"push-content":!0},argTypes:{expanded:{control:{type:"boolean"}},"push-content":{control:{type:"boolean"}}},decorators:[S,n=>(requestAnimationFrame(()=>{document.querySelectorAll("modus-wc-utility-panel").forEach(d=>{const c=d.closest(".demo-container");if(c){const r=c.querySelector(".main-content");r&&d&&(d.targetElement=r)}})}),n())],parameters:{actions:{handles:["panelOpened","panelClosed"]},docs:{description:{component:"A utility panel component that slides in from the right side of the screen. It can either push content or display as an overlay."}},layout:"fullscreen"}},e=`
  .demo-container {
    height: 100vh;
    display: flex;
...
\${scriptBlock}\`
  ...
  \`
}`,...(T=(g=i.parameters)==null?void 0:g.docs)==null?void 0:T.source}}};const q=["Default","Expanded","OverlayMode","WithoutHeaderFooter"];export{t as Default,o as Expanded,a as OverlayMode,i as WithoutHeaderFooter,q as __namedExportsOrder,E as default};
