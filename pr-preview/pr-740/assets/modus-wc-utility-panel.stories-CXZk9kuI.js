import{w as k}from"./decorator-D4YmxizW.js";import{x as e}from"./lit-element-C8zulti1.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const P={title:"Components/Utility Panel",component:"modus-wc-utility-panel",args:{expanded:!1,"push-content":!0},argTypes:{expanded:{control:{type:"boolean"}},"push-content":{control:{type:"boolean"}}},decorators:[k,n=>(requestAnimationFrame(()=>{document.querySelectorAll("modus-wc-utility-panel").forEach(d=>{const c=d.closest(".demo-container");if(c){const r=c.querySelector(".main-content");r&&d&&(d.targetElement=r)}})}),n())],parameters:{actions:{handles:["panelOpened","panelClosed"]},docs:{description:{component:"A utility panel component that slides in from the right side of the screen. It can either push content or display as an overlay."}},layout:"fullscreen"}},s=`
  .demo-container {
    height: 100vh;
    display: flex;
...
${l}`}}},render:n=>e`
  ...
  `},o={args:{expanded:!0,"push-content":!0},parameters:{docs:{source:{transform:()=>`<style>
  ${s}
...
${l}`}}},render:n=>e`
  ...
  `},i={args:{expanded:!1,"push-content":!0},render:n=>e`
    ${z}
...
\${scriptBlock}\`
  ...
  \`
}`,...(m=(p=t.parameters)==null?void 0:p.docs)==null?void 0:m.source}}};var h,y,w;o.parameters={...o.parameters,docs:{...(h=o.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    expanded: true,
    'push-content': true
  },
...
\${scriptBlock}\`
  ...
  \`
}`,...(w=(y=o.parameters)==null?void 0:y.docs)==null?void 0:w.source}}};var v,b,f;a.parameters={...a.parameters,docs:{...(v=a.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    expanded: true,
    'push-content': false
  },
...
\${scriptBlock}\`
  ...
  \`
}`,...(T=(g=i.parameters)==null?void 0:g.docs)==null?void 0:T.source}}};const I=["Default","Expanded","OverlayMode","WithoutHeaderFooter"];export{t as Default,o as Expanded,a as OverlayMode,i as WithoutHeaderFooter,I as __namedExportsOrder,P as default};
