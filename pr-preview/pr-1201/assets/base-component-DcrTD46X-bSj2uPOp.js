...
modus-wc-time-input .time-picker-column {
  ...
  max-height: 200px;
  overflow-y: auto;
  padding: var(--modus-wc-spacing-xs, 4px);
}
modus-wc-time-input .time-picker-column:not(:last-child) {
  border-inline-end: 1px solid #e9eaf0;
}
...
modus-wc-time-input .time-picker-item {
  ...
  border: none;
  border-radius: 8px;
  color: var(--modus-wc-color-base-content, inherit);
  cursor: pointer;
  font-size: 14px;
  padding: 8px 16px;
  text-align: start;
...
modus-wc-time-input .time-picker-item--other {
  ...
  color: var(--modus-wc-color-base-content, inherit);
  margin-top: var(--modus-wc-spacing-xs, 4px);
}
