...
modus-wc-time-input .time-picker-dropdown {
  background: var(--modus-wc-color-base-page, #fff);
  border: 1px solid var(--modus-wc-color-base-200, #e9eaf0);
...
modus-wc-time-input .time-picker-panel {
  display: flex;
  gap: 12px;
  padding: var(--modus-wc-spacing-sm, 8px);
}
modus-wc-time-input .time-picker-column {
  display: flex;
  flex-direction: column;
  max-height: 220px;
  overflow-y: auto;
}
modus-wc-time-input .time-picker-column:not(:last-child) {
  border-inline-end: 1px solid var(--modus-wc-color-base-200, #e9eaf0);
}
modus-wc-time-input .time-datalist-panel {
  display: flex;
  flex-direction: column;
  min-width: 180px;
  overflow: hidden;
}
modus-wc-time-input .time-picker-item {
  background: none;
  border: none;
  border-radius: var(--modus-wc-border-radius-btn, 8px);
  color: var(--modus-wc-color-base-content, #171c1e);
  cursor: pointer;
  font-size: var(--modus-wc-font-size-sm, 14px);
  line-height: 24px;
  margin-bottom: -4px;
  padding: var(--modus-wc-spacing-sm, 8px) var(--modus-wc-spacing-md, 16px);
  text-align: start;
  white-space: nowrap;
}
modus-wc-time-input .time-picker-item:last-child {
  margin-bottom: 0;
}
modus-wc-time-input .time-picker-item:hover {
  background-color: var(--modus-wc-color-primary-pale, #dcedf9);
}
modus-wc-time-input .time-picker-item--selected {
  background-color: var(--modus-wc-color-primary-pale, #dcedf9);
}
modus-wc-time-input .time-picker-item--other {
  border-top: 1px solid var(--modus-wc-color-base-200, #e9eaf0);
  color: var(--modus-wc-color-base-content, #171c1e);
  margin-bottom: 0;
  margin-top: var(--modus-wc-spacing-sm, 8px);
}
...
modus-wc-tree-item .modus-wc-menu-item .modus-wc-menu-item-interactive:hover {
  background-color: transparent;
}
