import{w as D}from"./decorator-Cv9na35H.js";import{b as r}from"./lit-element-DgBvYnzn.js";import{o as t}from"./if-defined-BnVFTJ4o.js";import{c as T}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-C_wAuwg_.js";import"./v4-C6aID195.js";var u=Object.freeze,q=Object.defineProperty,B=(e,c)=>u(q(e,"raw",{value:u(e.slice())})),p;const O={title:"Components/Forms/Text Input",component:"modus-wc-text-input",args:{bordered:!0,disabled:!1,"include-clear":!1,"include-search":!1,inputmode:"text",label:"Label",size:"md",spellcheck:!1,type:"text",value:""},argTypes:{"auto-capitalize":{options:["off","none","on","sentences","words","characters"]},"auto-complete":{control:{type:"text"}},"auto-correct":{options:["on","off"]},enterkeyhint:{options:["enter","done","go","next","previous","search","send"]},feedback:{description:"Feedback prop for input components",table:{type:{detail:`
    ...
    <modus-wc-text-input
      ...
      .feedback=${e.feedback}
      hide-password-aria-label=${t(e["hide-password-aria-label"])}
      ...
      ?required=${e.required}
      show-password-aria-label=${t(e["show-password-aria-label"])}
      size=${t(e.size)}
      spellcheck=${t(e.spellcheck)}
      type=${t(e.type)}
      .value=${e.value}
    ></modus-wc-text-input>
  `},o={...P},A={level:"error",message:"Value is required."},l={render:e=>r(p||(p=B([`
    <modus-wc-text-input
    ...
    <\/script>
  `])),A,t(e.label),!0,e.value)},i={render:e=>r`
<modus-wc-text-input
...
>
  ...
  `,args:{placeholder:"Enter text here..."}},s={render:e=>{if(!customElements.get("text-input-shadow-host")){const c=T({componentTag:"modus-wc-text-input",propsMapper:(n,S)=>{const a=S;a.autoCapitalize=n["auto-capitalize"]||"",a.autoComplete=n["auto-complete"]||"",a.autoCorrect=n["auto-correct"]||"",a.bordered=!!n.bordered,a.clearAriaLabel=n["clear-aria-label"]||""||"Clear text",a.customClass=n["custom-class"]||"",a.disabled=!!n.disabled,a.enterkeyhint=n.enterkeyhint||"",a.hidePasswordAriaLabel=n["hide-password-aria-label"]||"Hide password",a.includeClear=!!n["include-clear"],a.includeSearch=!!n["include-search"],a.inputId=n["input-id"]||"",a.inputTabIndex=n["input-tab-index"]||0,a.label=n.label||"",a.maxLength=n["max-length"],a.minLength=n["min-length"],a.name=n.name||"",a.pattern=n.pattern||"",a.placeholder=n.placeholder||"",a.readOnly=!!n["read-only"],a.required=!!n.required,a.showPasswordAriaLabel=n["show-password-aria-label"]||"Show password",a.size=n.size||"",a.type=n.type||"",a.value=n.value}});customElements.define("text-input-shadow-host",c)}return r`<text-input-shadow-host
      .props=${{...e}}
...
| valueChange | inputChange |                  |
  ...
  ...Template
}`,...(b=(h=o.parameters)==null?void 0:h.docs)==null?void 0:b.source}}};var f,x,w;l.parameters={...l.parameters,docs:{...(f=l.parameters)==null?void 0:f.docs,source:{originalSource:`{
  // prettier-ignore
  render: args => html\`
    <modus-wc-text-input
      aria-label="Text input with error feedback"
    ...
    <\/script>
  \`
}`,...(w=(x=l.parameters)==null?void 0:x.docs)==null?void 0:w.source}}};var g,$,v;i.parameters={...i.parameters,docs:{...(g=i.parameters)==null?void 0:g.docs,source:{originalSource:`{
  // prettier-ignore
  render: args => html\`
<modus-wc-text-input
  aria-label="Text input with custom icon"
...
}`,...(v=($=i.parameters)==null?void 0:$.docs)==null?void 0:v.source}}};var k,y,I;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: args => {
    ...
    if (!customElements.get('text-input-shadow-host')) {
      const TextInputShadowHost = createShadowHostClass<TextInputArgs>({
        ...
        propsMapper: (v: TextInputArgs, el: HTMLElement) => {
          ...
          textInputEl.hidePasswordAriaLabel = v['hide-password-aria-label'] || 'Hide password';
          ...
          textInputEl.showPasswordAriaLabel = v['show-password-aria-label'] || 'Show password';
...
}`,...(I=(y=s.parameters)==null?void 0:y.docs)==null?void 0:I.source}}};var E,z,C;d.parameters={...d.parameters,docs:{...(E=d.parameters)==null?void 0:E.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| valueChange | inputChange |                  |
  ...
  render: () => html\`<div></div>\`
}`,...(C=(z=d.parameters)==null?void 0:z.docs)==null?void 0:C.source}}};const W=["Default","WithErrorFeedback","WithCustomIconSlot","ShadowDomParent","Migration"];export{o as Default,d as Migration,s as ShadowDomParent,i as WithCustomIconSlot,l as WithErrorFeedback,W as __namedExportsOrder,O as default};
