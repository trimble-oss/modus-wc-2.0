...
<modus-wc-autocomplete
  ...
  value=${e.value}
></modus-wc-autocomplete>
    `},I={...me},y={name:"With Tooltips",parameters:{docs:{description:{story:"This example demonstrates menu items with tooltips. Hover over the items to see the tooltips."}}},render:()=>{const e=[{label:"Apple",value:"apple",tooltip:"apple",tooltipPosition:"bottom",visibleInMenu:!0,focused:!1},{label:"Banana",value:"banana",tooltip:"Banana",tooltipPosition:"bottom",visibleInMenu:!0,focused:!1},{label:"Cherry",value:"cherry",tooltip:"Cherry",tooltipPosition:"bottom",visibleInMenu:!0,focused:!1},{label:"Grape",value:"grape",tooltip:"Grape",tooltipPosition:"bottom",visibleInMenu:!0,focused:!1},{label:"Orange",value:"orange",tooltip:"Orange",tooltipPosition:"top",visibleInMenu:!0,focused:!1}];return v(L||(L=g([`
      <script>
    ...
    `])),e)}},M={render:e=>((!e.items||e.items.length===0)&&(e.items=[...f]),e.items=f.map(m=>m.value==="apple"||m.value==="banana"?{...m,selected:!0}:m),v(k||(k=g([`
<script>
...
<modus-wc-autocomplete
  ...
  value=`,`
></modus-wc-autocomplete>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["max-chips"]??4,e["min-chars"],t(e["min-input-width"]),!0,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e.value))},x={render:e=>{let m;const h=b=>{var a;if(!((a=b.detail)!=null&&a.target))return;const r=b.target.closest("modus-wc-autocomplete");if(r){const n=b.detail.target.value.toLowerCase();m&&window.clearTimeout(m),r.showSpinner=!0,m=window.setTimeout(()=>{const i=f.filter(o=>o.label.toLowerCase().includes(n));r.items=i,r.showSpinner=!1},2e3)}};return v(P||(P=g([`
<script>
...
\`\`\`
      ...
      <modus-wc-autocomplete
        ...
        @itemSelect=`,`
      ></modus-wc-autocomplete>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),m,t(e.label),e["leave-menu-open"],0,!1,t(e.name),e["no-results"],e["read-only"],e.required,!0,t(e.size),e.value,b,r)}},T={parameters:{docs:{description:{story:`
#### Breaking Changes
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>v`<div></div>`};var F,B,H;I.parameters={...I.parameters,docs:{...(F=I.parameters)==null?void 0:F.docs,source:{originalSource:`{
  ...Template
}`,...(H=(B=I.parameters)==null?void 0:B.docs)==null?void 0:H.source}}};var q,O,R;y.parameters={...y.parameters,docs:{...(q=y.parameters)==null?void 0:q.docs,source:{originalSource:`{
  name: 'With Tooltips',
  parameters: {
    docs: {
      description: {
...
}`,...(R=(O=y.parameters)==null?void 0:O.docs)==null?void 0:R.source}}};var N,W,j;M.parameters={...M.parameters,docs:{...(N=M.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: args => {
    // Initialize args.items if empty
    if (!args.items || args.items.length === 0) {
      args.items = [...items];
...
}`,...(j=(W=M.parameters)==null?void 0:W.docs)==null?void 0:j.source}}};var U,K,V;x.parameters={...x.parameters,docs:{...(U=x.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: args => {
    let debounceTimer: number;
    const handleInputChange = (e: CustomEvent<Event>) => {
      if (!e.detail?.target) return;
...
}`,...(V=(K=x.parameters)==null?void 0:K.docs)==null?void 0:V.source}}};var G,_,J;C.parameters={...C.parameters,docs:{...(G=C.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: args => {
    const originalNoResults = args['no-results'];
    if (args['leave-menu-open'] == true) {
      args['no-results'] = {
...
}`,...(J=(_=C.parameters)==null?void 0:_.docs)==null?void 0:J.source}}};var Q,X,Y;$.parameters={...$.parameters,docs:{...(Q=$.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  render: args => {
...
}`,...(Y=(X=$.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};var Z,ee,te;S.parameters={...S.parameters,docs:{...(Z=S.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  args: {
    ...meta.args,
...
}`,...(le=(oe=E.parameters)==null?void 0:oe.docs)==null?void 0:le.source}}};var se,ae,ie;T.parameters={...T.parameters,docs:{...(se=T.parameters)==null?void 0:se.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(ie=(ae=T.parameters)==null?void 0:ae.docs)==null?void 0:ie.source}}};const fe=["Default","WithTooltips","MultiSelect","WithSpinner","CustomMenuItems","CustomEventHandlers","WithProgrammaticControl","DynamicOptions","Migration"];export{$ as CustomEventHandlers,C as CustomMenuItems,I as Default,E as DynamicOptions,T as Migration,M as MultiSelect,S as WithProgrammaticControl,x as WithSpinner,y as WithTooltips,fe as __namedExportsOrder,ce as default};
