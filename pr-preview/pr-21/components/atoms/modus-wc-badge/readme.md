...
| `color`                  | `color`        | The color variant of the badge.                                                       | `"danger" \| "primary" \| "secondary" \| "success" \| "tertiary" \| "warning"` | `'primary'` |
...
| `customClass`            | `custom-class` | Custom CSS class to apply to the badge.                                               | `string`                                                                       | `''`        |
