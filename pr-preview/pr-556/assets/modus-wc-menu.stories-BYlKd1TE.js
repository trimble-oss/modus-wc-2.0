import{w as E}from"./decorator-D4YmxizW.js";import{x as t}from"./lit-element-C8zulti1.js";import{o as a}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var w=Object.freeze,z=Object.defineProperty,A=(e,c)=>w(z(e,"raw",{value:w(e.slice())})),v;const T={title:"Components/Menu",component:"modus-wc-menu",args:{orientation:"vertical",size:"md"},argTypes:{orientation:{control:{type:"select"},options:["horizontal","vertical"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[E],parameters:{actions:{handles:["menuFocusout"]}}},n={render:e=>t`
<modus-wc-menu
  aria-label="Menu"
  ?bordered=${e.bordered}
...
>
  ...
  <li>
    ...
    `},o={render:()=>{const e=c=>{var m;const r=c.currentTarget,s=r.closest("li");if(!s)return;const l=r.querySelector(".dropdown-toggle");if(!l)return;const u=l.getAttribute("name")==="expand_more";l.setAttribute("name",u?"expand_less":"expand_more");const d=(m=s.nextElementSibling)!=null&&m.classList.contains("children-container")?s.nextElementSibling:null;d&&(d.classList.toggle("hidden"),d.setAttribute("aria-hidden",u?"false":"true"))};return t(v||(v=A([`
      <style>
        .children-container {
