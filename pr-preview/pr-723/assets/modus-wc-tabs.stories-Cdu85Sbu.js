...
}`,...(C=(I=r.parameters)==null?void 0:I.docs)==null?void 0:C.source}}};var N,P,S;l.parameters={...l.parameters,docs:{...(N=l.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: args => {
    // Normalize tabs to ensure disabled is strictly boolean (true/false only)
    const normalizedTabs = args.tabs.map(tab => ({
      ...tab,
...
}`,...(S=(P=l.parameters)==null?void 0:P.docs)==null?void 0:S.source}}};var D,A,M;c.parameters={...c.parameters,docs:{...(D=c.parameters)==null?void 0:D.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
