import{w as q}from"./decorator-Cv9na35H.js";import{b as G}from"./lit-element-DgBvYnzn.js";import{o as s}from"./if-defined-BnVFTJ4o.js";import"./chunk-4XZ63LWV-C_wAuwg_.js";import"./v4-C6aID195.js";const l="https://images.pexels.com/photos/5146774/pexels-photo-5146774.jpeg",U={title:"Components/Image",component:"modus-wc-image",args:{src:l,alt:"A zebra drinks from a pond",fit:"default",shape:"square",size:"md"},argTypes:{fit:{control:{type:"select"},options:["default","contain","scale-down","none"]},shape:{control:{type:"select"},options:["square","rounded"]},size:{control:{type:"select"},options:["sm","md","lg","xl"]}},decorators:[q],parameters:{actions:{handles:["imageLoad","imageError"]},docs:{description:{component:"\nA resilient atomic image component wrapping the native `<img>` tag with consistent sizing tokens,\naspect-ratio control, an accessible error fallback, and WCAG 2.2 compliance."}}}},e={render:t=>G`
    <modus-wc-image
      src=${t.src}
      alt=${s(t.alt)}
      size=${s(t.size)}
  ...
  `,parameters:{docs:{description:{story:'\nAll available size tokens side by side (xl omitted for layout reasons — it is 1486×384 px).\nFor `fit="scale-down"` these values act as `max-width / max-height` constraints rather than fixed dimensions.\n\n| `size` | Width | Height |\n|---------|-------|--------|\n| `sm` | 128 px | 128 px |\n| `md` *(default)* | 288 px | 192 px |\n| `lg` | 384 px | 256 px |\n| `xl` | 1486 px | 384 px |\n        '}}}},c={...e,args:{alt:""},parameters:{docs:{description:{story:"When `alt` is empty or whitespace-only the image is treated as decorative: an empty `alt` attribute is set so screen readers skip it."}}}},p={...e,args:{src:"https://example.com/this-image-does-not-exist.png",alt:"A missing image"},parameters:{docs:{description:{story:"When the image URL fails to load the broken image icon is hidden and a `modus-wc-icon` fallback (`image_disabled`) is rendered; the container keeps the accessible name from `alt`."}}}};var m,h,g;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`{
  ...Template,
  parameters: {
    docs: {
      description: {
...
}`,...(x=(u=i.parameters)==null?void 0:u.docs)==null?void 0:x.source}}};var w,y,b;n.parameters={...n.parameters,docs:{...(w=n.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...Template,
  args: {
    fit: 'scale-down'
  },
...
}`,...(b=(y=n.parameters)==null?void 0:y.docs)==null?void 0:b.source}}};var v,z,k;o.parameters={...o.parameters,docs:{...(v=o.parameters)==null?void 0:v.docs,source:{originalSource:`{
  ...Template,
  args: {
    fit: 'none'
  },
...
}`,...(k=(z=o.parameters)==null?void 0:z.docs)==null?void 0:k.source}}};var A,S,T;r.parameters={...r.parameters,docs:{...(A=r.parameters)==null?void 0:A.docs,source:{originalSource:`{
  ...Template,
  args: {
    shape: 'rounded'
  },
...
}`,...(T=(S=r.parameters)==null?void 0:S.docs)==null?void 0:T.source}}};var E,$,F;d.parameters={...d.parameters,docs:{...(E=d.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: () => html\`
    <div
      style="display: flex; flex-wrap: wrap; gap: 24px; align-items: flex-end;"
    >
...
}`,...(L=(I=c.parameters)==null?void 0:I.docs)==null?void 0:L.source}}};var D,_,W;p.parameters={...p.parameters,docs:{...(D=p.parameters)==null?void 0:D.docs,source:{originalSource:`{
  ...Template,
  args: {
...
}`,...(W=(_=p.parameters)==null?void 0:_.docs)==null?void 0:W.source}}};const j=["Default","FitContain","FitScaleDown","FitNone","Rounded","AllSizes","DecorativeImage","ErrorFallback"];export{d as AllSizes,c as DecorativeImage,a as Default,p as ErrorFallback,i as FitContain,o as FitNone,n as FitScaleDown,r as Rounded,j as __namedExportsOrder,U as default};
