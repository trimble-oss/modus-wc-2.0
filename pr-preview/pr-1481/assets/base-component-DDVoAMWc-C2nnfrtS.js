...
modus-wc-select .modus-wc-select.modus-wc-select-md {
  font-size: var(--modus-wc-font-size-lg);
  height: var(--modus-wc-size-md);
  line-height: calc(var(--modus-wc-size-md) - var(--modus-wc-border-width-sm));
  min-height: var(--modus-wc-size-md);
  padding-block: 0;
...
modus-wc-select .modus-wc-select.modus-wc-select-lg {
  font-size: var(--modus-wc-font-size-xl);
  height: var(--modus-wc-size-lg);
  line-height: calc(var(--modus-wc-size-lg) - var(--modus-wc-border-width-sm));
  min-height: var(--modus-wc-size-lg);
  padding-block: 0;
  padding-inline-end: calc(var(--modus-wc-spacing-lg) + var(--modus-wc-line-height-md));
...
modus-wc-select .modus-wc-select.modus-wc-select-xl {
  font-size: var(--modus-wc-font-size-xl);
  height: var(--modus-wc-size-xl);
  line-height: calc(var(--modus-wc-size-xl) - var(--modus-wc-border-width-sm));
  min-height: var(--modus-wc-size-xl);
  padding-block: 0;
  padding-inline-end: calc(var(--modus-wc-spacing-lg) + var(--modus-wc-line-height-md));
  padding-inline-start: var(--modus-wc-spacing-xl);
