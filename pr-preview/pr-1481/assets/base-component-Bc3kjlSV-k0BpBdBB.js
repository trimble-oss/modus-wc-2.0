...
[data-theme=modus-modern-light] modus-wc-select .modus-wc-select.modus-wc-select-lg, [data-theme=modus-modern-light] modus-wc-select .modus-wc-select.modus-wc-select-xl,
...
[data-theme=modus-modern-light] modus-wc-select:has(.modus-wc-select-bordered) .modus-wc-select-wrapper,
[data-theme=modus-modern-dark] modus-wc-select:has(.modus-wc-select-bordered) .modus-wc-select-wrapper {
  background-color: var(--modus-wc-color-base-page);
...
[data-theme=modus-modern-light] modus-wc-select:has(.modus-wc-select--error) .modus-wc-select-wrapper,
[data-theme=modus-modern-dark] modus-wc-select:has(.modus-wc-select--error) .modus-wc-select-wrapper {
  border-color: var(--modus-wc-color-error) !important;
}

[data-theme=modus-modern-light] modus-wc-select:has(.modus-wc-select--info) .modus-wc-select-wrapper,
[data-theme=modus-modern-dark] modus-wc-select:has(.modus-wc-select--info) .modus-wc-select-wrapper {
  border-color: var(--modus-wc-color-info) !important;
}

[data-theme=modus-modern-light] modus-wc-select:has(.modus-wc-select--success) .modus-wc-select-wrapper,
[data-theme=modus-modern-dark] modus-wc-select:has(.modus-wc-select--success) .modus-wc-select-wrapper {
  border-color: var(--modus-wc-color-success) !important;
}

[data-theme=modus-modern-light] modus-wc-select:has(.modus-wc-select--warning) .modus-wc-select-wrapper,
[data-theme=modus-modern-dark] modus-wc-select:has(.modus-wc-select--warning) .modus-wc-select-wrapper {
  border-color: var(--modus-wc-color-warning) !important;
}

[data-theme=modus-modern-light] modus-wc-select:has(.modus-wc-select:disabled) .modus-wc-select-wrapper,
[data-theme=modus-modern-dark] modus-wc-select:has(.modus-wc-select:disabled) .modus-wc-select-wrapper {
  background-color: var(--modus-wc-color-base-200);
}
...
[data-theme=modus-modern-light] modus-wc-select .modus-wc-select:focus {
  outline: none;
}

[data-theme=modus-modern-dark] modus-wc-select .modus-wc-select:focus {
  outline: none;
}
