...
[data-theme=connect-light] modus-wc-date .modus-wc-date-input:not(.modus-wc-select, .modus-wc-number-input, .modus-wc-text-input),
[data-theme=connect-dark] modus-wc-date .modus-wc-date-input:not(.modus-wc-select, .modus-wc-number-input, .modus-wc-text-input) {
...
[data-theme=connect-light] modus-wc-number-input .modus-wc-number-input:not(.modus-wc-select, .modus-wc-number-input, .modus-wc-text-input),
[data-theme=connect-dark] modus-wc-number-input .modus-wc-number-input:not(.modus-wc-select, .modus-wc-number-input, .modus-wc-text-input) {
  padding: 0 var(--modus-wc-spacing-sm);
}
...
modus-wc-select .modus-wc-select::-ms-expand {
  display: none;
}
modus-wc-select .modus-wc-select.modus-wc-select-xs {
...
modus-wc-select .modus-wc-select.modus-wc-select-sm {
  --modus-wc-select-inner-height: calc(
...
modus-wc-select .modus-wc-select.modus-wc-select-md {
  --modus-wc-select-inner-height: calc(
...
modus-wc-select .modus-wc-select.modus-wc-select-lg {
  --modus-wc-select-inner-height: calc(
...
modus-wc-select .modus-wc-select.modus-wc-select-xl {
  --modus-wc-select-inner-height: calc(
...
modus-wc-select .modus-wc-select-chevron {
  align-items: center;
  color: var(--modus-wc-color-base-content);
  display: inline-flex;
...
modus-wc-select:has(.modus-wc-select:disabled) .modus-wc-select-chevron {
  opacity: 0.5;
}
...
modus-wc-select:has(.modus-wc-select-xs) .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-sm);
  line-height: 1.25rem;
}

modus-wc-select:has(.modus-wc-select-sm) .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-md);
  line-height: var(--modus-wc-line-height-md);
}

modus-wc-select:has(.modus-wc-select-md) .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-lg);
  line-height: var(--modus-wc-line-height-md);
}

modus-wc-select:has(.modus-wc-select-lg) .modus-wc-input-label,
modus-wc-select:has(.modus-wc-select-xl) .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-xl);
  line-height: var(--modus-wc-line-height-lg);
}
...
[data-theme=connect-light] modus-wc-select .modus-wc-select:not(.modus-wc-select, .modus-wc-number-input, .modus-wc-text-input),
[data-theme=connect-dark] modus-wc-select .modus-wc-select:not(.modus-wc-select, .modus-wc-number-input, .modus-wc-text-input) {
  padding: 0 var(--modus-wc-spacing-sm);
}
...
modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-xs input::placeholder {
  line-height: 1.25rem;
}
...
modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-sm input::placeholder {
  line-height: var(--modus-wc-line-height-md);
}
...
modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-md input,
modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-md input::placeholder {
  line-height: var(--modus-wc-line-height-md);
}
...
modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-md .modus-wc-clear-icon-container {
...
modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-lg input,
modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-lg input::placeholder {
  line-height: var(--modus-wc-line-height-lg);
}
...
modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-xl {
  font-size: var(--modus-wc-font-size-xl);
  height: var(--modus-wc-size-xl);
  line-height: var(--modus-wc-line-height-lg);
  min-height: var(--modus-wc-size-xl);
...
modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-xl input,
modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-xl input::placeholder {
  line-height: var(--modus-wc-line-height-lg);
}
...
modus-wc-text-input:has(.modus-wc-input-xs) .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-sm);
  line-height: 1.25rem;
}

modus-wc-text-input:has(.modus-wc-input-sm) .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-md);
  line-height: var(--modus-wc-line-height-md);
}

modus-wc-text-input:has(.modus-wc-input-md) .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-lg);
  line-height: var(--modus-wc-line-height-md);
}

modus-wc-text-input:has(.modus-wc-input-lg) .modus-wc-input-label,
modus-wc-text-input:has(.modus-wc-input-xl) .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-xl);
  line-height: var(--modus-wc-line-height-lg);
}
...
[data-theme=connect-light] modus-wc-text-input .modus-wc-text-input:not(.modus-wc-select, .modus-wc-number-input, .modus-wc-text-input),
[data-theme=connect-dark] modus-wc-text-input .modus-wc-text-input:not(.modus-wc-select, .modus-wc-number-input, .modus-wc-text-input) {
  padding: 0 var(--modus-wc-spacing-sm);
}
...
[data-theme=connect-light] modus-wc-textarea .modus-wc-textarea:not(.modus-wc-select, .modus-wc-number-input, .modus-wc-text-input),
[data-theme=connect-dark] modus-wc-textarea .modus-wc-textarea:not(.modus-wc-select, .modus-wc-number-input, .modus-wc-text-input) {
  padding: 0 var(--modus-wc-spacing-sm);
}
...
[data-theme=connect-light] modus-wc-time-input .modus-wc-time-input:not(.modus-wc-select, .modus-wc-number-input, .modus-wc-text-input),
[data-theme=connect-dark] modus-wc-time-input .modus-wc-time-input:not(.modus-wc-select, .modus-wc-number-input, .modus-wc-text-input) {
  padding: 0 var(--modus-wc-spacing-sm);
}
