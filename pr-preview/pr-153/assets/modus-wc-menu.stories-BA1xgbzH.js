import{k as r}from"./lit-element-DVRzCIa_.js";import{t as s}from"./if-defined-1ipA9LQg.js";const b={title:"Components/Menu",component:"modus-wc-menu",args:{"aria-label":"Example menu",orientation:"vertical",size:"md"},argTypes:{orientation:{control:{type:"select"},options:["horizontal","vertical"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]}}},n={render:e=>r`
<modus-wc-menu
