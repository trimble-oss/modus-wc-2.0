...
// autocomplete.items = autocompleteItems;
<\/script>
  `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e.feedback),e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["min-chars"],t(e["min-input-width"]),!1,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],e["show-spinner"],t(e.size),e.value,g),args:{label:"Autocomplete with custom icon",placeholder:"Search fruits..."}},M={render:e=>b`
    <style>
    ...
    `},S={render:e=>(e.items||(e.items=[...w]),e.items=e.items.map(m=>m.value==="apple"||m.value==="banana"?{...m,selected:!0}:m),b(P||(P=v([`
      ...
      <script>
        ...
        `,`
          ...
          // }
        <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["max-chips"]??4,e["min-chars"],t(e["min-input-width"]),!0,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e.value,g))},E={render:e=>{let m;const s=p=>{var u;if(!((u=p.detail)!=null&&u.target))return;const n=p.target.closest("modus-wc-autocomplete");if(n){const o=p.detail.target.value.toLowerCase();m&&window.clearTimeout(m),n.showSpinner=!0,m=window.setTimeout(()=>{const c=w.filter(l=>l.label.toLowerCase().includes(o));n.items=c,n.showSpinner=!1},2e3)}};return b(q||(q=v([`
      <style>
      ...
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["min-chars"],!1,t(e.name),t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],e["show-spinner"],t(e.size),e.value,s,g)}},k={render:e=>{const m=e["no-results"];e["leave-menu-open"]==!0&&(e["no-results"]={ariaLabel:"",label:"",subLabel:""});const s=a=>{const o=a.querySelectorAll("modus-wc-menu-item:not([disabled])");return Array.from(o).filter(c=>window.getComputedStyle(c).display!=="none"&&!c.classList.contains("hidden"))},p=a=>{var f,h;const o=a.target.closest("modus-wc-autocomplete");if(!o||o.disabled||o.readOnly)return;const l=s(o).map(d=>d.querySelector("button")).filter(Boolean),i=document.activeElement,r=l.indexOf(i);switch(a.key){case"ArrowDown":{a.preventDefault(),o.openMenu();let d=r+1;if(d>=l.length)return;d<0&&(d=0),(f=l[d])==null||f.focus();break}case"ArrowUp":{a.preventDefault(),o.openMenu();let d=r-1;if(d<0)return;(h=l[d])==null||h.focus();break}case"Enter":{a.preventDefault(),l.includes(i)&&i.click();const d=o.querySelector("input");d==null||d.focus();break}case"Escape":{a.preventDefault(),o.closeMenu();const d=o.querySelector("input");d==null||d.focus();break}}},n=a=>{var c;if(!((c=a.detail)!=null&&c.target))return;const o=a.target.closest("modus-wc-autocomplete");if(o){const l=a.detail.target.value.toLowerCase(),i=o==null?void 0:o.querySelectorAll("modus-wc-menu-item");l===""&&(i==null||i.forEach(h=>{h.removeAttribute("selected")}));let r=0;Array.from(i??[]).forEach(h=>{var I;(((I=h.getAttribute("label"))==null?void 0:I.toLowerCase())||"").includes(l)?h.classList.remove("hidden"):(h.classList.add("hidden"),r++)}),o.noResults=r===(i==null?void 0:i.length)?m:{ariaLabel:"",label:"",subLabel:""};const f=o.querySelector(".no-results-item");f&&(r===(i==null?void 0:i.length)?f.classList.add("visible"):f.classList.remove("visible"))}},u=a=>{const o=a.target.closest("modus-wc-autocomplete");if(o){const c=a.detail.value;o.value=c,o.querySelectorAll("modus-wc-menu-item").forEach(i=>{i.getAttribute("value")===c?i.setAttribute("selected","true"):i.removeAttribute("selected")}),e["leave-menu-open"]||o.closeMenu()}};return b(O||(O=v([`
<style>
...
<script>
        ...
        // }
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),t(e.label),e["leave-menu-open"],e["min-chars"],!1,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e["show-spinner"],e.value,p,n,!0,u,u,u,u)}},A={render:e=>{const m=n=>{const u=document.getElementById("autocomplete-custom-event-handlers");if(!u)return;["ArrowDown","ArrowUp","Enter","Escape"].includes(n.key)&&n.preventDefault();const a=e.items.filter(o=>o.visibleInMenu&&!o.disabled);switch(n.key){case"Escape":e.items=e.items.map(o=>({...o,focused:!1})),u.items=[...e.items],u.closeMenu(),u.style.transform="scale(0.98)",setTimeout(()=>{u.style.transform=""},200);break;case"ArrowDown":{u.openMenu();const o=a.findIndex(i=>i.focused),c=o<0?0:Math.min(o+1,a.length-1),l=c+1<a.length?c+1:c;e.items=e.items.map(i=>{var r;return{...i,focused:((r=a[l])==null?void 0:r.value)===i.value}});break}case"ArrowUp":{const o=a.findIndex(i=>i.focused),c=o<0?a.length-1:Math.max(o-1,0),l=c-1>=0?c-1:c;e.items=e.items.map(i=>{var r;return{...i,focused:((r=a[l])==null?void 0:r.value)===i.value}});break}case"Enter":{const o=a.find(c=>c.focused);o&&(e.items=e.items.map(c=>({...c,selected:c.value===o.value,focused:!1})),u.value=o.label,u.closeMenu());break}default:return}u.items=[...e.items]},s=n=>{const u=document.getElementById("autocomplete-custom-event-handlers");if(!u)return;const a=n.toLowerCase().split("");if(n.length>0){const l=e.items.map(i=>{const r=i.label.toLowerCase();let f=0,h=!0;for(const d of a)if(r.includes(d)){const I=r.indexOf(d);I===0?f+=3:r[I-1]===" "?f+=2:f+=1}else{h=!1;break}return h&&r.includes(n.toLowerCase())&&(f+=10),{item:i,score:h?f:-1,visible:h}});l.sort((i,r)=>r.score-i.score),e.items=l.map(({item:i,visible:r})=>({...i,visibleInMenu:r,focused:!1,selected:i.selected&&r&&i.label.toLowerCase()===n.toLowerCase(),label:i.label}))}else e.items=e.items.map(l=>({...l,visibleInMenu:!0,focused:!1,selected:!1}));u.items=[...e.items],u.value=n;const o=e.items.filter(l=>l.visibleInMenu).length;console.log(`Fuzzy search for "${n}": ${o} matches found`),e.items.some(l=>l.visibleInMenu)&&n.length>=e["min-chars"]?u.openMenu():u.closeMenu()},p=n=>{const u=document.getElementById("autocomplete-custom-event-handlers");u&&(e.items=e.items.map(a=>({...a,selected:a.value===n.value,focused:!1})),u.items=[...e.items],u.value=n.label,e["leave-menu-open"]?(e.items=e.items.map(a=>({...a,visibleInMenu:!0,focused:!1})),u.items=[...e.items],u.openMenu()):u.closeMenu())};return b(R||(R=v([`
      <style>
...
\`\`\`
        ...
        `}}}},L={render:e=>{const m=[{label:"Apple",value:"apple",visibleInMenu:!0},{label:"Banana",value:"banana",visibleInMenu:!0},{label:"Orange",value:"orange",visibleInMenu:!0},{label:"Strawberry",value:"strawberry",visibleInMenu:!0}],s=[...m,{label:"Blackberry",value:"blackberry",visibleInMenu:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0},{label:"Cherry",value:"cherry",visibleInMenu:!0},{label:"Cranberry",value:"cranberry",visibleInMenu:!0},{label:"Fig",value:"fig",visibleInMenu:!0},{label:"Grape",value:"grape",visibleInMenu:!0},{label:"Kiwi",value:"kiwi",visibleInMenu:!0},{label:"Lemon",value:"lemon",visibleInMenu:!0},{label:"Lime",value:"lime",visibleInMenu:!0},{label:"Mango",value:"mango",visibleInMenu:!0},{label:"Melon",value:"melon",visibleInMenu:!0},{label:"Peach",value:"peach",visibleInMenu:!0},{label:"Pineapple",value:"pineapple",visibleInMenu:!0},{label:"Raspberry",value:"raspberry",visibleInMenu:!0},{label:"Watermelon",value:"watermelon",visibleInMenu:!0}],p=u=>{var o;if(!((o=u.detail)!=null&&o.target))return;const a=u.target.closest("modus-wc-autocomplete");if(a){const c=u.detail.target,l=c.value.toLowerCase();if(l===""){a.items=[...m],a.value=c.value;return}a.showSpinner=!0,setTimeout(()=>{const i=s.filter(r=>r.label.toLowerCase().includes(l));a.items=i,a.showSpinner=!1},1e3),a.value=c.value}},n=u=>{const a=u.target.closest("modus-wc-autocomplete");if(a){const o=u.detail.label;o&&(a.value=o)}};return b(H||(H=v([`
      <style>
      ...
      <script>
        ...
        // }
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),m,t(e.label),e["leave-menu-open"],0,!1,t(e.name),e["no-results"],e["read-only"],e.required,!0,t(e.size),e.value,p,n)}},T={render:e=>{if(!customElements.get("autocomplete-shadow-host")){const m=Se({componentTag:"modus-wc-autocomplete",propsMapper:(s,p)=>{const n=p;n.bordered=!!s.bordered,n.customClass=s["custom-class"]||"",typeof s["debounce-ms"]=="number"&&(n.debounceMs=s["debounce-ms"]),n.disabled=!!s.disabled,n.includeClear=!!s["include-clear"],n.includeSearch=!!s["include-search"],typeof s["input-id"]=="string"&&(n.inputId=s["input-id"]),typeof s["input-tab-index"]=="number"&&(n.inputTabIndex=s["input-tab-index"]),n.items=s.items,typeof s.label=="string"&&(n.label=s.label),typeof s["leave-menu-open"]=="boolean"&&(n.leaveMenuOpen=s["leave-menu-open"]),typeof s["max-chips"]=="number"&&(n.maxChips=s["max-chips"]),typeof s["min-chars"]=="number"&&(n.minChars=s["min-chars"]),typeof s["min-input-width"]=="number"&&(n.minInputWidth=s["min-input-width"]),n.multiSelect=!!s["multi-select"],typeof s.name=="string"&&(n.name=s.name),n.noResults=s["no-results"],typeof s.placeholder=="string"&&(n.placeholder=s.placeholder),n.readOnly=!!s["read-only"],n.required=!!s.required,typeof s["show-menu-on-focus"]=="boolean"&&(n.showMenuOnFocus=s["show-menu-on-focus"]),n.showSpinner=!!s["show-spinner"],typeof s.size=="string"&&(n.size=s.size),n.value=s.value}});customElements.define("autocomplete-shadow-host",m)}return b`<autocomplete-shadow-host
      .props=${{...e}}
...
}`,...(se=(le=E.parameters)==null?void 0:le.docs)==null?void 0:se.source}}};var ae,ie,ue;k.parameters={...k.parameters,docs:{...(ae=k.parameters)==null?void 0:ae.docs,source:{originalSource:`{
  render: args => {
