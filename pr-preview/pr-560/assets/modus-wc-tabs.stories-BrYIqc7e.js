...
>
  ...
  `}},n={...l};n.args={activeTabIndex:1,tabs:[{label:"Normal"},{label:"Active"},{label:"Disabled",disabled:!0}]};const o={...l,args:{tabs:[{icon:"home"},{icon:"settings",iconPosition:"left",label:"Settings"},{icon:"alert",iconPosition:"right",label:"Alerts"}]}},i={render:e=>c`
<modus-wc-tabs
  active-tab-index="${t(e.activeTabIndex)}"
  aria-label="Tab group"
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(N=(D=r.parameters)==null?void 0:D.docs)==null?void 0:N.source}}};const W=["Default","CustomContent","ActiveAndDisabled","Icons","TabsWithPanel","Migration"];export{n as ActiveAndDisabled,s as CustomContent,a as Default,o as Icons,r as Migration,i as TabsWithPanel,W as __namedExportsOrder,O as default};
