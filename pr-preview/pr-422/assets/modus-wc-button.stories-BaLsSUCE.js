...
<modus-wc-button aria-label="Checkout button">
  ...
  <modus-wc-icon decorative name="shopping_cart"></modus-wc-icon>
    ...
    `},p={render:()=>{const t={alignment:"center",period:"week",formatting:["italic"],options:["option1","option3"],sizes:{sm:"group",md:"group",lg:"group"}},o=(s,i)=>w=>{t[s]=i;const r=w.target,u=r.closest(".button-group");u&&(u.querySelectorAll("modus-wc-button").forEach(K=>{K.removeAttribute("pressed")}),r.setAttribute("pressed","true"))},n=(s,i)=>w=>{const r=t[s],u=w.target;r.includes(i)?(t[s]=r.filter(v=>v!==i),u.removeAttribute("pressed")):(t[s]=[...r,i],u.setAttribute("pressed","true"))};return e`
<style>
  .button-group {
    display: flex;
    gap: 0;
    ...
    <div class="demo-row">
      <div class="button-group button-group-vertical">
        ...
        <modus-wc-button 
          ...
          full-width
          ?pressed=${t.formatting.includes("italic")}
          @buttonClick=${n("formatting","italic")}
        >
        ...
        <modus-wc-button 
          ...
          full-width
          ?pressed=${t.formatting.includes("underline")}
          @buttonClick=${n("formatting","underline")}
        >
...
}`,...(k=($=d.parameters)==null?void 0:$.docs)==null?void 0:k.source}}};var y,C,x;c.parameters={...c.parameters,docs:{...(y=c.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => {
    // prettier-ignore
    return html\`
<modus-wc-button aria-label="Notification button">
