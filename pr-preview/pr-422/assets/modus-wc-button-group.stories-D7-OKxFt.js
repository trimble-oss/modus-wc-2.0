import{x as t}from"./lit-element-C8zulti1.js";const W={title:"Components/Button Group",component:"modus-wc-button-group",parameters:{docs:{description:{component:`
...
- **Styling**: Automatic pressed states and seamless button connections
        `}}},argTypes:{orientation:{control:"select",options:["horizontal","vertical"],description:"Layout orientation of the button group"},selectionMode:{control:"select",options:["single","multiple","none"],description:"Selection behavior - single (radio), multiple (checkbox), or none"},size:{control:"select",options:["sm","md","lg"],description:"Size of buttons in the group"},variant:{control:"select",options:["outlined","borderless"],description:"Visual variant of buttons"},value:{control:"text",description:"Selected value(s). String for single mode, array for multiple mode"},disabled:{control:"boolean",description:"Disable the entire button group"},spaced:{control:"boolean",description:"Add spacing between buttons"},customClass:{control:"text",description:"Custom CSS class to apply"}}},e={render:o=>t`
    <modus-wc-button-group
      orientation="${o.orientation||"horizontal"}"
      selection-mode="${o.selectionMode||"single"}"
      size="${o.size||"md"}"
  ...
  `,args:{orientation:"horizontal",selectionMode:"single",size:"md",variant:"outlined",value:"week",disabled:!1,spaced:!1,customClass:""}},n={render:()=>t`
  ...
  \`
}`,...($=(M=c.parameters)==null?void 0:M.docs)==null?void 0:$.source}}};const T=["Default","SingleSelect","MultipleSelect","VerticalOrientation","DifferentSizes","Disabled","WithSpacing"];export{e as Default,d as DifferentSizes,i as Disabled,u as MultipleSelect,n as SingleSelect,s as VerticalOrientation,c as WithSpacing,T as __namedExportsOrder,W as default};
