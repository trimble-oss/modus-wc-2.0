import{w as v}from"./decorator-534da2b0.js";import{b as r}from"./lit-element-38260dd9.js";import{o as a}from"./if-defined-30b85b98.js";import{c as f}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";const I={title:"Components/Forms/Checkbox",component:"modus-wc-checkbox",args:{"custom-class":"",disabled:!1,indeterminate:!1,label:"Label",name:"",required:!1,size:"md",value:!0},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[v],parameters:{actions:{handles:["inputBlur","inputChange","inputFocus"]}}},t={render:e=>r`
      <modus-wc-checkbox
        aria-label="Checkbox"
        ...
        .value=${e.value}
      ></modus-wc-checkbox>
    `},s={render:e=>{if(!customElements.get("checkbox-shadow-host")){const k=f({componentTag:"modus-wc-checkbox",propsMapper:(n,g)=>{const o=g;o.customClass=n["custom-class"]||"",o.disabled=Boolean(n.disabled),o.indeterminate=Boolean(n.indeterminate),o.inputId=n["input-id"]??"",o.inputTabIndex=n["input-tab-index"]??0,o.label=n.label??"",o.name=n.name??"",o.required=Boolean(n.required),o.size=n.size??"",o.value=Boolean(n.value)}});customElements.define("checkbox-shadow-host",k)}return r`<checkbox-shadow-host
      .props=${{...e}}
