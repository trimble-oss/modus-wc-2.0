...
<main role="main">
  <fieldset class="radio-group">
    ...
    `},t={render:e=>{if(!customElements.get("radio-shadow-host")){const i=C({componentTag:"modus-wc-radio",propsMapper:(n,E)=>{const o=E;o.customClass=n["custom-class"]||"",o.disabled=Boolean(n.disabled),o.inputId=n["input-id"]||"",o.inputTabIndex=n["input-tab-index"]||0,o.label=n.label||"",o.name=n.name||"",o.required=Boolean(n.required),o.size=n.size||"md",o.value=Boolean(n.value)}});customElements.define("radio-shadow-host",i)}return l`<radio-shadow-host .props=${{...e}}></radio-shadow-host>`}},r={parameters:{docs:{description:{story:`
#### Breaking Changes
