import{b as d}from"./lit-element-DgBvYnzn.js";import{o as u}from"./if-defined-BnVFTJ4o.js";import{c as B}from"./shadow-host-helper-A4Nvcs5e.js";function T(o=8){return Math.random().toString(36).substring(2,2+o)}var w=Object.freeze,H=Object.defineProperty,L=(o,n)=>w(H(o,"raw",{value:w(o.slice())})),b;const q={title:"Components/Modal",component:"modus-wc-modal",args:{backdrop:"default","custom-class":"",fullscreen:!1,"modal-id":"my_modal_1",position:"center","show-close":!0,"show-fullscreen-toggle":!1},argTypes:{backdrop:{control:{type:"select"},options:["default","static"]},position:{control:{type:"select"},options:["bottom","center","top"]}},parameters:{layout:"centered"}},x=d(b||(b=L([`
  <script>
    ...
    // );
  <\/script>
`]))),r={render:o=>{const n=`${o["modal-id"]}${T(4)}}`,a=l=>{const e=document.getElementById(n);e&&(l==="show"?e.showModal():e.close())};return d`
<modus-wc-button id="open-modal-btn" @buttonClick=${()=>a("show")}>
  Open modal
</modus-wc-button>
<modus-wc-modal
...
>
  ...
  <modus-wc-button slot="footer" id="close-modal-btn" @buttonClick=${()=>a("hide")}>
    Close
  </modus-wc-button>
</modus-wc-modal>
${x}
    `}},i={render:o=>{const n=`${o["modal-id"]}${T(4)}}`,a=l=>{const e=document.getElementById(n);e&&(l==="show"?e.showModal():e.close())};return d`
<style>
...
}`,...(v=(f=r.parameters)==null?void 0:f.docs)==null?void 0:v.source}}};var y,M,$;i.parameters={...i.parameters,docs:{...(y=i.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: args => {
    const modalId = \`\${args['modal-id']}\${generateRandomId(4)}}\`;
    const handleModalVisibility = (action: 'show' | 'hide') => {
      const modal = document.getElementById(modalId) as HTMLDialogElement;
...
}`,...($=(M=i.parameters)==null?void 0:M.docs)==null?void 0:$.source}}};var E,k,C;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: args => {
...
}`,...(C=(k=c.parameters)==null?void 0:k.docs)==null?void 0:C.source}}};var I,N,S;m.parameters={...m.parameters,docs:{...(I=m.parameters)==null?void 0:I.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| secondaryButtonClick |           | Not carried over, handle with events on custom buttons in \\\`footer\\\` slot instead |
  ...
  render: () => html\`<div></div>\`
}`,...(S=(N=m.parameters)==null?void 0:N.docs)==null?void 0:S.source}}};const _=["Default","CustomWidthAndHeight","ShadowDomParent","Migration"];export{i as CustomWidthAndHeight,r as Default,m as Migration,c as ShadowDomParent,_ as __namedExportsOrder,q as default};
