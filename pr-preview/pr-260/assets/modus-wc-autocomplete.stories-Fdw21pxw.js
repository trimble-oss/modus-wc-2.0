...
<modus-wc-autocomplete
  ...
  @itemSelect=`,`
></modus-wc-autocomplete>
    `])),e.bordered,n(e["custom-class"]),n(e["debounce-ms"]),e.disabled,n(e["input-id"]),n(e["input-tab-index"]),e.items,n(e.label),e["leave-menu-open"],e["min-chars"],!0,n(e.name),e["no-results"],n(e.placeholder),e["read-only"],e.required,n(e.size),e.value,r,c,l)}},f={render:e=>{const r=l=>{var a;if(!((a=l.detail)!=null&&a.target))return;const t=l.target.closest("modus-wc-autocomplete");if(t){const s=l.detail.target,o=s.value.toLowerCase();setTimeout(()=>{e["show-spinner"]=!1},2e3),e["show-spinner"]=!0;const m=i.map(u=>({...u,selected:o?u.selected:!1,visibleInMenu:u.label.toLowerCase().includes(o)}));t.items=[...m],t.value=s.value}},c=l=>{const t=l.target.closest("modus-wc-autocomplete");if(t){const a=l.detail.label;a&&(t.value=a),i.forEach(o=>o.selected=!1);const s=i.find(o=>o.value===l.detail.value);s&&(s.selected=!0,t.items=[...i])}};return v(M||(M=b([`
<style>
  /* Only for Storybook */
  div[id^="story--components-forms-autocomplete--default"] {
    height: 400px;
...
<modus-wc-autocomplete
  ...
  @itemSelect=`,`
></modus-wc-autocomplete>
    `])),e.bordered,n(e["custom-class"]),n(e["debounce-ms"]),e.disabled,n(e["input-id"]),n(e["input-tab-index"]),e.items,n(e.label),e["leave-menu-open"],e["min-chars"],e["show-spinner"],!1,n(e.name),n(e.placeholder),e["read-only"],e.required,n(e.size),e.value,r,c)}},h={parameters:{docs:{description:{story:`
#### Breaking Changes
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>v`<div></div>`};var C,T,x;d.parameters={...d.parameters,docs:{...(C=d.parameters)==null?void 0:C.docs,source:{originalSource:`{
  ...Template
}`,...(x=(T=d.parameters)==null?void 0:T.docs)==null?void 0:x.source}}};var E,L,S;p.parameters={...p.parameters,docs:{...(E=p.parameters)==null?void 0:E.docs,source:{originalSource:`{
  render: args => {
...
}`,...(S=(L=p.parameters)==null?void 0:L.docs)==null?void 0:S.source}}};var $,H,z;f.parameters={...f.parameters,docs:{...($=f.parameters)==null?void 0:$.docs,source:{originalSource:`{
  render: args => {
    const handleInputChange = (e: CustomEvent<Event>) => {
      if (!e.detail?.target) return;
      const autocomplete = (e.target as HTMLInputElement).closest('modus-wc-autocomplete');
