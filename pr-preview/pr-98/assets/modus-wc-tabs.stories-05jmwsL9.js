import{k as w}from"./lit-element-DVRzCIa_.js";import{t as a}from"./if-defined-1ipA9LQg.js";import{w as y}from"./decorator-Dt3Huotz.js";import"./v4-CQkTLCs1.js";const D={title:"Components/Tabs",component:"modus-wc-tabs",args:{"aria-label":"Example Tab Group",tabs:[{label:"Tab 1"},{label:"Tab 2"},{label:"Tab 3",disabled:!0},{icon:"home"}]},argTypes:{tabStyle:{control:{type:"radio"},options:["boxed","bordered","lifted","none"]},size:{control:{type:"radio"},options:["xs","sm","md","lg"]}},decorators:[y],parameters:{actions:{handles:["tabChange"]}}},r={render:e=>w`
<modus-wc-tabs
