import{x as c}from"./lit-element-CucEn6F2.js";import{o as l}from"./if-defined-BiZP-SBN.js";import{g as r}from"./logo-constants-CCF64jNC.js";const b={title:"Components/Logo",component:"modus-wc-logo",args:{name:"trimble",emblem:!1},argTypes:{name:{control:{type:"select"},options:r()},emblem:{control:{type:"boolean"}}}},g={render:e=>c`
      <modus-wc-logo
        name="${e.name}"
        ?emblem="${e.emblem}"
        alt="${l(e.alt)}"
