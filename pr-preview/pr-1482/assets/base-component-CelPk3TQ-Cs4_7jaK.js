...
modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-text-input--readonly input {
  background-color: transparent;
}
...
[data-theme=modus-modern-light] modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-bordered:not(:disabled) {
  border-color: rgba(23, 28, 30, 0.2);
}
@supports (background-color: color-mix(in sRGB, red 50%, blue)) {
  [data-theme=modus-modern-light] modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-bordered:not(:disabled) {
...
[data-theme=modus-modern-dark] modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-bordered:not(:disabled) {
  border-color: rgba(241, 241, 246, 0.2);
}
@supports (background-color: color-mix(in sRGB, red 50%, blue)) {
  [data-theme=modus-modern-dark] modus-wc-text-input .modus-wc-text-input.modus-wc-input.modus-wc-input-bordered:not(:disabled) {
