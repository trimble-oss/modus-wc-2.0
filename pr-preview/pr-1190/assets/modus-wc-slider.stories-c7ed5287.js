import{w}from"./decorator-534da2b0.js";import{b as t}from"./lit-element-38260dd9.js";import{o as s}from"./if-defined-30b85b98.js";import{c as x}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";const q={title:"Components/Forms/Slider",component:"modus-wc-slider",args:{"custom-class":"",disabled:!1,label:"Label",name:"",required:!1,size:"md",value:!0},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[w],parameters:{actions:{handles:["inputBlur","inputChange","inputFocus"]}}},i={render:e=>t`
      <modus-wc-slider
        aria-label="Slider"
        ...
        .value=${e.value}
      ></modus-wc-slider>
    `},r={render:e=>{if(!customElements.get("slider-shadow-host")){const f=x({componentTag:"modus-wc-slider",propsMapper:(n,g)=>{const a=g;a.customClass=n["custom-class"]||"",a.disabled=Boolean(n.disabled),a.inputId=n["input-id"]??"",a.inputTabIndex=n["input-tab-index"]??0,a.label=n.label??"",a.max=n.max??100,a.min=n.min??0,a.name=n.name??"",a.required=Boolean(n.required),a.size=n.size??"md",a.step=n.step??1,a.value=typeof n.value=="number"?n.value:0}});customElements.define("slider-shadow-host",f)}return t`<slider-shadow-host
      .props=${{...e}}
