import{w as S}from"./decorator-534da2b0.js";import{b as i}from"./lit-element-38260dd9.js";import{o as C}from"./if-defined-30b85b98.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";const P={title:"Components/ThemeSwitcher",component:"modus-wc-theme-switcher",args:{"custom-class":void 0,"initial-theme":void 0},decorators:[S],parameters:{actions:{handles:["themeChange"]}}},a=()=>{const t=document.documentElement.getAttribute("data-theme")||"modus-modern-light",s=t.endsWith("-dark")?"dark":"light";return{theme:t.replace(`-${s}`,""),mode:s}},E={render:t=>{const s=a();return i`
