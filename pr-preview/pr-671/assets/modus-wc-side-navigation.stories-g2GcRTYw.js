import{w as S}from"./decorator-D4YmxizW.js";import{x}from"./lit-element-C8zulti1.js";import{o}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var m=Object.freeze,M=Object.defineProperty,y=(e,r)=>m(M(e,"raw",{value:m(e.slice())})),l,p;const q={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[S],parameters:{layout:"padded",actions:{handles:["expandedChange","itemSelect"]}}},c={render:e=>{const r=u=>{const n=u.target,a=n==null?void 0:n.closest(".layout-with-navbar");let t;a?t=a.querySelector("modus-wc-side-navigation"):t=document.querySelector("modus-wc-side-navigation"),t&&(t.expanded=u.detail)};return x(l||(l=y([`
      <style>
        .layout-with-navbar {
          display: flex;
...
}`,...(f=(b=d.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};const k=["Default","SideNavWithSubmenu"];export{c as Default,d as SideNavWithSubmenu,k as __namedExportsOrder,q as default};
