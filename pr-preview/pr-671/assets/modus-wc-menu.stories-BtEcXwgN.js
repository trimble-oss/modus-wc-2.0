import{w as L}from"./decorator-D4YmxizW.js";import{x as l}from"./lit-element-C8zulti1.js";import{o as c}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var v=Object.freeze,z=Object.defineProperty,k=(e,r)=>v(z(e,"raw",{value:v(e.slice())})),p;const q={title:"Components/Menu",component:"modus-wc-menu",args:{orientation:"vertical",size:"md"},argTypes:{orientation:{control:{type:"select"},options:["horizontal","vertical"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[L],parameters:{actions:{handles:["menuFocusout"]}}},n={render:e=>l`
<modus-wc-menu
  aria-label="Menu"
  ?bordered=${e.bordered}
...
>
  ...
  <li>
    ...
    `},o={render:()=>{const e=r=>{var w;const u=r.currentTarget,t=u.closest("li");if(!t)return;const a=u.querySelector(".dropdown-toggle");if(!a)return;const m=a.getAttribute("name")==="expand_more";a.setAttribute("name",m?"expand_less":"expand_more");const d=(w=t.nextElementSibling)!=null&&w.classList.contains("children-container")?t.nextElementSibling:null;d&&(d.classList.toggle("hidden"),d.setAttribute("aria-hidden",m?"false":"true"))};return l(p||(p=k([`
      <style>
        .children-container {
