import{w as x}from"./decorator-D4YmxizW.js";import{x as f}from"./lit-element-C8zulti1.js";import{o as a}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var r=Object.freeze,y=Object.defineProperty,S=(e,c)=>r(y(e,"raw",{value:r(e.slice())})),l;const N={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[x],parameters:{layout:"padded",actions:{handles:["expandedChange","itemSelect"]}}},m={render:e=>{const c=u=>{const t=u.target,o=t==null?void 0:t.closest(".layout-with-navbar");let n;o?n=o.querySelector("modus-wc-side-navigation"):n=document.querySelector("modus-wc-side-navigation"),n&&(n.expanded=u.detail)};return f(l||(l=S([`
      <style>
        .layout-with-navbar {
          display: flex;
    ...
    `])),c,{avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},{ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],a(e["custom-class"]),e.expanded,e["max-width"],a(e.mode),a(e["target-content"]))}},d={render:e=>{const c=t=>{const o=t.target,n=o==null?void 0:o.closest(".layout-with-navbar");let s;if(n&&(s=n.querySelector("modus-wc-side-navigation"),s)){const i=s;i.expanded=t.detail}},u=t=>{t.detail||t.target.querySelectorAll("modus-wc-menu-item").forEach(s=>{const i=s;i.hasSubmenu&&typeof i.collapseSubmenu=="function"&&i.collapseSubmenu()})};return f`
      <style>
        .layout-with-navbar {
    ...
    `}};var p,v,h;m.parameters={...m.parameters,docs:{...(p=m.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: args => {
...
}`,...(h=(v=m.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};var w,g,b;d.parameters={...d.parameters,docs:{...(w=d.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: args => {
    const handleMenuOpenChange = (e: CustomEvent) => {
      const eventSource = e.target as HTMLElement;
      const storyContainer = eventSource?.closest('.layout-with-navbar');
...
}`,...(b=(g=d.parameters)==null?void 0:g.docs)==null?void 0:b.source}}};const I=["Default","CollapsibleMenuWithAPI"];export{d as CollapsibleMenuWithAPI,m as Default,I as __namedExportsOrder,N as default};
