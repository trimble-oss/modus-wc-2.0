import{b as w}from"./lit-element-DgBvYnzn.js";import{o as n}from"./if-defined-BnVFTJ4o.js";import{c as g}from"./shadow-host-helper-A4Nvcs5e.js";var a=Object.freeze,f=Object.defineProperty,b=(e,p)=>a(f(e,"raw",{value:a(e.slice())})),c;const _={title:"Components/Stepper",component:"modus-wc-stepper",args:{steps:[{label:"Scale",color:"primary"},{label:"Belong",color:"primary"},{label:"Grow",color:"warning"},{label:"Innovate",content:"🚀"}]},argTypes:{"custom-class":{control:"text"},orientation:{control:{type:"select"},options:["horizontal","vertical"]},steps:{description:"Array of step objects defining the steps to display",table:{type:{detail:`
          ...
          `}}}},parameters:{layout:"padded"}},y={render:e=>w(c||(c=b([`
<modus-wc-stepper
  custom-class="`,`"
  orientation="`,`"
  .steps="`,`"
