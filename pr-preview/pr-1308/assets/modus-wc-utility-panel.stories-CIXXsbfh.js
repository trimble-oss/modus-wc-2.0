...
${T}`}}},render:e=>d`
  ...
  `},f={args:{"background-overlay":!0,"collapse-on-click-outside":!0,expanded:!0,"push-content":!1},parameters:{docs:{source:{transform:()=>`
<style>
${a}
</style>
...
${T}`}}},render:e=>d`
  ...
  `},x={render:e=>{if(!customElements.get("utility-panel-shadow-host")){const $=X({componentTag:"modus-wc-utility-panel",propsMapper:(n,t)=>{if(t.backgroundOverlay=!!n["background-overlay"],t.collapseOnClickOutside=!!n["collapse-on-click-outside"],t.expanded=!!n.expanded,t.pushContent=!!n["push-content"],!t.hasAttribute("data-layout-built")){t.setAttribute("data-layout-built","");const c=t.getRootNode(),Q=t.parentElement,r=document.createElement("div");r.setAttribute("slot","header"),r.className="modus-wc-utility-panel-header",r.textContent="Utility Panel Header";const i=document.createElement("div");i.setAttribute("slot","body"),i.className="modus-wc-utility-panel-body";const A=document.createElement("p");A.textContent="This is the utility panel body content.";const S=document.createElement("p");S.textContent="You can add any content here including forms, lists, or other components.";const k=document.createElement("modus-wc-text-input");k.setAttribute("label","Example Input"),k.setAttribute("placeholder","Enter text..."),i.appendChild(A),i.appendChild(S),i.appendChild(k);const l=document.createElement("div");l.setAttribute("slot","footer"),l.className="modus-wc-utility-panel-footer";const u=document.createElement("modus-wc-button");u.setAttribute("color","tertiary"),u.setAttribute("size","sm"),u.textContent="Cancel";const p=document.createElement("modus-wc-button");p.setAttribute("color","primary"),p.setAttribute("size","sm"),p.textContent="Save",l.appendChild(u),l.appendChild(p),t.appendChild(r),t.appendChild(i),t.appendChild(l);const m=document.createElement("modus-wc-navbar");m.visibility={user:!1},m.userCard={name:"",email:""};const E=document.createElement("div");E.setAttribute("slot","end");const h=document.createElement("modus-wc-tooltip");h.setAttribute("content","Toggle Utility Panel"),h.setAttribute("position","left");const s=document.createElement("modus-wc-button");s.setAttribute("color","primary"),s.setAttribute("size","sm"),s.setAttribute("variant","outlined");const z=document.createElement("modus-wc-icon");z.setAttribute("name","menu"),s.appendChild(z),h.appendChild(s),E.appendChild(h),m.appendChild(E),s.addEventListener("buttonClick",()=>{t.expanded=!t.expanded});const o=document.createElement("div");o.className="main-content";const B=document.createElement("h1");B.textContent="Main Content Area";const P=document.createElement("p");P.textContent="This is the main content area below the navbar. When the utility panel opens with pushContent=true, this content will be pushed to the left.";const M=document.createElement("p");M.textContent="This is an example of how the utility panel interacts with the main content. When the panel opens with push content enabled, this area will shift to the left to make room for the panel.";const I=document.createElement("p");I.textContent="The content area maintains its full functionality while the panel is open. Users can continue to interact with the main content while accessing the utility panel features.",o.appendChild(B),o.appendChild(P),o.appendChild(M),o.appendChild(I);const y=document.createElement("div");y.className="main-content-wrapper",y.appendChild(o),y.appendChild(t);const w=document.createElement("div");w.className="demo-container",w.appendChild(m),w.appendChild(y),Q.appendChild(w);const U=document.createElement("style");U.textContent=a,c.appendChild(U),requestAnimationFrame(()=>{t.targetElement=o})}}});customElements.define("utility-panel-shadow-host",$)}return d`<utility-panel-shadow-host
      .props=${{...e}}
    ></utility-panel-shadow-host>`}};var H,q,O;v.parameters={...v.parameters,docs:{...(H=v.parameters)==null?void 0:H.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        transform: () => \`
...
\${scriptBlock}\`
  ...
  \`
}`,...(O=(q=v.parameters)==null?void 0:q.docs)==null?void 0:O.source}}};var W,N,D;b.parameters={...b.parameters,docs:{...(W=b.parameters)==null?void 0:W.docs,source:{originalSource:`{
  args: {
    expanded: true,
    'push-content': true
  },
...
\${scriptBlock}\`
  ...
  \`
}`,...(D=(N=b.parameters)==null?void 0:N.docs)==null?void 0:D.source}}};var F,R,Y;f.parameters={...f.parameters,docs:{...(F=f.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
