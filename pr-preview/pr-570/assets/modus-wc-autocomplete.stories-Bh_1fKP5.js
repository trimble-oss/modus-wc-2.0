...
<modus-wc-autocomplete
  ...
  value=${e.value}
></modus-wc-autocomplete>
    `},g={...ce},I={name:"With Tooltips",parameters:{docs:{description:{story:"This example demonstrates menu items with tooltips. Hover over the items to see the tooltips."},source:{code:`
const tooltipItems = [
  {
    label: 'Apple',
    value: 'apple',
...
`}}},render:()=>f`
    ...
    `},y={render:e=>(e.items=e.items.map(m=>m.value==="apple"||m.value==="banana"?{...m,selected:!0}:m),f(L||(L=A([`
<script>
...
<modus-wc-autocomplete
  ...
  value=`,`
></modus-wc-autocomplete>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["max-chips"]??4,e["min-chars"],t(e["min-input-width"]),!0,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e.value))},M={render:e=>{let m;const h=b=>{var a;if(!((a=b.detail)!=null&&a.target))return;const r=b.target.closest("modus-wc-autocomplete");if(r){const n=b.detail.target.value.toLowerCase();m&&window.clearTimeout(m),r.showSpinner=!0,m=window.setTimeout(()=>{const i=w.filter(o=>o.label.toLowerCase().includes(n));r.items=i,r.showSpinner=!1},2e3)}};return f(k||(k=A([`
<script>
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>f`<div></div>`};var D,F,H;g.parameters={...g.parameters,docs:{...(D=g.parameters)==null?void 0:D.docs,source:{originalSource:`{
  ...Template
}`,...(H=(F=g.parameters)==null?void 0:F.docs)==null?void 0:H.source}}};var B,q,R;I.parameters={...I.parameters,docs:{...(B=I.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: 'With Tooltips',
  parameters: {
    docs: {
      description: {
...
}`,...(R=(q=I.parameters)==null?void 0:q.docs)==null?void 0:R.source}}};var O,N,W;y.parameters={...y.parameters,docs:{...(O=y.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: args => {
    // If multi-select, set selected state for some items
...
}`,...(W=(N=y.parameters)==null?void 0:N.docs)==null?void 0:W.source}}};var j,U,K;M.parameters={...M.parameters,docs:{...(j=M.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: args => {
    let debounceTimer: number;
    const handleInputChange = (e: CustomEvent<Event>) => {
      if (!e.detail?.target) return;
...
}`,...(K=(U=M.parameters)==null?void 0:U.docs)==null?void 0:K.source}}};var V,G,J;x.parameters={...x.parameters,docs:{...(V=x.parameters)==null?void 0:V.docs,source:{originalSource:`{
  render: args => {
    const originalNoResults = args['no-results'];
    if (args['leave-menu-open'] == true) {
      args['no-results'] = {
...
}`,...(J=(G=x.parameters)==null?void 0:G.docs)==null?void 0:J.source}}};var _,Q,X;C.parameters={...C.parameters,docs:{...(_=C.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: args => {
...
}`,...(X=(Q=C.parameters)==null?void 0:Q.docs)==null?void 0:X.source}}};var Y,Z,ee;$.parameters={...$.parameters,docs:{...(Y=$.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  args: {
    ...meta.args,
...
}`,...(ee=(Z=$.parameters)==null?void 0:Z.docs)==null?void 0:ee.source}}};var te,ne,oe;S.parameters={...S.parameters,docs:{...(te=S.parameters)==null?void 0:te.docs,source:{originalSource:`{
  render: args => {
    const defaultFruits = [{
      label: 'Apple',
      value: 'apple',
...
}`,...(oe=(ne=S.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};var le,se,ae;E.parameters={...E.parameters,docs:{...(le=E.parameters)==null?void 0:le.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(ae=(se=E.parameters)==null?void 0:se.docs)==null?void 0:ae.source}}};const fe=["Default","WithTooltips","MultiSelect","WithSpinner","CustomMenuItems","CustomEventHandlers","WithProgrammaticControl","DynamicOptions","Migration"];export{C as CustomEventHandlers,x as CustomMenuItems,g as Default,S as DynamicOptions,E as Migration,y as MultiSelect,$ as WithProgrammaticControl,M as WithSpinner,I as WithTooltips,fe as __namedExportsOrder,re as default};
