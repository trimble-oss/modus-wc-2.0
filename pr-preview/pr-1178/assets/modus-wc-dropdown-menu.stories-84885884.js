import{w as _}from"./decorator-534da2b0.js";import{b as p}from"./lit-element-38260dd9.js";import{o as n}from"./if-defined-30b85b98.js";import{c as P}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";var S=Object.freeze,O=Object.defineProperty,j=(e,d)=>S(O(e,"raw",{value:S(d||e.slice())})),g;const U={title:"Components/Dropdown Menu",component:"modus-wc-dropdown-menu",args:{"button-aria-label":"Dropdown menu button","button-color":"primary","button-shape":"rectangle","button-size":"md","button-variant":"filled",disabled:!1,"menu-bordered":!0,"menu-offset":14,"menu-placement":"bottom-start","menu-size":"md","menu-strategy":"absolute","menu-visible":!1},argTypes:{"button-color":{control:{type:"select"},options:["primary","secondary","tertiary","warning","danger"]},"button-size":{control:{type:"select"},options:["xs","sm","md","lg","xl"]},"button-shape":{control:{type:"select"},options:["circle","ellipse","rectangle","square"]},"button-variant":{control:{type:"select"},options:["borderless","filled","outlined"]},"menu-placement":{control:{type:"select"},options:["top","top-start","top-end","bottom","bottom-start","bottom-end","left","left-start","left-end","right","right-start","right-end"]},"menu-size":{control:{type:"select"},options:["sm","md","lg"]},"menu-strategy":{control:{type:"select"},options:["absolute","fixed"]}},decorators:[_],parameters:{actions:{handles:["menuVisibilityChange"]}}},L={render:e=>{let d="";const t=s=>{d=s.detail.value;const o=document.querySelector("#selected-value");o&&(o.textContent=d);const l=s.target.closest("modus-wc-dropdown-menu");l&&(l.menuVisible=!1)};return p(g||(g=j([`
<style>
  /* Storybook styling */
