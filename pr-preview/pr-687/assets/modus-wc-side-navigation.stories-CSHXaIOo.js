import{w as C}from"./decorator-D4YmxizW.js";import{x as y}from"./lit-element-C8zulti1.js";import{o as a}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var u=Object.freeze,S=Object.defineProperty,b=(e,d)=>u(S(e,"raw",{value:u(e.slice())})),m,p;const k={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[C],parameters:{layout:"padded",actions:{handles:["expandedChange"]}}},l={render:e=>{const d=r=>{const t=r.target,i=t==null?void 0:t.closest(".layout-with-navbar");let n;i?n=i.querySelector("modus-wc-side-navigation"):n=document.querySelector("modus-wc-side-navigation"),n&&(n.expanded=r.detail)};return y(m||(m=b([`
      <style>
        .layout-with-navbar {
          display: flex;
      ...
      <\/script>
    `])),d,{avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},{ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],a(e["custom-class"]),e.expanded,e["max-width"],a(e.mode),a(e["target-content"]))}},c={render:e=>{const d=t=>{const i=t.target,n=i==null?void 0:i.closest(".layout-with-navbar");let o;n?o=n.querySelector("modus-wc-side-navigation"):o=document.querySelector("modus-wc-side-navigation"),o&&(o.expanded=t.detail)},r=t=>{if(!t.detail){const i=t.target,n=i==null?void 0:i.closest(".layout-with-navbar");n&&(n.querySelectorAll(".children-container").forEach(s=>{s.classList.add("hidden"),s.setAttribute("aria-hidden","true")}),n.querySelectorAll(".dropdown-toggle").forEach(s=>{s.getAttribute("name")==="expand_less"&&s.setAttribute("name","expand_more")}))}};return y(p||(p=b([`
      <style>
        .children-container {
    ...
    `])),d,{avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},{ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],a(e["custom-class"]),e.expanded,e["max-width"],a(e.mode),a(e["target-content"]),r)}};var v,h,g;l.parameters={...l.parameters,docs:{...(v=l.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: args => {
...
}`,...(g=(h=l.parameters)==null?void 0:h.docs)==null?void 0:g.source}}};var w,f,x;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: args => {
    const handleMenuOpenChange = (e: CustomEvent) => {
      const eventSource = e.target as HTMLElement;
      const storyContainer = eventSource?.closest('.layout-with-navbar');
...
}`,...(x=(f=c.parameters)==null?void 0:f.docs)==null?void 0:x.source}}};const L=["Default","collapsibleMenu"];export{l as Default,L as __namedExportsOrder,c as collapsibleMenu,k as default};
