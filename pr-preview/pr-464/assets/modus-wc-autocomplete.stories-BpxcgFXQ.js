...
<modus-wc-autocomplete
  ...
  value=${e.value}
></modus-wc-autocomplete>
    `},g={...te},y={render:e=>((!e.items||e.items.length===0)&&(e.items=[...v]),b(A||(A=E([`
<script>
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>b`<div></div>`};var k,z,D;g.parameters={...g.parameters,docs:{...(k=g.parameters)==null?void 0:k.docs,source:{originalSource:`{
  ...Template
