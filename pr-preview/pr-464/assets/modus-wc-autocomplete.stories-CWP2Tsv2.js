...
<modus-wc-autocomplete
  ...
  value=`,`
></modus-wc-autocomplete>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["max-chips"]??4,e["min-chars"],t(e["min-input-width"]),!0,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e.value))},y={render:e=>{let c;const h=m=>{var a;if(!((a=m.detail)!=null&&a.target))return;const u=m.target.closest("modus-wc-autocomplete");if(u){const n=m.detail.target.value.toLowerCase();c&&window.clearTimeout(c),u.showSpinner=!0,c=window.setTimeout(()=>{const s=v.filter(o=>o.label.toLowerCase().includes(n));u.items=s,u.showSpinner=!1},2e3)}};return b(T||(T=E([`
<script>
...
<modus-wc-autocomplete
  ...
  @inputChange=`,`
></modus-wc-autocomplete>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["min-chars"],!1,t(e.name),t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],e["show-spinner"],t(e.size),e.value,h)}},I={render:e=>{const c=e["no-results"];e["leave-menu-open"]==!0&&(e["no-results"]={ariaLabel:"",label:"",subLabel:""});const h=l=>{const n=l.querySelectorAll("modus-wc-menu-item:not([disabled])");return Array.from(n).filter(s=>window.getComputedStyle(s).display!=="none"&&!s.classList.contains("hidden"))},m=l=>{var f,p;const n=l.target.closest("modus-wc-autocomplete");if(!n||n.disabled||n.readOnly)return;const o=h(n).map(r=>r.querySelector("button")).filter(Boolean),i=document.activeElement,d=o.indexOf(i);switch(l.key){case"ArrowDown":{l.preventDefault(),n.openMenu();let r=d+1;if(r>=o.length)return;r<0&&(r=0),(f=o[r])==null||f.focus();break}case"ArrowUp":{l.preventDefault(),n.openMenu();let r=d-1;if(r<0)return;(p=o[r])==null||p.focus();break}case"Enter":{l.preventDefault(),o.includes(i)&&i.click();const r=n.querySelector("input");r==null||r.focus();break}case"Escape":{l.preventDefault(),n.closeMenu();const r=n.querySelector("input");r==null||r.focus();break}}},u=l=>{var s;if(!((s=l.detail)!=null&&s.target))return;const n=l.target.closest("modus-wc-autocomplete");if(n){const o=l.detail.target.value.toLowerCase(),i=n==null?void 0:n.querySelectorAll("modus-wc-menu-item");o===""&&(i==null||i.forEach(p=>{p.removeAttribute("selected")}));let d=0;Array.from(i??[]).forEach(p=>{var C;(((C=p.getAttribute("label"))==null?void 0:C.toLowerCase())||"").includes(o)?p.classList.remove("hidden"):(p.classList.add("hidden"),d++)}),n.noResults=d===(i==null?void 0:i.length)?c:{ariaLabel:"",label:"",subLabel:""};const f=n.querySelector(".no-results-item");f&&(d===(i==null?void 0:i.length)?f.classList.add("visible"):f.classList.remove("visible"))}},a=l=>{const n=l.target.closest("modus-wc-autocomplete");if(n){const s=l.detail.value;n.value=s,n.querySelectorAll("modus-wc-menu-item").forEach(i=>{i.getAttribute("value")===s?i.setAttribute("selected","true"):i.removeAttribute("selected")}),e["leave-menu-open"]||n.closeMenu()}};return b(L||(L=E([`
<script>
...
>
  <div slot="menu-items">
    ...
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),t(e.label),e["leave-menu-open"],e["min-chars"],!1,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e["show-spinner"],e.value,m,u,!0,a,a,a,a)}},x={render:e=>{const c=u=>{const a=u.target.closest("modus-wc-autocomplete");if(!a)return;["ArrowDown","ArrowUp","Enter","Escape"].includes(u.key)&&u.preventDefault();const l=e.items.filter(n=>n.visibleInMenu&&!n.disabled);switch(u.key){case"Escape":e.items=e.items.map(n=>({...n,focused:!1})),a.items=[...e.items],a.closeMenu();break;case"ArrowDown":{a.openMenu();const n=l.findIndex(o=>o.focused),s=n<0?0:Math.min(n+1,l.length-1);e.items=e.items.map(o=>{var i;return{...o,focused:((i=l[s])==null?void 0:i.value)===o.value}});break}case"ArrowUp":{const n=l.findIndex(o=>o.focused),s=n<0?l.length-1:Math.max(n-1,0);e.items=e.items.map(o=>{var i;return{...o,focused:((i=l[s])==null?void 0:i.value)===o.value}});break}case"Enter":{const n=l.find(s=>s.focused);n&&(e.items=e.items.map(s=>({...s,selected:s.value===n.value,focused:!1})),a.value=n.label,a.closeMenu());break}default:return}a.items=[...e.items]},h=u=>{const a=document.querySelector("modus-wc-autocomplete");if(!a)return;const l=u.toLowerCase();e.items=e.items.map(s=>({...s,visibleInMenu:s.label.toLowerCase().includes(l),focused:!1,selected:!!(l&&s.selected&&s.label.toLowerCase().includes(l))})),a.items=[...e.items],a.value=u,e.items.some(s=>s.visibleInMenu)&&u.length>=e["min-chars"]?a.openMenu():a.closeMenu()},m=u=>{const a=document.querySelector("modus-wc-autocomplete");a&&(e.items=e.items.map(l=>({...l,selected:l.value===u.value,focused:!1})),a.items=[...e.items],a.value=u.label,a.closeMenu())};return b`
      <style>
...
This is useful when you need specialized behavior that differs from the standard autocomplete functionality.`}}}},M={args:{...ee.args,items:v},render:e=>{const c=async()=>{const o=document.getElementById("programmatic-autocomplete");if(o){const i=v.find(d=>d.value==="apple")||null;await o.selectItem(i)}},h=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.selectItem(null)},m=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.openMenu()},u=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.closeMenu()},a=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.toggleMenu()},l=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.focusInput()},n=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.clearInput()},s=window;return s.handleSelectApple=c,s.handleSelectNull=h,s.handleOpenMenu=m,s.handleCloseMenu=u,s.handleToggleMenu=a,s.handleFocusInput=l,s.handleClearInput=n,b`
      <style>
...
}`,...(H=(q=g.parameters)==null?void 0:q.docs)==null?void 0:H.source}}};var B,R,F;y.parameters={...y.parameters,docs:{...(B=y.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: args => {
    let debounceTimer: number;
    const handleInputChange = (e: CustomEvent<Event>) => {
      if (!e.detail?.target) return;
...
}`,...(F=(R=y.parameters)==null?void 0:R.docs)==null?void 0:F.source}}};var O,N,j;I.parameters={...I.parameters,docs:{...(O=I.parameters)==null?void 0:O.docs,source:{originalSource:`{
  render: args => {
    const originalNoResults = args['no-results'];
    if (args['leave-menu-open'] == true) {
      args['no-results'] = {
...
}`,...(j=(N=I.parameters)==null?void 0:N.docs)==null?void 0:j.source}}};var W,K,U;x.parameters={...x.parameters,docs:{...(W=x.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: args => {
