...
modus-wc-time-input .clock-icon-trigger:focus {
  outline: none;
}
modus-wc-time-input .clock-icon-trigger:focus-visible {
  outline: 2px solid var(--modus-wc-color-primary);
  outline-offset: -2px;
}
modus-wc-time-input .clock-icon-trigger:disabled {
  cursor: not-allowed;
  opacity: 0.5;
}
...
modus-wc-time-input .time-wheel-option:focus-visible {
  outline: 2px solid var(--modus-wc-color-primary);
  outline-offset: -2px;
}
...
modus-wc-time-input .time-datalist-option:focus-visible {
  outline: 2px solid var(--modus-wc-color-primary);
  outline-offset: -2px;
}
