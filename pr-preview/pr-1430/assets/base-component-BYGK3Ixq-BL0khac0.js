...
modus-wc-time-input .modus-wc-input {
  font-variant-numeric: tabular-nums;
  letter-spacing: 0.04em;
  padding-inline-end: 1.75rem;
}
modus-wc-time-input .time-input-container {
  display: inline-flex;
  position: relative;
  width: auto;
}
modus-wc-time-input .time-input-container .modus-wc-time-input {
  box-sizing: border-box;
  min-width: 0;
  width: 5.375rem;
}
modus-wc-time-input .time-input-container:has(.modus-wc-time-input--with-seconds) .modus-wc-time-input {
  width: 6.8125rem;
}
modus-wc-time-input .time-input-container:has(.modus-wc-time-input--12hrs) .modus-wc-time-input {
  width: 7.25rem;
}
...
modus-wc-time-input .time-input-container--lg .modus-wc-input {
  padding-inline-end: 2.375rem;
}
modus-wc-time-input .time-input-container--lg .clock-icon-trigger {
  height: var(--modus-wc-size-sm);
  inset-inline-end: 0.875rem;
  width: var(--modus-wc-size-sm);
}
modus-wc-time-input .time-input-container--lg .modus-wc-time-input {
  width: 6.333rem;
}
modus-wc-time-input .time-input-container--lg:has(.modus-wc-time-input--with-seconds) .modus-wc-time-input {
  width: 8rem;
}
modus-wc-time-input .time-input-container--lg:has(.modus-wc-time-input--12hrs) .modus-wc-time-input {
  width: 8.5rem;
}
modus-wc-time-input .time-input-container--lg:has(.modus-wc-time-input--with-seconds.modus-wc-time-input--12hrs) .modus-wc-time-input {
  width: 10.125rem;
}
modus-wc-time-input .time-input-aria-live {
  border: 0;
  clip-path: inset(50%);
  height: 1px;
  margin: -1px;
...
modus-wc-time-input modus-wc-button.clock-icon-trigger,
modus-wc-time-input .clock-icon-trigger {
  cursor: default;
  display: inline-flex;
  height: var(--modus-wc-size-xs);
...
modus-wc-time-input modus-wc-button.clock-icon-trigger modus-wc-icon,
modus-wc-time-input .clock-icon-trigger modus-wc-icon {
  cursor: default;
}
modus-wc-time-input modus-wc-button.clock-icon-trigger .modus-wc-btn,
modus-wc-time-input .clock-icon-trigger .modus-wc-btn {
  align-items: center;
  cursor: default;
  display: inline-flex;
  height: 100%;
...
modus-wc-time-input modus-wc-button.clock-icon-trigger .modus-wc-btn, modus-wc-time-input modus-wc-button.clock-icon-trigger .modus-wc-btn:hover, modus-wc-time-input modus-wc-button.clock-icon-trigger .modus-wc-btn:active, modus-wc-time-input modus-wc-button.clock-icon-trigger .modus-wc-btn:focus, modus-wc-time-input modus-wc-button.clock-icon-trigger .modus-wc-btn:focus-visible, modus-wc-time-input modus-wc-button.clock-icon-trigger .modus-wc-btn:disabled,
modus-wc-time-input .clock-icon-trigger .modus-wc-btn,
modus-wc-time-input .clock-icon-trigger .modus-wc-btn:hover,
modus-wc-time-input .clock-icon-trigger .modus-wc-btn:active,
modus-wc-time-input .clock-icon-trigger .modus-wc-btn:focus,
modus-wc-time-input .clock-icon-trigger .modus-wc-btn:focus-visible,
modus-wc-time-input .clock-icon-trigger .modus-wc-btn:disabled {
  background: transparent;
  border: none;
  box-shadow: none;
  color: var(--modus-wc-color-base-content);
...
modus-wc-time-input modus-wc-button.clock-icon-trigger .modus-wc-btn:focus,
modus-wc-time-input .clock-icon-trigger .modus-wc-btn:focus {
  outline: none;
}
modus-wc-time-input modus-wc-button.clock-icon-trigger .modus-wc-btn:focus-visible,
modus-wc-time-input .clock-icon-trigger .modus-wc-btn:focus-visible {
  outline: 2px solid var(--modus-wc-color-primary);
  outline-offset: -2px;
}
modus-wc-time-input modus-wc-button.clock-icon-trigger .modus-wc-btn:disabled,
modus-wc-time-input .clock-icon-trigger .modus-wc-btn:disabled {
  cursor: not-allowed;
  opacity: 0.5;
}
modus-wc-time-input modus-wc-button.clock-icon-trigger .modus-wc-btn:disabled, modus-wc-time-input modus-wc-button.clock-icon-trigger .modus-wc-btn:disabled:hover, modus-wc-time-input modus-wc-button.clock-icon-trigger .modus-wc-btn:disabled:active,
modus-wc-time-input .clock-icon-trigger .modus-wc-btn:disabled,
modus-wc-time-input .clock-icon-trigger .modus-wc-btn:disabled:hover,
modus-wc-time-input .clock-icon-trigger .modus-wc-btn:disabled:active {
  cursor: not-allowed;
}
modus-wc-time-input .time-dropdown {
  background: var(--modus-wc-color-base-page);
  border: var(--modus-wc-border-width-xs) solid var(--modus-wc-color-base-200);
  border-radius: var(--modus-wc-border-radius-lg);
  box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1);
...
modus-wc-time-input .time-dropdown--picker {
  align-items: flex-start;
  display: flex;
  gap: var(--modus-wc-spacing-md);
  padding: var(--modus-wc-spacing-sm);
}
modus-wc-time-input .time-wheels {
  align-items: flex-start;
  display: flex;
  gap: var(--modus-wc-spacing-md);
}
modus-wc-time-input .time-wheel-viewport {
  box-sizing: border-box;
  flex-shrink: 0;
  height: 15rem;
...
modus-wc-time-input .time-wheel-viewport::-webkit-scrollbar {
  display: none;
}
modus-wc-time-input .time-wheel-viewport.time-wheel-viewport--compact {
  height: auto;
  overflow-y: hidden;
}
modus-wc-time-input .time-wheel {
  list-style: none;
  margin: 0;
  padding: 0;
}
modus-wc-time-input .time-wheel-option {
  align-items: center;
  border-radius: var(--modus-wc-border-radius-lg);
  box-sizing: border-box;
  color: var(--modus-wc-color-base-content);
...
modus-wc-time-input .time-wheel-option:hover:not(.is-selected) {
  background-color: var(--modus-wc-color-base-200);
}
modus-wc-time-input .time-wheel-option.is-selected {
  background-color: var(--modus-wc-color-primary-pale);
  color: var(--modus-wc-color-base-content);
}
modus-wc-time-input .time-wheel-option.is-disabled {
  opacity: 0.5;
  pointer-events: none;
}
modus-wc-time-input .time-wheel-option:focus {
  outline: 2px solid var(--modus-wc-color-primary);
  outline-offset: -2px;
}
modus-wc-time-input .time-dropdown--datalist {
  min-width: 11.25rem;
}
modus-wc-time-input .time-datalist {
  list-style: none;
  margin: 0;
  max-height: 16rem;
  -ms-overflow-style: none;
...
modus-wc-time-input .time-datalist::-webkit-scrollbar {
  display: none;
}
modus-wc-time-input .time-datalist-option {
  border-radius: var(--modus-wc-border-radius-lg);
  color: var(--modus-wc-color-base-content);
  cursor: pointer;
  font-size: var(--modus-wc-font-size-sm);
...
modus-wc-time-input .time-datalist-option:hover:not(.is-selected) {
  background-color: var(--modus-wc-color-base-200);
}
modus-wc-time-input .time-datalist-option.is-selected {
  background-color: var(--modus-wc-color-primary-pale);
}
modus-wc-time-input .time-datalist-option:focus {
  outline: 2px solid var(--modus-wc-color-primary);
  outline-offset: -2px;
}
modus-wc-time-input .time-datalist-divider {
  border-block-start: var(--modus-wc-border-width-xs) solid var(--modus-wc-color-base-200);
  height: 0;
  list-style: none;
  margin: var(--modus-wc-spacing-2xs) 0;
  padding: 0;
}
