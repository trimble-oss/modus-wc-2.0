import{w as j}from"./decorator-Dt3Huotz.js";import{k as b}from"./lit-element-DVRzCIa_.js";import{t}from"./if-defined-1ipA9LQg.js";import"./v4-CQkTLCs1.js";var I=Object.freeze,H=Object.defineProperty,q=(e,u)=>I(H(e,"raw",{value:I(e.slice())})),w,y;const c=[{label:"Apple",value:"apple",visibleInMenu:!0},{label:"Banana",value:"banana",visibleInMenu:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0},{label:"Cherry",value:"cherry",visibleInMenu:!0},{label:"Grape",value:"grape",visibleInMenu:!0},{label:"Lemon",value:"lemon",visibleInMenu:!0},{label:"Orange",value:"orange",visibleInMenu:!0},{label:"Peach",value:"peach",visibleInMenu:!0},{label:"Pear",value:"pear",visibleInMenu:!0},{label:"Strawberry",value:"strawberry",visibleInMenu:!0}],F={title:"Components/Forms/Autocomplete",component:"modus-wc-autocomplete",args:{bordered:!0,"debounce-ms":300,disabled:!1,items:c,label:"Label","min-chars":0,"multi-select":!1,size:"md",value:""},argTypes:{items:{description:"Array of items for the autocomplete component",table:{type:{detail:`
          ...
          `}}},size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[j],parameters:{actions:{handles:["chipRemove","inputBlur","inputChange","inputFocus","itemSelect"]}}},A={render:e=>{const u=l=>{var s;if(!((s=l.detail)!=null&&s.target))return;const n=l.target.closest("modus-wc-autocomplete");if(n){const o=l.detail.target,i=o.value.toLowerCase(),a=c.map(r=>({...r,selected:i?r.selected:!1,visibleInMenu:r.label.toLowerCase().includes(i)}));n.items=[...a],n.value=o.value}},d=l=>{const n=l.target.closest("modus-wc-autocomplete");if(n){const s=l.detail.label;s&&(n.value=s),c.forEach(i=>i.selected=!1);const o=c.find(i=>i.value===l.detail.value);o&&(o.selected=!0,n.items=[...c])}};return b(w||(w=q([`
<style>
  /* Only for Storybook */
...
<modus-wc-autocomplete
  ...
  @itemSelect=`,`
></modus-wc-autocomplete>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["min-chars"],!1,t(e.name),t(e.placeholder),e["read-only"],e.required,t(e.size),e.value,u,d)}},p={...A},v={render:e=>{const u=n=>{const s=n.target.closest("modus-wc-autocomplete");if(s){const o=c.find(i=>i.value===n.detail.value);o&&(o.selected=!1,s.items=[...c])}},d=n=>{var o;if(!((o=n.detail)!=null&&o.target))return;const s=n.target.closest("modus-wc-autocomplete");if(s){const i=n.detail.target,a=i.value.toLowerCase(),r=c.map(m=>({...m,visibleInMenu:m.label.toLowerCase().includes(a)}));s.items=[...r],s.value=i.value}},l=n=>{const s=n.target.closest("modus-wc-autocomplete");if(s){s.value="",s.items=c.map(i=>({...i,visibleInMenu:!0}));const o=c.find(i=>i.value===n.detail.value);o&&(o.selected=!0)}};return b(y||(y=q([`
<style>
  /* Only for Storybook */
...
<modus-wc-autocomplete
  ...
  @itemSelect=`,`
></modus-wc-autocomplete>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["min-chars"],!0,t(e.name),t(e.placeholder),e["read-only"],e.required,t(e.size),e.value,u,d,l)}},f={parameters:{docs:{description:{story:`
#### Breaking Changes
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>b`<div></div>`},h={render:e=>{const u=l=>{var s;if(!((s=l.detail)!=null&&s.target))return;const n=l.target.closest("modus-wc-autocomplete");if(n){const o=l.detail.target.value,i=n==null?void 0:n.querySelectorAll("li");Array.from(i??[]).forEach(a=>{var m,g;(((g=(m=a.querySelector(".title"))==null?void 0:m.textContent)==null?void 0:g.toLowerCase())||"").includes(o.toLowerCase())?a.classList.remove("hidden"):a.classList.add("hidden")})}},d=l=>{var s;const n=l.target.closest("modus-wc-autocomplete");if(n){const o=(s=l.detail.target)==null?void 0:s.value;n.value=o;const i=n==null?void 0:n.querySelectorAll("li");i==null||i.forEach(a=>a.classList.remove("selected")),i==null||i.forEach(a=>{var r;a.contains(l.target)&&(a.classList.add("selected"),n.value=(r=a.querySelector(".title"))==null?void 0:r.textContent)})}};return b`
<style>
  .list-item {
    display: flex;
    gap: 1rem;
...
}`,...(P=(D=h.parameters)==null?void 0:D.docs)==null?void 0:P.source}}};const N=["Default","MultiSelect","Migration","CustomMenuItems"];export{h as CustomMenuItems,p as Default,f as Migration,v as MultiSelect,N as __namedExportsOrder,F as default};
