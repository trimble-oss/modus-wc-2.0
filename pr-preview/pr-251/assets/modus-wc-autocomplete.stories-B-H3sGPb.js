import{w as H}from"./decorator-Dt3Huotz.js";import{k as b}from"./lit-element-DVRzCIa_.js";import{t as s}from"./if-defined-1ipA9LQg.js";import"./v4-CQkTLCs1.js";var I=Object.freeze,q=Object.defineProperty,j=(e,u)=>I(q(e,"raw",{value:I(e.slice())})),w,y;const c=[{label:"Apple",value:"apple",visibleInMenu:!0},{label:"Banana",value:"banana",visibleInMenu:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0},{label:"Cherry",value:"cherry",visibleInMenu:!0},{label:"Grape",value:"grape",visibleInMenu:!0},{label:"Lemon",value:"lemon",visibleInMenu:!0},{label:"Orange",value:"orange",visibleInMenu:!0},{label:"Peach",value:"peach",visibleInMenu:!0},{label:"Pear",value:"pear",visibleInMenu:!0},{label:"Strawberry",value:"strawberry",visibleInMenu:!0}],F={title:"Components/Forms/Autocomplete",component:"modus-wc-autocomplete",args:{bordered:!0,"debounce-ms":300,disabled:!1,items:c,label:"Label","min-chars":0,"multi-select":!1,size:"md",value:""},argTypes:{items:{description:"Array of items for the autocomplete component",table:{type:{detail:`
          ...
          `}}},size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[H],parameters:{actions:{handles:["chipRemove","inputBlur","inputChange","inputFocus","itemSelect"]}}},A={render:e=>{const u=l=>{var i;if(!((i=l.detail)!=null&&i.target))return;const t=l.target.closest("modus-wc-autocomplete");if(t){const o=l.detail.target,n=o.value.toLowerCase(),a=c.map(d=>({...d,selected:n?d.selected:!1,visibleInMenu:d.label.toLowerCase().includes(n)}));t.items=[...a],t.value=o.value}},r=l=>{const t=l.target.closest("modus-wc-autocomplete");if(t){const i=l.detail.label;i&&(t.value=i),c.forEach(n=>n.selected=!1);const o=c.find(n=>n.value===l.detail.value);o&&(o.selected=!0,t.items=[...c])}};return b(w||(w=j([`
<style>
  /* Only for Storybook */
...
<modus-wc-autocomplete
  ...
  @itemSelect=`,`
></modus-wc-autocomplete>
    `])),e.bordered,s(e["custom-class"]),s(e["debounce-ms"]),e.disabled,s(e["input-id"]),s(e["input-tab-index"]),e.items,s(e.label),e["min-chars"],!1,s(e.name),s(e.placeholder),e["read-only"],e.required,s(e.size),e.value,u,r)}},p={...A},v={render:e=>{const u=t=>{const i=t.target.closest("modus-wc-autocomplete");if(i){const o=c.find(n=>n.value===t.detail.value);o&&(o.selected=!1,i.items=[...c])}},r=t=>{var o;if(!((o=t.detail)!=null&&o.target))return;const i=t.target.closest("modus-wc-autocomplete");if(i){const n=t.detail.target,a=n.value.toLowerCase(),d=c.map(m=>({...m,visibleInMenu:m.label.toLowerCase().includes(a)}));i.items=[...d],i.value=n.value}},l=t=>{const i=t.target.closest("modus-wc-autocomplete");if(i){i.value="",i.items=c.map(n=>({...n,visibleInMenu:!0}));const o=c.find(n=>n.value===t.detail.value);o&&(o.selected=!0)}};return b(y||(y=j([`
<style>
  /* Only for Storybook */
...
<modus-wc-autocomplete
  ...
  @itemSelect=`,`
></modus-wc-autocomplete>
    `])),e.bordered,s(e["custom-class"]),s(e["debounce-ms"]),e.disabled,s(e["input-id"]),s(e["input-tab-index"]),e.items,s(e.label),e["min-chars"],!0,s(e.name),s(e.placeholder),e["read-only"],e.required,s(e.size),e.value,u,r,l)}},f={parameters:{docs:{description:{story:`
#### Breaking Changes
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>b`<div></div>`},h={render:e=>{const u=l=>{var i;if(!((i=l.detail)!=null&&i.target))return;const t=l.target.closest("modus-wc-autocomplete");if(t){const o=l.detail.target.value,n=t==null?void 0:t.querySelectorAll("li");Array.from(n??[]).forEach(a=>{var m,g;(((g=(m=a.querySelector(".title"))==null?void 0:m.textContent)==null?void 0:g.toLowerCase())||"").includes(o.toLowerCase())?a.classList.remove("hidden"):a.classList.add("hidden")})}},r=l=>{var i;const t=l.target.closest("modus-wc-autocomplete");if(t){const o=(i=l.detail.target)==null?void 0:i.value;t.value=o;const n=t==null?void 0:t.querySelectorAll("li");n==null||n.forEach(a=>a.classList.remove("selected")),n==null||n.forEach(a=>{var d;a.contains(l.target)&&(a.classList.add("selected"),t.value=(d=a.querySelector(".title"))==null?void 0:d.textContent)})}};return b`
<style>
  .list-item {
    display: flex;
    gap: 1rem;
...
`}};var C,M,$;p.parameters={...p.parameters,docs:{...(C=p.parameters)==null?void 0:C.docs,source:{originalSource:`{
  ...Template
}`,...($=(M=p.parameters)==null?void 0:M.docs)==null?void 0:$.source}}};var x,L,S;v.parameters={...v.parameters,docs:{...(x=v.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: args => {
...
}`,...(S=(L=v.parameters)==null?void 0:L.docs)==null?void 0:S.source}}};var T,E,z;f.parameters={...f.parameters,docs:{...(T=f.parameters)==null?void 0:T.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(z=(E=f.parameters)==null?void 0:E.docs)==null?void 0:z.source}}};var k,P,D;h.parameters={...h.parameters,docs:{...(k=h.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: args => {
    const handleInputChange = e => {
      if (!e.detail?.target) return;
      const autocomplete = (e.target as HTMLInputElement).closest('modus-wc-autocomplete');
...
}`,...(D=(P=h.parameters)==null?void 0:P.docs)==null?void 0:D.source}}};const N=["Default","MultiSelect","Migration","CustomMenuItems"];export{h as CustomMenuItems,p as Default,f as Migration,v as MultiSelect,N as __namedExportsOrder,F as default};
