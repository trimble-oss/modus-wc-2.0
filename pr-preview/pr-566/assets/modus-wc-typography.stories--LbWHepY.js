import{x as G,B as I}from"./lit-element-C8zulti1.js";import{o as m}from"./if-defined-yv6owfG8.js";const J="The quick brown fox jumps over the lazy dog",R={title:"Components/Typography",component:"modus-wc-typography",args:{size:"md",hierarchy:"p",weight:"normal"},argTypes:{size:{control:{type:"select"},options:["xs","sm","md","lg","xl","2xl","3xl","4xl","5xl","6xl","7xl","8xl","9xl"]},hierarchy:{control:{type:"select"},options:["body","h1","h2","h3","h4","h5","h6","p"]},weight:{control:{type:"select"},options:["light","normal","semibold","bold"]}},decorators:[r=>{const p=document.createElement("div"),g=document.createElement("template");return g.innerHTML=J,(()=>{I(r(),p);const d=p.querySelector("modus-wc-typography");d&&!d.textContent&&(d.textContent=g.innerHTML)})(),p}]},e={render:r=>G`
    <modus-wc-typography
