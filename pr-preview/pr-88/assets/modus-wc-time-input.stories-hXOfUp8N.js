import{w as E}from"./decorator-Dt3Huotz.js";import{k as t}from"./lit-element-DVRzCIa_.js";import{t as i}from"./if-defined-1ipA9LQg.js";import"./v4-CQkTLCs1.js";var m=Object.freeze,O=Object.defineProperty,I=(e,S)=>m(O(e,"raw",{value:m(e.slice())})),d;const L={title:"Components/Forms/Time Input",component:"modus-wc-time-input",args:{"aria-label":"Time input",disabled:!1,size:"md"},argTypes:{"auto-complete":{control:{type:"inline-radio"},options:["on","off"]},"input-dir":{control:{type:"inline-radio"},options:["ltr","rtl","auto"]},size:{control:{type:"inline-radio"},options:["sm","md","lg"]}},decorators:[E],parameters:{actions:{handles:["inputBlur","inputChange","inputFocus"]}}},n={render:e=>t`
    <modus-wc-time-input
