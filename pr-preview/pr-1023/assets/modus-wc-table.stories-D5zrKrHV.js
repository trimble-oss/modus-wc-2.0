import"./index-CuwpfXOz.js";import{x as m}from"./lit-element-CucEn6F2.js";import{c as te}from"./shadow-host-helper-A4Nvcs5e.js";import{a as i}from"./chunk-4XZ63LWV-C1hGcAQa.js";import"./v4-CtRu48qb.js";var I=Object.freeze,ae=Object.defineProperty,p=(e,o)=>I(ae(e,"raw",{value:I(o||e.slice())})),k,T,x,R,A,q;const de={title:"Components/Table",component:"modus-wc-table",args:{density:"comfortable",hover:!1,sortable:!0,paginated:!1,"show-page-size-selector":!0,"custom-class":"",selectable:"none",zebra:!1,"current-page":1,"page-size-options":[5,10,15],"selected-row-ids":[],editable:!1},argTypes:{columns:{control:"object",description:"An array of column definitions.",table:{type:{detail:`
    ...
    `],[`
      ...
      <script>
        ...
        // table.hover = 'false';
      <\/script>
    `])),o,n,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,e.caption,i("rowClick"),i("sortChange"),i("paginationChange"),i("rowSelectionChange"),i("cellEditStart"),i("cellEditCommit"))},args:{density:"comfortable",hover:!1,sortable:!0,paginated:!1,"show-page-size-selector":!0,"custom-class":"",selectable:"none",zebra:!1,"current-page":1,"page-size-options":[5,10,15],"selected-row-ids":[],editable:!1}},w={render:e=>{const o=e.columns||h(),n=e.data||g();return m(T||(T=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        // table.data = createDemoData();
      <\/script>
    `])),o,n,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,i("rowClick"))},args:{density:"comfortable",hover:!0}},f={render:e=>{const o=e.columns||oe(),n=e.data||g();return m(x||(x=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        // table.data = createDemoData();
      <\/script>
    `])),o,n,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,i("sortChange"))},args:{density:"comfortable",sortable:!0}},v={render:e=>{const o=e.columns||h(),n=e.data||g(15);return m(R||(R=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        // table.paginated = true;
      <\/script>
    `])),o,n,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,i("paginationChange"))},args:{density:"comfortable",paginated:!0,"show-page-size-selector":!0}},y={render:e=>{const o=e.columns||h(),n=e.data||g();return m(A||(A=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        // table.selectable = 'multi';
      <\/script>
    `])),o,n,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,i("rowSelectionChange"))},args:{density:"comfortable",selectable:"multi"}},C={render:e=>{const o=[{id:"id",header:"ID",accessor:"id",width:"20px"},{id:"name",header:"Name",accessor:"name"},{id:"status",header:"Status",accessor:"status",editor:"custom",customEditorRenderer:(s,a)=>{const r=document.createElement("div");r.style.width="100%";const t=document.createElement("modus-wc-autocomplete");t.items=[{label:"Active",value:"Active",visibleInMenu:!0},{label:"Inactive",value:"Inactive",visibleInMenu:!0},{label:"Pending",value:"Pending",visibleInMenu:!0}],t.value=s,t.style.width="100%";const d=u=>{a(u.detail.value)};return t.addEventListener("itemSelect",d),r.appendChild(t),setTimeout(()=>{const u=t.querySelector("input");u==null||u.focus()},0),r},cellRenderer:s=>{const r={Active:"green",Inactive:"gray",Pending:"blue"}[s]||"black",t=document.createElement("span");return t.textContent=s,t.style.color=r,t.style.fontWeight="bold",t}},{id:"dueDate",header:"Due Date",accessor:"dueDate",editor:"custom",customEditorRenderer:(s,a)=>{const r=document.createElement("div");r.style.width="100%";const t=document.createElement("modus-wc-date");t.value=s,t.style.width="100%",t.bordered=!1;let d=!1;const u=c=>{if(c.key==="Enter"){c.preventDefault();const l=t.querySelector("input");l&&l.value&&!d&&(d=!0,a(l.value))}else if(c.key==="Escape")c.preventDefault(),d||(d=!0,a(s||""));else if(c.key==="Tab"){const l=t.querySelector("input");l&&l.value&&!d&&(d=!0,a(l.value))}},D=c=>{var z,P;const l=c.relatedTarget;if(l&&(r.contains(l)||(z=t.shadowRoot)!=null&&z.contains(l))||((P=t.shadowRoot)==null?void 0:P.querySelector('[class*="calendar"]')))return;const E=t.querySelector("input");E&&E.value&&!d&&(d=!0,setTimeout(()=>a(E.value),50))};return r.addEventListener("keydown",u),r.addEventListener("focusout",D),r.appendChild(t),setTimeout(()=>{const c=t.querySelector("input");c==null||c.focus()},0),r},cellRenderer:s=>{if(!s)return"-";const a=s,r=a.split(/[-/]/);let t;if(r.length===3&&r[0].length<=2){const c=parseInt(r[0],10),l=parseInt(r[1],10)-1,$=parseInt(r[2],10);t=new Date($,l,c)}else t=new Date(a);if(isNaN(t.getTime()))return a;const d=t.getDate().toString().padStart(2,"0"),u=(t.getMonth()+1).toString().padStart(2,"0"),D=t.getFullYear();return`${d}-${u}-${D}`}}],n=[{id:"1",name:"John Doe",status:"Active",dueDate:"15-10-2025"},{id:"2",name:"Jane Smith",status:"Inactive",dueDate:"20-11-2025"},{id:"3",name:"Bob Johnson",status:"Pending",dueDate:"05-12-2025"}];return m(q||(q=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        //   table.editable = true;
      <\/script>
    `])),o,n,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],!0,i("cellEditStart"),i("cellEditCommit"))},args:{density:"comfortable",hover:!1,sortable:!0,paginated:!1,"show-page-size-selector":!0,"custom-class":"",selectable:"none",zebra:!1,"current-page":1,"page-size-options":[5,10,15],"selected-row-ids":[]}},S={render:e=>{if(!customElements.get("table-shadow-host")){const o=te({componentTag:"modus-wc-table",propsMapper:(n,s)=>{const a=s;a.caption=n.caption??"",a.columns=n.columns??h(),a.currentPage=n["current-page"]??1,a.data=n.data??g(),a.customClass=n["custom-class"]||"",a.density=n.density??"comfortable",a.editable=!!n.editable,a.hover=!!n.hover,a.paginated=!!n.paginated,a.pageSizeOptions=n["page-size-options"]??[5,10,15],a.selectable=n.selectable??"none",a.selectedRowIds=n["selected-row-ids"]??[],a.showPageSizeSelector=n["show-page-size-selector"]!==!1,a.sortable=!!n.sortable,a.zebra=!!n.zebra,s.dataset.eventsWired||(s.addEventListener("rowClick",i("rowClick")),s.addEventListener("sortChange",i("sortChange")),s.addEventListener("paginationChange",i("paginationChange")),s.addEventListener("rowSelectionChange",i("rowSelectionChange")),s.addEventListener("cellEditStart",i("cellEditStart")),s.addEventListener("cellEditCommit",i("cellEditCommit")),s.dataset.eventsWired="true")}});customElements.define("table-shadow-host",o)}return m`<table-shadow-host .props=${{...e}}></table-shadow-host>`}};var M,U,L;b.parameters={...b.parameters,docs:{...(M=b.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: args => {
...
}`,...(L=(U=b.parameters)==null?void 0:U.docs)==null?void 0:L.source}}};var N,B,O;w.parameters={...w.parameters,docs:{...(N=w.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
    const data = args.data || createDemoData();
    return html\`
...
}`,...(O=(B=w.parameters)==null?void 0:B.docs)==null?void 0:O.source}}};var J,F,Y;f.parameters={...f.parameters,docs:{...(J=f.parameters)==null?void 0:J.docs,source:{originalSource:`{
  render: args => {
...
}`,...(H=(j=v.parameters)==null?void 0:j.docs)==null?void 0:H.source}}};var W,K,V;y.parameters={...y.parameters,docs:{...(W=y.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
    const data = args.data || createDemoData();
    return html\`
...
}`,...(V=(K=y.parameters)==null?void 0:K.docs)==null?void 0:V.source}}};var Z,G,Q;C.parameters={...C.parameters,docs:{...(Z=C.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  render: args => {
...
}`,...(Q=(G=C.parameters)==null?void 0:G.docs)==null?void 0:Q.source}}};var X,ee,ne;S.parameters={...S.parameters,docs:{...(X=S.parameters)==null?void 0:X.docs,source:{originalSource:`{
  render: args => {
...
}`,...(ne=(ee=S.parameters)==null?void 0:ee.docs)==null?void 0:ne.source}}};const ue=["Default","Hover","Sorting","Pagination","CheckBoxRowSelection","InlineEditing","ShadowDomParent"];export{y as CheckBoxRowSelection,b as Default,w as Hover,C as InlineEditing,v as Pagination,S as ShadowDomParent,f as Sorting,ue as __namedExportsOrder,de as default};
