import{w as x}from"./decorator-BqOgn-6Y.js";import{x as r}from"./lit-element-CucEn6F2.js";import{o as c}from"./if-defined-BiZP-SBN.js";import{c as M}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-C1hGcAQa.js";import"./v4-CtRu48qb.js";var l=Object.freeze,U=Object.defineProperty,T=(e,d)=>l(U(e,"raw",{value:l(e.slice())})),u,b;const R=[{label:"Root",url:"#"},{label:"Subpage",url:"#"},{label:"Current Page",url:"#"}],$=[{label:"Unsafe URL fallback",url:"javascript:alert(1)"},{label:"Safe subpage",url:"#"},{label:"Current Page",url:"#"}],J={title:"Components/Breadcrumbs",component:"modus-wc-breadcrumbs",args:{items:R,size:"md"},argTypes:{items:{description:"Array of items for the breadcrumbs component",table:{type:{detail:`
