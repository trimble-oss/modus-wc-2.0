import{w as v}from"./decorator-BqOgn-6Y.js";import{x as r}from"./lit-element-CucEn6F2.js";import{o as a}from"./if-defined-BiZP-SBN.js";import{c as E}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-C1hGcAQa.js";import"./v4-CtRu48qb.js";const B={title:"Components/Forms/Switch",component:"modus-wc-switch",args:{"custom-class":"",disabled:!1,indeterminate:!1,label:"Label",name:"",required:!1,size:"md",value:!0},argTypes:{size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[v],parameters:{actions:{handles:["inputBlur","inputChange","inputFocus"]}}},t={render:e=>r`
      <modus-wc-switch
        aria-label="Toggle"
