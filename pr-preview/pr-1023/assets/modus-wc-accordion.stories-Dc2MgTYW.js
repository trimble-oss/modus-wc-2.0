import{w as E}from"./decorator-BqOgn-6Y.js";import{x as r}from"./lit-element-CucEn6F2.js";import{o as y}from"./if-defined-BiZP-SBN.js";import{c as I}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-C1hGcAQa.js";import"./v4-CtRu48qb.js";var l=Object.freeze,T=Object.defineProperty,S=(e,d)=>l(T(e,"raw",{value:l(e.slice())})),p;const a=[{description:"Item one description",icon:"alert",iconAriaLabel:"Alert",title:"Item One"},{description:"Item two description",icon:"alert",iconAriaLabel:"Alert",title:"Item Two"},{description:"Item three description",icon:"alert",iconAriaLabel:"Alert",title:"Item Three"}],z={title:"Components/Accordion",component:"modus-wc-accordion",decorators:[E],parameters:{actions:{handles:["expandedChange"]},layout:{padded:!0}}},P={render:e=>r(p||(p=S([`
