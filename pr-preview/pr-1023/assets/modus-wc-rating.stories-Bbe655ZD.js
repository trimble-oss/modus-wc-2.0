import{w as S}from"./decorator-BqOgn-6Y.js";import{x as o}from"./lit-element-CucEn6F2.js";import{o as e}from"./if-defined-BiZP-SBN.js";import{c as D}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-C1hGcAQa.js";import"./v4-CtRu48qb.js";var m=Object.freeze,R=Object.defineProperty,P=(a,s)=>m(R(a,"raw",{value:m(a.slice())})),u;const N={title:"Components/Forms/Rating",component:"modus-wc-rating",args:{"allow-half":!1,count:5,"custom-class":"",disabled:!1,getAriaLabelText:a=>`${a} rating`,size:"md",value:0,variant:"smiley"},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]},variant:{control:{type:"select"},options:["heart","smiley","star","thumb"]}},decorators:[S],parameters:{actions:{handles:["ratingChange"]}}},r={render:a=>o`
    <modus-wc-rating
