...
`,u={parameters:{docs:{source:{transform:(e,{args:a})=>s(a)}}},render:e=>y`
    ...
    `},t={...u,parameters:{docs:{description:{story:"App menu displayed in list layout."},source:{transform:(e,{args:a})=>s(a)}}}},o={...u,args:{layout:"grid"},parameters:{docs:{description:{story:"App menu in grid layout showing all app emblems."},source:{transform:(e,{args:a})=>s(a)}}}};var p,m,i;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`{
  ...Template,
  parameters: {
    docs: {
      description: {
...
}`,...(i=(m=t.parameters)==null?void 0:m.docs)==null?void 0:i.source}}};var d,c,l;o.parameters={...o.parameters,docs:{...(d=o.parameters)==null?void 0:d.docs,source:{originalSource:`{
  ...Template,
  args: {
    layout: 'grid'
  },
