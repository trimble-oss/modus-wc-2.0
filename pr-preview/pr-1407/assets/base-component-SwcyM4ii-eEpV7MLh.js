...
[data-theme^=modus-modern] modus-wc-button .modus-wc-btn.modus-wc-btn-outline.modus-wc-btn-neutral:not(:hover):not(:active):not([aria-pressed=true]):not(.modus-wc-btn-disabled) {
  border-color: var(--modus-wc-color-base-200);
}
