import{w as v}from"./decorator-534da2b0.js";import{b as r}from"./lit-element-38260dd9.js";import{o as a}from"./if-defined-30b85b98.js";import{c as E}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";const B={title:"Components/Forms/Switch",component:"modus-wc-switch",args:{"custom-class":"",disabled:!1,indeterminate:!1,label:"Label",name:"",required:!1,size:"md",value:!0},argTypes:{size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[v],parameters:{actions:{handles:["inputBlur","inputChange","inputFocus"]}}},t={render:e=>r`
      <modus-wc-switch
        aria-label="Toggle"
        ...
        .value=${e.value}
      ></modus-wc-switch>
    `},i={render:e=>{if(!customElements.get("switch-shadow-host")){const g=E({componentTag:"modus-wc-switch",propsMapper:(n,f)=>{const s=f;s.customClass=n["custom-class"]||"",s.disabled=Boolean(n.disabled),s.indeterminate=Boolean(n.indeterminate),s.inputId=n["input-id"]||"",s.inputTabIndex=n["input-tab-index"]||0,s.label=n.label||"",s.name=n.name||"",s.required=Boolean(n.required),s.size=n.size||"md",s.value=Boolean(n.value)}});customElements.define("switch-shadow-host",g)}return r`<switch-shadow-host
      .props=${{...e}}
