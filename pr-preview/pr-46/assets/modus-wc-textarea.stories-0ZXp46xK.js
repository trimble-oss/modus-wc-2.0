import{w as i}from"./decorator-Dt3Huotz.js";import{k as n}from"./lit-element-DVRzCIa_.js";import{t as a}from"./if-defined-1ipA9LQg.js";import"./v4-CQkTLCs1.js";const x={title:"Components/Atoms/Textarea",component:"modus-wc-textarea",args:{"aria-label":"Enter your comments",placeholder:"Type your comments here"},argTypes:{"textarea-aria-invalid":{control:{type:"inline-radio"},options:["grammar","spelling","true","false"]},"textarea-dir":{control:{type:"inline-radio"},options:["ltr","rtl","auto"]}},decorators:[i],parameters:{actions:{handles:["textareaBlur","textareaChange","textareaFocus"]}}},d={render:e=>n`
      <modus-wc-textarea
        ...
        .value=${e.value}
      ></modus-wc-textarea>
    `},t={...d};var r,o,l;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`{
  ...Template
