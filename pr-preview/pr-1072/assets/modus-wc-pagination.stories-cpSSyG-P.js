import{w}from"./decorator-D4YmxizW.js";import{x as r}from"./lit-element-CucEn6F2.js";import{o as n}from"./if-defined-BiZP-SBN.js";import{c as f}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const P={firstPage:"First page",lastPage:"Last page",nextPage:"Next page",page:"Page {0}",previousPage:"Previous page"},y={title:"Components/Pagination",component:"modus-wc-pagination",args:{"aria-label-values":P,count:5,"custom-class":"",page:1,size:"md"},argTypes:{"aria-label-values":{description:"Custom aria label values for pagination buttons",table:{type:{detail:`
          ...
          `}}},size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[w],parameters:{actions:{handles:["pageChange"]},docs:{description:{component:`
...
\`\`\`
    ...
    <modus-wc-pagination
      ...
      size=${n(e.size)}
    ></modus-wc-pagination>
  `},s={render:e=>{if(!customElements.get("pagination-shadow-host")){const v=f({componentTag:"modus-wc-pagination",propsMapper:(t,x)=>{const a=x;a.ariaLabelValues=t["aria-label-values"],a.count=t.count,a.customClass=t["custom-class"]||"",a.nextButtonText=t["next-button-text"]??"",a.page=t.page,a.prevButtonText=t["prev-button-text"]??"",a.size=t.size??"md"}});customElements.define("pagination-shadow-host",v)}return r`<pagination-shadow-host
      .props=${{...e}}
