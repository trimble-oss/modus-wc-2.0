import{k as i}from"./lit-element-DVRzCIa_.js";import{t as n}from"./if-defined-1ipA9LQg.js";const y={title:"Components/Skeleton",component:"modus-wc-skeleton",args:{"aria-hidden":"true","custom-class":"",height:"0.875rem",role:"presentation",shape:"rectangle",tabindex:-1,width:"100%"},argTypes:{shape:{control:{type:"inline-radio"},options:["circle","rectangle"]}},parameters:{layout:"padded"}},s={render:e=>i`
      <modus-wc-skeleton
