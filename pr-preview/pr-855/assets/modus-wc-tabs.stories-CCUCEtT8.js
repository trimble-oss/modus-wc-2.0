...
<\/script>`},u={parameters:{docs:{source:{transform:(e,{args:a})=>`<modus-wc-tabs
...
>
    ...
    `},n={...u},i={...u,args:{"tab-style":"lifted"},parameters:{docs:{description:{story:"The background color of the tabs can be customized by applying a custom class to the component and overriding the CSS custom properties defined in the example below. Custom colors are applied across all tab variants: boxed, bordered, lifted, and none."},source:{transform:(e,{args:a})=>`<style>
.custom-tabs {
...
>
  ...
  `},c={...u,args:{activeTabIndex:1,tabs:[{label:"Normal"},{label:"Active"},{label:"Disabled",disabled:!0}]}},d={...u,args:{tabs:[{icon:"home"},{icon:"settings",iconPosition:"left",label:"Settings"},{icon:"alert",iconPosition:"right",label:"Alerts"}]}},l={parameters:{docs:{source:{transform:(e,{args:a})=>`<modus-wc-tabs
  aria-label="Tab group"
  tab-style="bordered"
  size="md"
>
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>s`<div></div>`};var f,p,g;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`{
  ...Template
}`,...(g=(p=n.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};var w,h,v;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...Template,
  args: {
    'tab-style': 'lifted'
  },
  parameters: {
    docs: {
      description: {
        story: 'The background color of the tabs can be customized by applying a custom class to the component and overriding the CSS custom properties defined in the example below. Custom colors are applied across all tab variants: boxed, bordered, lifted, and none.'
      },
      source: {
        transform: (_src, {
          args
...
}`,...(v=(h=i.parameters)==null?void 0:h.docs)==null?void 0:v.source}}};var y,x,T;r.parameters={...r.parameters,docs:{...(y=r.parameters)==null?void 0:y.docs,source:{originalSource:`{
  args: {
    tabs: [{
      icon: 'home',
      iconPosition: 'left',
...
}`,...(T=(x=r.parameters)==null?void 0:x.docs)==null?void 0:T.source}}};var z,$,C;c.parameters={...c.parameters,docs:{...(z=c.parameters)==null?void 0:z.docs,source:{originalSource:`{
  ...Template,
  args: {
    activeTabIndex: 1,
    tabs: [{
...
}`,...(C=($=c.parameters)==null?void 0:$.docs)==null?void 0:C.source}}};var I,S,N;d.parameters={...d.parameters,docs:{...(I=d.parameters)==null?void 0:I.docs,source:{originalSource:`{
  ...Template,
  args: {
    tabs: [{
      icon: 'home'
...
}`,...(N=(S=d.parameters)==null?void 0:S.docs)==null?void 0:N.source}}};var D,P,A;l.parameters={...l.parameters,docs:{...(D=l.parameters)==null?void 0:D.docs,source:{originalSource:`{
  parameters: {
    docs: {
      source: {
        transform: (_src, {
...
}`,...(A=(P=l.parameters)==null?void 0:P.docs)==null?void 0:A.source}}};var k,B,M;b.parameters={...b.parameters,docs:{...(k=b.parameters)==null?void 0:k.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(M=(B=b.parameters)==null?void 0:B.docs)==null?void 0:M.source}}};const F=["Default","CustomBackground","CustomContent","ActiveAndDisabled","Icons","TabsWithPanel","Migration"];export{c as ActiveAndDisabled,i as CustomBackground,r as CustomContent,n as Default,d as Icons,b as Migration,l as TabsWithPanel,F as __namedExportsOrder,J as default};
