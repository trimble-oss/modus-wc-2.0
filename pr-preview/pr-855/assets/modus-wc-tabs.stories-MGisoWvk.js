...
>
    ...
    `},n={...f},i={...f,args:{"tab-style":"lifted"},parameters:{docs:{description:{story:"The background color of the tabs can be customized by applying a custom class to the component and defining CSS variables for the desired colors. Custom colors are applied across all tab variants: boxed, bordered, lifted, and none."},source:{transform:(e,{args:a})=>`<style>
.custom-tabs {
...
>
  ...
  `},c={...f,args:{activeTabIndex:1,tabs:[{label:"Normal"},{label:"Active"},{label:"Disabled",disabled:!0}]}},d={...f,args:{tabs:[{icon:"home"},{icon:"settings",iconPosition:"left",label:"Settings"},{icon:"alert",iconPosition:"right",label:"Alerts"}]}},l={parameters:{docs:{source:{transform:(e,{args:a})=>`<modus-wc-tabs
  aria-label="Tab group"
  tab-style="bordered"
  size="md"
>
...
\`\`\`
  ...
  ...Template
}`,...(g=(p=n.parameters)==null?void 0:p.docs)==null?void 0:g.source}}};var w,v,y;i.parameters={...i.parameters,docs:{...(w=i.parameters)==null?void 0:w.docs,source:{originalSource:`{
  ...Template,
  args: {
    'tab-style': 'lifted'
  },
  parameters: {
    docs: {
      description: {
        story: 'The background color of the tabs can be customized by applying a custom class to the component and defining CSS variables for the desired colors. Custom colors are applied across all tab variants: boxed, bordered, lifted, and none.'
      },
      source: {
        transform: (_src, {
          args
...
}`,...(y=(v=i.parameters)==null?void 0:v.docs)==null?void 0:y.source}}};var h,x,T;r.parameters={...r.parameters,docs:{...(h=r.parameters)==null?void 0:h.docs,source:{originalSource:`{
  args: {
    tabs: [{
      icon: 'home',
      iconPosition: 'left',
