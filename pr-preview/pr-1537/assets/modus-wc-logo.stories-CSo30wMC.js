import{b as t}from"./lit-element-DgBvYnzn.js";import{o as a}from"./if-defined-BnVFTJ4o.js";import{c as v}from"./shadow-host-helper-A4Nvcs5e.js";import{g as f}from"./logo-constants-Rjcleoxg.js";const z={title:"Components/Logo",component:"modus-wc-logo",args:{name:"trimble",emblem:!1},argTypes:{name:{control:{type:"select"},options:f()},emblem:{control:{type:"boolean"}}}},y={render:o=>t`
      <modus-wc-logo
        name="${o.name}"
        ?emblem="${o.emblem}"
        alt="${a(o.alt)}"
