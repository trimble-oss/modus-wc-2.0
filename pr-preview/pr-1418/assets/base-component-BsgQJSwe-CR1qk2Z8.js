...
modus-wc-switch .modus-wc-toggle.modus-wc-toggle-xs ~ modus-wc-input-label .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-sm);
  line-height: var(--modus-wc-font-size-2xl);
}
modus-wc-switch .modus-wc-toggle.modus-wc-toggle-sm ~ modus-wc-input-label .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-md);
  line-height: var(--modus-wc-line-height-md);
}
modus-wc-switch .modus-wc-toggle.modus-wc-toggle-md ~ modus-wc-input-label .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-lg);
  line-height: var(--modus-wc-line-height-md);
}
modus-wc-switch .modus-wc-toggle.modus-wc-toggle-lg ~ modus-wc-input-label .modus-wc-input-label {
  font-size: var(--modus-wc-font-size-xl);
  line-height: var(--modus-wc-line-height-lg);
}
