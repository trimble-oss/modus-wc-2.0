import{k as h}from"./lit-element-DVRzCIa_.js";import{t as o}from"./if-defined-1ipA9LQg.js";const x={title:"Components/Collapse",component:"modus-wc-collapse",args:{bordered:!0,"collapse-description":"Collapse description","collapse-title":"Collapse title",expanded:!1,icon:"info","icon-aria-label":"Information icon",size:"md"},argTypes:{size:{control:{type:"inline-radio"},options:["xs","sm","md","lg"]}},parameters:{layout:"padded"}},f={render:e=>h`
<modus-wc-collapse
  ?bordered=${e.bordered}
