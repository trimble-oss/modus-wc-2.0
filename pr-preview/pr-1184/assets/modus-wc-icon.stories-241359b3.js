import{b as o}from"./lit-element-38260dd9.js";import{o as d}from"./if-defined-30b85b98.js";import{c as k}from"./shadow-host-helper-0b7f7548.js";const H={title:"Components/Icon",component:"modus-wc-icon",args:{"custom-class":"",decorative:!1,name:"alert",size:"md"},argTypes:{size:{control:{type:"select"},options:["xs","sm","md","lg"]},variant:{control:{type:"select"},options:["outlined","solid"]}}},M={render:e=>o`
<modus-wc-icon
