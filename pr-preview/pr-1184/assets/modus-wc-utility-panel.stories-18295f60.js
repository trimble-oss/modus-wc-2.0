import{w as V}from"./decorator-534da2b0.js";import{b as d}from"./lit-element-38260dd9.js";import{o as C}from"./if-defined-30b85b98.js";import{c as X}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";const ie={title:"Components/Utility Panel",component:"modus-wc-utility-panel",args:{expanded:!1,"push-content":!0},argTypes:{"custom-class":{control:{type:"text"}},expanded:{control:{type:"boolean"}},"push-content":{control:{type:"boolean"}}},decorators:[V,e=>(requestAnimationFrame(()=>{document.querySelectorAll("modus-wc-utility-panel").forEach(a=>{const t=a.closest(".demo-container");if(t){const c=t.querySelector(".main-content");c&&a&&(a.targetElement=c)}})}),e())],parameters:{actions:{handles:["panelOpened","panelClosed"]},docs:{description:{component:"A utility panel component that slides in from the right side of the screen. It can either push content or display as an overlay.\n\nThe component supports `<slot>` called 'header' for panel title content, 'body' for main content area, and 'footer' for action buttons or additional controls."}},layout:"fullscreen"}},o=`
  .demo-container {
    height: 100vh;
    display: flex;
...
${A}`}}},render:e=>d`
  ...
  `},x={args:{expanded:!1,"push-content":!0},render:e=>d`
    <style>
      .demo-container {
        height: 100vh;
        position: relative;
  ...
  `},g={render:e=>{if(!customElements.get("utility-panel-shadow-host")){const S=X({componentTag:"modus-wc-utility-panel",propsMapper:(a,t)=>{if(t.expanded=Boolean(a.expanded),t.pushContent=Boolean(a["push-content"]),!t.hasAttribute("data-layout-built")){t.setAttribute("data-layout-built","");const c=t.getRootNode(),Q=t.parentElement,r=document.createElement("div");r.setAttribute("slot","header"),r.className="modus-wc-utility-panel-header",r.textContent="Utility Panel Header";const i=document.createElement("div");i.setAttribute("slot","body"),i.className="modus-wc-utility-panel-body";const k=document.createElement("p");k.textContent="This is the utility panel body content.";const $=document.createElement("p");$.textContent="You can add any content here including forms, lists, or other components.";const E=document.createElement("modus-wc-text-input");E.setAttribute("label","Example Input"),E.setAttribute("placeholder","Enter text..."),i.appendChild(k),i.appendChild($),i.appendChild(E);const l=document.createElement("div");l.setAttribute("slot","footer"),l.className="modus-wc-utility-panel-footer";const p=document.createElement("modus-wc-button");p.setAttribute("color","tertiary"),p.setAttribute("size","sm"),p.textContent="Cancel";const u=document.createElement("modus-wc-button");u.setAttribute("color","primary"),u.setAttribute("size","sm"),u.textContent="Save",l.appendChild(p),l.appendChild(u),t.appendChild(r),t.appendChild(i),t.appendChild(l);const m=document.createElement("modus-wc-navbar");m.visibility={user:!1},m.userCard={name:"",email:""};const T=document.createElement("div");T.setAttribute("slot","end");const h=document.createElement("modus-wc-tooltip");h.setAttribute("content","Toggle Utility Panel"),h.setAttribute("position","left");const s=document.createElement("modus-wc-button");s.setAttribute("color","primary"),s.setAttribute("size","sm"),s.setAttribute("variant","outlined");const z=document.createElement("modus-wc-icon");z.setAttribute("name","menu"),s.appendChild(z),h.appendChild(s),T.appendChild(h),m.appendChild(T),s.addEventListener("buttonClick",()=>{t.expanded=!t.expanded});const n=document.createElement("div");n.className="main-content";const P=document.createElement("h1");P.textContent="Main Content Area";const B=document.createElement("p");B.textContent="This is the main content area below the navbar. When the utility panel opens with pushContent=true, this content will be pushed to the left.";const M=document.createElement("p");M.textContent="This is an example of how the utility panel interacts with the main content. When the panel opens with push content enabled, this area will shift to the left to make room for the panel.";const I=document.createElement("p");I.textContent="The content area maintains its full functionality while the panel is open. Users can continue to interact with the main content while accessing the utility panel features.",n.appendChild(P),n.appendChild(B),n.appendChild(M),n.appendChild(I);const y=document.createElement("div");y.className="main-content-wrapper",y.appendChild(n),y.appendChild(t);const w=document.createElement("div");w.className="demo-container",w.appendChild(m),w.appendChild(y),Q.appendChild(w);const U=document.createElement("style");U.textContent=o,c.appendChild(U),requestAnimationFrame(()=>{t.targetElement=n})}}});customElements.define("utility-panel-shadow-host",S)}return d`<utility-panel-shadow-host
      .props=${{...e}}
...
\${scriptBlock}\`
  ...
  \`
}`,...(Y=(R=f.parameters)==null?void 0:R.docs)==null?void 0:Y.source}}};var L,j,_;x.parameters={...x.parameters,docs:{...(L=x.parameters)==null?void 0:L.docs,source:{originalSource:`{
  args: {
    expanded: false,
    'push-content': true
  },
  ...
  \`
}`,...(_=(j=x.parameters)==null?void 0:j.docs)==null?void 0:_.source}}};var G,J,K;g.parameters={...g.parameters,docs:{...(G=g.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: args => {
...
}`,...(K=(J=g.parameters)==null?void 0:J.docs)==null?void 0:K.source}}};const se=["Default","Expanded","OverlayMode","WithoutHeaderFooter","ShadowDomParent"];export{v as Default,b as Expanded,f as OverlayMode,g as ShadowDomParent,x as WithoutHeaderFooter,se as __namedExportsOrder,ie as default};
