import{w as S}from"./decorator-534da2b0.js";import{b as i}from"./lit-element-38260dd9.js";import{o as r}from"./if-defined-30b85b98.js";import{c as q}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";var c=Object.freeze,z=Object.defineProperty,C=(e,d)=>c(z(e,"raw",{value:c(d||e.slice())})),u;const M={title:"Components/Forms/Textarea",component:"modus-wc-textarea",args:{bordered:!0,"custom-class":"",disabled:!1,label:"Label",readonly:!1,required:!1,size:"md",spellcheck:!1,value:""},argTypes:{"auto-correct":{options:["on","off"]},enterkeyhint:{options:["enter","done","go","next","previous","search","send"]},feedback:{description:"Feedback prop for input components",table:{type:{detail:`
    ...
    <\/script>
  `])),D,r(e.label),!0,e.value)},s={render:e=>{if(!customElements.get("textarea-shadow-host")){const d=q({componentTag:"modus-wc-textarea",propsMapper:(a,E)=>{const n=E;n.autoCorrect=a["auto-correct"],n.bordered=Boolean(a.bordered),n.customClass=a["custom-class"]||"",n.disabled=Boolean(a.disabled),n.enterkeyhint=a.enterkeyhint||"",n.inputId=a["input-id"]||"",n.inputTabIndex=a["input-tab-index"]||0,n.label=a.label||"",n.maxLength=a["max-length"]||100,n.minLength=a["min-length"]||0,n.name=a.name||"",n.placeholder=a.placeholder||"",n.readonly=Boolean(a.readonly),n.required=Boolean(a.required),n.rows=typeof a.rows=="number"?a.rows:2,n.size=a.size||""}});customElements.define("textarea-shadow-host",d)}return i`<textarea-shadow-host
      .props=${{...e}}
