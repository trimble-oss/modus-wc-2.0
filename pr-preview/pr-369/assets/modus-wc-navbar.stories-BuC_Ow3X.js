import{w as s}from"./decorator-DFROgT0E.js";import{x as r}from"./lit-element-C8zulti1.js";import{o as n}from"./if-defined-yv6owfG8.js";import"./v4-CtRu48qb.js";const l={apps:"Apps",help:"Help",notifications:"Notifications",search:"Search"},p={avatarAlt:"Sonic",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"sonic@trimble.com",name:"Sonic the Hedgehog"},c={apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!0,user:!0},v={title:"Components/Navbar",component:"modus-wc-navbar",args:{condensed:!1,"search-debounce-ms":300,"text-overrides":l,"user-card":p,visibility:c},argTypes:{"text-overrides":{description:"Text replacements for navbar menu items",table:{type:{detail:`
...
>
  ...
  <div slot="apps">App drawer contents</div>
    ...
    `},t={...u};var o,i,a;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`{
  ...Template
}`,...(a=(i=t.parameters)==null?void 0:i.docs)==null?void 0:a.source}}};const f=["Default"];export{t as Default,f as __namedExportsOrder,v as default};
