import{w as p}from"./decorator-D4YmxizW.js";import{x as t}from"./lit-element-C8zulti1.js";import{o as u}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var i=Object.freeze,f=Object.defineProperty,S=(e,y)=>i(f(e,"raw",{value:i(e.slice())})),m;const A={title:"Components/Menu",component:"modus-wc-menu",args:{orientation:"vertical",size:"md"},argTypes:{orientation:{control:{type:"select"},options:["horizontal","vertical"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[p],parameters:{actions:{handles:["menuFocusout"]}}},n={render:e=>t`
<modus-wc-menu
  aria-label="Menu"
  ?bordered=${e.bordered}
  ...
  <li>
    ...
    `},o={render:()=>t(m||(m=S([`
      ...
      <script>
        ...
        // });
      <\/script>
    `])),!0,!0,!0,!0)};var c,a,r;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: args => {
    // prettier-ignore
    return html\`
<modus-wc-menu
...
}`,...(r=(a=n.parameters)==null?void 0:a.docs)==null?void 0:r.source}}};var l,d,b;s.parameters={...s.parameters,docs:{...(l=s.parameters)==null?void 0:l.docs,source:{originalSource:`{
  render: () => {
    // prettier-ignore
    return html\`
<style>
...
}`,...(b=(d=s.parameters)==null?void 0:d.docs)==null?void 0:b.source}}};var w,v,h;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: () => {
    return html\`
      <style>
        .menu-width {
...
}`,...(h=(v=o.parameters)==null?void 0:v.docs)==null?void 0:h.source}}};const C=["Default","CustomMenu","CollapsibleMenu"];export{o as CollapsibleMenu,s as CustomMenu,n as Default,C as __namedExportsOrder,A as default};
