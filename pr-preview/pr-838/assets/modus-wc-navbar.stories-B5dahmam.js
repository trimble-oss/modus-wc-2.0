import{w as S}from"./decorator-D4YmxizW.js";import{x as i}from"./lit-element-CucEn6F2.js";import{o as s}from"./if-defined-BiZP-SBN.js";import{g as k}from"./logo-constants-CCF64jNC.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var d=Object.freeze,M=Object.defineProperty,y=(e,r)=>d(M(e,"raw",{value:d(e.slice())})),u,m;const I={apps:"Apps",help:"Help",notifications:"Notifications",search:"Search"},A={avatarAlt:"Sonic",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"sonic@trimble.com",name:"Sonic the Hedgehog"},T={ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!0,user:!0},U={title:"Components/Navbar",component:"modus-wc-navbar",args:{condensed:!1,"search-debounce-ms":300,"text-overrides":I,"user-card":A,visibility:T,"logo-name":"trimble"},argTypes:{"text-overrides":{description:"Text replacements for navbar menu items",table:{type:{detail:`
          ...
          `}},control:{type:"object"}},"logo-name":{description:'The name of the logo to display. Defaults to "trimble".',table:{type:{summary:"LogoName"},defaultValue:{summary:"trimble"}},control:{type:"select"},options:k()},"user-card":{description:"⚠️ **Deprecated**: The `user-card` prop will be replaced by the `modus-wc-profile-menu` component in an upcoming release.",table:{type:{detail:`
            Interface: IUserCard
            Properties:
