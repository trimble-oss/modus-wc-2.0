import"./index-CK-iu89z.js";import{x as P}from"./lit-element-CucEn6F2.js";import{b as a}from"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const S={profileImageUrl:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",headerName:"Enterprise ABC",userName:"Jane Doe",userEmail:"jane.doe@example.com",manageTrimbleId:{link:"#"}},k={title:"Components/Profile Menu",component:"modus-wc-profile-menu",args:{"profile-props":S},argTypes:{"profile-props":{description:"Profile menu properties containing user information (profileImageUrl, headerName, userName, userEmail, manageTrimbleId)"},"menu-one":{description:"Configuration for the first menu including title and items"},"menu-two":{description:"Configuration for the second menu including title and items"}},parameters:{docs:{description:{component:`
...
}`,...(w=(g=i.parameters)==null?void 0:g.docs)==null?void 0:w.source}}};const T=["Default","WithOneSubmenu","WithTwoSubmenus"];export{o as Default,t as WithOneSubmenu,i as WithTwoSubmenus,T as __namedExportsOrder,k as default};
