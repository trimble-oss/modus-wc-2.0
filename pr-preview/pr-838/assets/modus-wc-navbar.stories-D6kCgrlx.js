import{w as x}from"./decorator-D4YmxizW.js";import{x as h}from"./lit-element-CucEn6F2.js";import{o as n}from"./if-defined-BiZP-SBN.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var r=Object.freeze,w=Object.defineProperty,f=(e,i)=>r(w(e,"raw",{value:r(e.slice())})),c,u;const y={apps:"Apps",help:"Help",notifications:"Notifications",search:"Search"},C={profileImageUrl:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",headerName:"Sonic the Hedgehog",userEmail:"sonic@trimble.com",userName:"Sonic",manageTrimbleId:{link:"#"}},I={ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!0,user:!0},j={title:"Components/Navbar",component:"modus-wc-navbar",args:{condensed:!1,"search-debounce-ms":300,"text-overrides":y,"user-card":C,visibility:I},argTypes:{"text-overrides":{description:"Text replacements for navbar menu items",table:{type:{detail:`
...
<\/script>
    ...
    `])),e["apps-menu-open"],e.condensed,e["condensed-menu-open"],n(e["custom-class"]),e["main-menu-open"],e["notifications-menu-open"],n(e["search-debounce-ms"]),e["search-input-open"],n(e["text-overrides"]),e["user-card"],e["user-menu-open"],e.visibility)},s={...S},t={render:e=>{function i(g){var a;const o=(a=g.currentTarget.parentElement)==null?void 0:a.querySelector("#custom-user-menu");o==null||o.classList.toggle("hidden")}return h(u||(u=f([`
