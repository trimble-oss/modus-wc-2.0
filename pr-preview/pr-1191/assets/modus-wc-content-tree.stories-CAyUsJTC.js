import{w as Ie}from"./decorator-D4YmxizW.js";import{b as E}from"./lit-element-DgBvYnzn.js";import{o as m}from"./if-defined-BnVFTJ4o.js";import{n as C}from"./ref-Bw8asrgi.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";import"./directive-helpers-BZ4DLK7w.js";import"./directive-C_Rw-dL6.js";const Ne=`
...
`,x=(d,e)=>{var n;for(const t of d){if(t.id===e)return t;if((n=t.children)!=null&&n.length){const o=x(t.children,e);if(o)return o}}},w=(d,e,n={})=>{const{parentId:t,index:o}=n;if(!t){const i=[...d];return i.splice(o??i.length,0,e),i}return d.map(i=>{var s;if(i.id===t){const r=i.children?[...i.children]:[];return r.splice(o??r.length,0,e),{...i,children:r}}if((s=i.children)!=null&&s.length){const r=w(i.children,e,n);return r===i.children?i:{...i,children:r}}return i})},F=(d,e,n)=>d.map(t=>{var o;if(t.id===e)return{...t,...n};if((o=t.children)!=null&&o.length){const i=F(t.children,e,n);return i===t.children?t:{...t,children:i}}return t}),y=(d,e)=>d.filter(n=>n.id!==e).map(n=>{var o;if(!((o=n.children)!=null&&o.length))return n;const t=y(n.children,e);return t===n.children?n:{...n,children:t}}),we=(d,e)=>e.reduce((n,t)=>y(n,t),d),ye=(d,e,n={})=>{const t=x(d,e);if(!t)return d;const o=y(d,e);return w(o,t,n)},M=(d,e,n)=>{var o;const t=d.findIndex(i=>i.id===e);if(t!==-1)return{parentId:n,index:t};for(const i of d)if((o=i.children)!=null&&o.length){const s=M(i.children,e,i.id);if(s)return s}},$e=(d,e,n)=>{var o;if(e===n)return!0;const t=x(d,e);return(o=t==null?void 0:t.children)!=null&&o.length?!!x(t.children,n):!1},Se=(d,e,n,t)=>{if(e===n)return d;const o=x(d,e);if(!o||!x(d,n)||$e(d,e,n))return d;if(t==="inside")return ye(d,e,{parentId:n,index:0});const i=y(d,e),s=M(i,n);if(!s)return d;const r=s.index+(t==="after"?1:0);return w(i,o,{parentId:s.parentId,index:r})},le=(d,e)=>{var n;return{...d,id:e(),children:(n=d.children)==null?void 0:n.map(t=>le(t,e))}},ke=(d,e,n)=>{const t=x(d,e),o=M(d,e);if(!t||!o)return{nodes:d};const i=le(t,n);return{nodes:w(d,i,{parentId:o.parentId,index:o.index+1}),newId:i.id}},ae=d=>{var e;return(e=d.children)!=null&&e.length?d.children.flatMap(ae):[d.id]},B=d=>d.reduce((e,n)=>{var t;return(t=n.children)!=null&&t.length&&e.push(n.id,...B(n.children)),e},[]),re=(d,e,n,t)=>{const o=x(d,n);if(!o)return e;const i=new Set(e);return ae(o).forEach(s=>t?i.add(s):i.delete(s)),[...i]},ce=(d,e,n)=>d.map(t=>{var o;if(t.id===e)return{...t,disabled:n};if((o=t.children)!=null&&o.length){const i=ce(t.children,e,n);return i===t.children?t:{...t,children:i}}return t}),I=(d,e="solid")=>({name:d,variant:e}),b=[{id:"1",label:"Project Files",icon:I("folder_closed"),children:[{id:"1-1",label:"Overview",icon:I("info")},{id:"1-2",label:"Resources",icon:I("folder_closed"),children:[{id:"1-2-1",label:"Specifications",icon:I("info")},{id:"1-2-2",label:"Search Index",icon:I("search")}]},{id:"1-3",label:"Archived",icon:I("alert")}]},{id:"2",label:"Settings",icon:I("settings")},{id:"3",label:"Notifications",icon:I("info")}],Fe={title:"Components/Content Tree",component:"modus-wc-content-tree",args:{"selection-mode":"single",size:"md"},argTypes:{"selection-mode":{control:{type:"select"},options:["single","multiple"]},size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[Ie],parameters:{actions:{handles:["nodeSelect","nodeExpandChange","nodeCheckChange","nodeEdit","nodeDuplicate","nodeAdd","nodeDelete","nodeRename","nodeEditCancel","nodeMove","nodeLoadChildren","expandAllChange","nodesDelete","nodeVisibilityChange"]}}},k={parameters:{docs:{source:{code:Ne}}},render:d=>{let e,n="1-1",t=["1"];const o=()=>{e&&(e.nodes=b,e.selectedNodeId=n,e.expandedNodeIds=[...t])},i=r=>{n=r.detail.id,o()},s=r=>{const{id:u,expanded:l}=r.detail;t=l?[...t,u]:t.filter(a=>a!==u),o()};return E`
    <modus-wc-content-tree
      ...
      @nodeSelect=${i}
      @nodeExpandChange=${s}
    ></modus-wc-content-tree>`}},D={args:{"selection-mode":"multiple"},parameters:{docs:{source:{code:xe}}},render:d=>{let e,n="1-1",t=["1","1-2"],o=["1-2-1"];const i=()=>{e&&(e.nodes=b,e.selectedNodeId=n,e.expandedNodeIds=[...t],e.checkedNodeIds=[...o])},s=l=>{n=l.detail.id,i()},r=l=>{const{id:a,expanded:f}=l.detail;t=f?[...t,a]:t.filter(h=>h!==a),i()},u=l=>{const{id:a,checked:f}=l.detail;o=re(b,o,a,f),i()};return E`
    <modus-wc-content-tree
      ${C(l=>{e=l??void 0,i()})}
      aria-label="Content tree"
      ?bordered=${d.bordered}
      ...
      @nodeExpandChange=${r}
      @nodeCheckChange=${u}
    ></modus-wc-content-tree>`}},L={args:{"selection-mode":"multiple"},parameters:{docs:{source:{code:ve}}},render:d=>{let e,n=structuredClone(b),t="1-1",o=["1","1-2"],i=["1-2-1"];const s=()=>{e&&(e.nodes=n,e.selectedNodeId=t,e.expandedNodeIds=[...o],e.checkedNodeIds=[...i],e.toolbar={expandCollapse:!0,delete:!0},e.searchable=!0)},r=h=>{t=h.detail.id,s()},u=h=>{const{id:N,expanded:$}=h.detail;o=$?[...new Set([...o,N])]:o.filter(R=>R!==N),s()},l=h=>{const{id:N,checked:$}=h.detail;i=re(n,i,N,$),s()},a=h=>{o=h.detail.expanded?B(n):[],s()},f=h=>{n=we(n,h.detail.ids),i=i.filter(N=>!!x(n,N)),s()};return E`
    <modus-wc-content-tree
      ${C(h=>{e=h??void 0,s()})}
      aria-label="Content tree"
      ?bordered=${d.bordered}
      ...
      @expandAllChange=${a}
      @nodesDelete=${f}
    ></modus-wc-content-tree>`}},T={parameters:{docs:{source:{code:ge}}},render:d=>{let e,n="1-2-2",t=["1","1-2"];const o=()=>{e&&(e.nodes=b,e.selectedNodeId=n,e.expandedNodeIds=[...t],e.searchable=!0,e.toolbar={expandCollapse:!0})},i=u=>{n=u.detail.id,o()},s=u=>{const{id:l,expanded:a}=u.detail;t=a?[...new Set([...t,l])]:t.filter(f=>f!==l),o()},r=u=>{t=u.detail.expanded?B(b):[],o()};return E`
    <modus-wc-content-tree
      ${C(u=>{e=u??void 0,o()})}
      aria-label="Content tree"
      ?bordered=${d.bordered}
      ...
      @nodeExpandChange=${s}
      @expandAllChange=${r}
    ></modus-wc-content-tree>`}},A={parameters:{docs:{source:{code:be}}},render:d=>{let e,n=structuredClone(b),t="1-1",o=["1","1-2"],i;const s=new Set;let r=0;const u=()=>`new-${Date.now()}-${r++}`,l=()=>{e&&(e.nodes=n,e.selectedNodeId=t,e.expandedNodeIds=[...o],e.editingNodeId=i)},a=(c,p)=>{i=c,p&&s.add(c),l()},f=c=>{t=c.detail.id,l()},h=c=>{const{id:p,expanded:g}=c.detail;o=g?[...o,p]:o.filter(S=>S!==p),l()},N=c=>{a(c.detail.id,!1)},$=c=>{const p=ke(n,c.detail.id,u);n=p.nodes,p.newId?a(p.newId,!1):l()},R=c=>{const{referenceId:p,position:g}=c.detail,S=u(),O={id:S,label:""};if(g==="child")n=w(n,O,{parentId:p}),o.includes(p)||(o=[...o,p]);else{const v=M(n,p),me=((v==null?void 0:v.index)??0)+(g==="below"?1:0);n=w(n,O,{parentId:v==null?void 0:v.parentId,index:me})}a(S,!0)},he=c=>{n=y(n,c.detail.id),s.delete(c.detail.id),l()},pe=c=>{const{id:p,label:g}=c.detail;n=F(n,p,{label:g||"Untitled"}),s.delete(p),i=void 0,l()},ue=c=>{const{id:p}=c.detail;s.has(p)&&(n=y(n,p)),s.delete(p),i=void 0,l()},fe=c=>{const{id:p,disabled:g}=c.detail;n=ce(n,p,g),l()};return E`
    <modus-wc-content-tree
      ${C(c=>{e=c??void 0,l()})}
      aria-label="Content tree"
      ?bordered=${d.bordered}
