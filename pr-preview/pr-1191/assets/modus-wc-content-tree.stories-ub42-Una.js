...
<\/script>
`,y=(t,n)=>{var d;for(const s of t){if(s.id===n)return s;if((d=s.children)!=null&&d.length){const e=y(s.children,n);if(e)return e}}},C=(t,n,d={})=>{const{parentId:s,index:e}=d;if(!s){const o=[...t];return o.splice(e??o.length,0,n),o}return t.map(o=>{var i;if(o.id===s){const r=o.children?[...o.children]:[];return r.splice(e??r.length,0,n),{...o,children:r}}if((i=o.children)!=null&&i.length){const r=C(o.children,n,d);return r===o.children?o:{...o,children:r}}return o})},V=(t,n,d)=>{let s=!1;const e=t.map(o=>{var i;if(o.id===n)return s=!0,{...o,...d};if((i=o.children)!=null&&i.length){const r=V(o.children,n,d);return r===o.children?o:(s=!0,{...o,children:r})}return o});return s?e:t},v=(t,n)=>t.filter(d=>d.id!==n).map(d=>{var e;if(!((e=d.children)!=null&&e.length))return d;const s=v(d.children,n);return s===d.children?d:{...d,children:s}}),Le=(t,n)=>n.reduce((d,s)=>v(d,s),t),Te=(t,n,d={})=>{const s=y(t,n);if(!s)return t;const e=v(t,n);return C(e,s,d)},T=(t,n,d)=>{var e;const s=t.findIndex(o=>o.id===n);if(s!==-1)return{parentId:d,index:s};for(const o of t)if((e=o.children)!=null&&e.length){const i=T(o.children,n,o.id);if(i)return i}},ze=(t,n,d)=>{var e;if(n===d)return!0;const s=y(t,n);return(e=s==null?void 0:s.children)!=null&&e.length?!!y(s.children,d):!1},Ae=(t,n,d,s)=>{if(n===d)return t;const e=y(t,n);if(!e||!y(t,d)||ze(t,n,d))return t;if(s==="inside")return Te(t,n,{parentId:d,index:0});const o=v(t,n),i=T(o,d);if(!i)return t;const r=i.index+(s==="after"?1:0);return C(o,e,{parentId:i.parentId,index:r})},Ie=(t,n)=>{var d;return{...t,id:n(),children:(d=t.children)==null?void 0:d.map(s=>Ie(s,n))}},Ne=(t,n,d)=>{const s=y(t,n),e=T(t,n);if(!s||!e)return{nodes:t};const o=Ie(s,d);return{nodes:C(t,o,{parentId:e.parentId,index:e.index+1}),newId:o.id}},_e=t=>!!t.hasChildren&&t.children===void 0,ge=t=>{var n;return _e(t)?[]:(n=t.children)!=null&&n.length?t.children.flatMap(ge):[t.id]},j=t=>t.reduce((n,d)=>{var o;const s=!!d.hasChildren&&d.children===void 0,e=!!((o=d.children)!=null&&o.length);return(e||s)&&(n.push(d.id),e&&n.push(...j(d.children))),n},[]),xe=(t,n,d,s)=>{const e=y(t,d);if(!e)return n;const o=new Set(n);return ge(e).forEach(i=>s?o.add(i):o.delete(i)),[...o]},W=(t,n,d)=>{let s=!1;const e=t.map(o=>{var i;if(o.id===n)return o.disabled===d?o:(s=!0,{...o,disabled:d});if((i=o.children)!=null&&i.length){const r=W(o.children,n,d);return r===o.children?o:(s=!0,{...o,children:r})}return o});return s?e:t},N=(t,n="solid")=>({name:t,variant:n}),$=[{id:"1",label:"Project Files",icon:N("folder_closed"),children:[{id:"1-1",label:"Overview",icon:N("info")},{id:"1-2",label:"Resources",icon:N("folder_closed"),children:[{id:"1-2-1",label:"Specifications",icon:N("info")},{id:"1-2-2",label:"Search Index",icon:N("search")}]},{id:"1-3",label:"Archived",icon:N("alert")}]},{id:"2",label:"Settings",icon:N("settings")},{id:"3",label:"Notifications",icon:N("info")}],He={title:"Components/Content Tree",component:"modus-wc-content-tree",args:{"selection-mode":"single",size:"md"},argTypes:{"selection-mode":{control:{type:"select"},options:["single","multiple"]},size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[be],parameters:{actions:{handles:["nodeSelect","nodeExpandChange","nodeCheckChange","nodeEdit","nodeDuplicate","nodeAdd","nodeDelete","nodeRename","nodeEditCancel","nodeMove","nodeLoadChildren","expandAllChange","nodesDelete","nodeVisibilityChange"]}}},z={parameters:{docs:{source:{code:we}}},render:t=>{let n,d="1-1",s=["1"];const e=()=>{n&&(n.nodes=$,n.selectedNodeId=d,n.expandedNodeIds=[...s])},o=r=>{d=r.detail.id,e()},i=r=>{const{id:m,expanded:c}=r.detail;s=c?[...s,m]:s.filter(p=>p!==m),e()};return S`
    <modus-wc-content-tree
      ${b(r=>{n=r??void 0,e()})}
      aria-label="Content tree"
      ?bordered=${t.bordered}
      ...
      @nodeSelect=${o}
      @nodeExpandChange=${i}
    ></modus-wc-content-tree>`}},Me={nodes:[],selectedNodeId:void 0,expandedNodeIds:[],editingNodeId:void 0,freshIds:new Set,idCounter:0},A={parameters:{docs:{source:{code:De}}},render:t=>{let n,d,s;const e=Me,o=()=>`new-${Date.now()}-${e.idCounter++}`,i=()=>{const a=e.nodes.length===0;d==null||d.classList.toggle("is-empty",a),s&&(s.hidden=!a),n&&(n.nodes=e.nodes,n.selectedNodeId=e.selectedNodeId,n.expandedNodeIds=[...e.expandedNodeIds],n.editingNodeId=e.editingNodeId,n.searchable=!0,n.toolbar={expandCollapse:!0})},r=(a,l)=>{e.editingNodeId=a,l&&e.freshIds.add(a),i()},m=()=>{const a=o();e.nodes=[{id:a,label:"",icon:N("folder_closed")}],e.selectedNodeId=a,r(a,!0)},c=a=>{e.selectedNodeId=a.detail.id,i()},p=a=>{const{id:l,expanded:h}=a.detail;e.expandedNodeIds=h?[...new Set([...e.expandedNodeIds,l])]:e.expandedNodeIds.filter(g=>g!==l),i()},f=a=>{e.expandedNodeIds=a.detail.expanded?j(e.nodes):[],i()},u=a=>{r(a.detail.id,!1)},x=a=>{const l=Ne(e.nodes,a.detail.id,o);e.nodes=l.nodes,l.newId?r(l.newId,!1):i()},k=a=>{const{referenceId:l,position:h}=a.detail,g=o(),D={id:g,label:""};if(h==="child")e.nodes=C(e.nodes,D,{parentId:l}),e.expandedNodeIds.includes(l)||(e.expandedNodeIds=[...e.expandedNodeIds,l]);else{const w=T(e.nodes,l),E=((w==null?void 0:w.index)??0)+(h==="below"?1:0);e.nodes=C(e.nodes,D,{parentId:w==null?void 0:w.parentId,index:E})}r(g,!0)},L=a=>{var l;e.nodes=v(e.nodes,a.detail.id),e.freshIds.delete(a.detail.id),y(e.nodes,e.selectedNodeId??"")||(e.selectedNodeId=(l=e.nodes[0])==null?void 0:l.id),i()},O=a=>{const{id:l,label:h}=a.detail;e.nodes=V(e.nodes,l,{label:h||"Untitled"}),e.freshIds.delete(l),e.editingNodeId=void 0,i()},U=a=>{var h;const{id:l}=a.detail;e.freshIds.has(l)&&(e.nodes=v(e.nodes,l)),e.freshIds.delete(l),e.editingNodeId=void 0,y(e.nodes,e.selectedNodeId??"")||(e.selectedNodeId=(h=e.nodes[0])==null?void 0:h.id),i()},H=a=>{const{id:l,disabled:h}=a.detail;e.nodes=W(e.nodes,l,h),i()};return S`
    <style>
      .modus-wc-content-tree-empty-story {
        background-color: var(--modus-wc-color-base-page);
        display: flex;
    ...
    </div>`}},_={args:{"selection-mode":"multiple"},parameters:{docs:{source:{code:Ee}}},render:t=>{let n,d="1-1",s=["1","1-2"],e=["1-2-1"];const o=()=>{n&&(n.nodes=$,n.selectedNodeId=d,n.expandedNodeIds=[...s],n.checkedNodeIds=[...e])},i=c=>{d=c.detail.id,o()},r=c=>{const{id:p,expanded:f}=c.detail;s=f?[...s,p]:s.filter(u=>u!==p),o()},m=c=>{const{id:p,checked:f}=c.detail;e=xe($,e,p,f),o()};return S`
    <modus-wc-content-tree
      ${b(c=>{n=c??void 0,o()})}
      aria-label="Content tree"
      ?bordered=${t.bordered}
      ...
      @nodeExpandChange=${r}
      @nodeCheckChange=${m}
    ></modus-wc-content-tree>`}},M={args:{"selection-mode":"multiple"},parameters:{docs:{source:{code:ke}}},render:t=>{let n,d=structuredClone($),s="1-1",e=["1","1-2"],o=["1-2-1"];const i=()=>{n&&(n.nodes=d,n.selectedNodeId=s,n.expandedNodeIds=[...e],n.checkedNodeIds=[...o],n.toolbar={expandCollapse:!0,delete:!0},n.searchable=!0)},r=u=>{s=u.detail.id,i()},m=u=>{const{id:x,expanded:k}=u.detail;e=k?[...new Set([...e,x])]:e.filter(L=>L!==x),i()},c=u=>{const{id:x,checked:k}=u.detail;o=xe(d,o,x,k),i()},p=u=>{e=u.detail.expanded?j(d):[],i()},f=u=>{d=Le(d,u.detail.ids),o=o.filter(x=>!!y(d,x)),i()};return S`
    <modus-wc-content-tree
      ${b(u=>{n=u??void 0,i()})}
      aria-label="Content tree"
      ?bordered=${t.bordered}
      ...
      @expandAllChange=${p}
      @nodesDelete=${f}
    ></modus-wc-content-tree>`}},R={parameters:{docs:{source:{code:Ce}}},render:t=>{let n,d="1-2-2",s=["1","1-2"];const e=()=>{n&&(n.nodes=$,n.selectedNodeId=d,n.expandedNodeIds=[...s],n.searchable=!0,n.toolbar={expandCollapse:!0})},o=m=>{d=m.detail.id,e()},i=m=>{const{id:c,expanded:p}=m.detail;s=p?[...new Set([...s,c])]:s.filter(f=>f!==c),e()},r=m=>{s=m.detail.expanded?j($):[],e()};return S`
    <modus-wc-content-tree
      ${b(m=>{n=m??void 0,e()})}
      aria-label="Content tree"
      ?bordered=${t.bordered}
      ...
      @nodeExpandChange=${i}
      @expandAllChange=${r}
    ></modus-wc-content-tree>`}},F={parameters:{docs:{source:{code:ve}}},render:t=>{let n,d=structuredClone($),s="1-1",e=["1","1-2"],o;const i=new Set;let r=0;const m=()=>`new-${Date.now()}-${r++}`,c=()=>{n&&(n.nodes=d,n.selectedNodeId=s,n.expandedNodeIds=[...e],n.editingNodeId=o)},p=(l,h)=>{o=l,h&&i.add(l),c()},f=l=>{s=l.detail.id,c()},u=l=>{const{id:h,expanded:g}=l.detail;e=g?[...e,h]:e.filter(D=>D!==h),c()},x=l=>{p(l.detail.id,!1)},k=l=>{const h=Ne(d,l.detail.id,m);d=h.nodes,h.newId?p(h.newId,!1):c()},L=l=>{const{referenceId:h,position:g}=l.detail,D=m(),w={id:D,label:""};if(g==="child")d=C(d,w,{parentId:h}),e.includes(h)||(e=[...e,h]);else{const E=T(d,h),ye=((E==null?void 0:E.index)??0)+(g==="below"?1:0);d=C(d,w,{parentId:E==null?void 0:E.parentId,index:ye})}p(D,!0)},O=l=>{d=v(d,l.detail.id),i.delete(l.detail.id),c()},U=l=>{const{id:h,label:g}=l.detail;d=V(d,h,{label:g||"Untitled"}),i.delete(h),o=void 0,c()},H=l=>{const{id:h}=l.detail;i.has(h)&&(d=v(d,h)),i.delete(h),o=void 0,c()},a=l=>{const{id:h,disabled:g}=l.detail;d=W(d,h,g),c()};return S`
    <modus-wc-content-tree
      ${b(l=>{n=l??void 0,c()})}
      aria-label="Content tree"
      ?bordered=${t.bordered}
    ...
    ></modus-wc-content-tree>`}},B={parameters:{docs:{source:{code:$e}}},render:t=>{let n,d=structuredClone($),s="1-1",e=["1","1-2"];const o=()=>{n&&(n.nodes=d,n.selectedNodeId=s,n.expandedNodeIds=[...e],n.allowDragDrop=!0)},i=c=>{s=c.detail.id,o()},r=c=>{const{id:p,expanded:f}=c.detail;e=f?[...new Set([...e,p])]:e.filter(u=>u!==p),o()},m=c=>{const{id:p,targetId:f,position:u}=c.detail;d=Ae(d,p,f,u),u==="inside"&&!e.includes(f)&&(e=[...e,f]),o()};return S`
    <modus-wc-content-tree
      ${b(c=>{n=c??void 0,o()})}
      aria-label="Content tree"
      ?bordered=${t.bordered}
      ...
      @nodeExpandChange=${r}
      @nodeMove=${m}
    ></modus-wc-content-tree>`}},P={parameters:{docs:{source:{code:Se}}},render:t=>{let n,d=[{id:"documents",label:"Documents",icon:N("folder_closed"),hasChildren:!0},{id:"media",label:"Media",icon:N("folder_closed"),hasChildren:!0},{id:"empty",label:"Empty Folder",icon:N("folder_closed"),hasChildren:!0},{id:"readme",label:"Read Me",icon:N("info")}],s="readme",e=[];const o=p=>p==="empty"?[]:[{id:`${p}-1`,label:"First item",icon:N("info")},{id:`${p}-2`,label:"Subfolder",icon:N("folder_closed"),hasChildren:!0},{id:`${p}-3`,label:"Last item",icon:N("info")}],i=()=>{n&&(n.nodes=d,n.selectedNodeId=s,n.expandedNodeIds=[...e])},r=p=>{s=p.detail.id,i()},m=p=>{const{id:f,expanded:u}=p.detail;e=u?[...new Set([...e,f])]:e.filter(x=>x!==f),i()},c=p=>{const{id:f}=p.detail;window.setTimeout(()=>{d=V(d,f,{children:o(f)}),i()},1200)};return S`
    <modus-wc-content-tree
      ${b(p=>{n=p??void 0,i()})}
      aria-label="Content tree"
      ?bordered=${t.bordered}
