...
>
  ...
  `,args:{placeholder:"Search fruits..."}},y={name:"With Tooltips",parameters:{docs:{description:{story:"This example demonstrates menu items with tooltips. Hover over the items to see the tooltips."},source:{code:`
const tooltipItems = [
  {
    label: 'Apple',
    value: 'apple',
...
`}}},render:()=>h`
    ...
    `},x={render:e=>(e.items||(e.items=[...v]),e.items=e.items.map(m=>m.value==="apple"||m.value==="banana"?{...m,selected:!0}:m),h(k||(k=T([`
<script>
...
<modus-wc-autocomplete
  ...
  value=`,`
></modus-wc-autocomplete>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["max-chips"]??4,e["min-chars"],t(e["min-input-width"]),!0,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e.value))},M={render:e=>{let m;const f=b=>{var a;if(!((a=b.detail)!=null&&a.target))return;const r=b.target.closest("modus-wc-autocomplete");if(r){const n=b.detail.target.value.toLowerCase();m&&window.clearTimeout(m),r.showSpinner=!0,m=window.setTimeout(()=>{const i=v.filter(o=>o.label.toLowerCase().includes(n));r.items=i,r.showSpinner=!1},2e3)}};return h(P||(P=T([`
<script>
...
>
  <div slot="menu-items">
    ...
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),t(e.label),e["leave-menu-open"],e["min-chars"],!1,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e["show-spinner"],e.value,b,r,!0,a,a,a,a)}},C={render:e=>{const m=r=>{const a=r.target.closest("modus-wc-autocomplete");if(!a)return;["ArrowDown","ArrowUp","Enter","Escape"].includes(r.key)&&r.preventDefault();const l=e.items.filter(n=>n.visibleInMenu&&!n.disabled);switch(r.key){case"Escape":e.items=e.items.map(n=>({...n,focused:!1})),a.items=[...e.items],a.closeMenu(),a.style.transform="scale(0.98)",setTimeout(()=>{a.style.transform=""},200);break;case"ArrowDown":{a.openMenu();const n=l.findIndex(s=>s.focused),i=n<0?0:Math.min(n+1,l.length-1),o=i+1<l.length?i+1:i;e.items=e.items.map(s=>{var u;return{...s,focused:((u=l[o])==null?void 0:u.value)===s.value}});break}case"ArrowUp":{const n=l.findIndex(s=>s.focused),i=n<0?l.length-1:Math.max(n-1,0),o=i-1>=0?i-1:i;e.items=e.items.map(s=>{var u;return{...s,focused:((u=l[o])==null?void 0:u.value)===s.value}});break}case"Enter":{const n=l.find(i=>i.focused);n&&(e.items=e.items.map(i=>({...i,selected:i.value===n.value,focused:!1})),a.value=n.label,a.closeMenu());break}default:return}a.items=[...e.items]},f=r=>{const a=document.querySelector("modus-wc-autocomplete");if(!a)return;const l=r.toLowerCase().split("");if(r.length>0){const o=e.items.map(s=>{const u=s.label.toLowerCase();let p=0,d=!0;for(const c of l)if(u.includes(c)){const w=u.indexOf(c);w===0?p+=3:u[w-1]===" "?p+=2:p+=1}else{d=!1;break}return d&&u.includes(r.toLowerCase())&&(p+=10),{item:s,score:d?p:-1,visible:d}});o.sort((s,u)=>u.score-s.score),e.items=o.map(({item:s,visible:u})=>({...s,visibleInMenu:u,focused:!1,selected:s.selected&&u,label:s.label}))}else e.items=e.items.map(o=>({...o,visibleInMenu:!0,focused:!1}));a.items=[...e.items],a.value=r;const n=e.items.filter(o=>o.visibleInMenu).length;console.log(`Fuzzy search for "${r}": ${n} matches found`),e.items.some(o=>o.visibleInMenu)&&r.length>=e["min-chars"]?a.openMenu():a.closeMenu()},b=r=>{const a=document.querySelector("modus-wc-autocomplete");a&&(e.items=e.items.map(l=>({...l,selected:l.value===r.value,focused:!1})),a.items=[...e.items],a.value=r.label,a.closeMenu())};return h`
      <style>
...
Items are automatically sorted by relevance with exact substring matches appearing first.`}}}},S={args:{...pe.args,items:v},render:e=>{const m=async()=>{const o=document.getElementById("programmatic-autocomplete");if(o){const s=v.find(u=>u.value==="apple")||null;await o.selectItem(s)}},f=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.selectItem(null)},b=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.openMenu()},r=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.closeMenu()},a=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.toggleMenu()},l=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.focusInput()},n=async()=>{const o=document.getElementById("programmatic-autocomplete");o&&await o.clearInput()},i=window;return i.handleSelectApple=m,i.handleSelectNull=f,i.handleOpenMenu=b,i.handleCloseMenu=r,i.handleToggleMenu=a,i.handleFocusInput=l,i.handleClearInput=n,h`
      <style>
...
\`\`\`
        ...
        `}}}},E={render:e=>{const m=[{label:"Apple",value:"apple",visibleInMenu:!0},{label:"Banana",value:"banana",visibleInMenu:!0},{label:"Orange",value:"orange",visibleInMenu:!0},{label:"Strawberry",value:"strawberry",visibleInMenu:!0}],f=[...m,{label:"Blackberry",value:"blackberry",visibleInMenu:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0},{label:"Cherry",value:"cherry",visibleInMenu:!0},{label:"Cranberry",value:"cranberry",visibleInMenu:!0},{label:"Fig",value:"fig",visibleInMenu:!0},{label:"Grape",value:"grape",visibleInMenu:!0},{label:"Kiwi",value:"kiwi",visibleInMenu:!0},{label:"Lemon",value:"lemon",visibleInMenu:!0},{label:"Lime",value:"lime",visibleInMenu:!0},{label:"Mango",value:"mango",visibleInMenu:!0},{label:"Melon",value:"melon",visibleInMenu:!0},{label:"Peach",value:"peach",visibleInMenu:!0},{label:"Pineapple",value:"pineapple",visibleInMenu:!0},{label:"Raspberry",value:"raspberry",visibleInMenu:!0},{label:"Watermelon",value:"watermelon",visibleInMenu:!0}],b=a=>{var n;if(!((n=a.detail)!=null&&n.target))return;const l=a.target.closest("modus-wc-autocomplete");if(l){const i=a.detail.target,o=i.value.toLowerCase();if(o===""){l.items=[...m],l.value=i.value;return}l.showSpinner=!0,setTimeout(()=>{const s=f.filter(u=>u.label.toLowerCase().includes(o));l.items=s,l.showSpinner=!1},1e3),l.value=i.value}},r=a=>{const l=a.target.closest("modus-wc-autocomplete");if(l){const n=a.detail.label;n&&(l.value=n)}};return h(D||(D=T([`
      <style>
      ...
      <modus-wc-autocomplete
        ...
        @itemSelect=`,`
      ></modus-wc-autocomplete>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),m,t(e.label),e["leave-menu-open"],0,!1,t(e.name),e["no-results"],e["read-only"],e.required,!0,t(e.size),e.value,b,r)}},A={parameters:{docs:{description:{story:`
#### Breaking Changes
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>h`<div></div>`};var F,H,q;g.parameters={...g.parameters,docs:{...(F=g.parameters)==null?void 0:F.docs,source:{originalSource:`{
  ...Template
}`,...(q=(H=g.parameters)==null?void 0:H.docs)==null?void 0:q.source}}};var B,R,O;I.parameters={...I.parameters,docs:{...(B=I.parameters)==null?void 0:B.docs,source:{originalSource:`{
  // prettier-ignore
  render: args => html\`
<style>
  div[id^='story--components-forms-autocomplete--with-custom-icon-slot'] {
...
}`,...(O=(R=I.parameters)==null?void 0:R.docs)==null?void 0:O.source}}};var N,W,j;y.parameters={...y.parameters,docs:{...(N=y.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: 'With Tooltips',
  parameters: {
    docs: {
      description: {
...
}`,...(j=(W=y.parameters)==null?void 0:W.docs)==null?void 0:j.source}}};var U,K,V;x.parameters={...x.parameters,docs:{...(U=x.parameters)==null?void 0:U.docs,source:{originalSource:`{
  render: args => {
...
}`,...(V=(K=x.parameters)==null?void 0:K.docs)==null?void 0:V.source}}};var G,J,_;M.parameters={...M.parameters,docs:{...(G=M.parameters)==null?void 0:G.docs,source:{originalSource:`{
  render: args => {
    let debounceTimer: number;
    const handleInputChange = (e: CustomEvent<Event>) => {
      if (!e.detail?.target) return;
...
}`,...(_=(J=M.parameters)==null?void 0:J.docs)==null?void 0:_.source}}};var Q,X,Y;$.parameters={...$.parameters,docs:{...(Q=$.parameters)==null?void 0:Q.docs,source:{originalSource:`{
  render: args => {
    const originalNoResults = args['no-results'];
    if (args['leave-menu-open'] == true) {
      args['no-results'] = {
...
}`,...(Y=(X=$.parameters)==null?void 0:X.docs)==null?void 0:Y.source}}};var Z,ee,te;C.parameters={...C.parameters,docs:{...(Z=C.parameters)==null?void 0:Z.docs,source:{originalSource:`{
  render: args => {
...
}`,...(ie=(ae=E.parameters)==null?void 0:ae.docs)==null?void 0:ie.source}}};var ue,re,ce;A.parameters={...A.parameters,docs:{...(ue=A.parameters)==null?void 0:ue.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(ce=(re=A.parameters)==null?void 0:re.docs)==null?void 0:ce.source}}};const Ie=["Default","WithCustomIconSlot","WithTooltips","MultiSelect","WithSpinner","CustomMenuItems","CustomEventHandlers","WithProgrammaticControl","DynamicOptions","Migration"];export{C as CustomEventHandlers,$ as CustomMenuItems,g as Default,E as DynamicOptions,A as Migration,x as MultiSelect,I as WithCustomIconSlot,S as WithProgrammaticControl,M as WithSpinner,y as WithTooltips,Ie as __namedExportsOrder,pe as default};
