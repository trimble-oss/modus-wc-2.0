import{x as d}from"./lit-element-C8zulti1.js";import{o as s}from"./if-defined-yv6owfG8.js";const b={title:"Components/Menu",component:"modus-wc-menu",args:{orientation:"vertical",size:"md"},argTypes:{orientation:{control:{type:"select"},options:["horizontal","vertical"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]}}},n={render:e=>d`
<modus-wc-menu
  aria-label="Menu"
  ?bordered=${e.bordered}
