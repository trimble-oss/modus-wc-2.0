import{w as M}from"./decorator-D4YmxizW.js";import{b as r}from"./lit-element-DgBvYnzn.js";import{o as c}from"./if-defined-BnVFTJ4o.js";import{c as U}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var l=Object.freeze,x=Object.defineProperty,T=(e,d)=>l(x(e,"raw",{value:l(e.slice())})),u,b;const R=[{label:"Root",url:"#"},{label:"Subpage",url:"#"},{label:"Current Page",url:"#"}],$=[{label:"Unsafe URL fallback",url:"javascript:alert(1)"},{label:"Safe subpage",url:"#"},{label:"Current Page",url:"#"}],J={title:"Components/Breadcrumbs",component:"modus-wc-breadcrumbs",args:{items:R,size:"md"},argTypes:{items:{description:"Array of items for the breadcrumbs component",table:{type:{detail:`
            Interface: IBreadcrumb
            Properties:
            - label (string): The text to render in the breadcrumb
            - url (string, optional): The URL emitted when the breadcrumb is clicked
          `}}},size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[M],parameters:{actions:{handles:["breadcrumbClick"]}}},A={render:e=>r(u||(u=T([`
...
<modus-wc-breadcrumbs
  ...
  size=${c(e.size)}
></modus-wc-breadcrumbs>
    `},t={render:e=>{if(!customElements.get("breadcrumbs-shadow-host")){const d=U({componentTag:"modus-wc-breadcrumbs",propsMapper:(i,_)=>{const m=_;m.customClass=i["custom-class"]||"",m.items=i.items,m.size=i.size??"md"}});customElements.define("breadcrumbs-shadow-host",d)}return r`<breadcrumbs-shadow-host
      .props=${{...e}}
