...
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-xs,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-xs {
  font-size: var(--modus-wc-font-size-xs);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-xs:not(.modus-wc-btn-circle):not(.modus-wc-btn-square),
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-xs:not(.modus-wc-btn-circle):not(.modus-wc-btn-square) {
  padding: var(--modus-wc-spacing-2xs) var(--modus-wc-spacing-sm);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-sm,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-sm {
  font-size: var(--modus-wc-font-size-sm);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-sm:not(.modus-wc-btn-circle):not(.modus-wc-btn-square),
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-sm:not(.modus-wc-btn-circle):not(.modus-wc-btn-square) {
  padding: var(--modus-wc-spacing-xs) var(--modus-wc-spacing-md);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-md,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-md {
  font-size: var(--modus-wc-font-size-md);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-md:not(.modus-wc-btn-circle):not(.modus-wc-btn-square),
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-md:not(.modus-wc-btn-circle):not(.modus-wc-btn-square) {
  padding: var(--modus-wc-spacing-sm) var(--modus-wc-spacing-lg);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-lg,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-lg {
  font-size: var(--modus-wc-font-size-lg);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-lg:not(.modus-wc-btn-circle):not(.modus-wc-btn-square),
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-lg:not(.modus-wc-btn-circle):not(.modus-wc-btn-square) {
  padding: var(--modus-wc-spacing-md) var(--modus-wc-spacing-xl);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-xl,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-xl {
  font-size: var(--modus-wc-font-size-xl);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-xl:not(.modus-wc-btn-circle):not(.modus-wc-btn-square),
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-xl:not(.modus-wc-btn-circle):not(.modus-wc-btn-square) {
  padding: var(--modus-wc-spacing-lg) var(--modus-wc-spacing-2xl);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless {
  background-color: transparent;
  box-shadow: none;
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless:active, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless[aria-pressed=true],
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless:active,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless[aria-pressed=true] {
  background-color: transparent;
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless:hover,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless:hover {
  background-color: transparent;
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline {
  background-color: transparent;
  border: var(--modus-wc-border-width-xs) solid var(--modus-wc-color-trimble-gray);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline:active, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline[aria-pressed=true],
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline:active,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline[aria-pressed=true] {
  background-color: transparent;
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline:hover,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline:hover {
  background-color: transparent;
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-primary:focus-visible, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-primary:focus-visible,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-primary:focus-visible,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-primary:focus-visible {
  box-shadow: 0 0 0 0.25rem rgba(38, 122, 177, 0.5);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-secondary:focus-visible, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-secondary:focus-visible,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-secondary:focus-visible,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-secondary:focus-visible {
  box-shadow: 0 0 0 0.25rem rgba(98, 102, 108, 0.5);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-neutral:focus-visible, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-neutral:focus-visible,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-neutral:focus-visible,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-neutral:focus-visible {
  box-shadow: 0 0 0 0.25rem rgba(98, 102, 108, 0.5);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-warning:focus-visible, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-warning:focus-visible,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-warning:focus-visible,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-warning:focus-visible {
  box-shadow: 0 0 0 0.25rem rgba(194, 125, 31, 0.5);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-error:focus-visible, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-error:focus-visible,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-error:focus-visible,
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-error:focus-visible {
  box-shadow: 0 0 0 0.25rem rgba(224, 66, 76, 0.5);
}

[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-disabled {
  opacity: 0.3;
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless:focus-visible {
  border: var(--modus-wc-border-width-sm) solid var(--modus-wc-color-black);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless.modus-wc-btn-primary {
  color: var(--modus-wc-color-trimble-blue);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless.modus-wc-btn-secondary {
  color: var(--modus-wc-color-gray-6);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless.modus-wc-btn-neutral {
  color: var(--modus-wc-color-gray-6);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless.modus-wc-btn-warning {
  color: var(--modus-wc-color-yellow);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless.modus-wc-btn-error {
  color: var(--modus-wc-color-red);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-primary {
  background-color: var(--modus-wc-color-trimble-blue);
  color: var(--modus-wc-color-white);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-primary:hover {
  background-color: var(--modus-wc-color-blue-light);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-primary:active, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-primary[aria-pressed=true] {
  background-color: var(--modus-wc-color-blue-dark);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-secondary {
  background-color: var(--modus-wc-color-gray-6);
  color: var(--modus-wc-color-white);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-secondary:hover {
  background-color: var(--modus-wc-color-gray-5);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-secondary:active, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-secondary[aria-pressed=true] {
  background-color: var(--modus-wc-color-gray-7);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-neutral {
  background-color: var(--modus-wc-color-gray-1);
  color: var(--modus-wc-color-trimble-gray);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-neutral:hover {
  background-color: var(--modus-wc-color-gray-0);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-neutral:active, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-neutral[aria-pressed=true] {
  background-color: var(--modus-wc-color-gray-2);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-warning {
  background-color: var(--modus-wc-color-yellow);
  border: var(--modus-wc-border-width-xs) solid var(--modus-wc-color-red);
  color: var(--modus-wc-color-trimble-gray);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-warning:hover {
  background-color: var(--modus-wc-color-yellow-light);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-warning:active, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-warning[aria-pressed=true] {
  background-color: var(--modus-wc-color-yellow-dark);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-error {
  background-color: var(--modus-wc-color-red);
  color: var(--modus-wc-color-white);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-error:hover {
  background-color: var(--modus-wc-color-red-light);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-error:active, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-error[aria-pressed=true] {
  background-color: var(--modus-wc-color-red-dark);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-primary {
  border-color: var(--modus-wc-color-trimble-blue);
  color: var(--modus-wc-color-trimble-blue);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-primary:hover {
  background-color: var(--modus-wc-color-blue-pale);
  border-color: var(--modus-wc-color-blue-light);
  color: var(--modus-wc-color-blue-light);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-primary:active, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-primary[aria-pressed=true] {
  background-color: rgba(0, 99, 163, 0.18);
  border-color: var(--modus-wc-color-blue-dark);
  color: var(--modus-wc-color-blue-dark);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-secondary {
  border-color: var(--modus-wc-color-trimble-gray);
  color: var(--modus-wc-color-trimble-gray);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-secondary:hover {
  background-color: var(--modus-wc-color-gray-0);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-secondary:active, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-secondary[aria-pressed=true] {
  background-color: var(--modus-wc-color-gray-1);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-neutral {
  border-color: var(--modus-wc-color-trimble-gray);
  color: var(--modus-wc-color-trimble-gray);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-neutral:hover {
  background-color: var(--modus-wc-color-gray-1);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-neutral:active, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-neutral[aria-pressed=true] {
  background-color: var(--modus-wc-color-gray-2);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-warning {
  border-color: var(--modus-wc-color-yellow);
  color: var(--modus-wc-color-yellow);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-warning:hover {
  border-color: var(--modus-wc-color-yellow-light);
  color: var(--modus-wc-color-yellow-light);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-warning:active, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-warning[aria-pressed=true] {
  border-color: var(--modus-wc-color-yellow-dark);
  color: var(--modus-wc-color-yellow-dark);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-error {
  border-color: var(--modus-wc-color-red);
  color: var(--modus-wc-color-red);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-error:hover {
  border-color: var(--modus-wc-color-red-light);
  color: var(--modus-wc-color-red-light);
}
[data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-error:active, [data-theme=modus-classic-light] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-error[aria-pressed=true] {
  border-color: var(--modus-wc-color-red-dark);
  color: var(--modus-wc-color-red-dark);
}

[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-disabled {
  opacity: 0.4;
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless:focus-visible {
  border: var(--modus-wc-border-width-sm) solid var(--modus-wc-color-white);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless.modus-wc-btn-primary {
  color: var(--modus-wc-color-highlight-blue);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless.modus-wc-btn-secondary {
  color: var(--modus-wc-color-gray-6);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless.modus-wc-btn-neutral {
  color: var(--modus-wc-color-gray-1);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless.modus-wc-btn-warning {
  color: var(--modus-wc-color-yellow);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-borderless.modus-wc-btn-error {
  color: var(--modus-wc-color-red);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-primary {
  background-color: var(--modus-wc-color-highlight-blue);
  color: var(--modus-wc-color-gray-10);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-primary:hover {
  background-color: var(--modus-wc-color-blue-light);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-primary:active, [data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-primary[aria-pressed=true] {
  background-color: var(--modus-wc-color-blue-dark);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-secondary {
  background-color: var(--modus-wc-color-gray-6);
  color: var(--modus-wc-color-white);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-secondary:hover {
  background-color: var(--modus-wc-color-gray-5);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-secondary:active, [data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-secondary[aria-pressed=true] {
  background-color: var(--modus-wc-color-gray-7);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-neutral {
  background-color: var(--modus-wc-color-gray-1);
  color: var(--modus-wc-color-trimble-gray);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-neutral:hover {
  background-color: var(--modus-wc-color-gray-0);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-neutral:active, [data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-neutral[aria-pressed=true] {
  background-color: var(--modus-wc-color-gray-4);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-warning {
  background-color: var(--modus-wc-color-yellow);
  border: var(--modus-wc-border-width-xs) solid var(--modus-wc-color-red);
  color: var(--modus-wc-color-trimble-gray);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-warning:hover {
  background-color: var(--modus-wc-color-yellow-light);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-warning:active, [data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-warning[aria-pressed=true] {
  background-color: var(--modus-wc-color-yellow-dark);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-error {
  background-color: var(--modus-wc-color-red);
  color: var(--modus-wc-color-white);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-error:hover {
  background-color: var(--modus-wc-color-red-light);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-error:active, [data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-filled.modus-wc-btn-error[aria-pressed=true] {
  background-color: var(--modus-wc-color-red-dark);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-primary {
  border-color: var(--modus-wc-color-highlight-blue);
  color: var(--modus-wc-color-highlight-blue);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-primary:hover {
  background-color: rgba(1, 154, 235, 0.12);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-primary:active, [data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-primary[aria-pressed=true] {
  background-color: rgba(1, 154, 235, 0.3);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-secondary {
  border-color: var(--modus-wc-color-gray-1);
  color: var(--modus-wc-color-gray-1);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-secondary:hover {
  background-color: rgba(203, 205, 214, 0.12);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-secondary:active, [data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-secondary[aria-pressed=true] {
  background-color: rgba(203, 205, 214, 0.3);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-neutral {
  border-color: var(--modus-wc-color-gray-2);
  color: var(--modus-wc-color-gray-2);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-neutral:hover {
  background-color: rgba(203, 205, 214, 0.12);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-neutral:active, [data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-neutral[aria-pressed=true] {
  background-color: rgba(203, 205, 214, 0.3);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-warning {
  border-color: var(--modus-wc-color-yellow);
  color: var(--modus-wc-color-yellow);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-warning:hover {
  border-color: var(--modus-wc-color-yellow-light);
  color: var(--modus-wc-color-yellow-light);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-warning:active, [data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-warning[aria-pressed=true] {
  border-color: var(--modus-wc-color-yellow-dark);
  color: var(--modus-wc-color-yellow-dark);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-error {
  border-color: var(--modus-wc-color-red);
  color: var(--modus-wc-color-red);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-error:hover {
  border-color: var(--modus-wc-color-red-light);
  color: var(--modus-wc-color-red-light);
}
[data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-error:active, [data-theme=modus-classic-dark] modus-wc-button .modus-wc-btn:not(.modus-wc-btn-success).modus-wc-btn-outline.modus-wc-btn-error[aria-pressed=true] {
  border-color: var(--modus-wc-color-red-dark);
  color: var(--modus-wc-color-red-dark);
}
...
`,s=new WeakSet;let n=null;const r=new WeakSet;let a=null;async function b(o,d=!1){if(o instanceof ShadowRoot)if(d){if(r.has(o))return;const e=m+`
`+u+`
`+i+`
`+w;if(!e.trim()){console.warn("No CSS content available for shadow DOM injection");return}if("adoptedStyleSheets"in Document.prototype&&"CSSStyleSheet"in window)try{a||(a=new CSSStyleSheet,await a.replace(e));const c=o;c.adoptedStyleSheets=[...c.adoptedStyleSheets||[],a]}catch(c){console.warn("adoptedStyleSheets failed, falling back to <style> element:",c);const t=document.createElement("style");t.textContent=e,o.appendChild(t)}else{const c=document.createElement("style");c.textContent=e,o.appendChild(c)}r.add(o),s.add(o)}else{if(r.has(o)||s.has(o))return;const e=m+`
`+u+`
`+i;if(!e.trim()){console.warn("No CSS content available for shadow DOM injection");return}if("adoptedStyleSheets"in Document.prototype&&"CSSStyleSheet"in window)try{n||(n=new CSSStyleSheet,await n.replace(e));const c=o;c.adoptedStyleSheets=[...c.adoptedStyleSheets||[],n]}catch(c){console.warn("adoptedStyleSheets failed, falling back to <style> element:",c);const t=document.createElement("style");t.textContent=e,o.appendChild(t)}else{const c=document.createElement("style");c.textContent=e,o.appendChild(c)}s.add(o)}}function h(o,d=!1){const e=o.getRootNode();e instanceof ShadowRoot&&b(e,d)}export{h};
