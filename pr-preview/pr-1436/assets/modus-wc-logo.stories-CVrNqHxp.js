import{b as t}from"./lit-element-DgBvYnzn.js";import{o as a}from"./if-defined-BnVFTJ4o.js";import{c as v}from"./shadow-host-helper-A4Nvcs5e.js";import{g as f}from"./logo-constants-BQVkW94f.js";const z={title:"Components/Logo",component:"modus-wc-logo",args:{name:"trimble",emblem:!1},argTypes:{name:{control:{type:"select"},options:f()},emblem:{control:{type:"boolean"}}}},y={render:o=>t`
      <modus-wc-logo
        name="${o.name}"
        ?emblem="${o.emblem}"
        alt="${a(o.alt)}"
    ...
    `},n={render:o=>{if(!customElements.get("logo-shadow-host")){const b=v({componentTag:"modus-wc-logo",propsMapper:(e,x)=>{const s=x;s.name=e.name,s.emblem=!!e.emblem,s.alt=e.alt??"",s.customClass=e["custom-class"]||""}});customElements.define("logo-shadow-host",b)}return t`<logo-shadow-host .props=${{...o}}></logo-shadow-host>`}};var r,c,d;l.parameters={...l.parameters,docs:{...(r=l.parameters)==null?void 0:r.docs,source:{originalSource:`{
  ...Template
