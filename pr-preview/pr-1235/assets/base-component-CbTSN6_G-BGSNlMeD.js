...
modus-wc-button .modus-wc-btn-outline.modus-wc-btn-base-inverted:hover {
  background-color: color-mix(in oklab, var(--modus-wc-color-base-inverted) 12%, transparent);
...
modus-wc-button .modus-wc-btn.modus-wc-btn-base-inverted.modus-wc-btn-filled:not(.modus-wc-btn-disabled):hover {
  background-color: color-mix(in oklab, var(--modus-wc-color-base-inverted) 90%, var(--modus-wc-color-black));
  border-color: color-mix(in oklab, var(--modus-wc-color-base-inverted) 90%, var(--modus-wc-color-black));
}
modus-wc-button .modus-wc-btn.modus-wc-btn-base-inverted.modus-wc-btn-filled:not(.modus-wc-btn-disabled):active, modus-wc-button .modus-wc-btn.modus-wc-btn-base-inverted.modus-wc-btn-filled:not(.modus-wc-btn-disabled)[aria-pressed=true] {
  background-color: color-mix(in oklab, var(--modus-wc-color-base-inverted) 80%, var(--modus-wc-color-black));
  border-color: color-mix(in oklab, var(--modus-wc-color-base-inverted) 80%, var(--modus-wc-color-black));
}
