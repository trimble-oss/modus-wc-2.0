import{w as C}from"./decorator-D4YmxizW.js";import{x as s}from"./lit-element-CucEn6F2.js";import{o}from"./if-defined-BiZP-SBN.js";import{c as T}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const _={title:"Components/Menu Item",component:"modus-wc-menu-item",args:{label:"Menu Item",size:"md",value:"menuItem"},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]},"tooltip-position":{control:{type:"select"},options:["auto","top","right","bottom","left"]},"_show-more-actions":{table:{disable:!0}},"_show-visibility-toggle":{table:{disable:!0}}},decorators:[C],parameters:{actions:{handles:["itemSelect","visibilityToggle"]}}},L={render:e=>s`
<modus-wc-menu>
  <modus-wc-menu-item
    ?bordered=${e.bordered}
    ?checkbox=${e.checkbox}
...
<modus-wc-menu>
  ...
  ></modus-wc-menu-item>
    ...
    `},r={render:e=>{if(!customElements.get("menu-item-shadow-host")){const D=T({componentTag:"modus-wc-menu",propsMapper:(n,l)=>{const S=l;S.ariaLabel="Shadow DOM Menu";let m=l.querySelector("modus-wc-menu-item");m||(m=document.createElement("modus-wc-menu-item"),l.innerHTML="",l.appendChild(m));const t=m;t.ariaLabel="Menu item in shadow DOM",t.bordered=!!n.bordered,t.checkbox=!!n.checkbox,t.customClass=n["custom-class"]||"",t.disabled=!!n.disabled,t.label=n.label,t.selected=!!n.selected,t.size=n.size||"md",t.subLabel=n["sub-label"]||"",t.tooltipContent=n["tooltip-content"]||"",t.tooltipPosition=n["tooltip-position"]||"auto",t.value=n.value}});customElements.define("menu-item-shadow-host",D)}return s`<menu-item-shadow-host
      .props=${{...e}}
...
}`,...(I=(g=u.parameters)==null?void 0:g.docs)==null?void 0:I.source}}};var E,v,x;c.parameters={...c.parameters,docs:{...(E=c.parameters)==null?void 0:E.docs,source:{originalSource:`{
  args: {
...
}`,...(x=(v=c.parameters)==null?void 0:v.docs)==null?void 0:x.source}}};var z,k,M;r.parameters={...r.parameters,docs:{...(z=r.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: args => {
...
}`,...(M=(k=r.parameters)==null?void 0:k.docs)==null?void 0:M.source}}};const q=["Default","WithIcon","WithCheckbox","WithTooltip","ShadowDomParent"];export{i as Default,r as ShadowDomParent,u as WithCheckbox,a as WithIcon,c as WithTooltip,q as __namedExportsOrder,_ as default};
