...
>
  ...
  `,args:{label:"Text input with custom icon",placeholder:"Enter text here..."}},c={render:e=>{if(!customElements.get("text-input-shadow-host")){const d=q({componentTag:"modus-wc-text-input",propsMapper:(n,S)=>{const a=S;a.autoCapitalize=n["auto-capitalize"]||"",a.autoComplete=n["auto-complete"]||"",a.autoCorrect=n["auto-correct"]||"",a.bordered=!!n.bordered,a.clearAriaLabel=n["clear-aria-label"]||""||"Clear text",a.customClass=n["custom-class"]||"",a.disabled=!!n.disabled,a.enterkeyhint=n.enterkeyhint||"",a.includeClear=!!n["include-clear"],a.includeSearch=!!n["include-search"],a.inputId=n["input-id"]||"",a.inputTabIndex=n["input-tab-index"]||0,a.label=n.label||"",a.maxLength=n["max-length"],a.minLength=n["min-length"],a.name=n.name||"",a.pattern=n.pattern||"",a.placeholder=n.placeholder||"",a.readOnly=!!n["read-only"],a.required=!!n.required,a.size=n.size||"",a.type=n.type||"",a.value=n.value}});customElements.define("text-input-shadow-host",d)}return r`<text-input-shadow-host
      .props=${{...e}}
    ></text-input-shadow-host>`}},s={parameters:{docs:{description:{story:`
#### Breaking Changes
...
| valueChange | inputChange |                  |
  ...
  render: args => html\`
    ...
    <\/script>
  \`
}`,...(g=(x=l.parameters)==null?void 0:x.docs)==null?void 0:g.source}}};var $,v,y;i.parameters={...i.parameters,docs:{...($=i.parameters)==null?void 0:$.docs,source:{originalSource:`{
  // prettier-ignore
  render: args => html\`
<modus-wc-text-input
...
}`,...(y=(v=i.parameters)==null?void 0:v.docs)==null?void 0:y.source}}};var k,w,I;c.parameters={...c.parameters,docs:{...(k=c.parameters)==null?void 0:k.docs,source:{originalSource:`{
  render: args => {
...
}`,...(I=(w=c.parameters)==null?void 0:w.docs)==null?void 0:I.source}}};var E,z,C;s.parameters={...s.parameters,docs:{...(E=s.parameters)==null?void 0:E.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
| valueChange | inputChange |                  |
  ...
  render: () => html\`<div></div>\`
}`,...(C=(z=s.parameters)==null?void 0:z.docs)==null?void 0:C.source}}};const W=["Default","WithErrorFeedback","WithCustomIconSlot","ShadowDomParent","Migration"];export{o as Default,s as Migration,c as ShadowDomParent,i as WithCustomIconSlot,l as WithErrorFeedback,W as __namedExportsOrder,O as default};
