import{w as x}from"./decorator-D4YmxizW.js";import{x as i}from"./lit-element-CucEn6F2.js";import{o as a}from"./if-defined-BiZP-SBN.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const M={title:"Components/Chip",component:"modus-wc-chip",args:{label:"Chip","show-remove":!0,shape:"rectangle",size:"md",variant:"filled"},argTypes:{shape:{control:{type:"select"},options:["rectangle","circle"]},size:{control:{type:"select"},options:["sm","md","lg"]},variant:{control:{type:"select"},options:["filled","outline"]}},decorators:[x],parameters:{actions:{handles:["chipClick","chipRemove"]}}},k={render:e=>i` <modus-wc-chip
