import{w as p}from"./decorator-D4YmxizW.js";import{x as t}from"./lit-element-CucEn6F2.js";import{o as u}from"./if-defined-BiZP-SBN.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var i=Object.freeze,f=Object.defineProperty,S=(e,y)=>i(f(e,"raw",{value:i(e.slice())})),m;const A={title:"Components/Menu",component:"modus-wc-menu",args:{orientation:"vertical",size:"md"},argTypes:{orientation:{control:{type:"select"},options:["horizontal","vertical"]},size:{control:{type:"select"},options:["xs","sm","md","lg"]}},decorators:[p],parameters:{actions:{handles:["menuFocusout"]}}},n={render:e=>t`
<modus-wc-menu
  aria-label="Menu"
  ?bordered=${e.bordered}
