    ...
    `},C={render:e=>(e.items||(e.items=[...w]),e.items=e.items.map(m=>m.value==="apple"||m.value==="banana"?{...m,selected:!0}:m),b(P||(P=v([`
      ...
      <script>
        ...
        `,`
          ...
          // }
        <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],t(e["input-id"]),t(e["input-tab-index"]),e.items,t(e.label),e["leave-menu-open"],e["max-chips"]??4,e["min-chars"],t(e["min-input-width"]),!0,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e.value,I))},S={render:e=>{let m;const f=h=>{var a;if(!((a=h.detail)!=null&&a.target))return;const c=h.target.closest("modus-wc-autocomplete");if(c){const n=h.detail.target.value.toLowerCase();m&&window.clearTimeout(m),c.showSpinner=!0,m=window.setTimeout(()=>{const i=w.filter(o=>o.label.toLowerCase().includes(n));c.items=i,c.showSpinner=!1},2e3)}};return b(F||(F=v([`
      <style>
...
<script>
        ...
        // }
      <\/script>
    `])),e.bordered,t(e["custom-class"]),t(e["debounce-ms"]),e.disabled,t(e["input-id"]),t(e["input-tab-index"]),t(e.label),e["leave-menu-open"],e["min-chars"],!1,t(e.name),e["no-results"],t(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],t(e.size),e["show-spinner"],e.value,h,c,!0,a,a,a,a)}},A={render:e=>{const m=c=>{const a=document.getElementById("autocomplete-custom-event-handlers");if(!a)return;["ArrowDown","ArrowUp","Enter","Escape"].includes(c.key)&&c.preventDefault();const l=e.items.filter(n=>n.visibleInMenu&&!n.disabled);switch(c.key){case"Escape":e.items=e.items.map(n=>({...n,focused:!1})),a.items=[...e.items],a.closeMenu(),a.style.transform="scale(0.98)",setTimeout(()=>{a.style.transform=""},200);break;case"ArrowDown":{a.openMenu();const n=l.findIndex(s=>s.focused),i=n<0?0:Math.min(n+1,l.length-1),o=i+1<l.length?i+1:i;e.items=e.items.map(s=>{var u;return{...s,focused:((u=l[o])==null?void 0:u.value)===s.value}});break}case"ArrowUp":{const n=l.findIndex(s=>s.focused),i=n<0?l.length-1:Math.max(n-1,0),o=i-1>=0?i-1:i;e.items=e.items.map(s=>{var u;return{...s,focused:((u=l[o])==null?void 0:u.value)===s.value}});break}case"Enter":{const n=l.find(i=>i.focused);n&&(e.items=e.items.map(i=>({...i,selected:i.value===n.value,focused:!1})),a.value=n.label,a.closeMenu());break}default:return}a.items=[...e.items]},f=c=>{const a=document.getElementById("autocomplete-custom-event-handlers");if(!a)return;const l=c.toLowerCase().split("");if(c.length>0){const o=e.items.map(s=>{const u=s.label.toLowerCase();let p=0,d=!0;for(const r of l)if(u.includes(r)){const g=u.indexOf(r);g===0?p+=3:u[g-1]===" "?p+=2:p+=1}else{d=!1;break}return d&&u.includes(c.toLowerCase())&&(p+=10),{item:s,score:d?p:-1,visible:d}});o.sort((s,u)=>u.score-s.score),e.items=o.map(({item:s,visible:u})=>({...s,visibleInMenu:u,focused:!1,selected:s.selected&&u,label:s.label}))}else e.items=e.items.map(o=>({...o,visibleInMenu:!0,focused:!1}));a.items=[...e.items],a.value=c;const n=e.items.filter(o=>o.visibleInMenu).length;console.log(`Fuzzy search for "${c}": ${n} matches found`),e.items.some(o=>o.visibleInMenu)&&c.length>=e["min-chars"]?a.openMenu():a.closeMenu()},h=c=>{const a=document.getElementById("autocomplete-custom-event-handlers");a&&(e.items=e.items.map(l=>({...l,selected:l.value===c.value,focused:!1})),a.items=[...e.items],a.value=c.label,a.closeMenu())};return b(q||(q=v([`
      <style>
...
\`\`\`
        ...
        `}}}},$={render:e=>{const m=[{label:"Apple",value:"apple",visibleInMenu:!0},{label:"Banana",value:"banana",visibleInMenu:!0},{label:"Orange",value:"orange",visibleInMenu:!0},{label:"Strawberry",value:"strawberry",visibleInMenu:!0}],f=[...m,{label:"Blackberry",value:"blackberry",visibleInMenu:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0},{label:"Cherry",value:"cherry",visibleInMenu:!0},{label:"Cranberry",value:"cranberry",visibleInMenu:!0},{label:"Fig",value:"fig",visibleInMenu:!0},{label:"Grape",value:"grape",visibleInMenu:!0},{label:"Kiwi",value:"kiwi",visibleInMenu:!0},{label:"Lemon",value:"lemon",visibleInMenu:!0},{label:"Lime",value:"lime",visibleInMenu:!0},{label:"Mango",value:"mango",visibleInMenu:!0},{label:"Melon",value:"melon",visibleInMenu:!0},{label:"Peach",value:"peach",visibleInMenu:!0},{label:"Pineapple",value:"pineapple",visibleInMenu:!0},{label:"Raspberry",value:"raspberry",visibleInMenu:!0},{label:"Watermelon",value:"watermelon",visibleInMenu:!0}],h=a=>{var n;if(!((n=a.detail)!=null&&n.target))return;const l=a.target.closest("modus-wc-autocomplete");if(l){const i=a.detail.target,o=i.value.toLowerCase();if(o===""){l.items=[...m],l.value=i.value;return}l.showSpinner=!0,setTimeout(()=>{const s=f.filter(u=>u.label.toLowerCase().includes(o));l.items=s,l.showSpinner=!1},1e3),l.value=i.value}},c=a=>{const l=a.target.closest("modus-wc-autocomplete");if(l){const n=a.detail.label;n&&(l.value=n)}};return b(R||(R=v([`
      <style>
...
}`,...(oe=(ne=E.parameters)==null?void 0:ne.docs)==null?void 0:oe.source}}};var le,se,ae;A.parameters={...A.parameters,docs:{...(le=A.parameters)==null?void 0:le.docs,source:{originalSource:`{
  render: args => {
...
}`,...(ae=(se=A.parameters)==null?void 0:se.docs)==null?void 0:ae.source}}};var ie,ue,ce;k.parameters={...k.parameters,docs:{...(ie=k.parameters)==null?void 0:ie.docs,source:{originalSource:`{
  args: {
    ...meta.args,
