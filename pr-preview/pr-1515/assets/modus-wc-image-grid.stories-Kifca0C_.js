...
`,x={title:"Components/Image Grid",component:"modus-wc-image-grid",args:{images:i,"aria-label":"Product image gallery","image-shape":"rectangle","images-per-view":4},argTypes:{images:{control:"object",description:"Images to display in the grid",table:{type:{detail:`
    ...
    ></modus-wc-image-grid>
  `},t={...h,args:{images:i,"aria-label":"Product image gallery","image-shape":"rectangle","images-per-view":4},parameters:{docs:{source:{code:d},description:{story:"Default layout: four rectangle images in a 2×2 grid with 24px gap and 16px corner radius."}}}},s={render:()=>c`
...
}`,...(g=(n=t.parameters)==null?void 0:n.docs)==null?void 0:g.source}}};var o,m,l;s.parameters={...s.parameters,docs:{...(o=s.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 48px;">
      <section>
        <h3 style="margin: 0 0 16px;">4 images — rectangle</h3>
...
}`,...(l=(m=s.parameters)==null?void 0:m.docs)==null?void 0:l.source}}};const q=["Default","AllVariants"];export{s as AllVariants,t as Default,q as __namedExportsOrder,x as default};
