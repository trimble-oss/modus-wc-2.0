...
`,x={title:"Components/Image Grid",component:"modus-wc-image-grid",args:{images:i,"aria-label":"Product image gallery","image-shape":"rectangle","images-per-view":4},argTypes:{images:{control:"object",description:"Images to display in the grid",table:{type:{detail:`
  ...
  `,parameters:{docs:{source:{code:w},description:{story:"All layout variants from the Figma ImageGrid design."}}}};var r,g,n;t.parameters={...t.parameters,docs:{...(r=t.parameters)==null?void 0:r.docs,source:{originalSource:`{
  ...Template,
  args: {
...
}`,...(n=(g=t.parameters)==null?void 0:g.docs)==null?void 0:n.source}}};var m,o,c;s.parameters={...s.parameters,docs:{...(m=s.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: () => html\`
    <div style="display: flex; flex-direction: column; gap: 48px;">
      <section>
        <h3 style="margin: 0 0 16px;">4 images — rectangle</h3>
