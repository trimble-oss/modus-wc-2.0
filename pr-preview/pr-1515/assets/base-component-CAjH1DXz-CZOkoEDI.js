...
modus-wc-image-grid modus-wc-image .modus-wc-image-container.modus-wc-image-grid-cell.modus-wc-image--default.modus-wc-image--sm, modus-wc-image-grid modus-wc-image .modus-wc-image-container.modus-wc-image-grid-cell.modus-wc-image--default.modus-wc-image--md, modus-wc-image-grid modus-wc-image .modus-wc-image-container.modus-wc-image-grid-cell.modus-wc-image--default.modus-wc-image--lg, modus-wc-image-grid modus-wc-image .modus-wc-image-container.modus-wc-image-grid-cell.modus-wc-image--default.modus-wc-image--xl, modus-wc-image-grid modus-wc-image .modus-wc-image-container.modus-wc-image-grid-cell.modus-wc-image--default.modus-wc-image--error.modus-wc-image--sm, modus-wc-image-grid modus-wc-image .modus-wc-image-container.modus-wc-image-grid-cell.modus-wc-image--default.modus-wc-image--error.modus-wc-image--md, modus-wc-image-grid modus-wc-image .modus-wc-image-container.modus-wc-image-grid-cell.modus-wc-image--default.modus-wc-image--error.modus-wc-image--lg, modus-wc-image-grid modus-wc-image .modus-wc-image-container.modus-wc-image-grid-cell.modus-wc-image--default.modus-wc-image--error.modus-wc-image--xl {
  height: 100%;
  max-height: none;
  max-width: none;
  width: 100%;
