import{w as P}from"./decorator-534da2b0.js";import{b as n}from"./lit-element-38260dd9.js";import{o as s}from"./if-defined-30b85b98.js";import{c as O}from"./shadow-host-helper-0b7f7548.js";import"./chunk-4XZ63LWV-918fa35e.js";import"./v4-4a60fe23.js";const R=`
<modus-wc-tree-menu>
  <modus-wc-tree-item
    label="Tree Item"
    size="md"
...
<modus-wc-tree-menu>
  ...
  ></modus-wc-tree-item>
    ...
    `},w={parameters:{docs:{source:{code:J}}},render:e=>{if(!customElements.get("tree-item-shadow-host")){const L=O({componentTag:"modus-wc-tree-menu",propsMapper:(t,r)=>{const H=r;H.ariaLabel="Shadow DOM Tree Menu";let m=r.querySelector("modus-wc-tree-item");m||(m=document.createElement("modus-wc-tree-item"),r.innerHTML="",r.appendChild(m));const o=m;o.bordered=Boolean(t.bordered),o.blockExpand=Boolean(t["block-expand"]),o.checkbox=Boolean(t.checkbox),o.customClass=t["custom-class"]||"",o.disabled=Boolean(t.disabled),o.focused=Boolean(t.focused),o.hasSubmenu=Boolean(t["has-submenu"]),o.label=t.label,o.selected=Boolean(t.selected),o.size=t.size||"md",o.subLabel=t["sub-label"]||"",o.tooltipContent=t["tooltip-content"]||"",o.tooltipPosition=t["tooltip-position"]||"auto",o.value=t.value}});customElements.define("tree-item-shadow-host",L)}return n`<tree-item-shadow-host
      .props=${{...e}}
