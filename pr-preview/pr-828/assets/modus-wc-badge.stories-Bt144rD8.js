import{x as a}from"./lit-element-CucEn6F2.js";import{o as g}from"./if-defined-BiZP-SBN.js";const y={title:"Components/Badge",component:"modus-wc-badge",args:{color:"primary",size:"md",variant:"filled"},argTypes:{color:{control:{type:"select"},options:["primary","secondary","tertiary","high-contrast","success","warning","danger"]},size:{control:{type:"select"},options:["sm","md","lg"]},variant:{control:{type:"select"},options:["counter","filled","outlined","text"]}}},h={render:e=>a`
<modus-wc-badge
  color="${e.color}"
