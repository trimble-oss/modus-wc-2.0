import{w as v}from"./decorator-Cv9na35H.js";import{b as d}from"./lit-element-DgBvYnzn.js";import{o}from"./if-defined-BnVFTJ4o.js";import"./chunk-4XZ63LWV-C_wAuwg_.js";import"./v4-C6aID195.js";const f={showBackButton:!0,title:"Title",subtitle:"Subtitle",showCloseButton:!0},S={title:"Components/Bottom Sheet",component:"modus-wc-bottom-sheet",args:{"custom-class":"",visible:!0,"display-mode":"default","drag-step-threshold":.4,header:f},argTypes:{visible:{control:"boolean",table:{defaultValue:{summary:"false"}}},"display-mode":{control:"select",options:["default","expanded","minimized"],table:{defaultValue:{summary:"default"}}},"drag-step-threshold":{control:{type:"number",min:0,max:1,step:.05},table:{defaultValue:{summary:"0.4"}}},header:{description:"Configuration for the built-in header layout. Do not set if you use the header slot.",table:{type:{detail:`
