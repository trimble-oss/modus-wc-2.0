...
<\/script>`;var P=Object.freeze,Se=Object.defineProperty,p=(e,t)=>P(Se(e,"raw",{value:P(t||e.slice())})),T,A,L,O,M,q,U;const Ae={title:"Components/Table",component:"modus-wc-table",args:{density:"comfortable",hover:!1,sortable:!0,paginated:!1,"show-page-size-selector":!0,"custom-class":"",selectable:"none",zebra:!1,"current-page":1,"page-size-options":[5,10,15],"selected-row-ids":[],editable:!1},argTypes:{columns:{control:"object",description:"An array of column definitions.",table:{type:{detail:`
    ...
    `],[`
      ...
      <script>
        ...
        // table.data = createDemoData();
      <\/script>
    `])),t,n,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,i("rowClick"))},args:{density:"comfortable",hover:!0}},f={render:e=>{const t=e.columns||Ce(),n=e.data||g();return m(L||(L=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
...
}`,...(F=(_=w.parameters)==null?void 0:_.docs)==null?void 0:F.source}}};var j,W,J;v.parameters={...v.parameters,docs:{...(j=v.parameters)==null?void 0:j.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
    const data = args.data || createDemoData();
    return html\`
...
}`,...(J=(W=v.parameters)==null?void 0:W.docs)==null?void 0:J.source}}};var K,V,Y;f.parameters={...f.parameters,docs:{...(K=f.parameters)==null?void 0:K.docs,source:{originalSource:`{
  render: args => {
...
}`,...(Y=(V=f.parameters)==null?void 0:V.docs)==null?void 0:Y.source}}};var H,G,X;y.parameters={...y.parameters,docs:{...(H=y.parameters)==null?void 0:H.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
...
}`,...(me=(ue=$.parameters)==null?void 0:ue.docs)==null?void 0:me.source}}};const Le=["Default","Hover","Sorting","Pagination","CheckBoxRowSelection","PartialRowSelection","InlineEditing","ExpandableSubrows","ShadowDomParent"];export{S as CheckBoxRowSelection,w as Default,E as ExpandableSubrows,v as Hover,D as InlineEditing,y as Pagination,C as PartialRowSelection,$ as ShadowDomParent,f as Sorting,Le as __namedExportsOrder,Ae as default};
