import{w as b}from"./decorator-D4YmxizW.js";import{x as f}from"./lit-element-C8zulti1.js";import{o as a}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var m=Object.freeze,y=Object.defineProperty,S=(e,i)=>m(y(e,"raw",{value:m(e.slice())})),u;const L={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[b],parameters:{layout:"padded",actions:{handles:["expandedChange"]}}},c={render:e=>{const i=d=>{const t=d.target,n=t==null?void 0:t.closest(".layout-with-navbar");let o;n?o=n.querySelector("modus-wc-side-navigation"):o=document.querySelector("modus-wc-side-navigation"),o&&(o.expanded=d.detail)};return f(u||(u=S([`
      <style>
        .layout-with-navbar {
    ...
    `])),i,{apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],a(e["custom-class"]),e.expanded,e["max-width"],a(e.mode),a(e["target-content"]))}},l={render:e=>{const i=t=>{const n=t.target,o=n==null?void 0:n.closest(".layout-with-navbar");let s;o?s=o.querySelector("modus-wc-side-navigation"):s=document.querySelector("modus-wc-side-navigation"),s&&(s.expanded=t.detail)},d=t=>{const n=t.target;if(!n)return;n.querySelectorAll(".modus-wc-menu-dropdown-toggle").forEach(s=>{s.classList.remove("modus-wc-menu-dropdown-show")}),document.querySelectorAll(".dropdown-content").forEach(s=>{s.classList.remove("modus-wc-menu-dropdown-show")})};return requestAnimationFrame(()=>{document.querySelectorAll(".modus-wc-menu-dropdown-toggle").forEach(t=>{t.addEventListener("click",n=>{const o=n.currentTarget.closest("modus-wc-side-navigation");if(o&&o.expanded){const s=n.currentTarget,r=n.currentTarget.nextElementSibling;r&&(r.classList.toggle("modus-wc-menu-dropdown-show"),s.classList.toggle("modus-wc-menu-dropdown-show"))}})})}),f`
      <style>
        .layout-with-navbar {
          box-shadow: rgba(36, 35, 45, 0.3) 1px 0 4px;
          display: flex;
      ...
      <div class="layout-with-navbar">
        ...
        <div class="main-content-row">
          ...
          >
            <modus-wc-menu size="lg" @menuFocusout=${d}>
    ...
    `}};var p,g,w;c.parameters={...c.parameters,docs:{...(p=c.parameters)==null?void 0:p.docs,source:{originalSource:`{
  render: args => {
...
}`,...(w=(g=c.parameters)==null?void 0:g.docs)==null?void 0:w.source}}};var v,h,x;l.parameters={...l.parameters,docs:{...(v=l.parameters)==null?void 0:v.docs,source:{originalSource:`{
  render: args => {
    const handleMenuOpenChange = (e: CustomEvent) => {
      const eventSource = e.target as HTMLElement;
      const storyContainer = eventSource?.closest('.layout-with-navbar');
...
}`,...(x=(h=l.parameters)==null?void 0:h.docs)==null?void 0:x.source}}};const $=["Default","collapsibleMenu"];export{c as Default,$ as __namedExportsOrder,l as collapsibleMenu,L as default};
