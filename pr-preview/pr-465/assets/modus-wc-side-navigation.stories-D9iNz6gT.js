import{w as N}from"./decorator-D4YmxizW.js";import{x as S}from"./lit-element-C8zulti1.js";import{o as d}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var h=Object.freeze,_=Object.defineProperty,A=(e,c)=>h(_(e,"raw",{value:h(e.slice())})),g,w;const k={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[N],parameters:{layout:"padded",actions:{handles:["expandedChange"]}}},r={render:e=>{const c=a=>{const l=a.target,t=l==null?void 0:l.closest(".layout-with-navbar");let i;t?i=t.querySelector("modus-wc-side-navigation"):i=document.querySelector("modus-wc-side-navigation"),i&&(i.expanded=a.detail)};return S(g||(g=A([`
    ...
    `])),c,{avatarAlt:"User Avatar",avatarSrc:"https://i1.sndcdn.com/artworks-000405996468-wmh3uv-t500x500.jpg",email:"user@trimble.com",name:"Sonic the Hedgehog"},{ai:!0,apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],d(e["custom-class"]),e.expanded,e["max-width"],d(e.mode),d(e["target-content"]),l,a,a,a)}};var x,f,b;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: args => {
...
}`,...(b=(f=r.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};var y,C,E;u.parameters={...u.parameters,docs:{...(y=u.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: args => {
    const handleMenuOpenChange = (e: CustomEvent) => {
      const eventSource = e.target as HTMLElement;
      const storyContainer = eventSource?.closest('.layout-with-navbar');
...
}`,...(E=(C=u.parameters)==null?void 0:C.docs)==null?void 0:E.source}}};const $=["Default","collapsibleMenu"];export{r as Default,$ as __namedExportsOrder,u as collapsibleMenu,k as default};
