import{w as A}from"./decorator-D4YmxizW.js";import{x as E}from"./lit-element-C8zulti1.js";import{o as s}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var v=Object.freeze,N=Object.defineProperty,S=(e,l)=>v(N(e,"raw",{value:v(e.slice())})),h,g;const z={title:"Components/Side Navigation",component:"modus-wc-side-navigation",args:{"collapse-on-click-outside":!0,expanded:!1,"max-width":"256px",mode:"push","target-content":".panel-content"},argTypes:{"max-width":{control:{type:"text"},description:"Maximum width of the side navigation panel in an expanded state."},mode:{control:{type:"select"},options:["overlay","push"],description:"Display mode of the side navigation (overlay or push)."}},decorators:[A],parameters:{layout:"padded",actions:{handles:["expandedChange"]}}},c={render:e=>{const l=a=>{const d=a.target,i=d==null?void 0:d.closest(".layout-with-navbar");let n;i?n=i.querySelector("modus-wc-side-navigation"):n=document.querySelector("modus-wc-side-navigation"),n&&(n.expanded=a.detail)};return E(h||(h=S([`
      <style>
        .layout-with-navbar {
    ...
    `])),l,{apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],s(e["custom-class"]),e.expanded,e["max-width"],s(e.mode),s(e["target-content"]))}},r={render:e=>{const l=i=>{const n=i.target,t=n==null?void 0:n.closest(".layout-with-navbar");let o;t?o=t.querySelector("modus-wc-side-navigation"):o=document.querySelector("modus-wc-side-navigation"),o&&(o.expanded=i.detail)},a=i=>{var m,p;const n=i.currentTarget,t=(m=n.closest(".flex-row"))==null?void 0:m.closest("li");if(!t)return;const o=n.getAttribute("name")==="expand_more";n.setAttribute("name",o?"chevron_right":"expand_more");const u=(p=t.nextElementSibling)!=null&&p.classList.contains("children-container")?t.nextElementSibling:null;u&&(u.classList.toggle("hidden"),u.setAttribute("aria-hidden",o?"false":"true"))},d=i=>{i.detail||document.querySelectorAll(".children-container").forEach(t=>{t.classList.add("hidden"),t.setAttribute("aria-hidden","true")})};return E(g||(g=S([`
      <style>
        .layout-with-navbar {
          box-shadow: rgba(36, 35, 45, 0.3) 1px 0 4px;
          display: flex;
    ...
    `])),l,{apps:!0,help:!0,mainMenu:!0,notifications:!0,search:!0,searchInput:!1,user:!0},e["collapse-on-click-outside"],s(e["custom-class"]),e.expanded,e["max-width"],s(e.mode),s(e["target-content"]),d,a,a,a)}};var w,f,b;c.parameters={...c.parameters,docs:{...(w=c.parameters)==null?void 0:w.docs,source:{originalSource:`{
  render: args => {
...
}`,...(b=(f=c.parameters)==null?void 0:f.docs)==null?void 0:b.source}}};var x,y,C;r.parameters={...r.parameters,docs:{...(x=r.parameters)==null?void 0:x.docs,source:{originalSource:`{
  render: args => {
    const handleMenuOpenChange = (e: CustomEvent) => {
      const eventSource = e.target as HTMLElement;
      const storyContainer = eventSource?.closest('.layout-with-navbar');
...
}`,...(C=(y=r.parameters)==null?void 0:y.docs)==null?void 0:C.source}}};const q=["Default","collapsibleMenu"];export{c as Default,q as __namedExportsOrder,r as collapsibleMenu,z as default};
