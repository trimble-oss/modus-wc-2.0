...
modus-wc-dropdown-menu.modus-wc-dropdown-menu .modus-wc-dropdown-menu-loading {
  align-items: center;
  display: flex;
  justify-content: center;
...
modus-wc-dropdown-menu.modus-wc-dropdown-menu .modus-wc-dropdown-menu-menu-content--hidden {
  display: none;
}
modus-wc-dropdown-menu.modus-wc-dropdown-menu {
