...
<div class="value">
  ...
  <span id="tree-dropdown-selected-value"></span>
    ...
    `}},J=()=>[{label:"Fetched One",value:"1"},{label:"Fetched Two",value:"2"},{label:"Fetched Three",value:"3"}],U={status:"idle",pendingLoad:!1},j=e=>{const n=e.querySelector('[slot="menu"]');if(!(n instanceof HTMLDivElement))throw new Error('Expected a stable div[slot="menu"] in the lazy loading story.');return n},k=e=>{e.replaceChildren(),e.removeAttribute("aria-busy"),e.removeAttribute("aria-live"),e.className=""},G=e=>{const n=j(e);k(n),n.className="lazy-menu-loading",n.setAttribute("aria-busy","true"),n.setAttribute("aria-live","polite");const t=document.createElement("modus-wc-loader");t.setAttribute("variant","spinner"),t.setAttribute("size","sm"),n.appendChild(t)},Q=(e,n)=>{const t=j(e);k(t),n.forEach(({label:d,value:o})=>{const l=document.createElement("modus-wc-menu-item");l.setAttribute("label",d),l.setAttribute("value",o),l.addEventListener("itemSelect",()=>{e.menuVisible=!1}),t.appendChild(l)})},b={parameters:{actions:{handles:["menuVisibilityChange","itemSelect"]},docs:{source:{code:`
<style>
  .lazy-menu-loading {
    align-items: center;
    display: flex;
...
}`,...(B=($=b.parameters)==null?void 0:$.docs)==null?void 0:B.source}}};var _,O,P;w.parameters={...w.parameters,docs:{...(_=w.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: args => {
...
}`,...(P=(O=w.parameters)==null?void 0:O.docs)==null?void 0:P.source}}};const le=["Default","IconOnlyDropdownMenu","WithTreeMenu","LazyLoading","ShadowDomParent"];export{m as Default,c as IconOnlyDropdownMenu,b as LazyLoading,w as ShadowDomParent,p as WithTreeMenu,le as __namedExportsOrder,de as default};
