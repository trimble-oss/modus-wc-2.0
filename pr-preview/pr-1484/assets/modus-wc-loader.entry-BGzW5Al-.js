import{r,h as t,H as a,g as o}from"./preview-BZua5ygx.js";import{h as l}from"./base-component-5dPYqsAn-CTgVlG6-.js";import{i as d}from"./utils-DbTqjSZo-CU1YZUgt.js";import"./index-DrFu-skq.js";import"./index-CrDdwNf4.js";import"./iframe-wp1yXpih.js";import"./_commonjsHelpers-CqkleIqs.js";import"./index-C__6K5js.js";import"./chunk-L4EGOTBX-D2rLuJr7.js";import"./entry-preview-i_sU6fcR.js";import"./lit-element-DgBvYnzn.js";import"./directive-helpers-BZ4DLK7w.js";const m=({color:e,size:i,variant:n})=>{let s="";return e&&(s=`${s} modus-wc-text-${e}`),i&&(s=`${s} modus-wc-loader-${i}`),n&&(s=`${s} modus-wc-loader-${n}`),s.trim()},c=`/**
...
}`,p=class{constructor(e){r(this,e),this.inheritedAttributes={},this.color="primary",this.customClass="",this.size="md",this.variant="spinner"}componentWillLoad(){l(this.el),this.el.ariaLabel||(this.el.ariaLabel="Loading"),this.inheritedAttributes=d(this.el)}getClasses(){const e=["modus-wc-loader"],i=m({color:this.color,size:this.size,variant:this.variant});return i&&e.push(i),this.customClass&&e.push(this.customClass),e.join(" ")}render(){return t(a,{key:"9a0a15bea0684234cf50f03fb107bd934a96fe06"},t("span",Object.assign({key:"f00e40d7c536ba2b09538fe34e7a6c8a27a82726",class:this.getClasses(),role:"status",tabindex:-1},this.inheritedAttributes)))}get el(){return o(this)}};p.style=c;export{p as modus_wc_loader};
