import{x as a}from"./lit-element-C8zulti1.js";import{o}from"./if-defined-yv6owfG8.js";const B={title:"Components/Card",component:"modus-wc-card",args:{"background-figure":!1,bordered:!1,layout:"vertical",padding:"normal"},argTypes:{layout:{control:{type:"select"},options:["vertical","horizontal"]},padding:{control:{type:"select"},options:["normal","compact"]}},parameters:{layout:"padded"}},r={render:e=>a`
<style>
  .modus-wc-card {
    width: 400px;
  }
...
| width                |                     | Not carried over, use CSS instead    |
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>a`<div></div>`};var u,p,m;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`{
  ...Template
