import{k as d}from"./lit-element-HWJBnAmk.js";import{t}from"./if-defined-C-SyXhla.js";const b={title:"Components/Forms/Input Label",component:"modus-wc-input-label",args:{"label-text":"Label",required:!1,size:"md"},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]}}},n={render:e=>d`
