import{k as i}from"./lit-element-HWJBnAmk.js";import{t}from"./if-defined-C-SyXhla.js";const y={title:"Components/Alert",component:"modus-wc-alert",args:{"alert-description":"You have 3 new messages.","alert-title":"New message!",dismissible:!1,delay:15e3,role:"status",variant:"info"},argTypes:{role:{control:{type:"select"},options:["","alert","log","marquee","status","timer"]},variant:{control:{type:"select"},options:["","error","info","success","warning"]}},parameters:{layout:"padded"}},w={render:e=>i`
<modus-wc-alert
