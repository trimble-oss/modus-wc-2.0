import{w as l}from"./decorator-DFROgT0E.js";import{k as d}from"./lit-element-HWJBnAmk.js";import{t as m}from"./if-defined-C-SyXhla.js";import"./v4-CtRu48qb.js";const n=[{description:"Item one description",icon:"alert",iconAriaLabel:"Alert",title:"Item One"},{description:"Item two description",icon:"alert",iconAriaLabel:"Alert",title:"Item Two"},{description:"Item three description",icon:"alert",iconAriaLabel:"Alert",title:"Item Three"}],w={title:"Components/Accordion",component:"modus-wc-accordion",decorators:[l],parameters:{actions:{handles:["expandedChange"]},layout:{padded:!0}}},u={render:p=>d`
