import{w as m}from"./decorator-DFROgT0E.js";import{k as l}from"./lit-element-HWJBnAmk.js";import{t as n}from"./if-defined-C-SyXhla.js";import"./v4-CtRu48qb.js";const c={firstPage:"First page",lastPage:"Last page",nextPage:"Next page",page:"Page {0}",previousPage:"Previous page"},h={title:"Components/Pagination",component:"modus-wc-pagination",args:{"aria-label-values":c,count:5,"custom-class":"",page:1,size:"md"},argTypes:{"aria-label-values":{description:"Custom aria label values for pagination buttons",table:{type:{detail:`
