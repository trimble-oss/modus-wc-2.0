import{w as r}from"./decorator-DFROgT0E.js";import{k as l}from"./lit-element-HWJBnAmk.js";import{t as o}from"./if-defined-C-SyXhla.js";import"./v4-CtRu48qb.js";const p={title:"Components/Menu Item",component:"modus-wc-menu-item",args:{label:"Menu Item",size:"md",value:"menuItem"},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[r],parameters:{actions:{handles:["itemSelect"]}}},c={render:e=>l`
<modus-wc-menu>
  <modus-wc-menu-item
    ?bordered=${e.bordered}
