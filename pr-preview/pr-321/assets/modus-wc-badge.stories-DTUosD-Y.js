import{k as a}from"./lit-element-HWJBnAmk.js";import{t as g}from"./if-defined-C-SyXhla.js";const y={title:"Components/Badge",component:"modus-wc-badge",args:{color:"primary",size:"md",variant:"filled"},argTypes:{color:{control:{type:"select"},options:["primary","secondary","tertiary","high-contrast","success","warning","danger"]},size:{control:{type:"select"},options:["sm","md","lg"]},variant:{control:{type:"select"},options:["counter","filled","text"]}}},h={render:e=>a`
<modus-wc-badge
  color="${e.color}"
...
<modus-wc-badge>
  ...
  ...Template
}`,...(i=(t=n.parameters)==null?void 0:t.docs)==null?void 0:i.source}}};var c,d,l;o.parameters={...o.parameters,docs:{...(c=o.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => {
    // prettier-ignore
    return html\`
<style>
