import{w as m}from"./decorator-DFROgT0E.js";import{k as c}from"./lit-element-HWJBnAmk.js";import{t as n}from"./if-defined-C-SyXhla.js";import"./v4-CtRu48qb.js";const v={title:"Components/Forms/Checkbox",component:"modus-wc-checkbox",args:{"custom-class":"",disabled:!1,indeterminate:!1,label:"Label",name:"",required:!1,size:"md",value:!0},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[m],parameters:{actions:{handles:["inputBlur","inputChange","inputFocus"]}}},a={render:e=>c`
      <modus-wc-checkbox
        aria-label="Checkbox"
