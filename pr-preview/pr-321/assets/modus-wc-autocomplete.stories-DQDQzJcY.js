import{w as _}from"./decorator-DFROgT0E.js";import{k as v}from"./lit-element-HWJBnAmk.js";import{t as a}from"./if-defined-C-SyXhla.js";import"./v4-CtRu48qb.js";var C=Object.freeze,K=Object.defineProperty,y=(e,p)=>C(K(e,"raw",{value:C(e.slice())})),E,M,T,S;const d=[{label:"Apple",value:"apple",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Banana",value:"banana",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0,focused:!1},{label:"Cherry",value:"cherry",visibleInMenu:!0,focused:!1},{label:"Grape",value:"grape",visibleInMenu:!0,focused:!1},{label:"Lemon",value:"lemon",visibleInMenu:!0,focused:!1},{label:"Orange",value:"orange",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Peach",value:"peach",visibleInMenu:!0,focused:!1},{label:"Pear",value:"pear",visibleInMenu:!0,focused:!1},{label:"Strawberry",value:"strawberry",visibleInMenu:!0,focused:!1,disabled:!0}],X={title:"Components/Forms/Autocomplete",component:"modus-wc-autocomplete",args:{bordered:!0,"debounce-ms":300,disabled:!1,items:d,label:"Label","leave-menu-open":!1,"min-chars":0,"multi-select":!1,"show-spinner":!1,"no-results":{ariaLabel:"No results found",label:"No results found",subLabel:"Check spelling or try a different keyword"},size:"md",value:""},argTypes:{items:{description:"Array of items for the autocomplete component",table:{type:{detail:`
          ...
          `}}},size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[_],parameters:{actions:{handles:["chipRemove","inputBlur","inputChange","inputFocus","itemSelect"]}}},W={render:e=>{const p=o=>{const t=o.target.closest("modus-wc-autocomplete");if(!t)return;e.initialNavigation===void 0&&(e.initialNavigation=!0),["ArrowDown","ArrowUp","Enter","Escape"].includes(o.key)&&o.preventDefault();const s=e.items.filter(i=>i.visibleInMenu&&!i.disabled);switch(o.key){case"Escape":e.items=e.items.map(i=>({...i,focused:!1})),e.initialNavigation=!0,t.items=[...e.items];return;case"ArrowDown":if(e.initialNavigation){e.initialNavigation=!1;return}else{const i=s.findIndex(l=>l.focused),n=i<0?0:Math.min(i+1,s.length-1);e.items=e.items.map(l=>{var c;return{...l,focused:((c=s[n])==null?void 0:c.value)===l.value}})}break;case"ArrowUp":if(e.initialNavigation){e.initialNavigation=!1;return}else{const i=s.findIndex(l=>l.focused),n=i<0?s.length-1:Math.max(i-1,0);e.items=e.items.map(l=>{var c;return{...l,focused:((c=s[n])==null?void 0:c.value)===l.value}})}break;case"Enter":{const i=s.find(n=>n.focused);i&&(e.items=e.items.map(n=>({...n,selected:n.value===i.value,focused:!1})),t.value=i.label,e.initialNavigation=!0);break}default:return}t.items=[...e.items]},f=o=>{var s;if(!((s=o.detail)!=null&&s.target))return;const t=o.target.closest("modus-wc-autocomplete");if(t){const i=o.detail.target,n=i.value.toLowerCase();e.items=e.items.map(l=>({...l,visibleInMenu:l.label.toLowerCase().includes(n),focused:!1,selected:n?l.selected:!1})),t.items=[...e.items],t.value=i.value}},m=()=>{e.initialNavigation=!0,e.items=e.items.map(o=>({...o,focused:!1,visibleInMenu:!0}))},u=o=>{const t=o.target.closest("modus-wc-autocomplete");if(t){const s=o.detail.label;s&&(t.value=s),d.forEach(n=>n.selected=!1);const i=d.find(n=>n.value===o.detail.value);i&&(i.selected=!0,t.items=[...d])}};return v(E||(E=y([`
      <style>
    ...
    `])),e.bordered,a(e["custom-class"]),a(e["debounce-ms"]),e.disabled,a(e["input-id"]),a(e["input-tab-index"]),e.items,a(e.label),e["leave-menu-open"],e["min-chars"],!1,a(e.name),e["no-results"],a(e.placeholder),e["read-only"],e.required,e["show-spinner"],a(e.size),e.value,f,u,m,p)}},h={...W},b={render:e=>{(!e.items||e.items.length===0)&&(e.items=[...d]);const p=t=>{const s=t.target.closest("modus-wc-autocomplete");s&&(e.items=e.items.map(i=>i.value===t.detail.value?{...i,selected:!1}:i),s.items=[...e.items])},f=t=>{var i;if(!((i=t.detail)!=null&&i.target))return;const s=t.target.closest("modus-wc-autocomplete");if(s){const n=t.detail.target,l=n.value.toLowerCase(),c=e.items.map(r=>({...r,visibleInMenu:r.label.toLowerCase().includes(l),focused:!1}));e.items=c,s.items=[...e.items],s.value=n.value,s.value&&(e.initialNavigation=!1)}},m=()=>{e.initialNavigation=!0,e.items=e.items.map(t=>({...t,focused:!1,visibleInMenu:!0}))},u=t=>{const s=t.target.closest("modus-wc-autocomplete");s&&(e.items=e.items.map(i=>i.value===t.detail.value?{...i,selected:!0}:i),s.items=[...e.items],s.value="")},o=t=>{const s=t.target.closest("modus-wc-autocomplete");if(!s)return;e.initialNavigation===void 0&&(e.initialNavigation=!0),["ArrowDown","ArrowUp","Enter"].includes(t.key)&&t.preventDefault();const i=e.items.filter(n=>n.visibleInMenu&&!n.disabled);switch(t.target.value!==s.value&&(e.initialNavigation=!0),t.key){case"Escape":e.items=e.items.map(n=>({...n,focused:!1})),e.initialNavigation=!0,s.items=[...e.items];return;case"ArrowDown":if(e.initialNavigation){e.initialNavigation=!1;return}else{const n=i.findIndex(c=>c.focused),l=n<0?0:Math.min(n+1,i.length-1);e.items=e.items.map(c=>{var r;return{...c,focused:((r=i[l])==null?void 0:r.value)===c.value}})}break;case"ArrowUp":if(e.initialNavigation){e.initialNavigation=!1;return}else{const n=i.findIndex(c=>c.focused),l=n<0?i.length-1:Math.max(n-1,0);e.items=e.items.map(c=>{var r;return{...c,focused:((r=i[l])==null?void 0:r.value)===c.value}})}break;case"Enter":{const n=i.find(l=>l.focused);n&&(e.items=e.items.map(l=>({...l,selected:l.value===n.value?!l.selected:l.selected,focused:!1})),s.value="",e.initialNavigation=!0);break}default:return}s.items=[...e.items]};return v(M||(M=y([`
      ...
      <modus-wc-autocomplete
        ...
        @keydown=`,`
      ></modus-wc-autocomplete>
    `])),e.bordered,a(e["custom-class"]),a(e["debounce-ms"]),e.disabled,a(e["input-id"]),a(e["input-tab-index"]),e.items,a(e.label),e["leave-menu-open"],e["min-chars"],!0,a(e.name),e["no-results"],a(e.placeholder),e["read-only"],e.required,a(e.size),e.value,p,f,u,m,o)}},g={render:e=>{const p=m=>{var o;if(!((o=m.detail)!=null&&o.target))return;const u=m.target.closest("modus-wc-autocomplete");if(u){const t=m.detail.target,s=t.value.toLowerCase();setTimeout(()=>{u.showSpinner=!1},2e3),u.showSpinner=!0;const i=d.map(n=>({...n,selected:s?n.selected:!1,visibleInMenu:n.label.toLowerCase().includes(s)}));u.items=[...i],u.value=t.value}},f=m=>{const u=m.target.closest("modus-wc-autocomplete");if(u){const o=m.detail.label;o&&(u.value=o),d.forEach(s=>s.selected=!1);const t=d.find(s=>s.value===m.detail.value);t&&(t.selected=!0,u.items=[...d])}};return v(T||(T=y([`
<style>
  /* Only for Storybook */
  div[id^="story--components-forms-autocomplete--default"] {
    height: 400px;
...
<modus-wc-autocomplete
  ...
  @itemSelect=`,`
></modus-wc-autocomplete>
    `])),e.bordered,a(e["custom-class"]),a(e["debounce-ms"]),e.disabled,a(e["input-id"]),a(e["input-tab-index"]),e.items,a(e.label),e["leave-menu-open"],e["min-chars"],!1,a(e.name),a(e.placeholder),e["read-only"],e.required,e["show-spinner"],a(e.size),e.value,p,f)}},I={render:e=>{const p=e["no-results"];e["leave-menu-open"]==!0&&(e["no-results"]={ariaLabel:"",label:"",subLabel:""});const f=o=>{var s;if(!((s=o.detail)!=null&&s.target))return;const t=o.target.closest("modus-wc-autocomplete");if(t){const i=o.detail.target.value,n=t==null?void 0:t.querySelectorAll("li");i===""&&(n==null||n.forEach(c=>c.classList.remove("selected")));let l=0;Array.from(n??[]).forEach(c=>{var L,x;(((x=(L=c.querySelector(".title"))==null?void 0:L.textContent)==null?void 0:x.toLowerCase())||"").includes(i.toLowerCase())?(c.classList.remove("hidden"),t.noResults={ariaLabel:"",label:"",subLabel:""}):(c.classList.add("hidden"),l++,l===(n==null?void 0:n.length)&&(t.noResults=p))})}},m=o=>{const t=o.target.closest("modus-wc-autocomplete");t&&(t.noResults={ariaLabel:"",label:"",subLabel:""})},u=o=>{var s;const t=o.target.closest("modus-wc-autocomplete");if(t){const i=(s=o.detail.target)==null?void 0:s.value;t.value=i;const n=t==null?void 0:t.querySelectorAll("li");n==null||n.forEach(l=>l.classList.remove("selected")),n==null||n.forEach(l=>{var c;l.contains(o.target)&&(l.classList.add("selected"),t.value=(c=l.querySelector(".title"))==null?void 0:c.textContent)})}};return v(S||(S=y([`
<style>
  /* Only for Storybook */
...
`])),e.bordered,a(e["custom-class"]),a(e["debounce-ms"]),e.disabled,a(e["input-id"]),a(e["input-tab-index"]),a(e.label),e["leave-menu-open"],e["min-chars"],!1,a(e.name),e["no-results"],a(e.placeholder),e["read-only"],e.required,a(e.size),e.value,m,f,u,!0,a(e.size),u,!0,a(e.size),u,!0,a(e.size),u,!0,a(e.size),u,!0,a(e.size))}},w={parameters:{docs:{description:{story:`
#### Breaking Changes
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(O=(U=w.parameters)==null?void 0:U.docs)==null?void 0:O.source}}};const Y=["Default","MultiSelect","WithSpinner","CustomMenuItems","Migration"];export{I as CustomMenuItems,h as Default,w as Migration,b as MultiSelect,g as WithSpinner,Y as __namedExportsOrder,X as default};
