import{k as s}from"./lit-element-HWJBnAmk.js";import{t as i}from"./if-defined-C-SyXhla.js";const p={title:"Components/Divider",component:"modus-wc-divider",args:{color:"tertiary",content:"","custom-class":"",orientation:"vertical",position:"center",responsive:!0},argTypes:{color:{control:{type:"select"},options:["primary","secondary","tertiary","high-contrast","success","warning","danger"]},content:{control:"text"},"custom-class":{control:"text"},orientation:{control:{type:"select"},options:["horizontal","vertical"]},position:{control:{type:"select"},options:["start","center","end"]},responsive:{control:{type:"boolean"}}},parameters:{layout:"padded"}},c={render:o=>s`
    <modus-wc-divider
      aria-label="Divider"
      color="${o.color}"
      content="${o.content}"
