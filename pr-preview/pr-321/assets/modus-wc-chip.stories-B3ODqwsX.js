import{w as x}from"./decorator-DFROgT0E.js";import{k as i}from"./lit-element-HWJBnAmk.js";import{t as a}from"./if-defined-C-SyXhla.js";import"./v4-CtRu48qb.js";const E={title:"Components/Chip",component:"modus-wc-chip",args:{label:"Chip","show-remove":!0,size:"md",variant:"filled"},argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]},variant:{control:{type:"select"},options:["filled","outline"]}},decorators:[x],parameters:{actions:{handles:["chipClick","chipRemove"]}}},k={render:e=>i` <modus-wc-chip
...
| closeClick | chipRemove |       |
  ...
  render: () => html\`<div></div>\`
}`,...(g=(z=c.parameters)==null?void 0:z.docs)==null?void 0:g.source}}};const M=["Default","AvatarChip","CheckIconChip","Composable","Migration"];export{s as AvatarChip,n as CheckIconChip,o as Composable,r as Default,c as Migration,M as __namedExportsOrder,E as default};
