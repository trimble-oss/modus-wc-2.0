import{w as f}from"./decorator-DFROgT0E.js";import{k as o}from"./lit-element-HWJBnAmk.js";import{t as a}from"./if-defined-C-SyXhla.js";import"./v4-CtRu48qb.js";const v=[{label:"Option 1",value:"1"},{label:"Option 2",value:"2"},{label:"Option 3",value:"3"}],y={title:"Components/Forms/Select",component:"modus-wc-select",args:{bordered:!0,disabled:!1,label:"Label",options:v,size:"md",value:""},argTypes:{feedback:{description:"Feedback prop for input components",table:{type:{detail:`
...
| inputBlur    | inputBlur   |                  |
  ...
  render: () => html\`<div></div>\`
}`,...(b=(m=r.parameters)==null?void 0:m.docs)==null?void 0:b.source}}};const S=["Default","WithErrorFeedback","Migration"];export{n as Default,r as Migration,t as WithErrorFeedback,S as __namedExportsOrder,y as default};
