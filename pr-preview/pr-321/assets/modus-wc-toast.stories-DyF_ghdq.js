import{k as l}from"./lit-element-HWJBnAmk.js";import{t as n}from"./if-defined-C-SyXhla.js";const v={title:"Components/Toast",component:"modus-wc-toast",args:{position:"top-end"},argTypes:{position:{control:{type:"select"},options:["top-start","top-center","top-end","middle-start","middle-center","middle-end","bottom-start","bottom-center","bottom-end"]}},parameters:{layout:"padded",viewport:"responsive"}},p={render:o=>l`
