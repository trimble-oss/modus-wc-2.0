...
>
    ...
    `},s={...r},o={...r};o.args={activeTabIndex:1,tabs:[{label:"Normal"},{label:"Active"},{label:"Disabled",disabled:!0}]};const a={...r,args:{tabs:[{icon:"home"},{icon:"settings",iconPosition:"left",label:"Settings"},{icon:"alert",iconPosition:"right",label:"Alerts"}]}},n={render:e=>T`
<modus-wc-tabs
  active-tab-index="${t(e.activeTabIndex)}"
  aria-label="Tab group"
...
>
  ...
  ...Template
}`,...(l=(c=s.parameters)==null?void 0:c.docs)==null?void 0:l.source}}};var b,d,p;o.parameters={...o.parameters,docs:{...(b=o.parameters)==null?void 0:b.docs,source:{originalSource:`{
  ...Template
}`,...(p=(d=o.parameters)==null?void 0:d.docs)==null?void 0:p.source}}};var m,u,g;a.parameters={...a.parameters,docs:{...(m=a.parameters)==null?void 0:m.docs,source:{originalSource:`{
  ...Template,
  args: {
    tabs: [{
      icon: 'home'
...
}`,...(g=(u=a.parameters)==null?void 0:u.docs)==null?void 0:g.source}}};var f,h,y;n.parameters={...n.parameters,docs:{...(f=n.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: args => {
    // prettier-ignore
    return html\`
<modus-wc-tabs
...
}`,...(y=(h=n.parameters)==null?void 0:h.docs)==null?void 0:y.source}}};const D=["Default","ActiveAndDisabled","Icons","TabsWithPanel"];export{o as ActiveAndDisabled,s as Default,a as Icons,n as TabsWithPanel,D as __namedExportsOrder,A as default};
