import{w as h}from"./decorator-D4YmxizW.js";import{x as a}from"./lit-element-C8zulti1.js";import{o as s}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var c=Object.freeze,D=Object.defineProperty,M=(e,r)=>c(D(e,"raw",{value:c(e.slice())})),d;const I={title:"Components/File Dropzone",component:"modus-wc-file-dropzone",args:{"accept-file-types":".doc, .docx, .pdf",disabled:!1,"include-state-icon":!0,instructions:"Drag files here or browse to upload"},argTypes:{"accept-file-types":{control:"text",description:"Accepted file types (e.g. '.jpg,.png' or 'image/*')"},"custom-class":{control:"text",description:"Custom CSS class to apply to the file dropzone element"},disabled:{control:"boolean",description:"Disable the file input",table:{defaultValue:{summary:"false"}}},instructions:{control:"text",description:"Default instructions displayed in the dropzone"},"invalid-file-type-message":{control:"text",description:"Custom error message displayed when an invalid file type is selected"},"max-file-name-length":{control:"number",description:"Maximum allowed length of filename, will show error if exceeded"},"max-file-count":{control:"number",description:"Maximum number of files allowed, will show error if exceeded"},"max-total-file-size-bytes":{control:"number",description:"Maximum total file size in bytes allowed, will show error if exceeded"},multiple:{control:"boolean",description:"Allow multiple file selection",table:{defaultValue:{summary:"false"}}},reset:{description:"Reset the dropzone to its initial state, clearing all error and success states",table:{category:"Methods",type:{summary:"() => Promise<void>"}}}},decorators:[h],parameters:{actions:{handles:["fileSelect"]}}},i={render:e=>a`
    ...
    ></modus-wc-file-dropzone>
  `},o={args:{"accept-file-types":".pdf, .doc, .docx","success-message":"Files uploaded successfully!"},render:e=>{const r=()=>{const t=document.getElementById("custom-dropzone");t!=null&&t.reset&&t.reset()};return a(d||(d=M([`
<script>
const resetDropzone = () => {
...
<div style="display: flex; flex-direction: column; gap: 1rem;">
  ...
  `])),s(e["accept-file-types"]),s(e["success-message"]),r)}},n={args:{"max-file-name-length":20,"max-file-count":3,"max-total-file-size-bytes":10485760,"invalid-file-type-message":"Invalid file format. Please upload correct file type."},render:e=>a`
    <modus-wc-file-dropzone
      accept-file-types=${s(e["accept-file-types"])}
      invalid-file-type-message=${s(e["invalid-file-type-message"])}
      max-file-name-length=${s(e["max-file-name-length"])}
    ...
    ></modus-wc-file-dropzone>
  `},l={args:{multiple:!0,"accept-file-types":"image/*"},render:e=>a`
    <modus-wc-file-dropzone
      accept-file-types=${s(e["accept-file-types"])}
      multiple=${e.multiple}
...
<div style="display: flex; flex-direction: column; gap: 1rem;">
...
}`,...(y=(g=o.parameters)==null?void 0:g.docs)==null?void 0:y.source}}};var z,x,w;n.parameters={...n.parameters,docs:{...(z=n.parameters)==null?void 0:z.docs,source:{originalSource:`{
  args: {
  ...
  render: args => html\`
    ...
    ></modus-wc-file-dropzone>
  \`
}`,...(w=(x=n.parameters)==null?void 0:x.docs)==null?void 0:w.source}}};var b,$,v;l.parameters={...l.parameters,docs:{...(b=l.parameters)==null?void 0:b.docs,source:{originalSource:`{
  args: {
    multiple: true,
  ...
  render: args => html\`
    ...
    ></modus-wc-file-dropzone>
  \`
}`,...(v=($=l.parameters)==null?void 0:$.docs)==null?void 0:v.source}}};const F=["Default","customContent","fileValidations","multipleFiles"];export{i as Default,F as __namedExportsOrder,o as customContent,I as default,n as fileValidations,l as multipleFiles};
