import{w as S}from"./decorator-Cv9na35H.js";import{b as i}from"./lit-element-DgBvYnzn.js";import{o as r}from"./if-defined-BnVFTJ4o.js";import{c as q}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-C_wAuwg_.js";import"./v4-C6aID195.js";var c=Object.freeze,z=Object.defineProperty,C=(e,d)=>c(z(e,"raw",{value:c(e.slice())})),u;const M={title:"Components/Forms/Textarea",component:"modus-wc-textarea",args:{bordered:!0,"custom-class":"",disabled:!1,label:"Label",readonly:!1,required:!1,size:"md",spellcheck:!1,value:""},argTypes:{"auto-correct":{options:["on","off"]},enterkeyhint:{options:["enter","done","go","next","previous","search","send"]},feedback:{description:"Feedback prop for input components",table:{type:{detail:`
    ...
    <\/script>
  `])),D,r(e.label),!0,e.value)},s={render:e=>{if(!customElements.get("textarea-shadow-host")){const d=q({componentTag:"modus-wc-textarea",propsMapper:(n,E)=>{const a=E;a.autoCorrect=n["auto-correct"],a.bordered=!!n.bordered,a.customClass=n["custom-class"]||"",a.disabled=!!n.disabled,a.enterkeyhint=n.enterkeyhint||"",a.inputId=n["input-id"]||"",a.inputTabIndex=n["input-tab-index"]||0,a.label=n.label||"",a.maxLength=n["max-length"]||100,a.minLength=n["min-length"]||0,a.name=n.name||"",a.placeholder=n.placeholder||"",a.readonly=!!n.readonly,a.required=!!n.required,a.rows=typeof n.rows=="number"?n.rows:2,a.size=n.size||""}});customElements.define("textarea-shadow-host",d)}return i`<textarea-shadow-host
      .props=${{...e}}
