...
| buttonClick | inputChange | Now emits an \\\`InputEvent\\\` instead of a \\\`string\\\` |
  ...
  render: () => html\`<div></div>\`
}`,...(z=($=r.parameters)==null?void 0:$.docs)==null?void 0:z.source}}};const B=["Default","RadioGroup","ShadowDomParent","Migration"];export{s as Default,r as Migration,d as RadioGroup,t as ShadowDomParent,B as __namedExportsOrder,q as default};
