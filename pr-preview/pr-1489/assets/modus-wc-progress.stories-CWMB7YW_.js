...
>
  ${e.value}%
    ...
    `,parameters:{layout:"centered"}},p={render:e=>{if(!customElements.get("progress-shadow-host")){const F=J({componentTag:"modus-wc-progress",propsMapper:(o,G)=>{const a=G;a.customClass=o["custom-class"]||"",a.indeterminate=!!o.indeterminate,a.label=o.label??"",a.max=o.max??100,a.value=o.value,a.variant=o.variant??"default"}});customElements.define("progress-shadow-host",F)}return r`<progress-shadow-host
      .props=${{...e}}
...
}`,...(y=(C=l.parameters)==null?void 0:C.docs)==null?void 0:y.source}}};var x,z,k;c.parameters={...c.parameters,docs:{...(x=c.parameters)==null?void 0:x.docs,source:{originalSource:`{
  args: {
    label: 'Loading...',
    value: 50
  },
...
}`,...(k=(z=c.parameters)==null?void 0:z.docs)==null?void 0:k.source}}};var D,E,P;d.parameters={...d.parameters,docs:{...(D=d.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: args => {
    // prettier-ignore
    return html\`
<style>
...
}`,...(P=(E=d.parameters)==null?void 0:E.docs)==null?void 0:P.source}}};var N,T,B;i.parameters={...i.parameters,docs:{...(N=i.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: args => {
    // prettier-ignore
    return html\`
<style>
...
}`,...(B=(T=i.parameters)==null?void 0:T.docs)==null?void 0:B.source}}};var M,H,L;m.parameters={...m.parameters,docs:{...(M=m.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: args => {
    // prettier-ignore
    return html\`
<style>
