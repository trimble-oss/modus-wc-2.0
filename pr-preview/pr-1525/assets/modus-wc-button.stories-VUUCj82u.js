import{w as j}from"./decorator-Cv9na35H.js";import{b as o}from"./lit-element-DgBvYnzn.js";import{o as F}from"./if-defined-BnVFTJ4o.js";import{c as G}from"./shadow-host-helper-A4Nvcs5e.js";import"./chunk-4XZ63LWV-C_wAuwg_.js";import"./v4-C6aID195.js";var b=Object.freeze,J=Object.defineProperty,K=(t,s)=>b(J(t,"raw",{value:b(t.slice())})),w;const nt={title:"Components/Button",component:"modus-wc-button",args:{color:"primary",disabled:!1,"full-width":!1,pressed:!1,shape:"rectangle",size:"md",type:"button",variant:"filled"},argTypes:{color:{control:{type:"select"},options:["primary","secondary","tertiary","warning","danger","neutral","success"]},shape:{control:{type:"select"},options:["circle","ellipse","rectangle","square"]},size:{control:{type:"select"},options:["xs","sm","md","lg","xl"]},type:{control:{type:"select"},options:["button","submit","reset"]},variant:{control:{type:"select"},options:["borderless","filled","outlined"]}},decorators:[j],parameters:{actions:{handles:["buttonClick"]}}},Q={render:t=>o`
<modus-wc-button
  color="${t.color}"
