import{x as i}from"./lit-element-CucEn6F2.js";import{o as l}from"./if-defined-BiZP-SBN.js";function $(o=8){return Math.random().toString(36).substring(2,2+o)}var c=Object.freeze,k=Object.defineProperty,N=(o,t)=>c(k(o,"raw",{value:c(o.slice())})),m;const E={title:"Components/Modal",component:"modus-wc-modal",args:{backdrop:"default","custom-class":"",fullscreen:!1,"modal-id":"my_modal_1",position:"center","show-close":!0,"show-fullscreen-toggle":!1},argTypes:{backdrop:{control:{type:"select"},options:["default","static"]},position:{control:{type:"select"},options:["bottom","center","top"]}},parameters:{layout:"centered"}},M=i(m||(m=N([`
  <script>
