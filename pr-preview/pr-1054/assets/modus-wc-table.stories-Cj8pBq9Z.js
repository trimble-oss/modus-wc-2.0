import"./index-CK-iu89z.js";import{x as m}from"./lit-element-CucEn6F2.js";import{b as c}from"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var z=Object.freeze,Q=Object.defineProperty,p=(e,t)=>z(Q(e,"raw",{value:z(t||e.slice())})),I,k,x,T,R,q;const oe={title:"Components/Table",component:"modus-wc-table",argTypes:{columns:{control:"object",description:"An array of column definitions.",table:{type:{detail:`
    ...
    `],[`
      ...
      <script>
        ...
        // table.hover = 'false';
      <\/script>
    `])),t,a,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,e.caption,c("rowClick"),c("sortChange"),c("paginationChange"),c("rowSelectionChange"),c("cellEditStart"),c("cellEditCommit"))},args:{density:"comfortable",hover:!1,sortable:!0,paginated:!1,"show-page-size-selector":!0,"custom-class":"",selectable:"none",zebra:!1,"current-page":1,"page-size-options":[5,10,15],"selected-row-ids":[],editable:!1}},f={render:e=>{const t=e.columns||h(),a=e.data||g();return m(k||(k=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        // table.data = createDemoData();
      <\/script>
    `])),t,a,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,c("rowClick"))},args:{density:"comfortable",hover:!0}},w={render:e=>{const t=e.columns||X(),a=e.data||g();return m(x||(x=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        // table.data = createDemoData();
      <\/script>
    `])),t,a,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,c("sortChange"))},args:{density:"comfortable",sortable:!0}},v={render:e=>{const t=e.columns||h(),a=e.data||g(15);return m(T||(T=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        // table.paginated = true;
      <\/script>
    `])),t,a,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,c("paginationChange"))},args:{density:"comfortable",paginated:!0,"show-page-size-selector":!0}},y={render:e=>{const t=e.columns||h(),a=e.data||g();return m(R||(R=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        // table.selectable = 'multi';
      <\/script>
    `])),t,a,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],e.editable,c("rowSelectionChange"))},args:{density:"comfortable",selectable:"multi"}},C={render:e=>{const t=[{id:"id",header:"ID",accessor:"id",width:"20px"},{id:"name",header:"Name",accessor:"name"},{id:"status",header:"Status",accessor:"status",editor:"custom",customEditorRenderer:(d,l)=>{const o=document.createElement("div");o.style.width="100%";const n=document.createElement("modus-wc-autocomplete");n.items=[{label:"Active",value:"Active",visibleInMenu:!0},{label:"Inactive",value:"Inactive",visibleInMenu:!0},{label:"Pending",value:"Pending",visibleInMenu:!0}],n.value=d,n.style.width="100%";const i=u=>{l(u.detail.value)};return n.addEventListener("itemSelect",i),o.appendChild(n),setTimeout(()=>{const u=n.querySelector("input");u==null||u.focus()},0),o},cellRenderer:d=>{const o={Active:"green",Inactive:"gray",Pending:"blue"}[d]||"black",n=document.createElement("span");return n.textContent=d,n.style.color=o,n.style.fontWeight="bold",n}},{id:"dueDate",header:"Due Date",accessor:"dueDate",editor:"custom",customEditorRenderer:(d,l)=>{const o=document.createElement("div");o.style.width="100%";const n=document.createElement("modus-wc-date");n.value=d,n.style.width="100%",n.bordered=!1;let i=!1;const u=r=>{if(r.key==="Enter"){r.preventDefault();const s=n.querySelector("input");s&&s.value&&!i&&(i=!0,l(s.value))}else if(r.key==="Escape")r.preventDefault(),i||(i=!0,l(d||""));else if(r.key==="Tab"){const s=n.querySelector("input");s&&s.value&&!i&&(i=!0,l(s.value))}},S=r=>{var E,P;const s=r.relatedTarget;if(s&&(o.contains(s)||(E=n.shadowRoot)!=null&&E.contains(s))||((P=n.shadowRoot)==null?void 0:P.querySelector('[class*="calendar"]')))return;const D=n.querySelector("input");D&&D.value&&!i&&(i=!0,setTimeout(()=>l(D.value),50))};return o.addEventListener("keydown",u),o.addEventListener("focusout",S),o.appendChild(n),setTimeout(()=>{const r=n.querySelector("input");r==null||r.focus()},0),o},cellRenderer:d=>{if(!d)return"-";const l=d,o=l.split(/[-/]/);let n;if(o.length===3&&o[0].length<=2){const r=parseInt(o[0],10),s=parseInt(o[1],10)-1,$=parseInt(o[2],10);n=new Date($,s,r)}else n=new Date(l);if(isNaN(n.getTime()))return l;const i=n.getDate().toString().padStart(2,"0"),u=(n.getMonth()+1).toString().padStart(2,"0"),S=n.getFullYear();return`${i}-${u}-${S}`}}],a=[{id:"1",name:"John Doe",status:"Active",dueDate:"15-10-2025"},{id:"2",name:"Jane Smith",status:"Inactive",dueDate:"20-11-2025"},{id:"3",name:"Bob Johnson",status:"Pending",dueDate:"05-12-2025"}];return m(q||(q=p([`
      <modus-wc-table
        .columns=`,`
        .data=`,`
        .density=`,`
    ...
    `],[`
      ...
      <script>
        ...
        //   table.editable = true;
      <\/script>
    `])),t,a,e.density,e.hover,e.sortable,e.paginated,e["show-page-size-selector"],e["custom-class"],e.selectable,e.zebra,e["current-page"],e["page-size-options"],e["selected-row-ids"],!0,c("cellEditStart"),c("cellEditCommit"))},args:{density:"comfortable",hover:!1,sortable:!0,paginated:!1,"show-page-size-selector":!0,"custom-class":"",selectable:"none",zebra:!1,"current-page":1,"page-size-options":[5,10,15],"selected-row-ids":[]}};var A,M,U;b.parameters={...b.parameters,docs:{...(A=b.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: args => {
...
}`,...(U=(M=b.parameters)==null?void 0:M.docs)==null?void 0:U.source}}};var N,O,L;f.parameters={...f.parameters,docs:{...(N=f.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
    const data = args.data || createDemoData();
    return html\`
...
}`,...(L=(O=f.parameters)==null?void 0:O.docs)==null?void 0:L.source}}};var B,J,F;w.parameters={...w.parameters,docs:{...(B=w.parameters)==null?void 0:B.docs,source:{originalSource:`{
  render: args => {
...
}`,...(F=(J=w.parameters)==null?void 0:J.docs)==null?void 0:F.source}}};var Y,_,j;v.parameters={...v.parameters,docs:{...(Y=v.parameters)==null?void 0:Y.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
...
}`,...(j=(_=v.parameters)==null?void 0:_.docs)==null?void 0:j.source}}};var K,V,H;y.parameters={...y.parameters,docs:{...(K=y.parameters)==null?void 0:K.docs,source:{originalSource:`{
  render: args => {
    const columns = args.columns || createDemoColumns();
    const data = args.data || createDemoData();
    return html\`
...
}`,...(H=(V=y.parameters)==null?void 0:V.docs)==null?void 0:H.source}}};var W,Z,G;C.parameters={...C.parameters,docs:{...(W=C.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: args => {
...
}`,...(G=(Z=C.parameters)==null?void 0:Z.docs)==null?void 0:G.source}}};const re=["Default","Hover","Sorting","Pagination","CheckBoxRowSelection","InlineEditing"];export{y as CheckBoxRowSelection,b as Default,f as Hover,C as InlineEditing,v as Pagination,w as Sorting,re as __namedExportsOrder,oe as default};
