import{w as _}from"./decorator-D4YmxizW.js";import{x as v}from"./lit-element-C8zulti1.js";import{o as a}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";var C=Object.freeze,K=Object.defineProperty,y=(e,d)=>C(K(e,"raw",{value:C(e.slice())})),E,M,T,S;const f=[{label:"Apple",value:"apple",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Banana",value:"banana",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Blueberry",value:"blueberry",visibleInMenu:!0,focused:!1},{label:"Cherry",value:"cherry",visibleInMenu:!0,focused:!1},{label:"Grape",value:"grape",visibleInMenu:!0,focused:!1},{label:"Lemon",value:"lemon",visibleInMenu:!0,focused:!1},{label:"Orange",value:"orange",visibleInMenu:!0,focused:!1,disabled:!0},{label:"Peach",value:"peach",visibleInMenu:!0,focused:!1},{label:"Pear",value:"pear",visibleInMenu:!0,focused:!1},{label:"Strawberry",value:"strawberry",visibleInMenu:!0,focused:!1,disabled:!0}],Y={title:"Components/Forms/Autocomplete",component:"modus-wc-autocomplete",args:{bordered:!0,"debounce-ms":300,disabled:!1,"include-clear":!1,"include-search":!1,items:f,label:"Label","leave-menu-open":!1,"min-chars":0,"multi-select":!1,"show-menu-on-focus":!1,"show-spinner":!1,"no-results":{ariaLabel:"No results found",label:"No results found",subLabel:"Check spelling or try a different keyword"},size:"md",value:""},argTypes:{items:{description:"Array of items for the autocomplete component",table:{type:{detail:`
          ...
          `}}},size:{control:{type:"select"},options:["sm","md","lg"]}},decorators:[_],parameters:{actions:{handles:["chipRemove","inputBlur","inputChange","inputFocus","itemSelect"]}}},W={render:e=>{const d=o=>{const c=o.target.closest("modus-wc-autocomplete");if(!c)return;["ArrowDown","ArrowUp","Enter","Escape"].includes(o.key)&&o.preventDefault();const t=e.items.filter(n=>n.visibleInMenu&&!n.disabled);switch(o.key){case"Escape":e.items=e.items.map(n=>({...n,focused:!1})),c.items=[...e.items];break;case"ArrowDown":{const n=t.findIndex(s=>s.focused),i=n<0?0:Math.min(n+1,t.length-1);e.items=e.items.map(s=>{var l;return{...s,focused:((l=t[i])==null?void 0:l.value)===s.value}});break}case"ArrowUp":{const n=t.findIndex(s=>s.focused),i=n<0?t.length-1:Math.max(n-1,0);e.items=e.items.map(s=>{var l;return{...s,focused:((l=t[i])==null?void 0:l.value)===s.value}});break}case"Enter":{const n=t.find(i=>i.focused);n&&(e.items=e.items.map(i=>({...i,selected:i.value===n.value,focused:!1})),c.value=n.label);break}default:return}c.items=[...e.items]},p=o=>{var t,n;if(!((t=o.detail)!=null&&t.target))return;const c=o.target.closest("modus-wc-autocomplete");if(c){const i=o.detail.target,s=((n=i.value)==null?void 0:n.toLowerCase())??"";e.items=e.items.map(l=>({...l,visibleInMenu:l.label.toLowerCase().includes(s),focused:!1,selected:s?l.selected:!1})),c.items=[...e.items],c.value=i.value}},m=o=>{const c=o.target.closest("modus-wc-autocomplete");if(c){const t=o.detail.label;t&&(c.value=t),e.items.forEach(i=>i.selected=!1);const n=e.items.find(i=>i.value===o.detail.value);n&&(n.selected=!0,c.items=[...e.items])}};return v(E||(E=y([`
      <style>
      ...
      <modus-wc-autocomplete
        ...
        @keydown=`,`
      ></modus-wc-autocomplete>
    `])),e.bordered,a(e["custom-class"]),a(e["debounce-ms"]),e.disabled,e["include-clear"],e["include-search"],a(e["input-id"]),a(e["input-tab-index"]),e.items,a(e.label),e["leave-menu-open"],e["min-chars"],!1,a(e.name),e["no-results"],a(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],e["show-spinner"],a(e.size),e.value,p,m,d)}},h={...W},b={render:e=>{(!e.items||e.items.length===0)&&(e.items=[...f]);const d=t=>{const n=t.target.closest("modus-wc-autocomplete");n&&(e.items=e.items.map(i=>i.value===t.detail.value?{...i,selected:!1}:i),n.items=[...e.items])},p=t=>{var i;if(!((i=t.detail)!=null&&i.target))return;const n=t.target.closest("modus-wc-autocomplete");if(n){const s=t.detail.target,l=s.value.toLowerCase(),u=e.items.map(r=>({...r,visibleInMenu:r.label.toLowerCase().includes(l),focused:!1}));e.items=u,n.items=[...e.items],n.value=s.value,n.value&&(e.initialNavigation=!1)}},m=()=>{e.initialNavigation=!0,e.items=e.items.map(t=>({...t,focused:!1,visibleInMenu:!0}))},o=t=>{const n=t.target.closest("modus-wc-autocomplete");n&&(e.items=e.items.map(i=>i.value===t.detail.value?{...i,selected:!0}:i),n.items=[...e.items],n.value="")},c=t=>{const n=t.target.closest("modus-wc-autocomplete");if(!n)return;e.initialNavigation===void 0&&(e.initialNavigation=!0),["ArrowDown","ArrowUp","Enter"].includes(t.key)&&t.preventDefault();const i=e.items.filter(s=>s.visibleInMenu&&!s.disabled);switch(t.target.value!==n.value&&(e.initialNavigation=!0),t.key){case"Escape":e.items=e.items.map(s=>({...s,focused:!1})),e.initialNavigation=!0,n.items=[...e.items];return;case"ArrowDown":if(e.initialNavigation){e.initialNavigation=!1;return}else{const s=i.findIndex(u=>u.focused),l=s<0?0:Math.min(s+1,i.length-1);e.items=e.items.map(u=>{var r;return{...u,focused:((r=i[l])==null?void 0:r.value)===u.value}})}break;case"ArrowUp":if(e.initialNavigation){e.initialNavigation=!1;return}else{const s=i.findIndex(u=>u.focused),l=s<0?i.length-1:Math.max(s-1,0);e.items=e.items.map(u=>{var r;return{...u,focused:((r=i[l])==null?void 0:r.value)===u.value}})}break;case"Enter":{const s=i.find(l=>l.focused);s&&(e.items=e.items.map(l=>({...l,selected:l.value===s.value?!l.selected:l.selected,focused:!1})),n.value="",e.initialNavigation=!0);break}default:return}n.items=[...e.items]};return v(M||(M=y([`
      <style>
      ...
      <modus-wc-autocomplete
        ...
        @keydown=`,`
      ></modus-wc-autocomplete>
    `])),e.bordered,a(e["custom-class"]),a(e["debounce-ms"]),e.disabled,a(e["input-id"]),a(e["input-tab-index"]),e.items,a(e.label),e["leave-menu-open"],e["min-chars"],!0,a(e.name),e["no-results"],a(e.placeholder),e["read-only"],e.required,a(e.size),e.value,d,p,o,m,c)}},g={render:e=>{const d=m=>{var c;if(!((c=m.detail)!=null&&c.target))return;const o=m.target.closest("modus-wc-autocomplete");if(o){const t=m.detail.target,n=t.value.toLowerCase();setTimeout(()=>{o.showSpinner=!1},2e3),o.showSpinner=!0;const i=f.map(s=>({...s,selected:n?s.selected:!1,visibleInMenu:s.label.toLowerCase().includes(n)}));o.items=[...i],o.value=t.value}},p=m=>{const o=m.target.closest("modus-wc-autocomplete");if(o){const c=m.detail.label;c&&(o.value=c),f.forEach(n=>n.selected=!1);const t=f.find(n=>n.value===m.detail.value);t&&(t.selected=!0,o.items=[...f])}};return v(T||(T=y([`
<style>
  /* Only for Storybook */
  div[id^="story--components-forms-autocomplete--default"] {
    height: 400px;
...
<modus-wc-autocomplete
  ...
  @itemSelect=`,`
></modus-wc-autocomplete>
    `])),e.bordered,a(e["custom-class"]),a(e["debounce-ms"]),e.disabled,a(e["input-id"]),a(e["input-tab-index"]),e.items,a(e.label),e["leave-menu-open"],e["min-chars"],!1,a(e.name),a(e.placeholder),e["read-only"],e.required,e["show-menu-on-focus"],e["show-spinner"],a(e.size),e.value,d,p)}},I={render:e=>{const d=e["no-results"];e["leave-menu-open"]==!0&&(e["no-results"]={ariaLabel:"",label:"",subLabel:""});const p=c=>{var n;if(!((n=c.detail)!=null&&n.target))return;const t=c.target.closest("modus-wc-autocomplete");if(t){const i=c.detail.target.value,s=t==null?void 0:t.querySelectorAll("li");i===""&&(s==null||s.forEach(u=>u.classList.remove("selected")));let l=0;Array.from(s??[]).forEach(u=>{var x,L;(((L=(x=u.querySelector(".title"))==null?void 0:x.textContent)==null?void 0:L.toLowerCase())||"").includes(i.toLowerCase())?(u.classList.remove("hidden"),t.noResults={ariaLabel:"",label:"",subLabel:""}):(u.classList.add("hidden"),l++,l===(s==null?void 0:s.length)&&(t.noResults=d))})}},m=c=>{const t=c.target.closest("modus-wc-autocomplete");t&&(t.noResults={ariaLabel:"",label:"",subLabel:""})},o=c=>{var n;const t=c.target.closest("modus-wc-autocomplete");if(t){const i=(n=c.detail.target)==null?void 0:n.value;t.value=i;const s=t==null?void 0:t.querySelectorAll("li");s==null||s.forEach(l=>l.classList.remove("selected")),s==null||s.forEach(l=>{var u;l.contains(c.target)&&(l.classList.add("selected"),t.value=(u=l.querySelector(".title"))==null?void 0:u.textContent)})}};return v(S||(S=y([`
<style>
  /* Only for Storybook */
...
`])),e.bordered,a(e["custom-class"]),a(e["debounce-ms"]),e.disabled,a(e["input-id"]),a(e["input-tab-index"]),a(e.label),e["leave-menu-open"],e["min-chars"],!1,a(e.name),e["no-results"],a(e.placeholder),e["read-only"],e.required,a(e.size),e.value,m,p,o,!0,a(e.size),o,!0,a(e.size),o,!0,a(e.size),o,!0,a(e.size),o,!0,a(e.size))}},w={parameters:{docs:{description:{story:`
#### Breaking Changes
...
\`\`\`
        `}},controls:{disable:!0},canvas:{disable:!0}},render:()=>v`<div></div>`};var $,k,D;h.parameters={...h.parameters,docs:{...($=h.parameters)==null?void 0:$.docs,source:{originalSource:`{
  ...Template
}`,...(D=(k=h.parameters)==null?void 0:k.docs)==null?void 0:D.source}}};var z,A,H;b.parameters={...b.parameters,docs:{...(z=b.parameters)==null?void 0:z.docs,source:{originalSource:`{
  render: args => {
    // Initialize args.items if empty
    if (!args.items || args.items.length === 0) {
      args.items = [...items];
...
}`,...(H=(A=b.parameters)==null?void 0:A.docs)==null?void 0:H.source}}};var N,q,P;g.parameters={...g.parameters,docs:{...(N=g.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: args => {
    const handleInputChange = (e: CustomEvent<Event>) => {
      if (!e.detail?.target) return;
      const autocomplete = (e.target as HTMLInputElement).closest('modus-wc-autocomplete');
...
}`,...(j=(F=I.parameters)==null?void 0:F.docs)==null?void 0:j.source}}};var U,B,O;w.parameters={...w.parameters,docs:{...(U=w.parameters)==null?void 0:U.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
        story: \`
...
\\\`\\\`\\\`
  ...
  render: () => html\`<div></div>\`
}`,...(O=(B=w.parameters)==null?void 0:B.docs)==null?void 0:O.source}}};const Z=["Default","MultiSelect","WithSpinner","CustomMenuItems","Migration"];export{I as CustomMenuItems,h as Default,w as Migration,b as MultiSelect,g as WithSpinner,Z as __namedExportsOrder,Y as default};
