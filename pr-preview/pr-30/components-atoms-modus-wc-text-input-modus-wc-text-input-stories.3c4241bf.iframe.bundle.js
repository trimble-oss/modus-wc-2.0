/*! For license information please see components-atoms-modus-wc-text-input-modus-wc-text-input-stories.3c4241bf.iframe.bundle.js.LICENSE.txt */
"use strict";(self.webpackChunk_trimble_cms_modus_wc=self.webpackChunk_trimble_cms_modus_wc||[]).push([[574],{"./src/components/atoms/modus-wc-text-input/modus-wc-text-input.stories.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Default:()=>Default,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var lit__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/lit/index.js"),lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_1__=__webpack_require__("./node_modules/lit/directives/if-defined.js");const __WEBPACK_DEFAULT_EXPORT__={title:"Components/Text Input",component:"modus-wc-text-input",argTypes:{ariaDescribedby:{control:"text",table:{sort:"alpha"}},ariaInvalid:{control:"boolean",table:{sort:"alpha"}},ariaLabel:{control:"text",table:{sort:"alpha"}},autoCapitalize:{control:{type:"select"},options:["off","none","on","sentences","words","characters"],table:{sort:"alpha"}},autoComplete:{control:{type:"select"},options:["on","off"],table:{sort:"alpha"}},autoFocus:{control:"boolean",table:{sort:"alpha"}},customClass:{control:"text",table:{sort:"alpha"}},dir:{control:{type:"select"},options:["ltr","rtl","auto"],table:{sort:"alpha"}},disabled:{control:"boolean",table:{sort:"alpha"}},id:{control:"text",table:{sort:"alpha"}},inputMode:{control:{type:"select"},options:["decimal","email","none","numeric","search","tel","text","url"],table:{sort:"alpha"}},maxLength:{control:"number",table:{sort:"alpha"}},minLength:{control:"number",table:{sort:"alpha"}},name:{control:"text",table:{sort:"alpha"}},pattern:{control:"text",table:{sort:"alpha"}},placeholder:{control:"text",table:{sort:"alpha"}},readonly:{control:"boolean",table:{sort:"alpha"}},required:{control:"boolean",table:{sort:"alpha"}},spellcheck:{control:"boolean",table:{sort:"alpha"}},tabIndex:{control:"number",table:{sort:"alpha"}},type:{control:{type:"select"},options:["email","password","search","tel","text","url"],table:{sort:"alpha"}},value:{control:"text",table:{sort:"alpha"}}},parameters:{controls:{sort:"alpha"}}},Template={render:args=>lit__WEBPACK_IMPORTED_MODULE_0__.qy`
    <div>
      <h1>Text Input</h1>
      <modus-wc-text-input
        ...
        auto-capitalize=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_1__.J)(args.autoCapitalize)}
        auto-complete=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_1__.J)(args.autoComplete)}
        ...
        input-mode=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_1__.J)(args.inputMode)}
        max-length=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_1__.J)(args.maxLength)}
        min-length=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_1__.J)(args.minLength)}
        name=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_1__.J)(args.name)}
        pattern=${(0,lit_directives_if_defined_js__WEBPACK_IMPORTED_MODULE_1__.J)(args.pattern)}
...
//# sourceMappingURL=components-atoms-modus-wc-text-input-modus-wc-text-input-stories.3c4241bf.iframe.bundle.js.map