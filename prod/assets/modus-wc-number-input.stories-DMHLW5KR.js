import{w as k}from"./decorator-D4YmxizW.js";import{x as g}from"./lit-element-C8zulti1.js";import{o as n}from"./if-defined-yv6owfG8.js";import"./chunk-4XZ63LWV-CnYBn8W6.js";import"./v4-CtRu48qb.js";const z={title:"Components/Forms/Number Input",component:"modus-wc-number-input",args:{bordered:!0,disabled:!1,inputmode:"numeric",label:"Label",size:"md",type:"number",value:""},argTypes:{"auto-complete":{control:{type:"select"},options:["on","off"]},feedback:{description:"Feedback prop for input components",table:{type:{detail:`
...
| valueChange  | inputChange  |       |
  ...
  render: () => html\`<div></div>\`
}`,...(h=(f=t.parameters)==null?void 0:f.docs)==null?void 0:h.source}}};const F=["Default","Currency","WithErrorFeedback","Migration"];export{a as Currency,r as Default,t as Migration,o as WithErrorFeedback,F as __namedExportsOrder,z as default};
